...
const CONTRACT_ADDRESS = process.env.BATTERY_STORAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-storage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'battery-storage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>battery-storage-leaseback</h1>
      {!userData ? (
