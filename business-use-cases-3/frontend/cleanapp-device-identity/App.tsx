...
const contractAddress = process.env.REACT_APP_CLEANAPP_DEVICE_IDENTITY_CONTRACT_ADDRESS || '';
const contractName = 'cleanapp-device-identity';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>cleanapp device identity</h1>
