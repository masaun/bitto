...
const CONTRACT_ADDRESS = process.env.BRIDGE_DISPUTE_RESOLUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bridge-dispute-resolution';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Bridge Dispute Resolution',
