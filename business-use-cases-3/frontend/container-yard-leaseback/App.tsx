...
const CONTRACT_ADDRESS = process.env.CONTAINER_YARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'container-yard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'container-yard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>container-yard-leaseback</h1>
      {!userData ? (
