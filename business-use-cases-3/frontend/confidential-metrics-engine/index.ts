...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_METRICS_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-metrics-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialMetricsEngine',
