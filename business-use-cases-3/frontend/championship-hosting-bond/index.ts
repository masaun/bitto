...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_HOSTING_BOND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-hosting-bond';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Hosting Bond',
