...
const CONTRACT_ADDRESS = process.env.BATTERY_RECYCLING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-recycling-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'battery-recycling-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>battery-recycling-leaseback</h1>
      {!userData ? (
