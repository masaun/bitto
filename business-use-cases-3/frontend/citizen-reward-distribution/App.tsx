...
const contractAddress = process.env.REACT_APP_CITIZEN_REWARD_DISTRIBUTION_CONTRACT_ADDRESS || '';
const contractName = 'citizen-reward-distribution';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citizen Reward Distribution</h1>
