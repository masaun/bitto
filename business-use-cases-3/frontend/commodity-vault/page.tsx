...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COMMODITY_VAULT_ADDRESS || '';

export default function Commodity_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.commodity-vault/read-only/get-counter`,
        {
          method: 'GET',
