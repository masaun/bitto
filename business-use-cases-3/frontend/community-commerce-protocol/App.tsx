...
const contractAddress = process.env.REACT_APP_COMMUNITY_COMMERCE_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'community-commerce-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Commerce Protocol</h1>
