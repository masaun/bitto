...
const CONTRACT_ADDRESS = process.env.CAMERA_RIG_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'camera-rig-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'camera-rig-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
