...
export default function contractHotelFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Hotel Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_HOTEL_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-hotel-furnishings';
  ...
  return (
    <div>
      <h1>Contract Hotel Furnishings</h1>
