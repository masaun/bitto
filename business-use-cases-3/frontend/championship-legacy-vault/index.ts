...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_LEGACY_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-legacy-vault';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Legacy Vault',
