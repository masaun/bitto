...
const contractAddress = process.env.REACT_APP_CITYWIDE_SCAVENGER_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'citywide-scavenger-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citywide Scavenger Protocol</h1>
