...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_REVENUE_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-revenue-index';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Revenue Index',
