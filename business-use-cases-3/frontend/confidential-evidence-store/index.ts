...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_EVIDENCE_STORE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-evidence-store';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialEvidenceStore',
