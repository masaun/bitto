...
const CONTRACT_ADDRESS = process.env.BRIDGE_CONSTRUCTION_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bridge-construction-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Bridge Construction Ledger',
