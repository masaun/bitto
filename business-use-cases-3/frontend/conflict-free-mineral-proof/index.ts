...
const CONTRACT_ADDRESS = process.env.CONFLICT_FREE_MINERAL_PROOF_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'conflict-free-mineral-proof';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Conflict Free Mineral Proof',
