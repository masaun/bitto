...
const CONTRACT_ADDRESS = process.env.CEMENT_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cement-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cement-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
