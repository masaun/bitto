...
const contractAddress = process.env.REACT_APP_CONFIDENTIAL_PRICE_ORACLE_CONTRACT_ADDRESS || '';
const contractName = 'confidential-price-oracle';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Confidential Price Oracle',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Confidential Price Oracle</h1>
