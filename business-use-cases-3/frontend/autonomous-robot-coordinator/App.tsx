...
const CONTRACT_ADDRESS = process.env.AUTONOMOUS_ROBOT_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'autonomous-robot-coordinator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'autonomous-robot-coordinator',
