...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BTC_ANCHOR_VAULT_ADDRESS || '';

export default function Btc_Anchor_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.btc-anchor-vault/read-only/get-counter`,
        {
          method: 'GET',
