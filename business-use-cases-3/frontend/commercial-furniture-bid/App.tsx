...
export default function commercialFurnitureBid() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_FURNITURE_BID_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-furniture-bid';
  ...
  return (
    <div>
      <h1>Commercial Furniture Bid</h1>
