...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COLD_STORAGE_POR_ADDRESS || '';

export default function Cold_Storage_PorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.cold-storage-por/read-only/get-counter`,
        {
          method: 'GET',
