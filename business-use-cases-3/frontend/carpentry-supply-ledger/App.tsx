...
export default function carpentrySupplyLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CARPENTRY_SUPPLY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'carpentry-supply-ledger';
