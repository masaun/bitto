...
const contractAddress = process.env.REACT_APP_COMPLIANCE_REPORTING_HUB_CONTRACT_ADDRESS || '';
const contractName = 'compliance-reporting-hub';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>compliance reporting hub</h1>
