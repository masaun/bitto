...
const CONTRACT_ADDRESS = process.env.BROADCASTING_RIGHTS_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcasting-rights-clearinghouse';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcasting Rights Clearinghouse',
