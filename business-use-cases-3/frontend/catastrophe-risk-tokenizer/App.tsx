...
const contractAddress = process.env.REACT_APP_CATASTROPHE_RISK_TOKENIZER_CONTRACT_ADDRESS || '';
const contractName = 'catastrophe-risk-tokenizer';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>catastrophe risk tokenizer</h1>
