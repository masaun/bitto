...
const CONTRACT_ADDRESS = process.env.BRIDGE_INTEGRITY_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bridge-integrity-verifier';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Bridge Integrity Verifier',
