...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CERTIFICATE_AUTH_ADDRESS || '';

export default function Certificate_AuthPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.certificate-auth/read-only/get-counter`,
        {
          method: 'GET',
