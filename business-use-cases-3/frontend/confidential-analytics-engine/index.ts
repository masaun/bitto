...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_ANALYTICS_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-analytics-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialAnalyticsEngine',
