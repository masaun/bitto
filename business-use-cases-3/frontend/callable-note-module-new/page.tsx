...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CALLABLE_NOTE_MODULE_NEW_ADDRESS || '';

export default function Callable_Note_Module_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.callable-note-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'callable-note-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>callable-note-module-new</h1>
