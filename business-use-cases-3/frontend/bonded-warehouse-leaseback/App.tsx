...
const CONTRACT_ADDRESS = process.env.BONDED_WAREHOUSE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bonded-warehouse-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'bonded-warehouse-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>bonded-warehouse-leaseback</h1>
      {!userData ? (
