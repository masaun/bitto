...
const contractAddress = process.env.REACT_APP_CITY_COLLABORATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'city-collaboration-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>City Collaboration Ledger</h1>
