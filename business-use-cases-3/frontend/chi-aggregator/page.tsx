...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CHI_AGGREGATOR_ADDRESS || '';

export default function Chi_AggregatorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.chi-aggregator/read-only/get-counter`,
        {
          method: 'GET',
