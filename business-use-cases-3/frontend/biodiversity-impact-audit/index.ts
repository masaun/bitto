...
const CONTRACT_ADDRESS = process.env.BIODIVERSITY_IMPACT_AUDIT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biodiversity-impact-audit';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Biodiversity Impact Audit',
