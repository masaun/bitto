...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_EXECUTION_TRACKER_ADDRESS || '';
const CONTRACT_NAME = 'conditional-execution-tracker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-execution-tracker',
