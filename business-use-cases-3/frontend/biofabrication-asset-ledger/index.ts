...
const CONTRACT_ADDRESS = process.env.BIOFABRICATION_ASSET_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biofabrication-asset-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Biofabrication Asset Ledger',
