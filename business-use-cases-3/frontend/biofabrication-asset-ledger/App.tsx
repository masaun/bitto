...
const contractAddress = process.env.REACT_APP_BIOFABRICATION_ASSET_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'biofabrication-asset-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>uiofaurication asset ledger</h1>
