...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_PERFORMANCE_BONUS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-performance-bonus';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Performance Bonus',
