...
const CONTRACT_ADDRESS = process.env.BIODIVERSITY_IMPACT_MONITOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biodiversity-impact-monitor';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Biodiversity Impact Monitor',
