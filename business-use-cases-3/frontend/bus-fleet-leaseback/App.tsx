...
const CONTRACT_ADDRESS = process.env.BUS_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bus-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'bus-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
