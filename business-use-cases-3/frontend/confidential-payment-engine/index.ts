...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_PAYMENT_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-payment-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialPaymentEngine',
