...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BINANCE_PROOF_V1_ADDRESS || '';

export default function Binance_Proof_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.binance-proof-v1/read-only/get-counter`,
        {
          method: 'GET',
