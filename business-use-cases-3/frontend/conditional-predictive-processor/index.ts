...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-predictive-processor',
