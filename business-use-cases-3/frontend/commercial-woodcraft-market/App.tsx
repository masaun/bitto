...
export default function commercialWoodcraftMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Woodcraft Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_WOODCRAFT_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-woodcraft-market';
  ...
  return (
    <div>
      <h1>Commercial Woodcraft Market</h1>
