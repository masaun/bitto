...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUDGETARY_GOVERNANCE_MODULE_ADDRESS || '';

export default function Budgetary_Governance_ModulePage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'budgetary-governance-module',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.budgetary-governance-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'budgetary-governance-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>budgetary-governance-module</h1>
