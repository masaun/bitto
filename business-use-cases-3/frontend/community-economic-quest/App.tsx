...
const contractAddress = process.env.REACT_APP_COMMUNITY_ECONOMIC_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'community-economic-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Economic Quest</h1>
