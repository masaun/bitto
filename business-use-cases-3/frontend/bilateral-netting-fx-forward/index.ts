...
const CONTRACT_ADDRESS = process.env.BILATERAL_NETTING_FX_FORWARD_ADDRESS || '';
const CONTRACT_NAME = 'bilateral-netting-fx-forward';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'bilateral-netting-fx-forward',
