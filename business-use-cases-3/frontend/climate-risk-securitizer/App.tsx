...
const contractAddress = process.env.REACT_APP_CLIMATE_RISK_SECURITIZER_CONTRACT_ADDRESS || '';
const contractName = 'climate-risk-securitizer';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate risk securitizer</h1>
