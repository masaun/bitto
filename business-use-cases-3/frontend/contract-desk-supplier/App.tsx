...
export default function contractDeskSupplier() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_DESK_SUPPLIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-desk-supplier';
