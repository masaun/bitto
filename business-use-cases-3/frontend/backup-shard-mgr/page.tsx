...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BACKUP_SHARD_MGR_ADDRESS || '';

export default function Backup_Shard_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.backup-shard-mgr/read-only/get-counter`,
        {
          method: 'GET',
