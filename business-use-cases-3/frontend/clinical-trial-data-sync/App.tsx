...
const CONTRACT_ADDRESS = process.env.CLINICAL_TRIAL_DATA_SYNC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'clinical-trial-data-sync';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>clinical-trial-data-sync</h1>
      {!userData ? (
