...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_ASSET_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-asset-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialAssetExchange',
