...
const CONTRACT_ADDRESS = process.env.CLIMATE_SUSTAINABILITY_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-sustainability-index';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'climate-sustainability-index',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-sustainability-index</h1>
      {!userData ? (
