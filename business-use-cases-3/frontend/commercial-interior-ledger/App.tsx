...
export default function commercialInteriorLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Interior Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-interior-ledger';
  ...
  return (
    <div>
      <h1>Commercial Interior Ledger</h1>
