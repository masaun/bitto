...
const CONTRACT_ADDRESS = process.env.AUTONOMOUS_DRONE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'autonomous-drone-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'autonomous-drone-registry',
