...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_GLOBAL_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-global-index';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Global Index',
