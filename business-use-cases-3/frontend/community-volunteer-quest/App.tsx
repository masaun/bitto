...
const contractAddress = process.env.REACT_APP_COMMUNITY_VOLUNTEER_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'community-volunteer-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Volunteer Quest</h1>
