...
const CONTRACT_ADDRESS = process.env.CLOUD_INFRASTRUCTURE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cloud-infrastructure-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cloud-infrastructure-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>cloud-infrastructure-leaseback</h1>
      {!userData ? (
