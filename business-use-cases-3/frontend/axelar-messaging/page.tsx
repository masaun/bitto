...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AXELAR_MESSAGING_ADDRESS || '';

export default function Axelar_MessagingPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.axelar-messaging/read-only/get-counter`,
        {
          method: 'GET',
