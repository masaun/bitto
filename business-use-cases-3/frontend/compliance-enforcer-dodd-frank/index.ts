...
const CONTRACT_ADDRESS = process.env.COMPLIANCE_ENFORCER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'compliance-enforcer-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'compliance-enforcer-dodd-frank',
