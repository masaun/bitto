...
export default function cabinetmakerGuildLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Cabinetmaker Guild Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CABINETMAKER_GUILD_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'cabinetmaker-guild-ledger';
  ...
  return (
    <div>
      <h1>Cabinetmaker Guild Ledger</h1>
