...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_AUDIT_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-audit-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialAuditRegistry',
