...
const CONTRACT_ADDRESS = process.env.BIOTECH_LAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biotech-lab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'biotech-lab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
