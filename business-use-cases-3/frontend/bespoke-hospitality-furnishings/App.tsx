...
export default function bespokeHospitalityFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Hospitality Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_HOSPITALITY_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-hospitality-furnishings';
  ...
  return (
    <div>
      <h1>Bespoke Hospitality Furnishings</h1>
