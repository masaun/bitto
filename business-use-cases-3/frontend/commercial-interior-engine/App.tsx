...
export default function commercialInteriorEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Interior Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_INTERIOR_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-interior-engine';
  ...
  return (
    <div>
      <h1>Commercial Interior Engine</h1>
