...
const contractAddress = process.env.REACT_APP_BIODEGRADABLE_SUPPLY_AUCTION_CONTRACT_ADDRESS || '';
const contractName = 'biodegradable-supply-auction';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>uiodegradaule supply auction</h1>
