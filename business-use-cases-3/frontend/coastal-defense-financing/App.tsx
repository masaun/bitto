...
const contractAddress = process.env.REACT_APP_COASTAL_DEFENSE_FINANCING_CONTRACT_ADDRESS || '';
const contractName = 'coastal-defense-financing';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>coastal defense financing</h1>
