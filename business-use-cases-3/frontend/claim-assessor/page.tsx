...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CLAIM_ASSESSOR_ADDRESS || '';

export default function Claim_AssessorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.claim-assessor/read-only/get-counter`,
        {
          method: 'GET',
