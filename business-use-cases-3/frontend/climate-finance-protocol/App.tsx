...
const CONTRACT_ADDRESS = process.env.CLIMATE_FINANCE_PROTOCOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-finance-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-finance-protocol</h1>
      {!userData ? (
