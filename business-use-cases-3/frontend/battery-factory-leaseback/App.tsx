...
const CONTRACT_ADDRESS = process.env.BATTERY_FACTORY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-factory-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'battery-factory-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>battery-factory-leaseback</h1>
      {!userData ? (
