...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUYBACK_AND_BURN_ADDRESS || '';

export default function Buyback_And_BurnPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.buyback-and-burn/read-only/get-counter`,
        {
          method: 'GET',
