...
const CONTRACT_ADDRESS = process.env.BROADCAST_VIEWERSHIP_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-viewership-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcast Viewership Token',
