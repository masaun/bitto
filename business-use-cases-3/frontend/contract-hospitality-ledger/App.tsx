...
export default function contractHospitalityLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Hospitality Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_HOSPITALITY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-hospitality-ledger';
  ...
  return (
    <div>
      <h1>Contract Hospitality Ledger</h1>
