...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_LEGACY_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-legacy-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Legacy Token',
