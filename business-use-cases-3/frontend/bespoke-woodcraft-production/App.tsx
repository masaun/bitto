...
export default function bespokeWoodcraftProduction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Woodcraft Production',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_WOODCRAFT_PRODUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-woodcraft-production';
  ...
  return (
    <div>
      <h1>Bespoke Woodcraft Production</h1>
