...
export default function bespokeStorageSolutions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Storage Solutions',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_STORAGE_SOLUTIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-storage-solutions';
  ...
  return (
    <div>
      <h1>Bespoke Storage Solutions</h1>
