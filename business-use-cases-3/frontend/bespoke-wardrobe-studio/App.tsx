...
export default function bespokeWardrobeStudio() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_WARDROBE_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-wardrobe-studio';
