...
const contractAddress = process.env.REACT_APP_CONDITIONAL_PAYMENT_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'conditional-payment-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Conditional Payment Registry',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Conditional Payment Registry</h1>
