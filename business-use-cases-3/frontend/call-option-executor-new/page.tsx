...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CALL_OPTION_EXECUTOR_NEW_ADDRESS || '';

export default function Call_Option_Executor_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.call-option-executor-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'call-option-executor-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>call-option-executor-new</h1>
