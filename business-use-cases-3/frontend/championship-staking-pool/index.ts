...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_STAKING_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-staking-pool';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Staking Pool',
