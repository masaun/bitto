...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUDGETARY_CONTROL_MODULE_ADDRESS || '';

export default function Budgetary_Control_ModulePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.budgetary-control-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'budgetary-control-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>budgetary-control-module</h1>
