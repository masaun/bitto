...
export default function bespokeHomeFurnishings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_HOME_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-home-furnishings';
  ...
  return (
    <div>
      <h1>Bespoke Home Furnishings</h1>
