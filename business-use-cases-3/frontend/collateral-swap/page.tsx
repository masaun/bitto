...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COLLATERAL_SWAP_ADDRESS || '';

export default function Collateral_SwapPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.collateral-swap/read-only/get-counter`,
        {
          method: 'GET',
