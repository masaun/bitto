...
const contractAddress = process.env.REACT_APP_CONFIDENTIALITY_BREACH_LOG_CONTRACT_ADDRESS || '';
const contractName = 'confidentiality-breach-log';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Confidentiality Breach Log',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Confidentiality Breach Log</h1>
