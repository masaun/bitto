...
const CONTRACT_ADDRESS = process.env.BATTERY_RECOVERY_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-recovery-tracking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Battery Recovery Tracking',
