...
const CONTRACT_ADDRESS = process.env.BROADCAST_AD_SLOT_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-ad-slot-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcast Ad Slot Auction',
