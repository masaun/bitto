...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BIKE_SHARE_NODE_ADDRESS || '';

export default function Bike_Share_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bike-share-node/read-only/get-counter`,
        {
          method: 'GET',
