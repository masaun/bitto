...
const contractAddress = process.env.REACT_APP_CATASTROPHE_AUCTION_FACTORY_CONTRACT_ADDRESS || '';
const contractName = 'catastrophe-auction-factory';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>catastrophe auction factory</h1>
