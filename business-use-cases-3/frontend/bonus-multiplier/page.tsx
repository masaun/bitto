...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BONUS_MULTIPLIER_ADDRESS || '';

export default function Bonus_MultiplierPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bonus-multiplier/read-only/get-counter`,
        {
          method: 'GET',
