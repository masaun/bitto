...
export default function cabinetrySourcingEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Cabinetry Sourcing Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CABINETRY_SOURCING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'cabinetry-sourcing-engine';
  ...
  return (
    <div>
      <h1>Cabinetry Sourcing Engine</h1>
