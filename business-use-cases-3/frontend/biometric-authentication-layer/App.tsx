...
const CONTRACT_ADDRESS = process.env.BIOMETRIC_AUTHENTICATION_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biometric-authentication-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'biometric-authentication-layer',
