...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_TRADE_DATA_ROOM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-trade-data-room';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Confidential Trade Data Room',
