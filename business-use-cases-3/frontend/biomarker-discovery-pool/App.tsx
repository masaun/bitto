...
const contractAddress = process.env.REACT_APP_BIOMARKER_DISCOVERY_POOL_CONTRACT_ADDRESS || '';
const contractName = 'biomarker-discovery-pool';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>uiomarker discovery pool</h1>
