...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_SUPPLY_CHAIN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-supply-chain';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Supply Chain',
