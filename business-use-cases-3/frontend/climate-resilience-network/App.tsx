...
const CONTRACT_ADDRESS = process.env.CLIMATE_RESILIENCE_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-resilience-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'climate-resilience-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-resilience-network</h1>
      {!userData ? (
