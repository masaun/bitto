...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CIRCUIT_COMPILER_ADDRESS || '';

export default function Circuit_CompilerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.circuit-compiler/read-only/get-counter`,
        {
          method: 'GET',
