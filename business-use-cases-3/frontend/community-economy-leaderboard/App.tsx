...
const contractAddress = process.env.REACT_APP_COMMUNITY_ECONOMY_LEADERBOARD_CONTRACT_ADDRESS || '';
const contractName = 'community-economy-leaderboard';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Economy Leaderboard</h1>
