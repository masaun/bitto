...
const contractAddress = process.env.REACT_APP_CIVIC_PARTICIPATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'civic-participation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Civic Participation Ledger</h1>
