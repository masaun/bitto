...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-sequential-processor',
