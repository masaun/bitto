...
const contractAddress = process.env.REACT_APP_CITIZEN_PARTICIPATION_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'citizen-participation-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citizen Participation Protocol</h1>
