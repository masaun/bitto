...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_LIQUIDITY_BRIDGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-liquidity-bridge';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialLiquidityBridge',
