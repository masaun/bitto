...
const contractAddress = process.env.REACT_APP_CITYWIDE_PARTICIPATION_GAME_CONTRACT_ADDRESS || '';
const contractName = 'citywide-participation-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citywide Participation Game</h1>
