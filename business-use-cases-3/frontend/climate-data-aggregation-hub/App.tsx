...
const CONTRACT_ADDRESS = process.env.CLIMATE_DATA_AGGREGATION_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-data-aggregation-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'climate-data-aggregation-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-data-aggregation-hub</h1>
      {!userData ? (
