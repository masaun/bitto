...
export default function commercialInteriorContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Interior Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_INTERIOR_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-interior-contract';
  ...
  return (
    <div>
      <h1>Commercial Interior Contract</h1>
