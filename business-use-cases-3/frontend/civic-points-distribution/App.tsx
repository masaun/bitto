...
const contractAddress = process.env.REACT_APP_CIVIC_POINTS_DISTRIBUTION_CONTRACT_ADDRESS || '';
const contractName = 'civic-points-distribution';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Civic Points Distribution</h1>
