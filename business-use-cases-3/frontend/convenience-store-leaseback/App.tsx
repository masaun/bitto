...
const CONTRACT_ADDRESS = process.env.CONVENIENCE_STORE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'convenience-store-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'convenience-store-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>convenience-store-leaseback</h1>
      {!userData ? (
