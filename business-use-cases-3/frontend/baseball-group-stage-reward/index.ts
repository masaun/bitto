...
const CONTRACT_ADDRESS = process.env.BASEBALL_GROUP_STAGE_REWARD_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'baseball-group-stage-reward';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Baseball Group Stage Reward',
