...
export default function commercialFurnitureSupply() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Furniture Supply',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_FURNITURE_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-furniture-supply';
  ...
  return (
    <div>
      <h1>Commercial Furniture Supply</h1>
