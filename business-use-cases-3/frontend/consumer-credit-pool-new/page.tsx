...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONSUMER_CREDIT_POOL_NEW_ADDRESS || '';

export default function Consumer_Credit_Pool_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.consumer-credit-pool-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'consumer-credit-pool-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>consumer-credit-pool-new</h1>
