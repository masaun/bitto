...
const contractAddress = process.env.REACT_APP_CITIZEN_COMMERCE_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'citizen-commerce-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citizen Commerce Rewards</h1>
