...
const CONTRACT_ADDRESS = process.env.BASEBALL_ARENA_RENOVATION_BOND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'baseball-arena-renovation-bond';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Baseball Arena Renovation Bond',
