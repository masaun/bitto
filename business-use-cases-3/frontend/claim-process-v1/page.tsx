...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CLAIM_PROCESS_V1_ADDRESS || '';

export default function Claim_Process_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.claim-process-v1/read-only/get-counter`,
        {
          method: 'GET',
