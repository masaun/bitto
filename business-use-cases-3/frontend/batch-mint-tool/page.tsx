...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BATCH_MINT_TOOL_ADDRESS || '';

export default function Batch_Mint_ToolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.batch-mint-tool/read-only/get-counter`,
        {
          method: 'GET',
