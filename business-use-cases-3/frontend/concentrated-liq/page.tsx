...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONCENTRATED_LIQ_ADDRESS || '';

export default function Concentrated_LiqPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.concentrated-liq/read-only/get-counter`,
        {
          method: 'GET',
