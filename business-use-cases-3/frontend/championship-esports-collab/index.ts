...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_ESPORTS_COLLAB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-esports-collab';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Esports Collab',
