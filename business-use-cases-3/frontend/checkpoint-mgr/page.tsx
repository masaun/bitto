...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CHECKPOINT_MGR_ADDRESS || '';

export default function Checkpoint_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.checkpoint-mgr/read-only/get-counter`,
        {
          method: 'GET',
