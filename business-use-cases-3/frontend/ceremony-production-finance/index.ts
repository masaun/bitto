...
const CONTRACT_ADDRESS = process.env.CEREMONY_PRODUCTION_FINANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ceremony-production-finance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ceremony Production Finance',
