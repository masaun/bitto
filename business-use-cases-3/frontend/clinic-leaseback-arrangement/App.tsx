...
const CONTRACT_ADDRESS = process.env.CLINIC_LEASEBACK_ARRANGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'clinic-leaseback-arrangement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'clinic-leaseback-arrangement', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>clinic-leaseback-arrangement</h1>
      {!userData ? (
