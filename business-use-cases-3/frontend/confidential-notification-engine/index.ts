...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_NOTIFICATION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-notification-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialNotificationEngine',
