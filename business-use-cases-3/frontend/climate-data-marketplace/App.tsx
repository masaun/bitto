...
const CONTRACT_ADDRESS = process.env.CLIMATE_DATA_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-data-marketplace';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-data-marketplace</h1>
      {!userData ? (
