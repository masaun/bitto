...
const contractAddress = process.env.REACT_APP_COMMERCE_ACTIVATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'commerce-activation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Commerce Activation Ledger</h1>
