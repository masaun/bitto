...
const contractAddress = process.env.REACT_APP_COMMERCE_ENGAGEMENT_NETWORK_CONTRACT_ADDRESS || '';
const contractName = 'commerce-engagement-network';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Commerce Engagement Network</h1>
