...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_CEREMONY_NFT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-ceremony-nft';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Ceremony Nft',
