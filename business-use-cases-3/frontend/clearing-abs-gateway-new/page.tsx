...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CLEARING_ABS_GATEWAY_NEW_ADDRESS || '';

export default function Clearing_Abs_Gateway_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.clearing-abs-gateway-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'clearing-abs-gateway-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>clearing-abs-gateway-new</h1>
