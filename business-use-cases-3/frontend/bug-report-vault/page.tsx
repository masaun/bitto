...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUG_REPORT_VAULT_ADDRESS || '';

export default function Bug_Report_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bug-report-vault/read-only/get-counter`,
        {
          method: 'GET',
