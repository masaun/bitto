...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BAD_DEBT_SETTLER_ADDRESS || '';

export default function Bad_Debt_SettlerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bad-debt-settler/read-only/get-counter`,
        {
          method: 'GET',
