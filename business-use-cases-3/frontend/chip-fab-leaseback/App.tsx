...
const CONTRACT_ADDRESS = process.env.CHIP_FAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'chip-fab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'chip-fab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
