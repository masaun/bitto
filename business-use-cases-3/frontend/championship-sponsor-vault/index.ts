...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_SPONSOR_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-sponsor-vault';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Sponsor Vault',
