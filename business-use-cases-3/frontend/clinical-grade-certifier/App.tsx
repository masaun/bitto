...
const contractAddress = process.env.REACT_APP_CLINICAL_GRADE_CERTIFIER_CONTRACT_ADDRESS || '';
const contractName = 'clinical-grade-certifier';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>clinical grade certifier</h1>
