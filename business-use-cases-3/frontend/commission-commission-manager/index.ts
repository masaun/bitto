...
const CONTRACT_ADDRESS = process.env.COMMISSION_COMMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'commission-commission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'commission-commission-manager',
