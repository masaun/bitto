...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_IDENTITY_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-identity-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialIdentityRegistry',
