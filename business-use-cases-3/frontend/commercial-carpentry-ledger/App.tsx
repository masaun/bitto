...
export default function commercialCarpentryLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Carpentry Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_CARPENTRY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-carpentry-ledger';
  ...
  return (
    <div>
      <h1>Commercial Carpentry Ledger</h1>
