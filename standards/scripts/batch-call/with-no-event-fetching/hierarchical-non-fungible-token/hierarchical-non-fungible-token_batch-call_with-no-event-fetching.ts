...
const contractDetails = parseContractIdentifier(
  process.env.HIERARCHICAL_NON_FUNGIBLE_TOKEN_CONTRACT_ADDRESS,
  'hierarchical-non-fungible-token'
);
  ...
  return [
    {
      ...
      description: 'Mint new hierarchical NFT',
    },
    {
      name: 'mint-child',
      args: () => [uintCV(1), principalCV(recipientAddress), stringAsciiCV('ipfs://child-uri')],
      description: 'Mint child NFT under parent',
    },
    {
      name: 'transfer',
    ...
    },
    {
      ...
      args: () => [uintCV(2), uintCV(1)],
      description: 'Change parent of NFT',
    },
    {
      name: 'burn',
      args: () => [uintCV(1)],
...
async function executeBatchCycles(): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for hierarchical-non-fungible-token ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  Hierarchical Non-Fungible Token - Batch Call Script');
  console.log('==========================================================');
