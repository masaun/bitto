...
const CONTRACT_ADDRESS = process.env.ML_POWERED_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-proactive-processor',
