...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_FEE_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-fee-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-fee-manager',
