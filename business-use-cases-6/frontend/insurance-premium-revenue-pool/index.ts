...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_POOL_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-pool';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-pool',
