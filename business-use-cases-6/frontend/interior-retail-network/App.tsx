...
export default function interiorRetailNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_RETAIL_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-retail-network';
