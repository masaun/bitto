...
const CONTRACT_ADDRESS = process.env.MACHINERY_LEASEBACK_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'machinery-leaseback-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'machinery-leaseback-market', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>machinery-leaseback-market</h1>
      {!userData ? (
