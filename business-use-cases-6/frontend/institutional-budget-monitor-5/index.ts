...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_BUDGET_MONITOR_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-budget-monitor-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-budget-monitor-5',
