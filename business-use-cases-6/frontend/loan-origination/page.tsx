...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LOAN_ORIGINATION_ADDRESS || '';

export default function Loan_OriginationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.loan-origination/read-only/get-counter`,
        {
          method: 'GET',
