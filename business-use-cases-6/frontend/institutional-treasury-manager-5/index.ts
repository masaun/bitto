...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_TREASURY_MANAGER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-treasury-manager-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-treasury-manager-5',
