...
const CONTRACT_ADDRESS = process.env.MEDICAL_DEVICE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'medical-device-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'medical-device-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>medical-device-leaseback</h1>
      {!userData ? (
