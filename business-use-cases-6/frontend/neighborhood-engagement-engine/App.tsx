...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_ENGAGEMENT_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-engagement-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Engagement Engine</h1>
