...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LEGAL_DEFENSE_AI_ADDRESS || '';

export default function Legal_Defense_AiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.legal-defense-ai/read-only/get-counter`,
        {
          method: 'GET',
