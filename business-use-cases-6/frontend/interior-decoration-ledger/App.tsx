...
export default function interiorDecorationLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Interior Decoration Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_DECORATION_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-decoration-ledger';
  ...
  return (
    <div>
      <h1>Interior Decoration Ledger</h1>
