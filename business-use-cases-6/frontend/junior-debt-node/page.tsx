...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_JUNIOR_DEBT_NODE_ADDRESS || '';

export default function Junior_Debt_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.junior-debt-node/read-only/get-counter`,
        {
          method: 'GET',
