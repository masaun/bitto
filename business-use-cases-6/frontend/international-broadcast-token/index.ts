...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_BROADCAST_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-broadcast-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Broadcast Token',
