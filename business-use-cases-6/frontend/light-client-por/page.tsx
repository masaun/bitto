...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LIGHT_CLIENT_POR_ADDRESS || '';

export default function Light_Client_PorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.light-client-por/read-only/get-counter`,
        {
          method: 'GET',
