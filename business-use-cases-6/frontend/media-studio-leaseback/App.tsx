...
const CONTRACT_ADDRESS = process.env.MEDIA_STUDIO_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'media-studio-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'media-studio-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
