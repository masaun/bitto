...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_COMMUNITY_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-community-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-community-fund-5',
