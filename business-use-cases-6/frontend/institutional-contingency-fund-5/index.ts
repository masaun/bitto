...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_CONTINGENCY_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-contingency-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-contingency-fund-5',
