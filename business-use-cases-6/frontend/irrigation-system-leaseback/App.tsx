...
const CONTRACT_ADDRESS = process.env.IRRIGATION_SYSTEM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'irrigation-system-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'irrigation-system-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>irrigation-system-leaseback</h1>
      {!userData ? (
