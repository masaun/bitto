...
export default function modularSeatingMarket() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_SEATING_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-seating-market';
