...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_SPLITTER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-splitter-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-splitter-5',
