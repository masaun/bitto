...
const CONTRACT_ADDRESS = process.env.MINERAL_EXPLORATION_PERMITS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mineral-exploration-permits';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Mineral Exploration Permits',
