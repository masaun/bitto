...
const contractAddress = process.env.REACT_APP_JANITOR_PERFORMANCE_SCORE_CONTRACT_ADDRESS || '';
const contractName = 'janitor-performance-score';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>janitor performance score</h1>
