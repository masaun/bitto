...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MERGER_ARBITRAGE_ADDRESS || '';

export default function Merger_ArbitragePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.merger-arbitrage/read-only/get-counter`,
        {
          method: 'GET',
