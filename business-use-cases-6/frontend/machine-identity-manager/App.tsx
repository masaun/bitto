...
const CONTRACT_ADDRESS = process.env.MACHINE_IDENTITY_MANAGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'machine-identity-manager';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>machine-identity-manager</h1>
      {!userData ? (
