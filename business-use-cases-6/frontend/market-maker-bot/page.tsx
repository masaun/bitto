...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MARKET_MAKER_BOT_ADDRESS || '';

export default function Market_Maker_BotPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.market-maker-bot/read-only/get-counter`,
        {
          method: 'GET',
