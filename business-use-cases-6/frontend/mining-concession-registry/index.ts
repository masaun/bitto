...
const CONTRACT_ADDRESS = process.env.MINING_CONCESSION_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mining-concession-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Mining Concession Registry',
