...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_JAIL_SYSTEM_NODE_ADDRESS || '';

export default function Jail_System_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.jail-system-node/read-only/get-counter`,
        {
          method: 'GET',
