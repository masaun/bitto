...
export default function leatherSofaProducer() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LEATHER_SOFA_PRODUCER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'leather-sofa-producer';
