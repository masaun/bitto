...
const CONTRACT_ADDRESS = process.env.MANUFACTURING_PROCESS_TRACKER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'manufacturing-process-tracker';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>manufacturing-process-tracker</h1>
      {!userData ? (
