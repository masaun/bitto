...
const contractAddress = process.env.REACT_APP_LOCAL_INFLUENCER_MISSIONS_CONTRACT_ADDRESS || '';
const contractName = 'local-influencer-missions';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Influencer Missions</h1>
