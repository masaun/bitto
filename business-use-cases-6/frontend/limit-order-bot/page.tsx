...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LIMIT_ORDER_BOT_ADDRESS || '';

export default function Limit_Order_BotPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.limit-order-bot/read-only/get-counter`,
        {
          method: 'GET',
