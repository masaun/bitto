...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_DESTINATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-destination-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Destination Ledger</h1>
