...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MESSAGE_RELAY_V1_ADDRESS || '';

export default function Message_Relay_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.message-relay-v1/read-only/get-counter`,
        {
          method: 'GET',
