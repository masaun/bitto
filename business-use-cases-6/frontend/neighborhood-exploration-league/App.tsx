...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_EXPLORATION_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-exploration-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Exploration League</h1>
