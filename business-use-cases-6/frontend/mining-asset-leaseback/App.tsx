...
const CONTRACT_ADDRESS = process.env.MINING_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mining-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'mining-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
