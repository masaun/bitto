...
const CONTRACT_ADDRESS = process.env.KNOWLEDGE_GRAPH_SYNCHRONIZER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'knowledge-graph-synchronizer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'knowledge-graph-synchronizer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>knowledge-graph-synchronizer</h1>
      {!userData ? (
