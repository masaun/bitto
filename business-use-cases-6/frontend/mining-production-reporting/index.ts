...
const CONTRACT_ADDRESS = process.env.MINING_PRODUCTION_REPORTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mining-production-reporting';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Mining Production Reporting',
