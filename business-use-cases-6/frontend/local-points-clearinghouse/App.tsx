...
const contractAddress = process.env.REACT_APP_LOCAL_POINTS_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const contractName = 'local-points-clearinghouse';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Points Clearinghouse</h1>
