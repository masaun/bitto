...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_NETWORK_TOPOLOGY_ADDRESS || '';

export default function Network_TopologyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.network-topology/read-only/get-counter`,
        {
          method: 'GET',
