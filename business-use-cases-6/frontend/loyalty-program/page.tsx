...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LOYALTY_PROGRAM_ADDRESS || '';

export default function Loyalty_ProgramPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.loyalty-program/read-only/get-counter`,
        {
          method: 'GET',
