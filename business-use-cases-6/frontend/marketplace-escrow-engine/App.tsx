...
const CONTRACT_ADDRESS = process.env.MARKETPLACE_ESCROW_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'marketplace-escrow-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'marketplace-escrow-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>marketplace-escrow-engine</h1>
      {!userData ? (
