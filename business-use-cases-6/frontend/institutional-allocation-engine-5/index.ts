...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_ALLOCATION_ENGINE_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-allocation-engine-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-allocation-engine-5',
