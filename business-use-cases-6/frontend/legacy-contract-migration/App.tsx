...
const contractAddress = process.env.REACT_APP_LEGACY_CONTRACT_MIGRATION_CONTRACT_ADDRESS || '';
const contractName = 'legacy-contract-migration';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Legacy Contract Migration</h1>
