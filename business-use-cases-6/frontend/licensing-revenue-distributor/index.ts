...
const CONTRACT_ADDRESS = process.env.LICENSING_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'licensing-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'licensing-revenue-distributor',
