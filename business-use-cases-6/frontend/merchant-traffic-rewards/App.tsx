...
const contractAddress = process.env.REACT_APP_MERCHANT_TRAFFIC_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'merchant-traffic-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Merchant Traffic Rewards</h1>
