...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INTERNAL_RATE_RETURN_NEW_ADDRESS || '';

export default function Internal_Rate_Return_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.internal-rate-return-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'internal-rate-return-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>internal-rate-return-new</h1>
