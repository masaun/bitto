...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_GATEWAY_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-gateway-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-gateway-5',
