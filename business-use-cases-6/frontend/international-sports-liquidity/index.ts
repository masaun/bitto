...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_SPORTS_LIQUIDITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-sports-liquidity';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Sports Liquidity',
