...
const contractAddress = process.env.REACT_APP_INSURANCE_LINKED_SECURITY_HUB_CONTRACT_ADDRESS || '';
const contractName = 'insurance-linked-security-hub';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>insurance linked security hub</h1>
