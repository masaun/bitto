...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_DISTRIBUTION_ENGINE_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-distribution-engine-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-distribution-engine-5',
