...
const contractAddress = process.env.REACT_APP_IPS_CELL_LINEAGE_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'ips-cell-lineage-registry';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>ips cell lineage registry</h1>
