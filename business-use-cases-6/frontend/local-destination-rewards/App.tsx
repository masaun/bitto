...
const contractAddress = process.env.REACT_APP_LOCAL_DESTINATION_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'local-destination-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Destination Rewards</h1>
