...
export default function modularOfficeSystems() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_OFFICE_SYSTEMS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-office-systems';
