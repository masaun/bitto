...
const contractAddress = process.env.REACT_APP_LINEAGE_TRACING_CONSORTIUM_CONTRACT_ADDRESS || '';
const contractName = 'lineage-tracing-consortium';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>lineage tracing consortium</h1>
