...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MULTISIG_SAFE_V1_ADDRESS || '';

export default function Multisig_Safe_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.multisig-safe-v1/read-only/get-counter`,
        {
          method: 'GET',
