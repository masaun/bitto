...
export default function modularFurnishingNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Modular Furnishing Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_FURNISHING_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-furnishing-network';
  ...
  return (
    <div>
      <h1>Modular Furnishing Network</h1>
