...
const contractAddress = process.env.REACT_APP_INNOVATION_DISTRICT_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'innovation-district-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Innovation District Quest</h1>
