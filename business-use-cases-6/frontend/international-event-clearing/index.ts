...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_EVENT_CLEARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-event-clearing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Event Clearing',
