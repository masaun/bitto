...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MU_VAULT_MANAGER_ADDRESS || '';

export default function Mu_Vault_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.mu-vault-manager/read-only/get-counter`,
        {
          method: 'GET',
