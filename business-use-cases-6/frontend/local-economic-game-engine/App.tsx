...
const contractAddress = process.env.REACT_APP_LOCAL_ECONOMIC_GAME_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'local-economic-game-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Economic Game Engine</h1>
