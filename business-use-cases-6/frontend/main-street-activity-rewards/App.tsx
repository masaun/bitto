...
const contractAddress = process.env.REACT_APP_MAIN_STREET_ACTIVITY_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'main-street-activity-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Main Street Activity Rewards</h1>
