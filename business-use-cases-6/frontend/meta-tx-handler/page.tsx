...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_META_TX_HANDLER_ADDRESS || '';

export default function Meta_Tx_HandlerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.meta-tx-handler/read-only/get-counter`,
        {
          method: 'GET',
