...
const CONTRACT_ADDRESS = process.env.INTEREST_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'interest-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'interest-revenue-distributor',
