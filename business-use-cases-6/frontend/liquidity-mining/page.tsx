...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LIQUIDITY_MINING_ADDRESS || '';

export default function Liquidity_MiningPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.liquidity-mining/read-only/get-counter`,
        {
          method: 'GET',
