...
const CONTRACT_ADDRESS = process.env.LANDMARK_PROPERTY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'landmark-property-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'landmark-property-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>landmark-property-leaseback</h1>
      {!userData ? (
