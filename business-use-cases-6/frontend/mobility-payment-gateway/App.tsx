...
const CONTRACT_ADDRESS = process.env.MOBILITY_PAYMENT_GATEWAY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mobility-payment-gateway';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>mobility-payment-gateway</h1>
      {!userData ? (
