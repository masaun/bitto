...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MARKETING_WALLET_ADDRESS || '';

export default function Marketing_WalletPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.marketing-wallet/read-only/get-counter`,
        {
          method: 'GET',
