...
const CONTRACT_ADDRESS = process.env.MATCHDAY_HOSPITALITY_PASS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'matchday-hospitality-pass';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Matchday Hospitality Pass',
