...
const CONTRACT_ADDRESS = process.env.MEDAL_CEREMONY_LICENSING_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'medal-ceremony-licensing-hub';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Medal Ceremony Licensing Hub',
