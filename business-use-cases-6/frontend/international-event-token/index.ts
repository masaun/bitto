...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_EVENT_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-event-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Event Token',
