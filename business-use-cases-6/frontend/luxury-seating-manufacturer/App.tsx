...
export default function luxurySeatingManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Seating Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_SEATING_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-seating-manufacturer';
  ...
  return (
    <div>
      <h1>Luxury Seating Manufacturer</h1>
