...
export default function luxuryOfficeFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Office Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_OFFICE_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-office-furnishings';
  ...
  return (
    <div>
      <h1>Luxury Office Furnishings</h1>
