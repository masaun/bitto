...
const CONTRACT_ADDRESS = process.env.MODULAR_HOME_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'modular-home-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'modular-home-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>modular-home-plant-leaseback</h1>
      {!userData ? (
