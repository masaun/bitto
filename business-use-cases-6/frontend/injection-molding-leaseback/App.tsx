...
const CONTRACT_ADDRESS = process.env.INJECTION_MOLDING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'injection-molding-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'injection-molding-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>injection-molding-leaseback</h1>
      {!userData ? (
