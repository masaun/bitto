...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MINT_MASTER_CORE_ADDRESS || '';

export default function Mint_Master_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.mint-master-core/read-only/get-counter`,
        {
          method: 'GET',
