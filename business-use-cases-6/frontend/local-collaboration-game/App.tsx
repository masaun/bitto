...
const contractAddress = process.env.REACT_APP_LOCAL_COLLABORATION_GAME_CONTRACT_ADDRESS || '';
const contractName = 'local-collaboration-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Collaboration Game</h1>
