...
const CONTRACT_ADDRESS = process.env.MEDICAL_CAMPUS_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'medical-campus-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'medical-campus-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>medical-campus-leaseback</h1>
      {!userData ? (
