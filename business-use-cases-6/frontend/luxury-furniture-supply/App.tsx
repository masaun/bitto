...
export default function luxuryFurnitureSupply() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_FURNITURE_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-furniture-supply';
