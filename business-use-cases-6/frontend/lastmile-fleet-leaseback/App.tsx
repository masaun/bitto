...
const CONTRACT_ADDRESS = process.env.LASTMILE_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'lastmile-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'lastmile-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>lastmile-fleet-leaseback</h1>
      {!userData ? (
