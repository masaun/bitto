...
const CONTRACT_ADDRESS = process.env.NATIONAL_TEAM_FUNDING_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'national-team-funding-vault';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'National Team Funding Vault',
