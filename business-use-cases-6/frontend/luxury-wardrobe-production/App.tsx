...
export default function luxuryWardrobeProduction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Wardrobe Production',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_WARDROBE_PRODUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-wardrobe-production';
  ...
  return (
    <div>
      <h1>Luxury Wardrobe Production</h1>
