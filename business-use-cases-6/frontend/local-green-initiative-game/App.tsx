...
const contractAddress = process.env.REACT_APP_LOCAL_GREEN_INITIATIVE_GAME_CONTRACT_ADDRESS || '';
const contractName = 'local-green-initiative-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Green Initiative Game</h1>
