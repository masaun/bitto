...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MARKET_CAP_AGG_ADDRESS || '';

export default function Market_Cap_AggPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.market-cap-agg/read-only/get-counter`,
        {
          method: 'GET',
