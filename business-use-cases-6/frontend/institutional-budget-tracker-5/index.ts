...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_BUDGET_TRACKER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-budget-tracker-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-budget-tracker-5',
