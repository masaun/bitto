...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_EXAMINER_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-examiner';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-examiner',
