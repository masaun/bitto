...
const CONTRACT_ADDRESS = process.env.IT_HARDWARE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'it-hardware-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'it-hardware-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
