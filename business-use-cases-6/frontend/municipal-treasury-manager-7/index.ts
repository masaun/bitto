...
const CONTRACT_ADDRESS = process.env.MUNICIPAL_TREASURY_MANAGER_7_ADDRESS || '';
const CONTRACT_NAME = 'municipal-treasury-manager-7';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'municipal-treasury-manager-7',
