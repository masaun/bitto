...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_DEVELOPMENT_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-development-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-development-fund-5',
