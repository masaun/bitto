...
const contractAddress = process.env.REACT_APP_MERCHANT_DESTINATION_GAME_CONTRACT_ADDRESS || '';
const contractName = 'merchant-destination-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Merchant Destination Game</h1>
