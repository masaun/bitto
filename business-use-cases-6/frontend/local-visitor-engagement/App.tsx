...
const contractAddress = process.env.REACT_APP_LOCAL_VISITOR_ENGAGEMENT_CONTRACT_ADDRESS || '';
const contractName = 'local-visitor-engagement';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Visitor Engagement</h1>
