...
export default function luxurySofaRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_SOFA_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-sofa-registry';
