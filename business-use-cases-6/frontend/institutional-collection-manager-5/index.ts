...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_COLLECTION_MANAGER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-collection-manager-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-collection-manager-5',
