...
export default function luxuryCraftsmanshipIndex() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Craftsmanship Index',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_CRAFTSMANSHIP_INDEX_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-craftsmanship-index';
  ...
  return (
    <div>
      <h1>Luxury Craftsmanship Index</h1>
