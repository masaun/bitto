...
export default function luxuryJoineryStudio() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_JOINERY_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-joinery-studio';
