...
const CONTRACT_ADDRESS = process.env.MICROGRID_SETTLEMENT_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'microgrid-settlement-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'microgrid-settlement-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>microgrid-settlement-layer</h1>
      {!userData ? (
