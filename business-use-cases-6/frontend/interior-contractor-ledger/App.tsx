...
export default function interiorContractorLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Interior Contractor Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_CONTRACTOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-contractor-ledger';
  ...
  return (
    <div>
      <h1>Interior Contractor Ledger</h1>
