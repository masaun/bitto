...
const CONTRACT_ADDRESS = process.env.INLAND_PORT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'inland-port-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'inland-port-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
