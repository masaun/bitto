...
const CONTRACT_ADDRESS = process.env.ML_POWERED_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-sequential-processor',
