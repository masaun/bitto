...
const CONTRACT_ADDRESS = process.env.MULTI_SPORT_BETTING_LIQUIDITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'multi-sport-betting-liquidity';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Multi Sport Betting Liquidity',
