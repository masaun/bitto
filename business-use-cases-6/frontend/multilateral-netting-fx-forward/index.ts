...
const CONTRACT_ADDRESS = process.env.MULTILATERAL_NETTING_FX_FORWARD_ADDRESS || '';
const CONTRACT_NAME = 'multilateral-netting-fx-forward';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'multilateral-netting-fx-forward',
