...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LP_TOKEN_ISSUER_ADDRESS || '';

export default function Lp_Token_IssuerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.lp-token-issuer/read-only/get-counter`,
        {
          method: 'GET',
