...
const CONTRACT_ADDRESS = process.env.INSURANCE_CLAIM_AUTOMATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'insurance-claim-automation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>insurance-claim-automation</h1>
      {!userData ? (
