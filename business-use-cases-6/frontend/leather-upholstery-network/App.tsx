...
export default function leatherUpholsteryNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Leather Upholstery Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LEATHER_UPHOLSTERY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'leather-upholstery-network';
  ...
  return (
    <div>
      <h1>Leather Upholstery Network</h1>
