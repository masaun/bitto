...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_ESTIMATOR_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-estimator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-estimator',
