...
export default function interiorFitoutCoordination() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Interior Fitout Coordination',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_FITOUT_COORDINATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-fitout-coordination';
  ...
  return (
    <div>
      <h1>Interior Fitout Coordination</h1>
