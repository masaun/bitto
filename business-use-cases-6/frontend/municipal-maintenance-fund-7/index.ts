...
const CONTRACT_ADDRESS = process.env.MUNICIPAL_MAINTENANCE_FUND_7_ADDRESS || '';
const CONTRACT_NAME = 'municipal-maintenance-fund-7';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'municipal-maintenance-fund-7',
