...
const CONTRACT_ADDRESS = process.env.MUNICIPAL_CONTINGENCY_FUND_7_ADDRESS || '';
const CONTRACT_NAME = 'municipal-contingency-fund-7';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'municipal-contingency-fund-7',
