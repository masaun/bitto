...
export default function luxuryUpholsteryWorkshop() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Upholstery Workshop',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_UPHOLSTERY_WORKSHOP_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-upholstery-workshop';
  ...
  return (
    <div>
      <h1>Luxury Upholstery Workshop</h1>
