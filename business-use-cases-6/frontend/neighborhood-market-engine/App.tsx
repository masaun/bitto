...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_MARKET_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-market-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Market Engine</h1>
