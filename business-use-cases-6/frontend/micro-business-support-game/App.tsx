...
const contractAddress = process.env.REACT_APP_MICRO_BUSINESS_SUPPORT_GAME_CONTRACT_ADDRESS || '';
const contractName = 'micro-business-support-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Micro Business Support Game</h1>
