...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MU_HYBRID_ASSET_ADDRESS || '';

export default function Mu_Hybrid_AssetPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.mu-hybrid-asset/read-only/get-counter`,
        {
          method: 'GET',
