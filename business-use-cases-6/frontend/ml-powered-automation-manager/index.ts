...
const CONTRACT_ADDRESS = process.env.ML_POWERED_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-automation-manager',
