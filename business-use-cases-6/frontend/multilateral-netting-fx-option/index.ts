...
const CONTRACT_ADDRESS = process.env.MULTILATERAL_NETTING_FX_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'multilateral-netting-fx-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'multilateral-netting-fx-option',
