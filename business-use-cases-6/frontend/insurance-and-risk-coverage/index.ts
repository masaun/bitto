...
const CONTRACT_ADDRESS = process.env.INSURANCE_AND_RISK_COVERAGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'insurance-and-risk-coverage';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Insurance And Risk Coverage',
