...
export default function interiorDesignPartnership() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Interior Design Partnership',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_DESIGN_PARTNERSHIP_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-design-partnership';
  ...
  return (
    <div>
      <h1>Interior Design Partnership</h1>
