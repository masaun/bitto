...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_NETTING_SYSTEM_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-netting-system-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-netting-system-5',
