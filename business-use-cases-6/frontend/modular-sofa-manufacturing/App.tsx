...
export default function modularSofaManufacturing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Modular Sofa Manufacturing',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_SOFA_MANUFACTURING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-sofa-manufacturing';
  ...
  return (
    <div>
      <h1>Modular Sofa Manufacturing</h1>
