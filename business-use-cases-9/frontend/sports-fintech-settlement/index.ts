...
const CONTRACT_ADDRESS = process.env.SPORTS_FINTECH_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-fintech-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Fintech Settlement',
