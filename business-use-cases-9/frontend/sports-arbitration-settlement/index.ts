...
const CONTRACT_ADDRESS = process.env.SPORTS_ARBITRATION_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-arbitration-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Arbitration Settlement',
