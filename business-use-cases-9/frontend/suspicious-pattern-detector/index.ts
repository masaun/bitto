...
const CONTRACT_ADDRESS = process.env.SUSPICIOUS_PATTERN_DETECTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'suspicious-pattern-detector';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'SuspiciousPatternDetector',
