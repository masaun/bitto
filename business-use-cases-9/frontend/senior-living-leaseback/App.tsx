...
const CONTRACT_ADDRESS = process.env.SENIOR_LIVING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'senior-living-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'senior-living-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
