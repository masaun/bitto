...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TAG_ALONG_RIGHTS_ADDRESS || '';

export default function Tag_Along_RightsPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tag-along-rights/read-only/get-counter`,
        {
          method: 'GET',
