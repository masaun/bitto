...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOLAR_ENERGY_RWA_ADDRESS || '';

export default function Solar_Energy_RwaPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.solar-energy-rwa/read-only/get-counter`,
        {
          method: 'GET',
