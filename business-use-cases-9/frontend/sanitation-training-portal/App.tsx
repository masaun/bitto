...
const contractAddress = process.env.REACT_APP_SANITATION_TRAINING_PORTAL_CONTRACT_ADDRESS || '';
const contractName = 'sanitation-training-portal';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>sanitation training portal</h1>
