...
export default function seatingSupplyNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SEATING_SUPPLY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'seating-supply-network';
