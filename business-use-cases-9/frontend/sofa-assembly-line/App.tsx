...
export default function sofaAssemblyLine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SOFA_ASSEMBLY_LINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sofa-assembly-line';
