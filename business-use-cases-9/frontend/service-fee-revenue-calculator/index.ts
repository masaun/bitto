...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_CALCULATOR_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-calculator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-calculator',
