...
const CONTRACT_ADDRESS = process.env.SMART_CONTRACT_AUDIT_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-contract-audit-router';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'smart-contract-audit-router',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-contract-audit-router</h1>
      {!userData ? (
