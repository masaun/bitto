...
const CONTRACT_ADDRESS = process.env.SWAP_MARKET_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'swap-market-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'swap-market-interest-rate-floor',
