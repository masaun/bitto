...
const CONTRACT_ADDRESS = process.env.SHIPYARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'shipyard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'shipyard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
