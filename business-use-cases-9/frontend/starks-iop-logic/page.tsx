...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STARKS_IOP_LOGIC_ADDRESS || '';

export default function Starks_Iop_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.starks-iop-logic/read-only/get-counter`,
        {
          method: 'GET',
