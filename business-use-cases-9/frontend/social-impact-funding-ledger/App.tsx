...
const CONTRACT_ADDRESS = process.env.SOCIAL_IMPACT_FUNDING_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'social-impact-funding-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'social-impact-funding-ledger',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>social-impact-funding-ledger</h1>
      {!userData ? (
