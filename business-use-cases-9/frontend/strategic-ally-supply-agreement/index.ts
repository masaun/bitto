...
const CONTRACT_ADDRESS = process.env.STRATEGIC_ALLY_SUPPLY_AGREEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'strategic-ally-supply-agreement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Strategic Ally Supply Agreement',
