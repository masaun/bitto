...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SALES_TAX_ROUTER_ADDRESS || '';

export default function Sales_Tax_RouterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sales-tax-router/read-only/get-counter`,
        {
          method: 'GET',
