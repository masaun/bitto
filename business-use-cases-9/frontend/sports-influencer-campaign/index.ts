...
const CONTRACT_ADDRESS = process.env.SPORTS_INFLUENCER_CAMPAIGN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-influencer-campaign';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Influencer Campaign',
