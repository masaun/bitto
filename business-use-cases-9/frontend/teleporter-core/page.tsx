...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TELEPORTER_CORE_ADDRESS || '';

export default function Teleporter_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.teleporter-core/read-only/get-counter`,
        {
          method: 'GET',
