...
const contractAddress = process.env.REACT_APP_SUPPLIER_INSURANCE_CHECK_CONTRACT_ADDRESS || '';
const contractName = 'supplier-insurance-check';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Supplier Insurance Check</h1>
