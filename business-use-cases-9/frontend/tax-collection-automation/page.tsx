...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TAX_COLLECTION_AUTOMATION_ADDRESS || '';

export default function Tax_Collection_AutomationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tax-collection-automation/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'tax-collection-automation',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>tax-collection-automation</h1>
