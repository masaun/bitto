...
export default function sustainableTimberSourcing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Timber Sourcing',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_TIMBER_SOURCING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-timber-sourcing';
  ...
  return (
    <div>
      <h1>Sustainable Timber Sourcing</h1>
