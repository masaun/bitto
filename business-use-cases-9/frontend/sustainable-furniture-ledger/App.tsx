...
export default function sustainableFurnitureLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Furniture Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_FURNITURE_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-furniture-ledger';
  ...
  return (
    <div>
      <h1>Sustainable Furniture Ledger</h1>
