...
const CONTRACT_ADDRESS = process.env.SPECIALZONE_LEASEBACK_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'specialzone-leaseback-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'specialzone-leaseback-engine', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>specialzone-leaseback-engine</h1>
      {!userData ? (
