...
const CONTRACT_ADDRESS = process.env.SPORTS_EVENT_MICROINSURANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-event-microinsurance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Event Microinsurance',
