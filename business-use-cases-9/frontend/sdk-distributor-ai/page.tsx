...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SDK_DISTRIBUTOR_AI_ADDRESS || '';

export default function Sdk_Distributor_AiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sdk-distributor-ai/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'sdk-distributor-ai',
