...
const CONTRACT_ADDRESS = process.env.SANCTIONS_COMPLIANCE_CHECK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sanctions-compliance-check';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sanctions Compliance Check',
