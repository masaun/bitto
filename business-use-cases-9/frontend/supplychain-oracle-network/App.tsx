...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_ORACLE_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-oracle-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-oracle-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-oracle-network</h1>
      {!userData ? (
