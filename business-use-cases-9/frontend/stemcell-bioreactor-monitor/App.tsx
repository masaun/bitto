...
const contractAddress = process.env.REACT_APP_STEMCELL_BIOREACTOR_MONITOR_CONTRACT_ADDRESS || '';
const contractName = 'stemcell-bioreactor-monitor';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>stemcell uioreactor monitor</h1>
