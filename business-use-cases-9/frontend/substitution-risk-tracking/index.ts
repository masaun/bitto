...
const CONTRACT_ADDRESS = process.env.SUBSTITUTION_RISK_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'substitution-risk-tracking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Substitution Risk Tracking',
