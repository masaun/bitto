...
const CONTRACT_ADDRESS = process.env.SUMMER_ATHLETICS_PRIZE_DISTRIBUTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'summer-athletics-prize-distributor';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Summer Athletics Prize Distributor',
