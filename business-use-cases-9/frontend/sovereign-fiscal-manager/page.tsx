...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOVEREIGN_FISCAL_MANAGER_ADDRESS || '';

export default function Sovereign_Fiscal_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sovereign-fiscal-manager/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'sovereign-fiscal-manager',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>sovereign-fiscal-manager</h1>
