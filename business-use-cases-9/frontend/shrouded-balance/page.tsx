...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SHROUDED_BALANCE_ADDRESS || '';

export default function Shrouded_BalancePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.shrouded-balance/read-only/get-counter`,
        {
          method: 'GET',
