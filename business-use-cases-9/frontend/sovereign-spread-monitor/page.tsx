...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOVEREIGN_SPREAD_MONITOR_ADDRESS || '';

export default function Sovereign_Spread_MonitorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sovereign-spread-monitor/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'sovereign-spread-monitor',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>sovereign-spread-monitor</h1>
