...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SETTLEMENT_LAYER_ADDRESS || '';

export default function Settlement_LayerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.settlement-layer/read-only/get-counter`,
        {
          method: 'GET',
