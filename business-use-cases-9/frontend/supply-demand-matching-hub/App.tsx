...
const CONTRACT_ADDRESS = process.env.SUPPLY_DEMAND_MATCHING_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supply-demand-matching-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supply-demand-matching-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supply-demand-matching-hub</h1>
      {!userData ? (
