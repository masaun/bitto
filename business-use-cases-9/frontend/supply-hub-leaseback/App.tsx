...
const CONTRACT_ADDRESS = process.env.SUPPLY_HUB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supply-hub-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'supply-hub-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
