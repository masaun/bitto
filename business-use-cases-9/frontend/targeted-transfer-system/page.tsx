...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TARGETED_TRANSFER_SYSTEM_ADDRESS || '';

export default function Targeted_Transfer_SystemPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.targeted-transfer-system/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'targeted-transfer-system',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>targeted-transfer-system</h1>
