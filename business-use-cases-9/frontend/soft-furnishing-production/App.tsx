...
export default function softFurnishingProduction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Soft Furnishing Production',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SOFT_FURNISHING_PRODUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'soft-furnishing-production';
  ...
  return (
    <div>
      <h1>Soft Furnishing Production</h1>
