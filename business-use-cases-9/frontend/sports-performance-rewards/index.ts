...
const CONTRACT_ADDRESS = process.env.SPORTS_PERFORMANCE_REWARDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-performance-rewards';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Performance Rewards',
