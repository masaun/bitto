...
const CONTRACT_ADDRESS = process.env.SPA_FACILITY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'spa-facility-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'spa-facility-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
