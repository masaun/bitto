...
const contractAddress = process.env.REACT_APP_SUPPLIER_CONTRACT_HISTORY_CONTRACT_ADDRESS || '';
const contractName = 'supplier-contract-history';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Supplier Contract History',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Supplier Contract History</h1>
