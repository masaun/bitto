...
const CONTRACT_ADDRESS = process.env.SPORTSWEAR_SUPPLY_CHAIN_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sportswear-supply-chain-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sportswear Supply Chain Ledger',
