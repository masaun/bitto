...
const CONTRACT_ADDRESS = process.env.SMART_HOSPITAL_INTEGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-hospital-integration';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'smart-hospital-integration',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-hospital-integration</h1>
      {!userData ? (
