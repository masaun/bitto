...
const CONTRACT_ADDRESS = process.env.STADIUM_CONSTRUCTION_SYNDICATE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'stadium-construction-syndicate';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Stadium Construction Syndicate',
