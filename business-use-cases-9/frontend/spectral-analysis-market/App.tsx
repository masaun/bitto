...
const contractAddress = process.env.REACT_APP_SPECTRAL_ANALYSIS_MARKET_CONTRACT_ADDRESS || '';
const contractName = 'spectral-analysis-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>spectral analysis market</h1>
