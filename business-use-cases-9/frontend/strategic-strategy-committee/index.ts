...
const CONTRACT_ADDRESS = process.env.STRATEGIC_STRATEGY_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'strategic-strategy-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-strategy-committee',
