...
const CONTRACT_ADDRESS = process.env.SPORTS_BROADCAST_CLEARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-broadcast-clearing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Broadcast Clearing',
