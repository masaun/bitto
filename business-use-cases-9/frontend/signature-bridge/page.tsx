...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SIGNATURE_BRIDGE_ADDRESS || '';

export default function Signature_BridgePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.signature-bridge/read-only/get-counter`,
        {
          method: 'GET',
