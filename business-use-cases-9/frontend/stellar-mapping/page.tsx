...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STELLAR_MAPPING_ADDRESS || '';

export default function Stellar_MappingPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.stellar-mapping/read-only/get-counter`,
        {
          method: 'GET',
