...
const contractAddress = process.env.REACT_APP_STEMCELL_SHIPPING_LOGISTICS_CONTRACT_ADDRESS || '';
const contractName = 'stemcell-shipping-logistics';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>stemcell shipping logistics</h1>
