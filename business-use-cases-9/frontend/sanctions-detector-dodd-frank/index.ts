...
const CONTRACT_ADDRESS = process.env.SANCTIONS_DETECTOR_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'sanctions-detector-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'sanctions-detector-dodd-frank',
