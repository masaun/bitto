...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_PAYMENT_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-payment-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-payment-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-payment-layer</h1>
      {!userData ? (
