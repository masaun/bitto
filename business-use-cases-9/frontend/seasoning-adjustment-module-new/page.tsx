...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SEASONING_ADJUSTMENT_MODULE_NEW_ADDRESS || '';

export default function Seasoning_Adjustment_Module_NewPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'seasoning-adjustment-module-new',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.seasoning-adjustment-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'seasoning-adjustment-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>seasoning-adjustment-module-new</h1>
