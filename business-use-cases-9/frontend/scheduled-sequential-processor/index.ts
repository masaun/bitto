...
const CONTRACT_ADDRESS = process.env.SCHEDULED_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-sequential-processor',
