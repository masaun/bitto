...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SNAP_SYNC_TOOL_ADDRESS || '';

export default function Snap_Sync_ToolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.snap-sync-tool/read-only/get-counter`,
        {
          method: 'GET',
