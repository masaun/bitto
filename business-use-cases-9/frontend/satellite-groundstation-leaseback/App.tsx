...
const CONTRACT_ADDRESS = process.env.SATELLITE_GROUNDSTATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'satellite-groundstation-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'satellite-groundstation-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>satellite-groundstation-leaseback</h1>
      {!userData ? (
