...
const contractAddress = process.env.REACT_APP_SETTLEMENT_FEE_CALCULATION_CONTRACT_ADDRESS || '';
const contractName = 'settlement-fee-calculation';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Settlement Fee Calculation',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Settlement Fee Calculation</h1>
