...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_VISIBILITY_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-visibility-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-visibility-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-visibility-hub</h1>
      {!userData ? (
