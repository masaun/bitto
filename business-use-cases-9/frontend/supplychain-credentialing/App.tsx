...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_CREDENTIALING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-credentialing';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-credentialing',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-credentialing</h1>
      {!userData ? (
