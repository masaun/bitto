...
const CONTRACT_ADDRESS = process.env.SUMMER_GAMES_TICKETING_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'summer-games-ticketing-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Summer Games Ticketing Exchange',
