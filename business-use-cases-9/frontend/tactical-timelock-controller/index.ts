...
const CONTRACT_ADDRESS = process.env.TACTICAL_TIMELOCK_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'tactical-timelock-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-timelock-controller',
