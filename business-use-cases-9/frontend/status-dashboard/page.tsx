...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STATUS_DASHBOARD_ADDRESS || '';

export default function Status_DashboardPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.status-dashboard/read-only/get-counter`,
        {
          method: 'GET',
