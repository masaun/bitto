...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TAX_GAP_ANALYZER_ADDRESS || '';

export default function Tax_Gap_AnalyzerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tax-gap-analyzer/read-only/get-counter`,
        {
          method: 'GET',
