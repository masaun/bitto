...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_CARBON_TRACKER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-carbon-tracker';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-carbon-tracker',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-carbon-tracker</h1>
      {!userData ? (
