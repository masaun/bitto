...
const CONTRACT_ADDRESS = process.env.SPORTS_ANALYTICS_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-analytics-marketplace';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Analytics Marketplace',
