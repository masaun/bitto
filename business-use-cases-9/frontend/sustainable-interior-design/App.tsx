...
export default function sustainableInteriorDesign() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_INTERIOR_DESIGN_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-interior-design';
  ...
  return (
    <div>
      <h1>Sustainable Interior Design</h1>
