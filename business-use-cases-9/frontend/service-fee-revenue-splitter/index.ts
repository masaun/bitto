...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_SPLITTER_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-splitter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-splitter',
