...
const CONTRACT_ADDRESS = process.env.SPORTS_INSURANCE_RISK_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-insurance-risk-pool';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Insurance Risk Pool',
