...
export default function sustainableFurnitureMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Furniture Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_FURNITURE_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-furniture-market';
  ...
  return (
    <div>
      <h1>Sustainable Furniture Market</h1>
