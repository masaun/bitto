...
export default function seatingComfortEngine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SEATING_COMFORT_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'seating-comfort-engine';
