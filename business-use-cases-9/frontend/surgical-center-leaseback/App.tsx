...
const CONTRACT_ADDRESS = process.env.SURGICAL_CENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'surgical-center-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'surgical-center-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>surgical-center-leaseback</h1>
      {!userData ? (
