...
const CONTRACT_ADDRESS = process.env.SOUNDSTAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'soundstage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'soundstage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
