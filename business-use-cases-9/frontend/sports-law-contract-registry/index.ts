...
const CONTRACT_ADDRESS = process.env.SPORTS_LAW_CONTRACT_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-law-contract-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Law Contract Registry',
