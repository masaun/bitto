...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_ESTIMATOR_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-estimator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-estimator',
