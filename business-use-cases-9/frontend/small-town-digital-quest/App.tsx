...
const contractAddress = process.env.REACT_APP_SMALL_TOWN_DIGITAL_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'small-town-digital-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Small Town Digital Quest</h1>
