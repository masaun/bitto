...
const CONTRACT_ADDRESS = process.env.SPOT_MARKET_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'spot-market-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'spot-market-interest-rate-collar',
