...
const CONTRACT_ADDRESS = process.env.STADIUM_PARKING_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'stadium-parking-management';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Stadium Parking Management',
