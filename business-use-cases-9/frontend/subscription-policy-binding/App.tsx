...
const contractAddress = process.env.REACT_APP_SUBSCRIPTION_POLICY_BINDING_CONTRACT_ADDRESS || '';
const contractName = 'subscription-policy-binding';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Subscription Policy Binding',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Subscription Policy Binding</h1>
