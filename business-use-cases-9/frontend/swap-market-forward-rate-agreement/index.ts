...
const CONTRACT_ADDRESS = process.env.SWAP_MARKET_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'swap-market-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'swap-market-forward-rate-agreement',
