...
const CONTRACT_ADDRESS = process.env.SEMICONDUCTOR_TOOL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'semiconductor-tool-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'semiconductor-tool-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>semiconductor-tool-leaseback</h1>
      {!userData ? (
