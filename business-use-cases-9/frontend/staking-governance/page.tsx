...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STAKING_GOVERNANCE_ADDRESS || '';

export default function Staking_GovernancePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.staking-governance/read-only/get-counter`,
        {
          method: 'GET',
