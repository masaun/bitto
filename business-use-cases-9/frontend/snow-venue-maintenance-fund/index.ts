...
const CONTRACT_ADDRESS = process.env.SNOW_VENUE_MAINTENANCE_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'snow-venue-maintenance-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Snow Venue Maintenance Fund',
