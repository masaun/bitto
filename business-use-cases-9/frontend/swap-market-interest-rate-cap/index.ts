...
const CONTRACT_ADDRESS = process.env.SWAP_MARKET_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'swap-market-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'swap-market-interest-rate-cap',
