...
const CONTRACT_ADDRESS = process.env.SPORTS_ENDORSEMENT_CLEARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-endorsement-clearing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Endorsement Clearing',
