...
const CONTRACT_ADDRESS = process.env.TACTICAL_DISTRIBUTION_ENGINE_1_ADDRESS || '';
const CONTRACT_NAME = 'tactical-distribution-engine-1';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-distribution-engine-1',
