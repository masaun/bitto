...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STARGUARD_PRIVATE_ROUTER_ADDRESS || '';

export default function Starguard_Private_RouterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.starguard-private-router/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'starguard-private-router',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>starguard-private-router</h1>
