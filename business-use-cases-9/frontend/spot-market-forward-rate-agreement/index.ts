...
const CONTRACT_ADDRESS = process.env.SPOT_MARKET_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'spot-market-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'spot-market-forward-rate-agreement',
