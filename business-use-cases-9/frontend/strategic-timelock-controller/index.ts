...
const CONTRACT_ADDRESS = process.env.STRATEGIC_TIMELOCK_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'strategic-timelock-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-timelock-controller',
