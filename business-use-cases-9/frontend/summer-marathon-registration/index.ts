...
const CONTRACT_ADDRESS = process.env.SUMMER_MARATHON_REGISTRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'summer-marathon-registration';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Summer Marathon Registration',
