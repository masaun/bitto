...
const CONTRACT_ADDRESS = process.env.SALE_LEASEBACK_ORIGINATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sale-leaseback-origination';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'sale-leaseback-origination', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>sale-leaseback-origination</h1>
      {!userData ? (
