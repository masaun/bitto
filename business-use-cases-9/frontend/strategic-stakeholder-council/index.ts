...
const CONTRACT_ADDRESS = process.env.STRATEGIC_STAKEHOLDER_COUNCIL_ADDRESS || '';
const CONTRACT_NAME = 'strategic-stakeholder-council';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-stakeholder-council',
