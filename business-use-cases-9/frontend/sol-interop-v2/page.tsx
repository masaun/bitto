...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOL_INTEROP_V2_ADDRESS || '';

export default function Sol_Interop_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sol-interop-v2/read-only/get-counter`,
        {
          method: 'GET',
