...
const CONTRACT_ADDRESS = process.env.SELF_STORAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'self-storage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'self-storage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
