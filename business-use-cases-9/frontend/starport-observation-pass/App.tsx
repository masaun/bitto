...
const contractAddress = process.env.REACT_APP_STARPORT_OBSERVATION_PASS_CONTRACT_ADDRESS || '';
const contractName = 'starport-observation-pass';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>starport ouservation pass</h1>
