...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_ALLOCATION_ENGINE_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-allocation-engine-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-allocation-engine-2',
