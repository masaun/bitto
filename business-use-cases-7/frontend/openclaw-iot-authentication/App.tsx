...
const CONTRACT_ADDRESS = process.env.OPENCLAW_IOT_AUTHENTICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-iot-authentication';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-iot-authentication',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-iot-authentication</h1>
      {!userData ? (
