...
const CONTRACT_ADDRESS = process.env.OTC_HAIRCUT_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-haircut-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-haircut-commodity-option',
