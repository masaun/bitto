...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_VAULT_COMBINER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-vault-combiner-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-vault-combiner-2',
