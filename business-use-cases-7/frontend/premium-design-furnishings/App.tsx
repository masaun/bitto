...
export default function premiumDesignFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Design Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_DESIGN_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-design-furnishings';
  ...
  return (
    <div>
      <h1>Premium Design Furnishings</h1>
