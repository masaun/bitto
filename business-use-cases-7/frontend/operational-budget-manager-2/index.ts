...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_BUDGET_MANAGER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-budget-manager-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-budget-manager-2',
