...
const CONTRACT_ADDRESS = process.env.OTC_MATCHING_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-matching-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-matching-interest-rate-cap',
