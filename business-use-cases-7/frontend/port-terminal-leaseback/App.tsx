...
const CONTRACT_ADDRESS = process.env.PORT_TERMINAL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'port-terminal-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'port-terminal-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
