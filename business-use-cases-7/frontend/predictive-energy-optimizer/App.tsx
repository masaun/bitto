...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_ENERGY_OPTIMIZER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-energy-optimizer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-energy-optimizer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-energy-optimizer</h1>
      {!userData ? (
