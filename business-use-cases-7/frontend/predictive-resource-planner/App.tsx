...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_RESOURCE_PLANNER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-resource-planner';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-resource-planner',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-resource-planner</h1>
      {!userData ? (
