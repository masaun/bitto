...
const CONTRACT_ADDRESS = process.env.PRINTING_PRESS_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'printing-press-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'printing-press-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>printing-press-leaseback</h1>
      {!userData ? (
