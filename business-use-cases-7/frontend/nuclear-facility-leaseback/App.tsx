...
const CONTRACT_ADDRESS = process.env.NUCLEAR_FACILITY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'nuclear-facility-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'nuclear-facility-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>nuclear-facility-leaseback</h1>
      {!userData ? (
