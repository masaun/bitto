...
const contractAddress = process.env.REACT_APP_PRICING_MANIPULATION_RISK_CONTRACT_ADDRESS || '';
const contractName = 'pricing-manipulation-risk';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Pricing Manipulation Risk',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Pricing Manipulation Risk</h1>
