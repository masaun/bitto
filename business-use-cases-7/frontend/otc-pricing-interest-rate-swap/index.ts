...
const CONTRACT_ADDRESS = process.env.OTC_PRICING_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-pricing-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-pricing-interest-rate-swap',
