...
const CONTRACT_ADDRESS = process.env.PROJECT_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'project-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'project-ranked-choice-voting',
