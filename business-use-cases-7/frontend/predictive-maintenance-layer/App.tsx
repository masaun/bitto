...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_MAINTENANCE_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-maintenance-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-maintenance-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-maintenance-layer</h1>
      {!userData ? (
