...
const CONTRACT_ADDRESS = process.env.OTC_MATCHING_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-matching-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-matching-interest-rate-swap',
