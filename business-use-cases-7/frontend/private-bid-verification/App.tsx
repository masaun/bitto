...
const contractAddress = process.env.REACT_APP_PRIVATE_BID_VERIFICATION_CONTRACT_ADDRESS || '';
const contractName = 'private-bid-verification';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Private Bid Verification</h1>
