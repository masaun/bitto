...
const CONTRACT_ADDRESS = process.env.OTC_BROKER_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-broker-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-broker-interest-rate-floor',
