...
const CONTRACT_ADDRESS = process.env.OPTION_MARKET_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'option-market-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'option-market-interest-rate-swap',
