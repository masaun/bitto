...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_DISTRIBUTION_ENGINE_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-distribution-engine-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-distribution-engine-2',
