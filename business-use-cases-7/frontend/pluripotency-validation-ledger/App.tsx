...
const contractAddress = process.env.REACT_APP_PLURIPOTENCY_VALIDATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'pluripotency-validation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>pluripotency validation ledger</h1>
