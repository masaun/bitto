...
const CONTRACT_ADDRESS = process.env.OTC_HAIRCUT_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-haircut-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-haircut-interest-rate-collar',
