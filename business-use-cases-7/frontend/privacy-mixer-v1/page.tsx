...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PRIVACY_MIXER_V1_ADDRESS || '';

export default function Privacy_Mixer_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.privacy-mixer-v1/read-only/get-counter`,
        {
          method: 'GET',
