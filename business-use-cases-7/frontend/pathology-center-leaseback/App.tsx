...
const CONTRACT_ADDRESS = process.env.PATHOLOGY_CENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'pathology-center-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'pathology-center-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>pathology-center-leaseback</h1>
      {!userData ? (
