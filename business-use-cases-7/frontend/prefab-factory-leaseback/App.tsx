...
const CONTRACT_ADDRESS = process.env.PREFAB_FACTORY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'prefab-factory-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'prefab-factory-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>prefab-factory-leaseback</h1>
      {!userData ? (
