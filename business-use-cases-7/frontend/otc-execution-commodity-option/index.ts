...
const CONTRACT_ADDRESS = process.env.OTC_EXECUTION_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-execution-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-execution-commodity-option',
