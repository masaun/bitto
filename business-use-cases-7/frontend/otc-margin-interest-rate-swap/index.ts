...
const CONTRACT_ADDRESS = process.env.OTC_MARGIN_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-margin-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-margin-interest-rate-swap',
