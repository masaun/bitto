...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_OPERATIONAL_FUND_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-operational-fund-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-operational-fund-2',
