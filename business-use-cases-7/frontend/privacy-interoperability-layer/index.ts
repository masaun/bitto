...
const CONTRACT_ADDRESS = process.env.PRIVACY_INTEROPERABILITY_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'privacy-interoperability-layer';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivacyInteroperabilityLayer',
