...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_VAULT_AGGREGATOR_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-vault-aggregator-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-vault-aggregator-2',
