...
export default function premiumUpholsteryCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Upholstery Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_UPHOLSTERY_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-upholstery-collective';
  ...
  return (
    <div>
      <h1>Premium Upholstery Collective</h1>
