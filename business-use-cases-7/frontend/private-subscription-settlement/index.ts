...
const CONTRACT_ADDRESS = process.env.PRIVATE_SUBSCRIPTION_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'private-subscription-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivateSubscriptionSettlement',
