...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PACKET_FORWARDER_ADDRESS || '';

export default function Packet_ForwarderPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.packet-forwarder/read-only/get-counter`,
        {
          method: 'GET',
