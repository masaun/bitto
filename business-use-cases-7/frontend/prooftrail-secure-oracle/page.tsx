...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROOFTRAIL_SECURE_ORACLE_ADDRESS || '';

export default function Prooftrail_Secure_OraclePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.prooftrail-secure-oracle/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'prooftrail-secure-oracle',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>prooftrail-secure-oracle</h1>
