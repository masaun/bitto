...
export default function premiumHomeFurnishings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_HOME_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-home-furnishings';
  ...
  return (
    <div>
      <h1>Premium Home Furnishings</h1>
