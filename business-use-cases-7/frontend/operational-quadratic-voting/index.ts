...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_QUADRATIC_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'operational-quadratic-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-quadratic-voting',
