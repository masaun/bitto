...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PARAMETER_TUNER_ADDRESS || '';

export default function Parameter_TunerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.parameter-tuner/read-only/get-counter`,
        {
          method: 'GET',
