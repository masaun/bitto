...
const CONTRACT_ADDRESS = process.env.OTC_NETTING_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-netting-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-netting-interest-rate-floor',
