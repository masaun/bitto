...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_NU_RISK_ASSESSOR_ADDRESS || '';

export default function Nu_Risk_AssessorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.nu-risk-assessor/read-only/get-counter`,
        {
          method: 'GET',
