...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_LIQUIDITY_VAULT_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-liquidity-vault-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-liquidity-vault-2',
