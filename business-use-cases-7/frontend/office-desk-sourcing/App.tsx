...
export default function officeDeskSourcing() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_DESK_SOURCING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-desk-sourcing';
