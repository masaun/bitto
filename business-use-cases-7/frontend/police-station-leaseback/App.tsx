...
const CONTRACT_ADDRESS = process.env.POLICE_STATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'police-station-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'police-station-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>police-station-leaseback</h1>
      {!userData ? (
