...
const CONTRACT_ADDRESS = process.env.OTC_BROKER_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-broker-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-broker-interest-rate-collar',
