...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_NETTING_SYSTEM_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-netting-system-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-netting-system-2',
