...
const contractAddress = process.env.REACT_APP_PROCUREMENT_CONFIDENTIAL_DOCS_CONTRACT_ADDRESS || '';
const contractName = 'procurement-confidential-docs';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Procurement Confidential Docs',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Procurement Confidential Docs</h1>
