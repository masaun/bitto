...
const CONTRACT_ADDRESS = process.env.OTC_BROKER_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-broker-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-broker-interest-rate-cap',
