...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PHI_VALIDATOR_ADDRESS || '';

export default function Phi_ValidatorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.phi-validator/read-only/get-counter`,
        {
          method: 'GET',
