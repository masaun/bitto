...
const CONTRACT_ADDRESS = process.env.OTC_MARGIN_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-margin-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-margin-interest-rate-collar',
