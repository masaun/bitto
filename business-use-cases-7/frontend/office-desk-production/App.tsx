...
export default function officeDeskProduction() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_DESK_PRODUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-desk-production';
