...
const contractAddress = process.env.REACT_APP_PAYOUT_THRESHOLD_GOVERNOR_CONTRACT_ADDRESS || '';
const contractName = 'payout-threshold-governor';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>payout threshold governor</h1>
