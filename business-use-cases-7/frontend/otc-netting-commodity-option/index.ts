...
const CONTRACT_ADDRESS = process.env.OTC_NETTING_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-netting-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-netting-commodity-option',
