...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_MAINTENANCE_FUND_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-maintenance-fund-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-maintenance-fund-2',
