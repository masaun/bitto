...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PAYMASTER_LOGIC_ADDRESS || '';

export default function Paymaster_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.paymaster-logic/read-only/get-counter`,
        {
          method: 'GET',
