...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PI_GOVERNOR_HUB_ADDRESS || '';

export default function Pi_Governor_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.pi-governor-hub/read-only/get-counter`,
        {
          method: 'GET',
