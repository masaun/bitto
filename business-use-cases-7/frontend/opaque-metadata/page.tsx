...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_OPAQUE_METADATA_ADDRESS || '';

export default function Opaque_MetadataPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.opaque-metadata/read-only/get-counter`,
        {
          method: 'GET',
