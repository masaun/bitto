...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_OMEGA_FINALIZER_ADDRESS || '';

export default function Omega_FinalizerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.omega-finalizer/read-only/get-counter`,
        {
          method: 'GET',
