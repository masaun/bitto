...
export default function premiumUpholsteryLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Upholstery Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_UPHOLSTERY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-upholstery-ledger';
  ...
  return (
    <div>
      <h1>Premium Upholstery Ledger</h1>
