...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_OCEANVEIL_PRIVATE_STREAM_ADDRESS || '';

export default function Oceanveil_Private_StreamPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.oceanveil-private-stream/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'oceanveil-private-stream',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>oceanveil-private-stream</h1>
