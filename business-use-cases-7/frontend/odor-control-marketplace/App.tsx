...
const contractAddress = process.env.REACT_APP_ODOR_CONTROL_MARKETPLACE_CONTRACT_ADDRESS || '';
const contractName = 'odor-control-marketplace';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>odor control marketplace</h1>
