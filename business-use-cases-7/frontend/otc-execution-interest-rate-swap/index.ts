...
const CONTRACT_ADDRESS = process.env.OTC_EXECUTION_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-execution-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-execution-interest-rate-swap',
