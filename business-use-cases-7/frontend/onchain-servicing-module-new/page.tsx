...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ONCHAIN_SERVICING_MODULE_NEW_ADDRESS || '';

export default function Onchain_Servicing_Module_NewPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'onchain-servicing-module-new',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.onchain-servicing-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'onchain-servicing-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>onchain-servicing-module-new</h1>
