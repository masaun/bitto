...
const CONTRACT_ADDRESS = process.env.OPTION_MARKET_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'option-market-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'option-market-forward-rate-agreement',
