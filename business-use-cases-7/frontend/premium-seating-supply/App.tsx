...
export default function premiumSeatingSupply() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_SEATING_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-seating-supply';
