...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_P2P_LENDING_CORE_ADDRESS || '';

export default function P2P_Lending_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.p2p-lending-core/read-only/get-counter`,
        {
          method: 'GET',
