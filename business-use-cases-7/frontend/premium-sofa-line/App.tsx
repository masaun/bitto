...
export default function premiumSofaLine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_SOFA_LINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-sofa-line';
