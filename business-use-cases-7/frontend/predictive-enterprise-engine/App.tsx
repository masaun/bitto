...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_ENTERPRISE_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-enterprise-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-enterprise-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-enterprise-engine</h1>
      {!userData ? (
