...
const CONTRACT_ADDRESS = process.env.PRIVATE_TRANSACTION_SIMULATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'private-transaction-simulator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivateTransactionSimulator',
