...
const contractAddress = process.env.REACT_APP_ORGANOID_DEVELOPMENT_HUB_CONTRACT_ADDRESS || '';
const contractName = 'organoid-development-hub';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>organoid development hub</h1>
