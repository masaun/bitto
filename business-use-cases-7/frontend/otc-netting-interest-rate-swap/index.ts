...
const CONTRACT_ADDRESS = process.env.OTC_NETTING_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-netting-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-netting-interest-rate-swap',
