...
export default function precisionJoinerySystem() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PRECISION_JOINERY_SYSTEM_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'precision-joinery-system';
  ...
  return (
    <div>
      <h1>Precision Joinery System</h1>
