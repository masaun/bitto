...
const CONTRACT_ADDRESS = process.env.OTC_CLEARING_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'otc-clearing-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-clearing-forward-rate-agreement',
