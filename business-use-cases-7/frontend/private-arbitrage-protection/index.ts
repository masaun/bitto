...
const CONTRACT_ADDRESS = process.env.PRIVATE_ARBITRAGE_PROTECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'private-arbitrage-protection';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivateArbitrageProtection',
