...
export default function officeFurnitureContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Office Furniture Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_FURNITURE_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-furniture-contract';
  ...
  return (
    <div>
      <h1>Office Furniture Contract</h1>
