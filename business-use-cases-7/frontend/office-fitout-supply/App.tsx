...
export default function officeFitoutSupply() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_FITOUT_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-fitout-supply';
