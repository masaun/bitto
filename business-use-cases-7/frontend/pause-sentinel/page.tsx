...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PAUSE_SENTINEL_ADDRESS || '';

export default function Pause_SentinelPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.pause-sentinel/read-only/get-counter`,
        {
          method: 'GET',
