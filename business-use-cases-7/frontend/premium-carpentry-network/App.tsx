...
export default function premiumCarpentryNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Carpentry Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_CARPENTRY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-carpentry-network';
  ...
  return (
    <div>
      <h1>Premium Carpentry Network</h1>
