...
const contractAddress = process.env.REACT_APP_PROCUREMENT_CONTRACT_BINDING_CONTRACT_ADDRESS || '';
const contractName = 'procurement-contract-binding';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Procurement Contract Binding',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Procurement Contract Binding</h1>
