...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_BUDGET_TRACKER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-budget-tracker-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-budget-tracker-2',
