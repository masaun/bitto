...
const CONTRACT_ADDRESS = process.env.ONCHAIN_REPUTATION_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'onchain-reputation-system';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'onchain-reputation-system',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>onchain-reputation-system</h1>
      {!userData ? (
