...
const CONTRACT_ADDRESS = process.env.OTC_PRICING_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-pricing-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-pricing-interest-rate-collar',
