...
const CONTRACT_ADDRESS = process.env.OTC_EXECUTION_COMMODITY_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-execution-commodity-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-execution-commodity-swap',
