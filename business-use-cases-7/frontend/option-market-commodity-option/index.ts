...
const CONTRACT_ADDRESS = process.env.OPTION_MARKET_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'option-market-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'option-market-commodity-option',
