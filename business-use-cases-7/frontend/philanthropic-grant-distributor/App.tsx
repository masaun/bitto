...
const CONTRACT_ADDRESS = process.env.PHILANTHROPIC_GRANT_DISTRIBUTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'philanthropic-grant-distributor';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'philanthropic-grant-distributor',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>philanthropic-grant-distributor</h1>
      {!userData ? (
