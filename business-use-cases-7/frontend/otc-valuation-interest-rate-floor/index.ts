...
const CONTRACT_ADDRESS = process.env.OTC_VALUATION_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-valuation-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-valuation-interest-rate-floor',
