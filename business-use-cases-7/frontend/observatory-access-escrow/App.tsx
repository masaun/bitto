...
const contractAddress = process.env.REACT_APP_OBSERVATORY_ACCESS_ESCROW_CONTRACT_ADDRESS || '';
const contractName = 'observatory-access-escrow';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>ouservatory access escrow</h1>
