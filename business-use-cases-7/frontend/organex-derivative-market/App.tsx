...
const contractAddress = process.env.REACT_APP_ORGANEX_DERIVATIVE_MARKET_CONTRACT_ADDRESS || '';
const contractName = 'organex-derivative-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>organex derivative market</h1>
