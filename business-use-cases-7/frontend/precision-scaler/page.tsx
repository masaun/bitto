...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PRECISION_SCALER_ADDRESS || '';

export default function Precision_ScalerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.precision-scaler/read-only/get-counter`,
        {
          method: 'GET',
