...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_SUPPLYCHAIN_AI_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-supplychain-ai';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-supplychain-ai',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-supplychain-ai</h1>
      {!userData ? (
