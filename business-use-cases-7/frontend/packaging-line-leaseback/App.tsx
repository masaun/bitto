...
const CONTRACT_ADDRESS = process.env.PACKAGING_LINE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'packaging-line-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'packaging-line-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>packaging-line-leaseback</h1>
      {!userData ? (
