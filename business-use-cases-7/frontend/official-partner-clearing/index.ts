...
const CONTRACT_ADDRESS = process.env.OFFICIAL_PARTNER_CLEARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'official-partner-clearing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Official Partner Clearing',
