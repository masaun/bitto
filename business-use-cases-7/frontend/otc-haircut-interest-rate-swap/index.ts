...
const CONTRACT_ADDRESS = process.env.OTC_HAIRCUT_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-haircut-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-haircut-interest-rate-swap',
