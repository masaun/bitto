...
const CONTRACT_ADDRESS = process.env.OPTION_MARKET_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'option-market-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'option-market-interest-rate-floor',
