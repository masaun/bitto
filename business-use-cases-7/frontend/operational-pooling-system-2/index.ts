...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_POOLING_SYSTEM_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-pooling-system-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-pooling-system-2',
