...
const CONTRACT_ADDRESS = process.env.OTC_VALUATION_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-valuation-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-valuation-interest-rate-collar',
