...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_GRID_BALANCER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-grid-balancer';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-grid-balancer</h1>
      {!userData ? (
