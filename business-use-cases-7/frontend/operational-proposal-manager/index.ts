...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_PROPOSAL_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'operational-proposal-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-proposal-manager',
