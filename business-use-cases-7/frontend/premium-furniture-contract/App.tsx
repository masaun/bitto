...
export default function premiumFurnitureContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Furniture Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_FURNITURE_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-furniture-contract';
  ...
  return (
    <div>
      <h1>Premium Furniture Contract</h1>
