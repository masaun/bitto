...
export default function officeSeatingManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Office Seating Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_SEATING_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-seating-manufacturer';
  ...
  return (
    <div>
      <h1>Office Seating Manufacturer</h1>
