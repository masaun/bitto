...
const CONTRACT_ADDRESS = process.env.OPENCLAW_CROSSCHAIN_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-crosschain-router';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-crosschain-router',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-crosschain-router</h1>
      {!userData ? (
