...
const contractDetails = parseContractIdentifier(
  process.env.DECENTRALIZED_TELECOM_NETWORK_CONTRACT_ADDRESS,
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for Decentralized Telecom Network Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  Decentralized Telecom Network Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log(`Environment Variable: DECENTRALIZED_TELECOM_NETWORK_CONTRACT_ADDRESS`);

  if (!process.env.DECENTRALIZED_TELECOM_NETWORK_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: DECENTRALIZED_TELECOM_NETWORK_CONTRACT_ADDRESS not set in environment.');
