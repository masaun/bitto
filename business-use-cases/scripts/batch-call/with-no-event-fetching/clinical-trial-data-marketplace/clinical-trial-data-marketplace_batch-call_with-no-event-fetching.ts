...
const contractDetails = parseContractIdentifier(
  process.env.CLINICAL_TRIAL_DATA_MARKETPLACE_CONTRACT_ADDRESS,
  'clinical-trial-data-marketplace'
);
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  Clinical Trial Data Marketplace Contract - Batch Call Script');
