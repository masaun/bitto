...
const CONTRACT_NAME = 'satellite-routing-protocol';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'satellite-routing-protocol', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>satellite-routing-protocol</h1>
      {!userData ? (
