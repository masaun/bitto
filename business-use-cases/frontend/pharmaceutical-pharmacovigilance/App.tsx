...
export default function pharmaceuticalpharmacovigilance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical pharmacovigilance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-pharmacovigilance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical pharmacovigilance</h1>
