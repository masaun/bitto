...
export default function cosmeticsenvironmentalmonitoring() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics environmental monitoring',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-environmental-monitoring',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics environmental monitoring</h1>
