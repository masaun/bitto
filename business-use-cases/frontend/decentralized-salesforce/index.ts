...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_SALESFORCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-salesforce';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedSalesforce', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
