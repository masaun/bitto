...
export default function acceleratorapplicationwindow() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator application window',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-application-window',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator application window</h1>
