...
const CONTRACT_NAME = 'players-scouting-marketplace';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'players-scouting-marketplace', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>players-scouting-marketplace</h1>
      {!userData ? (
