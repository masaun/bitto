...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Long Term Throughput Ship Production Order Contract', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Long Term Throughput Ship Production Order Contract</h1>
      {!userData ? (
