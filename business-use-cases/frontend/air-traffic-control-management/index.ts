...
const CONTRACT_ADDRESS = process.env.AIR_TRAFFIC_CONTROL_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'air-traffic-control-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AirTrafficControlManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
