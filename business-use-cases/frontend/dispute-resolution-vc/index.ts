...
const CONTRACT_ADDRESS = process.env.DISPUTE_RESOLUTION_VC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dispute-resolution-vc';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DisputeResolutionVc', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
