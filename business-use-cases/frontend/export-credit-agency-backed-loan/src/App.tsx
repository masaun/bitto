...
const CONTRACT_NAME = 'export-credit-agency-backed-loan';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Export Credit Agency Backed Loan', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Export Credit Agency Backed Loan</h1>
      {!userData ? (
