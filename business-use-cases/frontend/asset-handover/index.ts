...
const CONTRACT_ADDRESS = process.env.ASSET_HANDOVER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asset-handover';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AssetHandover', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
