...
const CONTRACT_ADDRESS = process.env.ECOSYSTEM_GOVERNANCE_LUXURY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ecosystem-governance-luxury';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EcosystemGovernanceLuxury', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
