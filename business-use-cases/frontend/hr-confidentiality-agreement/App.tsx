...
export default function hrconfidentialityagreement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'hr confidentiality agreement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'hr-confidentiality-agreement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>hr confidentiality agreement</h1>
