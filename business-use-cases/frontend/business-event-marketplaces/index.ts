...
const CONTRACT_ADDRESS = process.env.BUSINESS_EVENT_MARKETPLACES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'business-event-marketplaces';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BusinessEventMarketplaces', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
