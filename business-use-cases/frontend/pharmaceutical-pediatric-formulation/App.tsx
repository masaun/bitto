...
export default function pharmaceuticalpediatricformulation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical pediatric formulation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-pediatric-formulation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical pediatric formulation</h1>
