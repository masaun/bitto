...
export default function pharmaceuticalpricingstrategy() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical pricing strategy',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-pricing-strategy',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical pricing strategy</h1>
