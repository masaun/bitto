...
export default function cosmeticssafetyassessment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics safety assessment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-safety-assessment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics safety assessment</h1>
