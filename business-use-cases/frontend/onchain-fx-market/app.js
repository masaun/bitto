...
const contractName = 'onchain-fx-market';
...
document.getElementById('create-pair').addEventListener('click', () => {
  callContract('create-pair', []);
});

document.getElementById('add-liquidity').addEventListener('click', () => {
  callContract('add-liquidity', []);
});

document.getElementById('remove-liquidity').addEventListener('click', () => {
  callContract('remove-liquidity', []);
});

document.getElementById('create-limit-order').addEventListener('click', () => {
  callContract('create-limit-order', []);
});

document.getElementById('execute-limit-order').addEventListener('click', () => {
  callContract('execute-limit-order', []);
});

document.getElementById('market-swap').addEventListener('click', () => {
  callContract('market-swap', []);
});
