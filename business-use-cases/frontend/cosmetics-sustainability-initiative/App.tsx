...
export default function cosmeticssustainauilityinitiative() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics sustainauility initiative',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-sustainability-initiative',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics sustainauility initiative</h1>
