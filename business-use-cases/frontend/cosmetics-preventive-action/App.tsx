...
export default function cosmeticspreventiveaction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics preventive action',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-preventive-action',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics preventive action</h1>
