...
export default function cosmeticspricingstrategy() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics pricing strategy',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-pricing-strategy',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics pricing strategy</h1>
