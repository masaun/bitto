...
export default function civilcommissioningrecords() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil commissioning records',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-commissioning-records',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil commissioning records</h1>
