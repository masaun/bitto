...
const CONTRACT_ADDRESS = process.env.CONTAINER_SHIP_PRODUCTION_ORDER_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'container-ship-production-order-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ContainerShipProductionOrderManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
