...
const CONTRACT_ADDRESS = process.env.ENVIRONMENTAL_COMPLIANCE_AUTOMATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'environmental-compliance-automation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EnvironmentalComplianceAutomation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
