...
const CONTRACT_ADDRESS = process.env.CLINICAL_TRIAL_DATA_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'clinical-trial-data-marketplace';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClinicalTrialDataMarketplace', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
