...
export default function cosmeticsrecallprocedure() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics recall procedure',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-recall-procedure',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics recall procedure</h1>
