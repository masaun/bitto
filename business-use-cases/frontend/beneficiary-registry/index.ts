...
const CONTRACT_ADDRESS = process.env.BENEFICIARY_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'beneficiary-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BeneficiaryRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
