...
export default function educationprerequisitetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education prerequisite tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-prerequisite-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education prerequisite tracking</h1>
