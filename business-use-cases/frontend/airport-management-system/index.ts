...
const CONTRACT_ADDRESS = process.env.AIRPORT_MANAGEMENT_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airport-management-system';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AirportManagementSystem', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
