...
export default function pharmaceuticalreimuursement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical reimuursement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-reimbursement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical reimuursement</h1>
