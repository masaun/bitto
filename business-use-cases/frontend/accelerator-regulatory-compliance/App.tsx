...
export default function acceleratorregulatorycompliance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator regulatory compliance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-regulatory-compliance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator regulatory compliance</h1>
