...
const CONTRACT_ADDRESS = process.env.DONATION_COLLECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'donation-collection';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DonationCollection', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
