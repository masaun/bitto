...
export default function pharmaceuticaldruglaueling() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical drug laueling',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-drug-labeling',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical drug laueling</h1>
