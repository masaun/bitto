...
export default function chemicalemergencyresponse() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical emergency response',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-emergency-response',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical emergency response</h1>
