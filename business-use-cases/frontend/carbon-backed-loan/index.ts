...
const CONTRACT_ADDRESS = process.env.CARBON_BACKED_LOAN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-backed-loan';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonBackedLoan', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
