...
const contractAddress = import.meta.env.LABOR_COMPLIANCE_FOR_MINING_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.LABOR_COMPLIANCE_FOR_MINING_CONTRACT_ADDRESS?.split('.')[1] || 'labor-compliance-for-mining';
