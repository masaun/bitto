...
const CONTRACT_ADDRESS = process.env.CROSS_SECTOR_COORDINATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-sector-coordination';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossSectorCoordination', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
