...
export default function acceleratorselectioncriteria() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator selection criteria',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-selection-criteria',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator selection criteria</h1>
