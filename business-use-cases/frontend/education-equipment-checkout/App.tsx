...
export default function educationequipmentcheckout() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education equipment checkout',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-equipment-checkout',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education equipment checkout</h1>
