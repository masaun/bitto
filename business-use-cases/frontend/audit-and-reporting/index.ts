...
const CONTRACT_ADDRESS = process.env.AUDIT_AND_REPORTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'audit-and-reporting';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AuditAndReporting', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
