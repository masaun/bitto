...
export default function chemicalhazmatclassification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical hazmat classification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-hazmat-classification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical hazmat classification</h1>
