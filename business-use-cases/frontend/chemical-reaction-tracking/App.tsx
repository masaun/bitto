...
export default function chemicalreactiontracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical reaction tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-reaction-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical reaction tracking</h1>
