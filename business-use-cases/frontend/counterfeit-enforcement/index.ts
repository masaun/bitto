...
const CONTRACT_ADDRESS = process.env.COUNTERFEIT_ENFORCEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'counterfeit-enforcement';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CounterfeitEnforcement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
