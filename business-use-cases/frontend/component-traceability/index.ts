...
const CONTRACT_ADDRESS = process.env.COMPONENT_TRACEABILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'component-traceability';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ComponentTraceability', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
