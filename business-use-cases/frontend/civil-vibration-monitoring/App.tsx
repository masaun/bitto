...
export default function civilviurationmonitoring() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil viuration monitoring',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-vibration-monitoring',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil viuration monitoring</h1>
