...
const CONTRACT_ADDRESS = process.env.ECOSYSTEM_GOVERNANCE_VC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ecosystem-governance-vc';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EcosystemGovernanceVc', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
