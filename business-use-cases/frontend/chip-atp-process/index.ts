...
const CONTRACT_ADDRESS = process.env.CHIP_ATP_PROCESS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'chip-atp-process';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ChipAtpProcess', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
