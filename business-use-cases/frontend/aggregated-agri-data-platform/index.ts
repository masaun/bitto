...
const CONTRACT_ADDRESS = process.env.AGGREGATED_AGRI_DATA_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aggregated-agri-data-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AggregatedAgriDataPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
