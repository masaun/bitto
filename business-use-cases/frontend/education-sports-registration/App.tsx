...
export default function educationsportsregistration() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education sports registration',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-sports-registration',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education sports registration</h1>
