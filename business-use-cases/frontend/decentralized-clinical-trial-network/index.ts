...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_CLINICAL_TRIAL_NETWORK_CONTRACT_ADDRESS || '';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedClinicalTrialNetwork', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
