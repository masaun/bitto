...
const CONTRACT_ADDRESS = process.env.CAPITAL_CALL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'capital-call';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CapitalCall', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
