...
const CONTRACT_ADDRESS = process.env.AUTOMATED_CHIEF_EXECUTIVE_OFFICER_IN_COMPANY_CONTRACT_ADDRESS || '';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedChiefExecutiveOfficerInCompany', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
