...
const CONTRACT_ADDRESS = process.env.AUTOMATED_CARBON_CREDIT_MRV_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'automated-carbon-credit-mrv';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedCarbonCreditMrv', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
