...
const CONTRACT_ADDRESS = process.env.ARMS_CONTROL_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'arms-control-verification';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ArmsControlVerification', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
