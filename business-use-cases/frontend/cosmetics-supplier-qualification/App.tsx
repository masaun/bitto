...
export default function cosmeticssupplierqualification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics supplier qualification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-supplier-qualification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics supplier qualification</h1>
