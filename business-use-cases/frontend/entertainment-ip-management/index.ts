...
const CONTRACT_ADDRESS = process.env.ENTERTAINMENT_IP_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'entertainment-ip-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EntertainmentIpManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
