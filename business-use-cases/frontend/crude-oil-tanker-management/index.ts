...
const CONTRACT_ADDRESS = process.env.CRUDE_OIL_TANKER_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crude-oil-tanker-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrudeOilTankerManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
