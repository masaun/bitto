...
export default function cosmeticsequipmentvalidation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics equipment validation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-equipment-validation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics equipment validation</h1>
