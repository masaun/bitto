...
export default function educationtranscriptissuance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education transcript issuance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-transcript-issuance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education transcript issuance</h1>
