...
const CONTRACT_ADDRESS = process.env.COMMUNITY_FEEDBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'community-feedback';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CommunityFeedback', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
