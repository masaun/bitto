...
const CONTRACT_ADDRESS = process.env.CONSENT_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'consent-attestation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConsentAttestation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
