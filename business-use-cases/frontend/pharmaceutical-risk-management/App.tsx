...
export default function pharmaceuticalriskmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical risk management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-risk-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical risk management</h1>
