...
const CONTRACT_ADDRESS = process.env.DOCK_YARD_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dock-yard-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DockYardRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
