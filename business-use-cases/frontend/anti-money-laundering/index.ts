...
const CONTRACT_ADDRESS = process.env.ANTI_MONEY_LAUNDERING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'anti-money-laundering';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AntiMoneyLaundering', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
