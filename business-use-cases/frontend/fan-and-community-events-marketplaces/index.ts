...
const CONTRACT_ADDRESS = process.env.FAN_AND_COMMUNITY_EVENTS_MARKETPLACES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fan-and-community-events-marketplaces';

export async function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Fan And Community Events Marketplaces',
...
export async function create_fan_event() {
  const functionArgs = [
...
export async function buy_ticket() {
  const functionArgs = [
