...
const CONTRACT_ADDRESS = process.env.AUTHENTICATION_PROOF_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'authentication-proof';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AuthenticationProof', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
