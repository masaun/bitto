...
export default function pharmaceuticalinsuranceclaim() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical insurance claim',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-insurance-claim',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical insurance claim</h1>
