...
const CONTRACT_ADDRESS = process.env.AUTOMATED_PLAYERS_TRANSFER_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'automated-players-transfer-market';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedPlayersTransferMarket', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
