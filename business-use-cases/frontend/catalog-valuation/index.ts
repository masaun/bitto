...
const CONTRACT_ADDRESS = process.env.CATALOG_VALUATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'catalog-valuation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CatalogValuation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
