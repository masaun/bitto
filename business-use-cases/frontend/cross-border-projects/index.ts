...
const CONTRACT_ADDRESS = process.env.CROSS_BORDER_PROJECTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-border-projects';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossBorderProjects', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
