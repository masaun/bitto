...
export default function pharmaceuticalrecallmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical recall management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-recall-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical recall management</h1>
