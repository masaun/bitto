...
const CONTRACT_ADDRESS = process.env.ASSET_LIFECYCLE_MANAGEMENT_HOSPITALITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asset-lifecycle-management-hospitality';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AssetLifecycleManagementHospitality', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
