...
export default function cosmeticsingredienttracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics ingredient tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-ingredient-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics ingredient tracking</h1>
