...
const CONTRACT_ADDRESS = process.env.CONTAINER_SHIP_LEASING_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'container-ship-leasing-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ContainerShipLeasingManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
