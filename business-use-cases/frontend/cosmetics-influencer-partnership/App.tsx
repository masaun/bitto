...
export default function cosmeticsinfluencerpartnership() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics influencer partnership',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-influencer-partnership',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics influencer partnership</h1>
