...
export default function educationlearningdisauility() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education learning disauility',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-learning-disability',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education learning disauility</h1>
