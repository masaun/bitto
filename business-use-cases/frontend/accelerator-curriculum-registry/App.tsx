...
export default function acceleratorcurriculumregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator curriculum registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-curriculum-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator curriculum registry</h1>
