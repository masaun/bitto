...
export default function pharmaceuticalformularymanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical formulary management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-formulary-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical formulary management</h1>
