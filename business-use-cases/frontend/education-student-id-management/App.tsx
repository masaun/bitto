...
export default function educationstudentidmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education student id management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-student-id-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education student id management</h1>
