...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_IDENTITY_FOR_DONOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-identity-for-donor';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedIdentityForDonor', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
