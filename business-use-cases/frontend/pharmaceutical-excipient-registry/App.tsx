...
export default function pharmaceuticalexcipientregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical excipient registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-excipient-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical excipient registry</h1>
