...
const CONTRACT_NAME = 'multi-use-docks-and-yards';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Multi Use Docks And Yards', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Multi Use Docks And Yards</h1>
      {!userData ? (
