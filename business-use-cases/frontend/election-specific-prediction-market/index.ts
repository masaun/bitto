...
const CONTRACT_ADDRESS = process.env.ELECTION_SPECIFIC_PREDICTION_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'election-specific-prediction-market';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ElectionSpecificPredictionMarket', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
