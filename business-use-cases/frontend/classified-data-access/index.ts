...
const CONTRACT_ADDRESS = process.env.CLASSIFIED_DATA_ACCESS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'classified-data-access';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClassifiedDataAccess', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
