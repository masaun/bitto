...
const CONTRACT_ADDRESS = process.env.CAUSE_CATEGORY_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cause-category-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CauseCategoryRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
