...
export default function pharmaceuticalformulationdevelopment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical formulation development',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-formulation-development',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical formulation development</h1>
