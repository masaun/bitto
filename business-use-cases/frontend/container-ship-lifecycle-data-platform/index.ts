...
const CONTRACT_ADDRESS = process.env.CONTAINER_SHIP_LIFECYCLE_DATA_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'container-ship-lifecycle-data-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ContainerShipLifecycleDataPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
