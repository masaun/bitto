...
const CONTRACT_ADDRESS = process.env.BIM_MODEL_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bim-model-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BimModelRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
