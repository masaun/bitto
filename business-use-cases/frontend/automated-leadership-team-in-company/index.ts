...
const CONTRACT_ADDRESS = process.env.AUTOMATED_LEADERSHIP_TEAM_IN_COMPANY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'automated-leadership-team-in-company';

export async function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Automated Leadership Team In Company',
...
export async function appoint_member() {
  const functionArgs = [
...
export async function vote_proposal() {
  const functionArgs = [
