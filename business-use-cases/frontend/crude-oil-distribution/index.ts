...
const CONTRACT_ADDRESS = process.env.CRUDE_OIL_DISTRIBUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crude-oil-distribution';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrudeOilDistribution', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
