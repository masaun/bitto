...
const CONTRACT_ADDRESS = process.env.EMERGENCY_MOBILIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'emergency-mobilization';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EmergencyMobilization', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
