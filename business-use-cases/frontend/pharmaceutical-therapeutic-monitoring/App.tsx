...
export default function pharmaceuticaltherapeuticmonitoring() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical therapeutic monitoring',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-therapeutic-monitoring',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical therapeutic monitoring</h1>
