...
const CONTRACT_ADDRESS = process.env.NFT_FOR_LOCAL_ART_FUNDING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'NFT-for-local-art-funding';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'NFTForLocalArtFunding', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
