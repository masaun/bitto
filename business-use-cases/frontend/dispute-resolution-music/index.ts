...
const CONTRACT_ADDRESS = process.env.DISPUTE_RESOLUTION_MUSIC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dispute-resolution-music';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DisputeResolutionMusic', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
