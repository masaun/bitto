...
const CONTRACT_ADDRESS = process.env.CBDC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cbdc';
...
export async function freeze_account() {
  const functionArgs = [
...
export async function unfreeze_account() {
  const functionArgs = [
...
export async function set_daily_limit() {
  const functionArgs = [
...
export async function add_authorized_minter() {
  const functionArgs = [
...
export async function remove_authorized_minter() {
  const functionArgs = [
  ...
  const options = {
    ...
    contractAddress: CONTRACT_ADDRESS.split('.')[0],
    contractName: CONTRACT_NAME,
    functionName: 'remove-authorized-minter',
    functionArgs,
    postConditionMode: PostConditionMode.Deny,
    postConditions: [],
    onFinish: (data: any) => {
...
export async function add_compliance_officer() {
  const functionArgs = [
  ...
  const options = {
    ...
    contractAddress: CONTRACT_ADDRESS.split('.')[0],
    contractName: CONTRACT_NAME,
    functionName: 'add-compliance-officer',
    functionArgs,
    postConditionMode: PostConditionMode.Deny,
    postConditions: [],
    onFinish: (data: any) => {
...
export async function remove_compliance_officer() {
  const functionArgs = [
  ...
  const options = {
    ...
    contractAddress: CONTRACT_ADDRESS.split('.')[0],
    contractName: CONTRACT_NAME,
    functionName: 'remove-compliance-officer',
    functionArgs,
    postConditionMode: PostConditionMode.Deny,
    postConditions: [],
    onFinish: (data: any) => {
...
export async function is_frozen() {
  const response = await fetch(
    `https://api.mainnet.hiro.so/v2/contracts/call-read/${CONTRACT_ADDRESS.split('.')[0]}/${CONTRACT_NAME}/is-frozen`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function get_daily_limit() {
  const response = await fetch(
    `https://api.mainnet.hiro.so/v2/contracts/call-read/${CONTRACT_ADDRESS.split('.')[0]}/${CONTRACT_NAME}/get-daily-limit`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function is_compliance_officer() {
  const response = await fetch(
    `https://api.mainnet.hiro.so/v2/contracts/call-read/${CONTRACT_ADDRESS.split('.')[0]}/${CONTRACT_NAME}/is-compliance-officer`,
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
