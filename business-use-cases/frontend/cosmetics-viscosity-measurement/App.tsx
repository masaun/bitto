...
export default function cosmeticsviscositymeasurement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics viscosity measurement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-viscosity-measurement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics viscosity measurement</h1>
