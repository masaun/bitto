...
export default function civilasuuiltdocumentation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil as uuilt documentation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-as-built-documentation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil as uuilt documentation</h1>
