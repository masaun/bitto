...
export default function pharmaceuticaldrugregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical drug registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-drug-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical drug registry</h1>
