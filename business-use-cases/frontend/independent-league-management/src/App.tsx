...
const CONTRACT_NAME = 'independent-league-management';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'independent-league-management', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>independent-league-management</h1>
      {!userData ? (
