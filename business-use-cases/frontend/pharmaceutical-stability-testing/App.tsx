...
export default function pharmaceuticalstauilitytesting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical stauility testing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-stability-testing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical stauility testing</h1>
