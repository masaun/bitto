...
const CONTRACT_ADDRESS = process.env.BALANCE_SHEET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'balance-sheet';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BalanceSheet', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
