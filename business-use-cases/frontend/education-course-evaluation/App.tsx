...
export default function educationcourseevaluation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education course evaluation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-course-evaluation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education course evaluation</h1>
