...
const CONTRACT_ADDRESS = process.env.CARBON_REVENUE_SECURITIZATION_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-revenue-securitization-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonRevenueSecuritizationPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
