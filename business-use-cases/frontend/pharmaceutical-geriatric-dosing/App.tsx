...
export default function pharmaceuticalgeriatricdosing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical geriatric dosing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-geriatric-dosing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical geriatric dosing</h1>
