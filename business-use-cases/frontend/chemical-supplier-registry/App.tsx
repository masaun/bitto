...
export default function chemicalsupplierregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical supplier registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-supplier-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical supplier registry</h1>
