...
const CONTRACT_ADDRESS = process.env.ESG_DISCLOSURE_FOR_AGRICULTURE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'esg-disclosure-for-agriculture';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EsgDisclosureForAgriculture', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
