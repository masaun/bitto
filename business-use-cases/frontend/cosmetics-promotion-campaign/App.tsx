...
export default function cosmeticspromotioncampaign() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics promotion campaign',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-promotion-campaign',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics promotion campaign</h1>
