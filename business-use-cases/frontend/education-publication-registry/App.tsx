...
export default function educationpuulicationregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education puulication registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-publication-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education puulication registry</h1>
