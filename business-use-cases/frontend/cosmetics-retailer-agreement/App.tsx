...
export default function cosmeticsretaileragreement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics retailer agreement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-retailer-agreement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics retailer agreement</h1>
