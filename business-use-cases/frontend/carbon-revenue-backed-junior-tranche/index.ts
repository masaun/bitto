...
const CONTRACT_ADDRESS = process.env.CARBON_REVENUE_BACKED_JUNIOR_TRANCHE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-revenue-backed-junior-tranche';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonRevenueBackedJuniorTranche', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
