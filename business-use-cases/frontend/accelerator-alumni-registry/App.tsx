...
export default function acceleratoralumniregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator alumni registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-alumni-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator alumni registry</h1>
