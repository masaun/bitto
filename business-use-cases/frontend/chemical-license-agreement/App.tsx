...
export default function chemicallicenseagreement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical license agreement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-license-agreement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical license agreement</h1>
