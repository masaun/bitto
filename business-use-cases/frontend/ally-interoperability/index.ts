...
const CONTRACT_ADDRESS = process.env.ALLY_INTEROPERABILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ally-interoperability';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AllyInteroperability', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
