...
const CONTRACT_ADDRESS = process.env.CONTRACTOR_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'contractor-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ContractorRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
