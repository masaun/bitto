...
export default function educationinsurancetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education insurance tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-insurance-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education insurance tracking</h1>
