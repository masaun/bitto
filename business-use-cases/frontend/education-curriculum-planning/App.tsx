...
export default function educationcurriculumplanning() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education curriculum planning',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-curriculum-planning',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education curriculum planning</h1>
