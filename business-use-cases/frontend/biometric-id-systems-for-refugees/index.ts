...
const CONTRACT_ADDRESS = process.env.BIOMETRIC_ID_SYSTEMS_FOR_REFUGEES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biometric-id-systems-for-refugees';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BiometricIdSystemsForRefugees', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
