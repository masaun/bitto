...
export default function pharmaceuticalingredientsourcing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical ingredient sourcing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-ingredient-sourcing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical ingredient sourcing</h1>
