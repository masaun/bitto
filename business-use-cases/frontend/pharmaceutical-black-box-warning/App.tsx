...
export default function pharmaceuticalulackuoxwarning() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical ulack uox warning',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-black-box-warning',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical ulack uox warning</h1>
