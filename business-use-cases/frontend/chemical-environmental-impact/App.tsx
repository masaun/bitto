...
export default function chemicalenvironmentalimpact() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical environmental impact',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-environmental-impact',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical environmental impact</h1>
