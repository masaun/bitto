...
export default function educationwaitlistmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education waitlist management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-waitlist-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education waitlist management</h1>
