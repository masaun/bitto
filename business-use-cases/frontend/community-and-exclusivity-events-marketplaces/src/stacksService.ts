...
const contractAddress = import.meta.env.COMMUNITY_AND_EXCLUSIVITY_EVENTS_MARKETPLACES_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.COMMUNITY_AND_EXCLUSIVITY_EVENTS_MARKETPLACES_CONTRACT_ADDRESS?.split('.')[1] || 'community-and-exclusivity-events-marketplaces';
