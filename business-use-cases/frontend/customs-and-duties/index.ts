...
const CONTRACT_ADDRESS = process.env.CUSTOMS_AND_DUTIES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'customs-and-duties';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CustomsAndDuties', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
