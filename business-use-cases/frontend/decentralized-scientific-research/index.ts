...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_SCIENTIFIC_RESEARCH_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-scientific-research';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedScientificResearch', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
