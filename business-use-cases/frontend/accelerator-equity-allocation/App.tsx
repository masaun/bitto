...
export default function acceleratorequityallocation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator equity allocation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-equity-allocation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator equity allocation</h1>
