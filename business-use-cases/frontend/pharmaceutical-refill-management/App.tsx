...
export default function pharmaceuticalrefillmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical refill management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-refill-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical refill management</h1>
