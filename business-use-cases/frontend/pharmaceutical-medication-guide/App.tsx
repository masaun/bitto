...
export default function pharmaceuticalmedicationguide() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical medication guide',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-medication-guide',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical medication guide</h1>
