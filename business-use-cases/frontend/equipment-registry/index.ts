...
const CONTRACT_ADDRESS = process.env.EQUIPMENT_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'equipment-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EquipmentRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
