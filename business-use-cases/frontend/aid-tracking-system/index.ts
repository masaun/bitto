...
const CONTRACT_ADDRESS = process.env.AID_TRACKING_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aid-tracking-system';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AidTrackingSystem', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
