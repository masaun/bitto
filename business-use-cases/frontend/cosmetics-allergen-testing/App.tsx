...
export default function cosmeticsallergentesting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics allergen testing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-allergen-testing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics allergen testing</h1>
