...
export default function chemicalcustomsclearance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical customs clearance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-customs-clearance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical customs clearance</h1>
