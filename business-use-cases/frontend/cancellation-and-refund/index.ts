...
const CONTRACT_ADDRESS = process.env.CANCELLATION_AND_REFUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cancellation-and-refund';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CancellationAndRefund', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
