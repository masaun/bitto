...
export default function chemicalinspectionrecords() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical inspection records',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-inspection-records',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical inspection records</h1>
