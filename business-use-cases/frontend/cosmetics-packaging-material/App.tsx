...
export default function cosmeticspackagingmaterial() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics packaging material',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-packaging-material',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics packaging material</h1>
