...
const CONTRACT_ADDRESS = process.env.COLLECTING_SMALL_FARMER_OUTPUT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'collecting-small-farmer-output';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CollectingSmallFarmerOutput', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
