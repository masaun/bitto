...
export default function chemicalincidentreporting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical incident reporting',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-incident-reporting',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical incident reporting</h1>
