...
const CONTRACT_ADDRESS = process.env.AUDIT_FEE_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'audit-fee-settlement';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AuditFeeSettlement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
