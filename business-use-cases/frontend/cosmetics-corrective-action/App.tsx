...
export default function cosmeticscorrectiveaction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics corrective action',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-corrective-action',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics corrective action</h1>
