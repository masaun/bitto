...
export default function educationfacultyregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education faculty registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-faculty-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education faculty registry</h1>
