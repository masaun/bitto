...
const CONTRACT_ADDRESS = process.env.CARBON_PERFORMANCE_OF_SHIP_BACKED_LOAN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-performance-of-ship-backed-loan';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonPerformanceOfShipBackedLoan', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
