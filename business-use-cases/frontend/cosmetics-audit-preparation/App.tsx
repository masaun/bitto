...
export default function cosmeticsauditpreparation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics audit preparation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-audit-preparation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics audit preparation</h1>
