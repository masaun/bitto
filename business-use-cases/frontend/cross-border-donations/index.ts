...
const CONTRACT_ADDRESS = process.env.CROSS_BORDER_DONATIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-border-donations';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossBorderDonations', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
