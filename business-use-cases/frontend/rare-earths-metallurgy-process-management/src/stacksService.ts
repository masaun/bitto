...
const contractAddress = import.meta.env.RARE_EARTHS_METALLURGY_PROCESS_MANAGEMENT_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.RARE_EARTHS_METALLURGY_PROCESS_MANAGEMENT_CONTRACT_ADDRESS?.split('.')[1] || 'rare-earths-metallurgy-process-management';
