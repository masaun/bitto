...
const CONTRACT_ADDRESS = process.env.BUDGET_ALLOCATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'budget-allocation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BudgetAllocation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
