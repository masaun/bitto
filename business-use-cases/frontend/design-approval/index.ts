...
const CONTRACT_ADDRESS = process.env.DESIGN_APPROVAL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'design-approval';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DesignApproval', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
