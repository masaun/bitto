...
export default function pharmaceuticalprescriptiontracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical prescription tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-prescription-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical prescription tracking</h1>
