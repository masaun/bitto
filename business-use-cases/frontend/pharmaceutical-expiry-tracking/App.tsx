...
export default function pharmaceuticalexpirytracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical expiry tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-expiry-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical expiry tracking</h1>
