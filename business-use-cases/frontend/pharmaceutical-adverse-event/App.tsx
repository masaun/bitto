...
export default function pharmaceuticaladverseevent() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical adverse event',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-adverse-event',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical adverse event</h1>
