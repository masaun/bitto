...
const CONTRACT_ADDRESS = process.env.CARBON_CREDIT_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-credit-clearinghouse';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonCreditClearinghouse', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
