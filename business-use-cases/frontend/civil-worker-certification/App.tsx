...
export default function civilworkercertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil worker certification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-worker-certification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil worker certification</h1>
