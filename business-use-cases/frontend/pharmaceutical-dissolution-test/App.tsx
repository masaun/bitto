...
export default function pharmaceuticaldissolutiontest() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical dissolution test',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-dissolution-test',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical dissolution test</h1>
