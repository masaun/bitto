...
const CONTRACT_ADDRESS = process.env.AID_ALLOCATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aid-allocator';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AidAllocator', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
