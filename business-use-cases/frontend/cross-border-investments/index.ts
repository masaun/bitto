...
const CONTRACT_ADDRESS = process.env.CROSS_BORDER_INVESTMENTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-border-investments';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossBorderInvestments', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
