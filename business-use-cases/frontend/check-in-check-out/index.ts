...
const CONTRACT_ADDRESS = process.env.CHECK_IN_CHECK_OUT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'check-in-check-out';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CheckInCheckOut', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
