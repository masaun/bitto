...
const CONTRACT_NAME = 'independent-league-sponcorship';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'independent-league-sponcorship', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>independent-league-sponcorship</h1>
      {!userData ? (
