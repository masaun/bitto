...
const contractName = 'micropayment-with-revenue-sharing';
...
document.getElementById('add-beneficiary').addEventListener('click', () => {
  callContract('add-beneficiary', []);
});

document.getElementById('make-micropayment').addEventListener('click', () => {
  callContract('make-micropayment', []);
});
