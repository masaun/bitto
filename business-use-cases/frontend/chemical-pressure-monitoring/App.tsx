...
export default function chemicalpressuremonitoring() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical pressure monitoring',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-pressure-monitoring',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical pressure monitoring</h1>
