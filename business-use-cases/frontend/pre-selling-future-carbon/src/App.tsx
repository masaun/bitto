...
const CONTRACT_NAME = 'pre-selling-future-carbon';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Pre Selling Future Carbon', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Pre Selling Future Carbon</h1>
      {!userData ? (
