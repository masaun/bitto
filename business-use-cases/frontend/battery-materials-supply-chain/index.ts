...
const CONTRACT_ADDRESS = process.env.BATTERY_MATERIALS_SUPPLY_CHAIN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-materials-supply-chain';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BatteryMaterialsSupplyChain', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
