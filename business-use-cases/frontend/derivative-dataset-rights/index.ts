...
const CONTRACT_ADDRESS = process.env.DERIVATIVE_DATASET_RIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'derivative-dataset-rights';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DerivativeDatasetRights', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
