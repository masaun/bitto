...
const CONTRACT_ADDRESS = process.env.DATA_PRIVACY_PROTECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-privacy-protection';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DataPrivacyProtection', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
