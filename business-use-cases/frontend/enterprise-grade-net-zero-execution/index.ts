...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_GRADE_NET_ZERO_EXECUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-grade-net-zero-execution';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EnterpriseGradeNetZeroExecution', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
