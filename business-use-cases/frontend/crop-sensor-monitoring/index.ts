...
const CONTRACT_ADDRESS = process.env.CROP_SENSOR_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crop-sensor-monitoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CropSensorMonitoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
