...
const CONTRACT_NAME = 'weather-sensor-monitoring';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Weather Sensor Monitoring', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Weather Sensor Monitoring</h1>
      {!userData ? (
