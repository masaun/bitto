...
export default function cosmeticsdeviationhandling() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics deviation handling',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-deviation-handling',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics deviation handling</h1>
