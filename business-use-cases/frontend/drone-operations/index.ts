...
const CONTRACT_ADDRESS = process.env.DRONE_OPERATIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'drone-operations';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DroneOperations', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
