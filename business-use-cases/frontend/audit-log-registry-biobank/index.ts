...
const CONTRACT_ADDRESS = process.env.AUDIT_LOG_REGISTRY_BIOBANK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'audit-log-registry-biobank';

export async function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Audit Log Registry Biobank',
...
export async function log_operation() {
  const functionArgs = [
