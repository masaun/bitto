...
export default function cosmeticssensoryevaluation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics sensory evaluation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-sensory-evaluation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics sensory evaluation</h1>
