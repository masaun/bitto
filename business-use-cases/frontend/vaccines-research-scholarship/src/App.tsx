...
const CONTRACT_NAME = 'vaccines-research-scholarship';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'vaccines-research-scholarship', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>vaccines-research-scholarship</h1>
      {!userData ? (
