...
export default function acceleratorofficeusagetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator office usage tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-office-usage-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator office usage tracking</h1>
