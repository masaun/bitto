...
const CONTRACT_ADDRESS = process.env.TOKENIZED_SPORTS_CLUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-sports-club';
...
export async function purchase_tokens() {
  const functionArgs = [
...
export async function get_club_info() {
  const response = await fetch(
    `https://api.mainnet.hiro.so/v2/contracts/call-read/${CONTRACT_ADDRESS.split('.')[0]}/${CONTRACT_NAME}/get-club-info`,
    {
      method: 'POST',
      headers: {
