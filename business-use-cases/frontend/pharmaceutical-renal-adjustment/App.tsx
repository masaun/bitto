...
export default function pharmaceuticalrenaladjustment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical renal adjustment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-renal-adjustment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical renal adjustment</h1>
