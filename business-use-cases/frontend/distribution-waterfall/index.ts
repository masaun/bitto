...
const CONTRACT_ADDRESS = process.env.DISTRIBUTION_WATERFALL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'distribution-waterfall';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DistributionWaterfall', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
