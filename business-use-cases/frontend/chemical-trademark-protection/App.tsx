...
export default function chemicaltrademarkprotection() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical trademark protection',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-trademark-protection',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical trademark protection</h1>
