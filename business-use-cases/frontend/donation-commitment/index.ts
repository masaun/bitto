...
const CONTRACT_ADDRESS = process.env.DONATION_COMMITMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'donation-commitment';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DonationCommitment', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
