...
const contractAddress = import.meta.env.IDENTITY_DRIVEN_ATTENDANCE_EVENT_MARKETPLACES_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.IDENTITY_DRIVEN_ATTENDANCE_EVENT_MARKETPLACES_CONTRACT_ADDRESS?.split('.')[1] || 'identity-driven-attendance-event-marketplaces';
