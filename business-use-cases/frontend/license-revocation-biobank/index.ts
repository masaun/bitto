...
const CONTRACT_ADDRESS = process.env.LICENSE_REVOCATION_BIOBANK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'license-revocation-biobank';

export async function connectWallet() {
  showConnect({
    appDetails: {
      name: 'License Revocation Biobank',
