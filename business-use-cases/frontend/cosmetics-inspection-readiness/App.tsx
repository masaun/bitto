...
export default function cosmeticsinspectionreadiness() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics inspection readiness',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-inspection-readiness',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics inspection readiness</h1>
