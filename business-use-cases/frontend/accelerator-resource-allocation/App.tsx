...
export default function acceleratorresourceallocation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator resource allocation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-resource-allocation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator resource allocation</h1>
