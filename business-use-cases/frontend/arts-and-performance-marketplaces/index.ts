...
const CONTRACT_ADDRESS = process.env.ARTS_AND_PERFORMANCE_MARKETPLACES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'arts-and-performance-marketplaces';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ArtsAndPerformanceMarketplaces', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
