...
export default function educationdegreecertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education degree certification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-degree-certification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education degree certification</h1>
