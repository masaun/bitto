...
const contractAddress = import.meta.env.B2C_CONSUMER_EVENTS_PLATFROM_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.B2C_CONSUMER_EVENTS_PLATFROM_CONTRACT_ADDRESS?.split('.')[1] || 'b2c-consumer-events-platfrom';
