...
const CONTRACT_ADDRESS = process.env.B2C_CONSUMER_EVENTS_PLATFROM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'b2c-consumer-events-platfrom';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'B2cConsumerEventsPlatfrom', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
