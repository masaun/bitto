...
export default function chemicallauequipmentregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical lau equipment registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-lab-equipment-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical lau equipment registry</h1>
