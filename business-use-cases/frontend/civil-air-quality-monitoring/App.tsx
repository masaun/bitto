...
export default function civilairqualitymonitoring() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil air quality monitoring',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-air-quality-monitoring',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil air quality monitoring</h1>
