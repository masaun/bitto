...
export default function chemicalanalyticalmethod() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical analytical method',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-analytical-method',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical analytical method</h1>
