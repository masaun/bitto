...
const contractName = 'decentralized-legal-counsel-network';
...
document.getElementById('register-counsel').addEventListener('click', () => {
  callContract('register-counsel', []);
});

document.getElementById('create-case').addEventListener('click', () => {
  callContract('create-case', []);
});

document.getElementById('upload-document').addEventListener('click', () => {
  callContract('upload-document', []);
});

document.getElementById('bill-hours').addEventListener('click', () => {
  callContract('bill-hours', []);
});

document.getElementById('close-case').addEventListener('click', () => {
  callContract('close-case', []);
});
