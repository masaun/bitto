...
const contractName = 'decentralizing-training-data-marketplace-for-robots';
...
document.getElementById('submit-quality-review').addEventListener('click', () => {
  callContract('submit-quality-review', []);
});
