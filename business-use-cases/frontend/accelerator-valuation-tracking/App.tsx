...
export default function acceleratorvaluationtracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator valuation tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-valuation-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator valuation tracking</h1>
