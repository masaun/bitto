...
export default function educationattendancetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education attendance tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-attendance-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education attendance tracking</h1>
