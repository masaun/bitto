...
export default function pharmaceuticaldosagecalculation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical dosage calculation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-dosage-calculation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical dosage calculation</h1>
