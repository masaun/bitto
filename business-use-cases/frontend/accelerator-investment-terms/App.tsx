...
export default function acceleratorinvestmentterms() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator investment terms',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-investment-terms',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator investment terms</h1>
