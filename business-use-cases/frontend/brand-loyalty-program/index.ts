...
const CONTRACT_ADDRESS = process.env.BRAND_LOYALTY_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'brand-loyalty-program';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BrandLoyaltyProgram', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
