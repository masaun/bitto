...
const CONTRACT_ADDRESS = process.env.AUTOMATED_CHIEF_TECHNICAL_OFFICER_IN_COMPANY_CONTRACT_ADDRESS || '';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedChiefTechnicalOfficerInCompany', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
