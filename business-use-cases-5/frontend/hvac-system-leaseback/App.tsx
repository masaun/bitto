...
const CONTRACT_ADDRESS = process.env.HVAC_SYSTEM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hvac-system-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hvac-system-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
