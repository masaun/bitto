...
export default function handcraftedFurnitureCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furniture Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNITURE_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furniture-certification';
  ...
  return (
    <div>
      <h1>Handcrafted Furniture Certification</h1>
