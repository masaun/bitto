...
export default function handcraftedFurnishingHub() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furnishing Hub',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNISHING_HUB_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furnishing-hub';
  ...
  return (
    <div>
      <h1>Handcrafted Furnishing Hub</h1>
