...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INCENTIVE_DISTRO_ADDRESS || '';

export default function Incentive_DistroPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.incentive-distro/read-only/get-counter`,
        {
          method: 'GET',
