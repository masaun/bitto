...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FEE_TIER_MANAGER_ADDRESS || '';

export default function Fee_Tier_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fee-tier-manager/read-only/get-counter`,
        {
          method: 'GET',
