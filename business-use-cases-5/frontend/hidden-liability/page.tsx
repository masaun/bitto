...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HIDDEN_LIABILITY_ADDRESS || '';

export default function Hidden_LiabilityPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.hidden-liability/read-only/get-counter`,
        {
          method: 'GET',
