...
const CONTRACT_ADDRESS = process.env.GLOBAL_TRAINING_SCHOLARSHIP_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-training-scholarship';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Training Scholarship',
