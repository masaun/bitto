...
const CONTRACT_ADDRESS = process.env.FREEPORT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'freeport-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'freeport-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
