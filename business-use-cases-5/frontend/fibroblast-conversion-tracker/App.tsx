...
const contractAddress = process.env.REACT_APP_FIBROBLAST_CONVERSION_TRACKER_CONTRACT_ADDRESS || '';
const contractName = 'fibroblast-conversion-tracker';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>fiuroulast conversion tracker</h1>
