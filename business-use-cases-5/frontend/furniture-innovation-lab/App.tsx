...
export default function furnitureInnovationLab() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_INNOVATION_LAB_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-innovation-lab';
  ...
  return (
    <div>
      <h1>Furniture Innovation Lab</h1>
