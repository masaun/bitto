...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GLOBAL_PARAMS_V1_ADDRESS || '';

export default function Global_Params_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.global-params-v1/read-only/get-counter`,
        {
          method: 'GET',
