...
const contractAddress = process.env.REACT_APP_EXPERIENTIAL_COMMERCE_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'experiential-commerce-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Experiential Commerce Quest</h1>
