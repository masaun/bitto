...
const CONTRACT_ADDRESS = process.env.FOOD_PROCESSING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'food-processing-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'food-processing-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>food-processing-leaseback</h1>
      {!userData ? (
