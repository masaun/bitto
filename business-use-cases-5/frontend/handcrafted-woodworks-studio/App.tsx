...
export default function handcraftedWoodworksStudio() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Woodworks Studio',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_WOODWORKS_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-woodworks-studio';
  ...
  return (
    <div>
      <h1>Handcrafted Woodworks Studio</h1>
