...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FIXED_POINT_MATH_ADDRESS || '';

export default function Fixed_Point_MathPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fixed-point-math/read-only/get-counter`,
        {
          method: 'GET',
