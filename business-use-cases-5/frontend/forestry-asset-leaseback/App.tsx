...
const CONTRACT_ADDRESS = process.env.FORESTRY_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'forestry-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'forestry-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>forestry-asset-leaseback</h1>
      {!userData ? (
