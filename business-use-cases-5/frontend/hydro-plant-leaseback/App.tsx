...
const CONTRACT_ADDRESS = process.env.HYDRO_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hydro-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hydro-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
