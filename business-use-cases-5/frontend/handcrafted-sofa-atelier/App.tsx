...
export default function handcraftedSofaAtelier() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_SOFA_ATELIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-sofa-atelier';
  ...
  return (
    <div>
      <h1>Handcrafted Sofa Atelier</h1>
