...
const CONTRACT_ADDRESS = process.env.HEALTHCARE_INTEROPERABILITY_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'healthcare-interoperability-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'healthcare-interoperability-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>healthcare-interoperability-layer</h1>
      {!userData ? (
