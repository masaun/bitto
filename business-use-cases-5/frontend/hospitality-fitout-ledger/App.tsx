...
export default function hospitalityFitoutLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Fitout Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_FITOUT_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-fitout-ledger';
  ...
  return (
    <div>
      <h1>Hospitality Fitout Ledger</h1>
