...
const CONTRACT_ADDRESS = process.env.GLOBAL_VIEWERSHIP_REWARDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-viewership-rewards';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Viewership Rewards',
