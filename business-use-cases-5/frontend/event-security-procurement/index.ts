...
const CONTRACT_ADDRESS = process.env.EVENT_SECURITY_PROCUREMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'event-security-procurement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Event Security Procurement',
