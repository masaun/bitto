...
const CONTRACT_ADDRESS = process.env.FINANCIAL_STABILIZATION_FUND_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-stabilization-fund-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-stabilization-fund-3',
