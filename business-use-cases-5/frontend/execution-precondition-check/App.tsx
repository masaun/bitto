...
const contractAddress = process.env.REACT_APP_EXECUTION_PRECONDITION_CHECK_CONTRACT_ADDRESS || '';
const contractName = 'execution-precondition-check';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Execution Precondition Check',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Execution Precondition Check</h1>
