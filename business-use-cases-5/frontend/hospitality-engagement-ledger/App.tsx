...
const contractAddress = process.env.REACT_APP_HOSPITALITY_ENGAGEMENT_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-engagement-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Engagement Ledger</h1>
