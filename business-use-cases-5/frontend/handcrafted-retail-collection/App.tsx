...
export default function handcraftedRetailCollection() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Retail Collection',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_RETAIL_COLLECTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-retail-collection';
  ...
  return (
    <div>
      <h1>Handcrafted Retail Collection</h1>
