...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_LIQUIDITY_VAULT_6_ADDRESS || '';
const CONTRACT_NAME = 'government-liquidity-vault-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-liquidity-vault-6',
