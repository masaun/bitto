...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FEE_ABSTRACTION_ADDRESS || '';

export default function Fee_AbstractionPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fee-abstraction/read-only/get-counter`,
        {
          method: 'GET',
