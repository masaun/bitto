...
const CONTRACT_ADDRESS = process.env.FIBER_NETWORK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fiber-network-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fiber-network-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
