...
const CONTRACT_ADDRESS = process.env.HOTEL_PROPERTY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hotel-property-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hotel-property-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>hotel-property-leaseback</h1>
      {!userData ? (
