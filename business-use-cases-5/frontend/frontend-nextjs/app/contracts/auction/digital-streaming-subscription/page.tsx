...
export default function DigitalStreamingSubscriptionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-streaming-subscription');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-streaming-subscription',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-streaming-subscription' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Digital Streaming Subscription</h1>
