...
export default function TacticalCollectionManager1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-collection-manager-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-collection-manager-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-collection-manager-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Collection Manager 1</h1>
