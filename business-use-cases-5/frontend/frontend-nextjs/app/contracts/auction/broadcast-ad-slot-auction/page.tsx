...
export default function BroadcastAdSlotAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('broadcast-ad-slot-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'broadcast-ad-slot-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'broadcast-ad-slot-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Broadcast Ad Slot Auction</h1>
