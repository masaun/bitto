...
export default function ChampionshipSupplyChainPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-supply-chain');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-supply-chain',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-supply-chain' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Supply Chain</h1>
