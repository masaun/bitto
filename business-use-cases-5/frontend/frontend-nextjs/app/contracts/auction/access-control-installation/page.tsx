...
export default function AccessControlInstallationPage() {
  ...
  const contractAddress = getContractAddress('access-control-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'access-control-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'access-control-installation' },
      });
