...
export default function PriceVolatilityAnalysisPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('price-volatility-analysis');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'price-volatility-analysis',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'price-volatility-analysis' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Price Volatility Analysis</h1>
