...
export default function GovernmentTaxCollectionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-tax-collection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-tax-collection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-tax-collection' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Tax Collection</h1>
