...
export default function SportsDocumentaryFinancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-documentary-finance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-documentary-finance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-documentary-finance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Documentary Finance</h1>
