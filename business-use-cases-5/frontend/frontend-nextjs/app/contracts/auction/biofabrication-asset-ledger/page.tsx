...
export default function BiofabricationAssetLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('biofabrication-asset-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'biofabrication-asset-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'biofabrication-asset-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Biofabrication Asset Ledger</h1>
