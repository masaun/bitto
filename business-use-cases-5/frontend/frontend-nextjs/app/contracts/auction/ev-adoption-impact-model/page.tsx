...
export default function EvAdoptionImpactModelPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ev-adoption-impact-model');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ev-adoption-impact-model',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ev-adoption-impact-model' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ev Adoption Impact Model</h1>
