...
export default function FlooringInstallationProtocolPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('flooring-installation-protocol');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'flooring-installation-protocol',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'flooring-installation-protocol' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Flooring Installation Protocol</h1>
