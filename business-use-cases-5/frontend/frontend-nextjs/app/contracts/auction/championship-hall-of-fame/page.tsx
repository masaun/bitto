...
export default function ChampionshipHallOfFamePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-hall-of-fame');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-hall-of-fame',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-hall-of-fame' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Hall Of Fame</h1>
