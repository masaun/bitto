...
export default function EncryptedInterchainCallPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('encrypted-interchain-call');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'encrypted-interchain-call',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'encrypted-interchain-call' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Encrypted Interchain Call</h1>
