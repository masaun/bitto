...
export default function WorkorderManagementSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('workorder-management-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'workorder-management-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'workorder-management-system' },
      });
