...
export default function SportswearSupplyChainLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sportswear-supply-chain-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sportswear-supply-chain-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sportswear-supply-chain-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sportswear Supply Chain Ledger</h1>
