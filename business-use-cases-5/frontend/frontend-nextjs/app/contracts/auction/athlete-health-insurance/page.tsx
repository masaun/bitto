...
export default function AthleteHealthInsurancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-health-insurance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-health-insurance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-health-insurance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Health Insurance</h1>
