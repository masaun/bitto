...
export default function ArtisanJoineryCertificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('artisan-joinery-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'artisan-joinery-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'artisan-joinery-certification' },
      });
