...
export default function AutonomousVehicleCoordinationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('autonomous-vehicle-coordination');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'autonomous-vehicle-coordination',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'autonomous-vehicle-coordination' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Autonomous Vehicle Coordination</h1>
