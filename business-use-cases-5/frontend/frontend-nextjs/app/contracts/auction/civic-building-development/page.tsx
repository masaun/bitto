...
export default function CivicBuildingDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('civic-building-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'civic-building-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'civic-building-development' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Civic Building Development</h1>
