...
export default function PrivateBehaviorAnalysisPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-behavior-analysis');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-behavior-analysis',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-behavior-analysis' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Behavior Analysis</h1>
