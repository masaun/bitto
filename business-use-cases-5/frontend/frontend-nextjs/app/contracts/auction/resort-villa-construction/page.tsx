...
export default function ResortVillaConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('resort-villa-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'resort-villa-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'resort-villa-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Resort Villa Construction</h1>
