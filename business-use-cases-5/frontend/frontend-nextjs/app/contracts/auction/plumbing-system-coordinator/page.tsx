...
export default function PlumbingSystemCoordinatorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('plumbing-system-coordinator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'plumbing-system-coordinator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'plumbing-system-coordinator' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Plumbing System Coordinator</h1>
