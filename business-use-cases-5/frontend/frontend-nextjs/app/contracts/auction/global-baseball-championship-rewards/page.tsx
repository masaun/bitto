...
export default function GlobalBaseballChampionshipRewardsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-baseball-championship-rewards');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-baseball-championship-rewards',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-baseball-championship-rewards' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Baseball Championship Rewards</h1>
