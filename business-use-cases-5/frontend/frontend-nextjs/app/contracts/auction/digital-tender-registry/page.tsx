...
export default function DigitalTenderRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-tender-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-tender-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-tender-registry' },
      });
