...
export default function LiquidationProtectionPage() {
  ...
  const contractAddress = getContractAddress('liquidation-protection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'liquidation-protection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'liquidation-protection' },
      });
