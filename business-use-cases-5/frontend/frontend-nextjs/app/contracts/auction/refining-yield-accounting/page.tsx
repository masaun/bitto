...
export default function RefiningYieldAccountingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('refining-yield-accounting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'refining-yield-accounting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'refining-yield-accounting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Refining Yield Accounting</h1>
