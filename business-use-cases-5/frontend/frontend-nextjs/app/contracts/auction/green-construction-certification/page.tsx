...
export default function GreenConstructionCertificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('green-construction-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'green-construction-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'green-construction-certification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Green Construction Certification</h1>
