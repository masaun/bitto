...
export default function BuildingValuationLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('building-valuation-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'building-valuation-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'building-valuation-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Building Valuation Ledger</h1>
