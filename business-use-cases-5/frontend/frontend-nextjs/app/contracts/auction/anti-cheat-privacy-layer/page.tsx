...
export default function AntiCheatPrivacyLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('anti-cheat-privacy-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'anti-cheat-privacy-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'anti-cheat-privacy-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Anti Cheat Privacy Layer</h1>
