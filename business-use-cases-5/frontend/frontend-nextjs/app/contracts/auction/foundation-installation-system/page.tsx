...
export default function FoundationInstallationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('foundation-installation-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'foundation-installation-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'foundation-installation-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Foundation Installation System</h1>
