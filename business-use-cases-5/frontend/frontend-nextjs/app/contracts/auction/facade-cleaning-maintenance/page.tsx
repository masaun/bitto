...
export default function FacadeCleaningMaintenancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('facade-cleaning-maintenance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'facade-cleaning-maintenance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'facade-cleaning-maintenance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Facade Cleaning Maintenance</h1>
