...
export default function PrivateOrderflowManagerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-orderflow-manager');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-orderflow-manager',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-orderflow-manager' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Orderflow Manager</h1>
