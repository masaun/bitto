...
export default function AffordableRentalProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('affordable-rental-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'affordable-rental-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'affordable-rental-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Affordable Rental Project</h1>
