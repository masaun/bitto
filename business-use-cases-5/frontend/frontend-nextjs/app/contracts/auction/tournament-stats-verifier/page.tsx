...
export default function TournamentStatsVerifierPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tournament-stats-verifier');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tournament-stats-verifier',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tournament-stats-verifier' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tournament Stats Verifier</h1>
