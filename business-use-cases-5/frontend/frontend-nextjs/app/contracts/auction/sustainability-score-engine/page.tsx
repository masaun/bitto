...
export default function SustainabilityScoreEnginePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sustainability-score-engine');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sustainability-score-engine',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sustainability-score-engine' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sustainability Score Engine</h1>
