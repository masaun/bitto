...
export default function SustainableMaterialSourcingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sustainable-material-sourcing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sustainable-material-sourcing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sustainable-material-sourcing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sustainable Material Sourcing</h1>
