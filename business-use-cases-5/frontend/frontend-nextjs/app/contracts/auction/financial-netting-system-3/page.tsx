...
export default function FinancialNettingSystem3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-netting-system-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-netting-system-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-netting-system-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Netting System 3</h1>
