...
export default function CurtainwallInstallationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('curtainwall-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'curtainwall-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'curtainwall-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Curtainwall Installation</h1>
