...
export default function FanExperienceMarketplacePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('fan-experience-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'fan-experience-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'fan-experience-marketplace' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Fan Experience Marketplace</h1>
