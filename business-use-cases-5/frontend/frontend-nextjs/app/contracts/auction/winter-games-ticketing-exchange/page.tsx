...
export default function WinterGamesTicketingExchangePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('winter-games-ticketing-exchange');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'winter-games-ticketing-exchange',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'winter-games-ticketing-exchange' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Winter Games Ticketing Exchange</h1>
