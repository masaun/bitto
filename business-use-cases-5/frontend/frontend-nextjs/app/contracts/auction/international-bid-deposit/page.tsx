...
export default function InternationalBidDepositPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-bid-deposit');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-bid-deposit',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-bid-deposit' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Bid Deposit</h1>
