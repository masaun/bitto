...
export default function FinancialCollectionManager3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-collection-manager-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-collection-manager-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-collection-manager-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Collection Manager 3</h1>
