...
export default function WaterproofingSystemLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('waterproofing-system-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'waterproofing-system-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'waterproofing-system-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Waterproofing System Ledger</h1>
