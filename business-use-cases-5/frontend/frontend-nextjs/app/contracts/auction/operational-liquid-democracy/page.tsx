...
export default function OperationalLiquidDemocracyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-liquid-democracy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-liquid-democracy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-liquid-democracy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Liquid Democracy</h1>
