...
export default function FootballSemiFinalBonusPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('football-semi-final-bonus');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'football-semi-final-bonus',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'football-semi-final-bonus' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Football Semi Final Bonus</h1>
