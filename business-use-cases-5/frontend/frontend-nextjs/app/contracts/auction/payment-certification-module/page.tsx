...
export default function PaymentCertificationModulePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('payment-certification-module');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'payment-certification-module',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'payment-certification-module' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Payment Certification Module</h1>
