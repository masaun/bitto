...
export default function MatchdayHospitalityPassPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('matchday-hospitality-pass');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'matchday-hospitality-pass',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'matchday-hospitality-pass' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Matchday Hospitality Pass</h1>
