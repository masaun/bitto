...
export default function ShellAndCoreDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('shell-and-core-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'shell-and-core-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'shell-and-core-development' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Shell And Core Development</h1>
