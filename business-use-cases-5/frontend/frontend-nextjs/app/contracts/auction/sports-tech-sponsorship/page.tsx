...
export default function SportsTechSponsorshipPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-tech-sponsorship');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-tech-sponsorship',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-tech-sponsorship' },
      });
