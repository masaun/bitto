...
export default function InteriorPaintingLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('interior-painting-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'interior-painting-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'interior-painting-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Interior Painting Ledger</h1>
