...
export default function TransitOrientedDevelopmentPage() {
  ...
  const contractAddress = getContractAddress('transit-oriented-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'transit-oriented-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'transit-oriented-development' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Transit Oriented Development</h1>
