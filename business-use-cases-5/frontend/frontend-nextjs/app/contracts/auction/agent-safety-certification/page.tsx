...
export default function AgentSafetyCertificationPage() {
  ...
  const contractAddress = getContractAddress('agent-safety-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'agent-safety-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'agent-safety-certification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Agent Safety Certification</h1>
