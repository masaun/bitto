...
export default function CircularEconomyIncentivesPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('circular-economy-incentives');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'circular-economy-incentives',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'circular-economy-incentives' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Circular Economy Incentives</h1>
