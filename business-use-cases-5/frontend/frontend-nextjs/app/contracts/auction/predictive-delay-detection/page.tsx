...
export default function PredictiveDelayDetectionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('predictive-delay-detection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'predictive-delay-detection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'predictive-delay-detection' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Predictive Delay Detection</h1>
