...
export default function TacticalPoolingSystem1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-pooling-system-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-pooling-system-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-pooling-system-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Pooling System 1</h1>
