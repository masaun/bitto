...
export default function RefereeAssignmentValidatorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('referee-assignment-validator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'referee-assignment-validator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'referee-assignment-validator' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Referee Assignment Validator</h1>
