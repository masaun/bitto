...
export default function ScaffoldingSafetyLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('scaffolding-safety-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'scaffolding-safety-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'scaffolding-safety-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Scaffolding Safety Ledger</h1>
