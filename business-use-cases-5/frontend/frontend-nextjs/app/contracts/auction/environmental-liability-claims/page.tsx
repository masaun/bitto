...
export default function EnvironmentalLiabilityClaimsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('environmental-liability-claims');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'environmental-liability-claims',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'environmental-liability-claims' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Environmental Liability Claims</h1>
