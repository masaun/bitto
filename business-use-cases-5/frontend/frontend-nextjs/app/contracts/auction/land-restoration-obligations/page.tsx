...
export default function LandRestorationObligationsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('land-restoration-obligations');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'land-restoration-obligations',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'land-restoration-obligations' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Land Restoration Obligations</h1>
