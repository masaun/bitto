...
export default function EliteAthleteScholarshipPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('elite-athlete-scholarship');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'elite-athlete-scholarship',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'elite-athlete-scholarship' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Elite Athlete Scholarship</h1>
