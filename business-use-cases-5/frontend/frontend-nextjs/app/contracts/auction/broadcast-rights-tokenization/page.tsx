...
export default function BroadcastRightsTokenizationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('broadcast-rights-tokenization');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'broadcast-rights-tokenization',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'broadcast-rights-tokenization' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Broadcast Rights Tokenization</h1>
