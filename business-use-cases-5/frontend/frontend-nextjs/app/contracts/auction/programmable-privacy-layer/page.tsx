...
export default function ProgrammablePrivacyLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('programmable-privacy-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'programmable-privacy-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'programmable-privacy-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Programmable Privacy Layer</h1>
