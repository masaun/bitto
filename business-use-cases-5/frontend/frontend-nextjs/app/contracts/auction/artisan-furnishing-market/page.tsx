...
export default function ArtisanFurnishingMarketPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('artisan-furnishing-market');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'artisan-furnishing-market',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'artisan-furnishing-market' },
      });
