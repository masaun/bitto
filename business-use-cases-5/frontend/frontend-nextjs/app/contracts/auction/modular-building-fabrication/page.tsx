...
export default function ModularBuildingFabricationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('modular-building-fabrication');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'modular-building-fabrication',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'modular-building-fabrication' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Modular Building Fabrication</h1>
