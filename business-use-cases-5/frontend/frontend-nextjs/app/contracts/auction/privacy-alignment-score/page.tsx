...
export default function PrivacyAlignmentScorePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('privacy-alignment-score');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'privacy-alignment-score',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'privacy-alignment-score' },
      });
