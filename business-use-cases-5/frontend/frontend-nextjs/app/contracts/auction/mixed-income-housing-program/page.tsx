...
export default function MixedIncomeHousingProgramPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('mixed-income-housing-program');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'mixed-income-housing-program',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'mixed-income-housing-program' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Mixed Income Housing Program</h1>
