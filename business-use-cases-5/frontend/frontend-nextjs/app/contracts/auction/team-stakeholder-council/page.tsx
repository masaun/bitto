...
export default function TeamStakeholderCouncilPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('team-stakeholder-council');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'team-stakeholder-council',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'team-stakeholder-council' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Team Stakeholder Council</h1>
