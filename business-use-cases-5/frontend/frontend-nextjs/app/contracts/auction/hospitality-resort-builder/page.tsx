...
export default function HospitalityResortBuilderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('hospitality-resort-builder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'hospitality-resort-builder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'hospitality-resort-builder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Hospitality Resort Builder</h1>
