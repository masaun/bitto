...
export default function TimingSystemVerificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('timing-system-verification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'timing-system-verification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'timing-system-verification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Timing System Verification</h1>
