...
export default function AiModelValidationPage() {
  ...
  const contractAddress = getContractAddress('ai-model-validation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-model-validation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-model-validation' },
      });
