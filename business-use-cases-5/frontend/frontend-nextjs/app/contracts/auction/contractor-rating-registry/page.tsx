...
export default function ContractorRatingRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('contractor-rating-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'contractor-rating-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'contractor-rating-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Contractor Rating Registry</h1>
