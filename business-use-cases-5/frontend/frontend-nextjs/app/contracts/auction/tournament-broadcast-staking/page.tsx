...
export default function TournamentBroadcastStakingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tournament-broadcast-staking');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tournament-broadcast-staking',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tournament-broadcast-staking' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tournament Broadcast Staking</h1>
