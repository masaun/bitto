...
export default function FinancialDistributionEngine3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-distribution-engine-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-distribution-engine-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-distribution-engine-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Distribution Engine 3</h1>
