...
export default function GovernmentBudgetMonitor6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-budget-monitor-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-budget-monitor-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-budget-monitor-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Budget Monitor 6</h1>
