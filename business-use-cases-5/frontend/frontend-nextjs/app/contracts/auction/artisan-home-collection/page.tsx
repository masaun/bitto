...
export default function ArtisanHomeCollectionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('artisan-home-collection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'artisan-home-collection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'artisan-home-collection' },
      });
