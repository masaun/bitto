...
export default function ConfidentialNftTransferPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('confidential-nft-transfer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'confidential-nft-transfer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'confidential-nft-transfer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Confidential Nft Transfer</h1>
