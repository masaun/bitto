...
export default function SprinklerSystemDeploymentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sprinkler-system-deployment');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sprinkler-system-deployment',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sprinkler-system-deployment' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sprinkler System Deployment</h1>
