...
export default function ParkingGarageConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('parking-garage-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'parking-garage-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'parking-garage-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Parking Garage Construction</h1>
