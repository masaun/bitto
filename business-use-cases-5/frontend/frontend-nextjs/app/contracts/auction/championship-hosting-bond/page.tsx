...
export default function ChampionshipHostingBondPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-hosting-bond');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-hosting-bond',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-hosting-bond' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Hosting Bond</h1>
