...
export default function EducationCampusBuilderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('education-campus-builder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'education-campus-builder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'education-campus-builder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Education Campus Builder</h1>
