...
export default function UniversityIndustryCollaborationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('university-industry-collaboration');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'university-industry-collaboration',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'university-industry-collaboration' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>University Industry Collaboration</h1>
