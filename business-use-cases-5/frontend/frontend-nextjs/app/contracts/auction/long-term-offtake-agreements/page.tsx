...
export default function LongTermOfftakeAgreementsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('long-term-offtake-agreements');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'long-term-offtake-agreements',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'long-term-offtake-agreements' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Long Term Offtake Agreements</h1>
