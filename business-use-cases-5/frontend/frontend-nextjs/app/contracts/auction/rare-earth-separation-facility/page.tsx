...
export default function RareEarthSeparationFacilityPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-separation-facility');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-separation-facility',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-separation-facility' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rare Earth Separation Facility</h1>
