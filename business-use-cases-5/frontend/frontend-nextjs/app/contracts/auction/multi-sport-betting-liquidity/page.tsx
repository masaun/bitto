...
export default function MultiSportBettingLiquidityPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('multi-sport-betting-liquidity');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'multi-sport-betting-liquidity',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'multi-sport-betting-liquidity' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Multi Sport Betting Liquidity</h1>
