...
export default function AquaticCenterOperationsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('aquatic-center-operations');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'aquatic-center-operations',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'aquatic-center-operations' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Aquatic Center Operations</h1>
