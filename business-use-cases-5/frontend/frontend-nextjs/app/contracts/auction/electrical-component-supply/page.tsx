...
export default function ElectricalComponentSupplyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('electrical-component-supply');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'electrical-component-supply',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'electrical-component-supply' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Electrical Component Supply</h1>
