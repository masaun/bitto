...
export default function VenueConstructionEscrowPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('venue-construction-escrow');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'venue-construction-escrow',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'venue-construction-escrow' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Venue Construction Escrow</h1>
