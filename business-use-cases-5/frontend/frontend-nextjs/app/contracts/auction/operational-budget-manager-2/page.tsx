...
export default function OperationalBudgetManager2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-budget-manager-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-budget-manager-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-budget-manager-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Budget Manager 2</h1>
