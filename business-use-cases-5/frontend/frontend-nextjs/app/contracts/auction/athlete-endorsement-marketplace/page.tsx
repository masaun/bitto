...
export default function AthleteEndorsementMarketplacePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-endorsement-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-endorsement-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-endorsement-marketplace' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Endorsement Marketplace</h1>
