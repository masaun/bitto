...
export default function CoastalProtectionProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('coastal-protection-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'coastal-protection-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'coastal-protection-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Coastal Protection Project</h1>
