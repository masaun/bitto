...
export default function AthleteVillageAccommodationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-village-accommodation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-village-accommodation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-village-accommodation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Village Accommodation</h1>
