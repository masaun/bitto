...
export default function GlobalFootballMerchExchangePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-football-merch-exchange');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-football-merch-exchange',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-football-merch-exchange' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Football Merch Exchange</h1>
