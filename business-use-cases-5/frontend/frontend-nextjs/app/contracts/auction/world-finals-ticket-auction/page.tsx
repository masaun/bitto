...
export default function WorldFinalsTicketAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('world-finals-ticket-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'world-finals-ticket-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'world-finals-ticket-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>World Finals Ticket Auction</h1>
