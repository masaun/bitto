...
export default function ChampionshipCeremonyNftPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-ceremony-nft');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-ceremony-nft',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-ceremony-nft' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Ceremony Nft</h1>
