...
export default function MiningProductionReportingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('mining-production-reporting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'mining-production-reporting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'mining-production-reporting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Mining Production Reporting</h1>
