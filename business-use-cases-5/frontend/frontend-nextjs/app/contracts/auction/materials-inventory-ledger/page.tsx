...
export default function MaterialsInventoryLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('materials-inventory-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'materials-inventory-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'materials-inventory-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Materials Inventory Ledger</h1>
