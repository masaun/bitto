...
export default function GovernmentPoolingSystem6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-pooling-system-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-pooling-system-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-pooling-system-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Pooling System 6</h1>
