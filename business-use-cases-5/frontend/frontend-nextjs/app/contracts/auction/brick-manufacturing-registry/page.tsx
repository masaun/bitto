...
export default function BrickManufacturingRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('brick-manufacturing-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'brick-manufacturing-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'brick-manufacturing-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Brick Manufacturing Registry</h1>
