...
export default function ExplorationDataOwnershipPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('exploration-data-ownership');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'exploration-data-ownership',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'exploration-data-ownership' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Exploration Data Ownership</h1>
