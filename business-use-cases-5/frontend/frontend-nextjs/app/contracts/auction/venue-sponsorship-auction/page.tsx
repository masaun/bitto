...
export default function VenueSponsorshipAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('venue-sponsorship-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'venue-sponsorship-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'venue-sponsorship-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Venue Sponsorship Auction</h1>
