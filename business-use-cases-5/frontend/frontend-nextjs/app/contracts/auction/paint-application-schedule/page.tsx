...
export default function PaintApplicationSchedulePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('paint-application-schedule');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'paint-application-schedule',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'paint-application-schedule' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Paint Application Schedule</h1>
