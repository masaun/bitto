...
export default function ConfidentialBridgeOraclePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('confidential-bridge-oracle');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'confidential-bridge-oracle',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'confidential-bridge-oracle' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Confidential Bridge Oracle</h1>
