...
export default function VenueMaintenanceStakingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('venue-maintenance-staking');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'venue-maintenance-staking',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'venue-maintenance-staking' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Venue Maintenance Staking</h1>
