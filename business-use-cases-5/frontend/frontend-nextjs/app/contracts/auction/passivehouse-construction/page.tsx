...
export default function PassivehouseConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('passivehouse-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'passivehouse-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'passivehouse-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Passivehouse Construction</h1>
