...
export default function CeilingInstallationProtocolPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ceiling-installation-protocol');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ceiling-installation-protocol',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ceiling-installation-protocol' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ceiling Installation Protocol</h1>
