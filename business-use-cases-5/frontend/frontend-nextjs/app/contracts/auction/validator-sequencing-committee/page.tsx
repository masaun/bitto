...
export default function ValidatorSequencingCommitteePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('validator-sequencing-committee');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'validator-sequencing-committee',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'validator-sequencing-committee' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Validator Sequencing Committee</h1>
