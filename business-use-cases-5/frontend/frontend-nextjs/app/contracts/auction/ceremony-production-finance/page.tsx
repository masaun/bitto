...
export default function CeremonyProductionFinancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ceremony-production-finance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ceremony-production-finance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ceremony-production-finance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ceremony Production Finance</h1>
