...
export default function ComputeMarketplacePage() {
  ...
  const contractAddress = getContractAddress('compute-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compute-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compute-marketplace' },
      });
