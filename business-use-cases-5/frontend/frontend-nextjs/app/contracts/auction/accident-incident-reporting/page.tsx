...
export default function AccidentIncidentReportingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('accident-incident-reporting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'accident-incident-reporting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'accident-incident-reporting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Accident Incident Reporting</h1>
