...
export default function BrownfieldRedevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('brownfield-redevelopment');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'brownfield-redevelopment',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'brownfield-redevelopment' },
      });
