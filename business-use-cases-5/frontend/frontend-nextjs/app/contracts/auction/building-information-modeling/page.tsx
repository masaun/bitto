...
export default function BuildingInformationModelingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('building-information-modeling');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'building-information-modeling',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'building-information-modeling' },
      });
