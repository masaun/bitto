...
export default function OperationalPoolingSystem2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-pooling-system-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-pooling-system-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-pooling-system-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Pooling System 2</h1>
