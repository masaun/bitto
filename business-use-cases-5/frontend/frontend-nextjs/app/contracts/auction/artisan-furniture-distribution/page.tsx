...
export default function ArtisanFurnitureDistributionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('artisan-furniture-distribution');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'artisan-furniture-distribution',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'artisan-furniture-distribution' },
      });
