...
export default function StadiumNamingRightsAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('stadium-naming-rights-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'stadium-naming-rights-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'stadium-naming-rights-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Stadium Naming Rights Auction</h1>
