...
export default function TenantImprovementProgramPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tenant-improvement-program');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tenant-improvement-program',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tenant-improvement-program' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tenant Improvement Program</h1>
