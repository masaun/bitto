...
export default function DrywallAssemblySchedulePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('drywall-assembly-schedule');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'drywall-assembly-schedule',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'drywall-assembly-schedule' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Drywall Assembly Schedule</h1>
