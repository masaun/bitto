...
export default function ConfidentialTradeFinancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('confidential-trade-finance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'confidential-trade-finance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'confidential-trade-finance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Confidential Trade Finance</h1>
