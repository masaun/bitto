...
export default function NationalSecurityReviewPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('national-security-review');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'national-security-review',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'national-security-review' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>National Security Review</h1>
