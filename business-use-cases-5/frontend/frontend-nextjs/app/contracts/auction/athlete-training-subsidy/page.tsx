...
export default function AthleteTrainingSubsidyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-training-subsidy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-training-subsidy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-training-subsidy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Training Subsidy</h1>
