...
export default function CraneInstallationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('crane-installation-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'crane-installation-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'crane-installation-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Crane Installation System</h1>
