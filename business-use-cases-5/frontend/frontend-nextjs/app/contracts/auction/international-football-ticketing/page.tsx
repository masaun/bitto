...
export default function InternationalFootballTicketingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-football-ticketing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-football-ticketing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-football-ticketing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Football Ticketing</h1>
