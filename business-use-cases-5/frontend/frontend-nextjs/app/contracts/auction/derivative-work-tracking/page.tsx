...
export default function DerivativeWorkTrackingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('derivative-work-tracking');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'derivative-work-tracking',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'derivative-work-tracking' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Derivative Work Tracking</h1>
