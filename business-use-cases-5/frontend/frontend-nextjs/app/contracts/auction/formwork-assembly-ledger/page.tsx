...
export default function FormworkAssemblyLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('formwork-assembly-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'formwork-assembly-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'formwork-assembly-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Formwork Assembly Ledger</h1>
