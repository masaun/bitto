...
export default function MedalCeremonyLicensingHubPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('medal-ceremony-licensing-hub');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'medal-ceremony-licensing-hub',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'medal-ceremony-licensing-hub' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Medal Ceremony Licensing Hub</h1>
