...
export default function RareEarthProspectingRightsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-prospecting-rights');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-prospecting-rights',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-prospecting-rights' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rare Earth Prospecting Rights</h1>
