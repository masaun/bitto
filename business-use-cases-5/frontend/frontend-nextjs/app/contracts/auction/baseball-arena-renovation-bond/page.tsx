...
export default function BaseballArenaRenovationBondPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('baseball-arena-renovation-bond');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'baseball-arena-renovation-bond',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'baseball-arena-renovation-bond' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Baseball Arena Renovation Bond</h1>
