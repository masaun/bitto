...
export default function BespokeHospitalityFurnishingsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-hospitality-furnishings');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-hospitality-furnishings',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-hospitality-furnishings' },
      });
