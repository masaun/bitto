...
export default function DigitalBlueprintArchivePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-blueprint-archive');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-blueprint-archive',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-blueprint-archive' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Digital Blueprint Archive</h1>
