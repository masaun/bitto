...
export default function ProjectAccessControlPage() {
  ...
  const contractAddress = getContractAddress('project-access-control');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-access-control',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-access-control' },
      });
