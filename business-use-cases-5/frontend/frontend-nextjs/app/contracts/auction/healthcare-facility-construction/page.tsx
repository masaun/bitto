...
export default function HealthcareFacilityConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('healthcare-facility-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'healthcare-facility-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'healthcare-facility-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Healthcare Facility Construction</h1>
