...
export default function SportsMemorabiliaAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-memorabilia-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-memorabilia-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-memorabilia-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Memorabilia Auction</h1>
