...
export default function EnvironmentalImpactReportingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('environmental-impact-reporting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'environmental-impact-reporting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'environmental-impact-reporting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Environmental Impact Reporting</h1>
