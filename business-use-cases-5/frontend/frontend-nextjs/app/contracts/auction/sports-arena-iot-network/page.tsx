...
export default function SportsArenaIotNetworkPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-arena-iot-network');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-arena-iot-network',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-arena-iot-network' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Arena Iot Network</h1>
