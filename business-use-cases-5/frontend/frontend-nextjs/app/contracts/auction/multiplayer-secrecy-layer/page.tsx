...
export default function MultiplayerSecrecyLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('multiplayer-secrecy-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'multiplayer-secrecy-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'multiplayer-secrecy-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Multiplayer Secrecy Layer</h1>
