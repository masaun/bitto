...
export default function SiteDemobilizationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('site-demobilization-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'site-demobilization-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'site-demobilization-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Site Demobilization System</h1>
