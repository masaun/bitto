...
export default function ProjectCloseoutProtocolPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-closeout-protocol');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-closeout-protocol',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-closeout-protocol' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Project Closeout Protocol</h1>
