...
export default function ProprietaryProcessProtectionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('proprietary-process-protection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'proprietary-process-protection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'proprietary-process-protection' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Proprietary Process Protection</h1>
