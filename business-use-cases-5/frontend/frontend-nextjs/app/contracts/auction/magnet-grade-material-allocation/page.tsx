...
export default function MagnetGradeMaterialAllocationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('magnet-grade-material-allocation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'magnet-grade-material-allocation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'magnet-grade-material-allocation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Magnet Grade Material Allocation</h1>
