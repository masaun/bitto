...
export default function PublicWorksCoordinatorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('public-works-coordinator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'public-works-coordinator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'public-works-coordinator' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Public Works Coordinator</h1>
