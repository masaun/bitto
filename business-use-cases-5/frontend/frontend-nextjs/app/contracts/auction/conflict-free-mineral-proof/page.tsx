...
export default function ConflictFreeMineralProofPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('conflict-free-mineral-proof');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'conflict-free-mineral-proof',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'conflict-free-mineral-proof' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Conflict Free Mineral Proof</h1>
