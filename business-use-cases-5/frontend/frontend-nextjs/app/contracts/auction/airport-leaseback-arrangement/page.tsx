...
export default function AirportLeasebackArrangementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('airport-leaseback-arrangement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'airport-leaseback-arrangement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'airport-leaseback-arrangement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Airport Leaseback Arrangement</h1>
