...
export default function SurveyorCoordinationHubPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('surveyor-coordination-hub');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'surveyor-coordination-hub',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'surveyor-coordination-hub' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Surveyor Coordination Hub</h1>
