...
export default function AiConstructionAnalyticsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ai-construction-analytics');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-construction-analytics',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-construction-analytics' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ai Construction Analytics</h1>
