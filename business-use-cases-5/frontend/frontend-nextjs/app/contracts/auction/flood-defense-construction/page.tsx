...
export default function FloodDefenseConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('flood-defense-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'flood-defense-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'flood-defense-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Flood Defense Construction</h1>
