...
export default function EncryptedArbitrationLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('encrypted-arbitration-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'encrypted-arbitration-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'encrypted-arbitration-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Encrypted Arbitration Layer</h1>
