...
export default function DemolitionProjectManagerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('demolition-project-manager');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'demolition-project-manager',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'demolition-project-manager' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Demolition Project Manager</h1>
