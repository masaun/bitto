...
export default function ProcurementAuctionSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('procurement-auction-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'procurement-auction-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'procurement-auction-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Procurement Auction System</h1>
