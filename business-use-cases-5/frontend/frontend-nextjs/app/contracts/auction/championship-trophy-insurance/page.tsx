...
export default function ChampionshipTrophyInsurancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-trophy-insurance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-trophy-insurance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-trophy-insurance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Trophy Insurance</h1>
