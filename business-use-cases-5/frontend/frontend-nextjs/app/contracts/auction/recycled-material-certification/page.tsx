...
export default function RecycledMaterialCertificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('recycled-material-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'recycled-material-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'recycled-material-certification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Recycled Material Certification</h1>
