...
export default function GlobalViewershipRewardsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-viewership-rewards');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-viewership-rewards',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-viewership-rewards' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Viewership Rewards</h1>
