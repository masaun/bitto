...
export default function ProjectFinanceStructurePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-finance-structure');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-finance-structure',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-finance-structure' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Project Finance Structure</h1>
