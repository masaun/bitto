...
export default function InstitutionalBudgetMonitor5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-budget-monitor-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-budget-monitor-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-budget-monitor-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Budget Monitor 5</h1>
