...
export default function SignageDeploymentSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('signage-deployment-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'signage-deployment-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'signage-deployment-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Signage Deployment System</h1>
