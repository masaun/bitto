...
export default function ScaffoldingDeploymentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('scaffolding-deployment');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'scaffolding-deployment',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'scaffolding-deployment' },
      });
