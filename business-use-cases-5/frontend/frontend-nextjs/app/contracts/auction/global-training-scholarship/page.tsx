...
export default function GlobalTrainingScholarshipPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-training-scholarship');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-training-scholarship',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-training-scholarship' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Training Scholarship</h1>
