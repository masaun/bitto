...
export default function AiRiskAssessmentModulePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ai-risk-assessment-module');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-risk-assessment-module',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-risk-assessment-module' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ai Risk Assessment Module</h1>
