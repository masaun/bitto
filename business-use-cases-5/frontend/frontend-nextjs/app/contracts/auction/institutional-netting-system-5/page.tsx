...
export default function InstitutionalNettingSystem5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-netting-system-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-netting-system-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-netting-system-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Netting System 5</h1>
