...
export default function StrategicAllySupplyAgreementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('strategic-ally-supply-agreement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'strategic-ally-supply-agreement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'strategic-ally-supply-agreement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Strategic Ally Supply Agreement</h1>
