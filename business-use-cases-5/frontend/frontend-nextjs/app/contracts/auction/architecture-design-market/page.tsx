...
export default function ArchitectureDesignMarketPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('architecture-design-market');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'architecture-design-market',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'architecture-design-market' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Architecture Design Market</h1>
