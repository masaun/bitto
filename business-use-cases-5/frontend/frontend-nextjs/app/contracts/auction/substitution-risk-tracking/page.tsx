...
export default function SubstitutionRiskTrackingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('substitution-risk-tracking');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'substitution-risk-tracking',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'substitution-risk-tracking' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Substitution Risk Tracking</h1>
