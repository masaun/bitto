...
export default function SkyscraperDevelopmentLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('skyscraper-development-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'skyscraper-development-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'skyscraper-development-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Skyscraper Development Ledger</h1>
