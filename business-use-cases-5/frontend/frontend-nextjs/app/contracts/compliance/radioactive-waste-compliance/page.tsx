...
export default function RadioactiveWasteCompliancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('radioactive-waste-compliance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'radioactive-waste-compliance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'radioactive-waste-compliance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Radioactive Waste Compliance</h1>
