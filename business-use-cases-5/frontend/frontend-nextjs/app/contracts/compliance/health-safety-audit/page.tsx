...
export default function HealthSafetyAuditPage() {
  ...
  const contractAddress = getContractAddress('health-safety-audit');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'health-safety-audit',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'health-safety-audit' },
      });
