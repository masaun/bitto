...
export default function ProjectAuditCommitteePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-audit-committee');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-audit-committee',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-audit-committee' },
      });
