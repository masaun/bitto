...
export default function AntiDopingComplianceRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('anti-doping-compliance-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'anti-doping-compliance-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'anti-doping-compliance-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Anti Doping Compliance Registry</h1>
