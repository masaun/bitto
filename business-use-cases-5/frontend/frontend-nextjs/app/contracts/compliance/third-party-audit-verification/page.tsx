...
export default function ThirdPartyAuditVerificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('third-party-audit-verification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'third-party-audit-verification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'third-party-audit-verification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Third Party Audit Verification</h1>
