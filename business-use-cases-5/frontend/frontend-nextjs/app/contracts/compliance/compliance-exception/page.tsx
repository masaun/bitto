...
export default function ComplianceExceptionPage() {
  ...
  const contractAddress = getContractAddress('compliance-exception');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compliance-exception',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compliance-exception' },
      });
