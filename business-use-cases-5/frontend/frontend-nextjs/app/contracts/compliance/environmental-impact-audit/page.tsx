...
export default function EnvironmentalImpactAuditPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('environmental-impact-audit');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'environmental-impact-audit',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'environmental-impact-audit' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Environmental Impact Audit</h1>
