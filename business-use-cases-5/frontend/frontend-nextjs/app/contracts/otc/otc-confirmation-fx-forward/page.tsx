...
export default function OtcConfirmationFxForwardPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('otc-confirmation-fx-forward');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'otc-confirmation-fx-forward',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'otc-confirmation-fx-forward' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Otc Confirmation Fx Forward</h1>
