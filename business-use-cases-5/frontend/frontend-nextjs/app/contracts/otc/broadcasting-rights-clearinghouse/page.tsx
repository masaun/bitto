...
export default function BroadcastingRightsClearinghousePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('broadcasting-rights-clearinghouse');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'broadcasting-rights-clearinghouse',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'broadcasting-rights-clearinghouse' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Broadcasting Rights Clearinghouse</h1>
