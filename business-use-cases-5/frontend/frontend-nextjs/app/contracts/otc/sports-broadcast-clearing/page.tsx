...
export default function SportsBroadcastClearingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-broadcast-clearing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-broadcast-clearing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-broadcast-clearing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Broadcast Clearing</h1>
