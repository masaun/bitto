...
export default function SportsEndorsementClearingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-endorsement-clearing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-endorsement-clearing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-endorsement-clearing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Endorsement Clearing</h1>
