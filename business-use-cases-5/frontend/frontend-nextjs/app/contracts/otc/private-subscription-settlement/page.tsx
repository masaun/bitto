...
export default function PrivateSubscriptionSettlementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-subscription-settlement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-subscription-settlement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-subscription-settlement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Subscription Settlement</h1>
