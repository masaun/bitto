...
export default function ApiDeserializerStablePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-deserializer-stable');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-deserializer-stable',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-deserializer-stable' },
      });
