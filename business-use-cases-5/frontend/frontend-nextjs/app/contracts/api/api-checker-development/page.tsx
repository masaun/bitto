...
export default function ApiCheckerDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-checker-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-checker-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-checker-development' },
      });
