...
export default function ApiSynthesizerStablePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-synthesizer-stable');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-synthesizer-stable',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-synthesizer-stable' },
      });
