...
export default function SportsTechIntegrationDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-tech-integration-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-tech-integration-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-tech-integration-dao' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Tech Integration Dao</h1>
