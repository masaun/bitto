...
export default function ChampionshipSponsorDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-sponsor-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-sponsor-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-sponsor-dao' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Sponsor Dao</h1>
