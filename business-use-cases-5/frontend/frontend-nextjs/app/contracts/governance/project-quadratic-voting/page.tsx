...
export default function ProjectQuadraticVotingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-quadratic-voting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-quadratic-voting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-quadratic-voting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Project Quadratic Voting</h1>
