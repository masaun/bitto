...
export default function TeamRankedChoiceVotingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('team-ranked-choice-voting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'team-ranked-choice-voting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'team-ranked-choice-voting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Team Ranked Choice Voting</h1>
