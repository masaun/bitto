...
export default function TacticalRankedChoiceVotingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-ranked-choice-voting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-ranked-choice-voting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-ranked-choice-voting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Ranked Choice Voting</h1>
