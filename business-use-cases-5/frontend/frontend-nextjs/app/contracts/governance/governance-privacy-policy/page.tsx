...
export default function GovernancePrivacyPolicyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('governance-privacy-policy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'governance-privacy-policy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'governance-privacy-policy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Governance Privacy Policy</h1>
