...
export default function CrossLeagueCollaborationDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('cross-league-collaboration-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'cross-league-collaboration-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'cross-league-collaboration-dao' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Cross League Collaboration Dao</h1>
