...
export default function RenovationWorkflowSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('renovation-workflow-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'renovation-workflow-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'renovation-workflow-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Renovation Workflow System</h1>
