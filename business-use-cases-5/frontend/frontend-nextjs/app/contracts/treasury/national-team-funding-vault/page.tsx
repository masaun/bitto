...
export default function NationalTeamFundingVaultPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('national-team-funding-vault');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'national-team-funding-vault',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'national-team-funding-vault' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>National Team Funding Vault</h1>
