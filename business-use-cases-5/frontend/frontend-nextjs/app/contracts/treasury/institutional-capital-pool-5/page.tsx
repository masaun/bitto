...
export default function InstitutionalCapitalPool5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-capital-pool-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-capital-pool-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-capital-pool-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Capital Pool 5</h1>
