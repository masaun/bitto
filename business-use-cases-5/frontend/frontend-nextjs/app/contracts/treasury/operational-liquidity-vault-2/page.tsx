...
export default function OperationalLiquidityVault2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-liquidity-vault-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-liquidity-vault-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-liquidity-vault-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Liquidity Vault 2</h1>
