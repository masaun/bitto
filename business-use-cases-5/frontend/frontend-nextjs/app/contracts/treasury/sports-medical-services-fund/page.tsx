...
export default function SportsMedicalServicesFundPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-medical-services-fund');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-medical-services-fund',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-medical-services-fund' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Medical Services Fund</h1>
