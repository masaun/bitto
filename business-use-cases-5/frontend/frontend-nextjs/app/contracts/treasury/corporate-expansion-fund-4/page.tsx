...
export default function CorporateExpansionFund4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-expansion-fund-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-expansion-fund-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-expansion-fund-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Expansion Fund 4</h1>
