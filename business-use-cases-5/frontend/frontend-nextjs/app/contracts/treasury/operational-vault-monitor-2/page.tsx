...
export default function OperationalVaultMonitor2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-vault-monitor-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-vault-monitor-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-vault-monitor-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Vault Monitor 2</h1>
