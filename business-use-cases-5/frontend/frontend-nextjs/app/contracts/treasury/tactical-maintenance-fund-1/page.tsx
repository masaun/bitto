...
export default function TacticalMaintenanceFund1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-maintenance-fund-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-maintenance-fund-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-maintenance-fund-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Maintenance Fund 1</h1>
