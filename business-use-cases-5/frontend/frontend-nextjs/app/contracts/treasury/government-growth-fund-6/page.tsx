...
export default function GovernmentGrowthFund6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-growth-fund-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-growth-fund-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-growth-fund-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Growth Fund 6</h1>
