...
export default function CorporateSecurityFund4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-security-fund-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-security-fund-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-security-fund-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Security Fund 4</h1>
