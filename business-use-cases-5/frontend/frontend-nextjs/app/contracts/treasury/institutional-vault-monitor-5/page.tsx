...
export default function InstitutionalVaultMonitor5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-vault-monitor-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-vault-monitor-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-vault-monitor-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Vault Monitor 5</h1>
