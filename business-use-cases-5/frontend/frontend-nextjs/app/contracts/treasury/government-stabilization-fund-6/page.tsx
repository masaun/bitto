...
export default function GovernmentStabilizationFund6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-stabilization-fund-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-stabilization-fund-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-stabilization-fund-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Stabilization Fund 6</h1>
