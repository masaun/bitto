...
export default function GovernmentSecurityFund6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-security-fund-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-security-fund-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-security-fund-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Security Fund 6</h1>
