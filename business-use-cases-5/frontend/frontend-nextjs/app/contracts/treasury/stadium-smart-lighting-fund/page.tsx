...
export default function StadiumSmartLightingFundPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('stadium-smart-lighting-fund');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'stadium-smart-lighting-fund',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'stadium-smart-lighting-fund' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Stadium Smart Lighting Fund</h1>
