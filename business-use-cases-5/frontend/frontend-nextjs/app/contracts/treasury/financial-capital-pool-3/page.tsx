...
export default function FinancialCapitalPool3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-capital-pool-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-capital-pool-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-capital-pool-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Capital Pool 3</h1>
