...
export default function FinancialLiquidityVault3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-liquidity-vault-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-liquidity-vault-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-liquidity-vault-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Liquidity Vault 3</h1>
