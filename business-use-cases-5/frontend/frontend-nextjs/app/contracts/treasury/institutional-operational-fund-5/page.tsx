...
export default function InstitutionalOperationalFund5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-operational-fund-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-operational-fund-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-operational-fund-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Operational Fund 5</h1>
