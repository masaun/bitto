...
export default function TacticalOperationalFund1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-operational-fund-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-operational-fund-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-operational-fund-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Operational Fund 1</h1>
