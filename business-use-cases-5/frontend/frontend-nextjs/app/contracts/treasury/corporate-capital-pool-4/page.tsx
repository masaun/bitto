...
export default function CorporateCapitalPool4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-capital-pool-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-capital-pool-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-capital-pool-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Capital Pool 4</h1>
