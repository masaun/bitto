...
export default function FinancialVaultMonitor3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-vault-monitor-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-vault-monitor-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-vault-monitor-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Vault Monitor 3</h1>
