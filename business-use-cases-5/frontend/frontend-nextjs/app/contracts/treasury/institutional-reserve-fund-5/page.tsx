...
export default function InstitutionalReserveFund5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-reserve-fund-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-reserve-fund-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-reserve-fund-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Reserve Fund 5</h1>
