...
export default function GlobalTrainingFacilityFundPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-training-facility-fund');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-training-facility-fund',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-training-facility-fund' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Training Facility Fund</h1>
