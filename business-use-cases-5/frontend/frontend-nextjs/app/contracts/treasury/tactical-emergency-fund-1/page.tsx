...
export default function TacticalEmergencyFund1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-emergency-fund-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-emergency-fund-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-emergency-fund-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Emergency Fund 1</h1>
