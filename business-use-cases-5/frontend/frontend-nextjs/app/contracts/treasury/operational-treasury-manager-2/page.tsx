...
export default function OperationalTreasuryManager2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-treasury-manager-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-treasury-manager-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-treasury-manager-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Treasury Manager 2</h1>
