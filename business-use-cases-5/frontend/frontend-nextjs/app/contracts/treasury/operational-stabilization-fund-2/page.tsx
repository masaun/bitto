...
export default function OperationalStabilizationFund2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-stabilization-fund-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-stabilization-fund-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-stabilization-fund-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Stabilization Fund 2</h1>
