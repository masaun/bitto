...
export default function TacticalVaultAggregator1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-vault-aggregator-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-vault-aggregator-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-vault-aggregator-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Vault Aggregator 1</h1>
