...
export default function InsurancePremiumRevenueReporterPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('insurance-premium-revenue-reporter');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'insurance-premium-revenue-reporter',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'insurance-premium-revenue-reporter' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Insurance Premium Revenue Reporter</h1>
