...
export default function HostNationRevenueSharingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('host-nation-revenue-sharing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'host-nation-revenue-sharing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'host-nation-revenue-sharing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Host Nation Revenue Sharing</h1>
