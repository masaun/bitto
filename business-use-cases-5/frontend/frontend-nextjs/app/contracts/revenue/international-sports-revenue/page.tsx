...
export default function InternationalSportsRevenuePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-sports-revenue');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-sports-revenue',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-sports-revenue' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Sports Revenue</h1>
