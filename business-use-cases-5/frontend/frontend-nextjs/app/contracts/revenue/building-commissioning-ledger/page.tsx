...
export default function BuildingCommissioningLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('building-commissioning-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'building-commissioning-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'building-commissioning-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Building Commissioning Ledger</h1>
