...
export default function AdvertisingRoyaltyManagerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('advertising-royalty-manager');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'advertising-royalty-manager',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'advertising-royalty-manager' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Advertising Royalty Manager</h1>
