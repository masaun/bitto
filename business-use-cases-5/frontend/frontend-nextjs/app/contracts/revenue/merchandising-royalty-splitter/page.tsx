...
export default function MerchandisingRoyaltySplitterPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('merchandising-royalty-splitter');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'merchandising-royalty-splitter',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'merchandising-royalty-splitter' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Merchandising Royalty Splitter</h1>
