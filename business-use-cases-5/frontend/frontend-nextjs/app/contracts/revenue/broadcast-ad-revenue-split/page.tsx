...
export default function BroadcastAdRevenueSplitPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('broadcast-ad-revenue-split');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'broadcast-ad-revenue-split',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'broadcast-ad-revenue-split' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Broadcast Ad Revenue Split</h1>
