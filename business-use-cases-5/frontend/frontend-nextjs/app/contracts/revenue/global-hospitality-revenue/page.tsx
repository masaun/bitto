...
export default function GlobalHospitalityRevenuePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-hospitality-revenue');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-hospitality-revenue',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-hospitality-revenue' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Hospitality Revenue</h1>
