...
const CONTRACT_ADDRESS = process.env.GRID_STORAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'grid-storage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'grid-storage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
