...
export default function hospitalityFurnitureContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Furniture Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_FURNITURE_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-furniture-contract';
  ...
  return (
    <div>
      <h1>Hospitality Furniture Contract</h1>
