...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ETA_BRIDGE_SYNC_ADDRESS || '';

export default function Eta_Bridge_SyncPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.eta-bridge-sync/read-only/get-counter`,
        {
          method: 'GET',
