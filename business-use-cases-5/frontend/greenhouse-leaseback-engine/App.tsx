...
const CONTRACT_ADDRESS = process.env.GREENHOUSE_LEASEBACK_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'greenhouse-leaseback-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'greenhouse-leaseback-engine', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>greenhouse-leaseback-engine</h1>
      {!userData ? (
