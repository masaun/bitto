...
const CONTRACT_ADDRESS = process.env.FINANCIAL_VAULT_AGGREGATOR_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-vault-aggregator-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-vault-aggregator-3',
