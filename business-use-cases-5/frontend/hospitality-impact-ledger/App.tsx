...
const contractAddress = process.env.REACT_APP_HOSPITALITY_IMPACT_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-impact-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Impact Ledger</h1>
