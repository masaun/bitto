...
const CONTRACT_ADDRESS = process.env.EXPLORATION_DATA_OWNERSHIP_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'exploration-data-ownership';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Exploration Data Ownership',
