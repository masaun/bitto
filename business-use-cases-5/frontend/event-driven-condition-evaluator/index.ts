...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-condition-evaluator',
