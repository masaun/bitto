...
export default function handcraftedInteriorNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Interior Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_INTERIOR_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-interior-network';
  ...
  return (
    <div>
      <h1>Handcrafted Interior Network</h1>
