...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_IDENTITY_DID_HUB_ADDRESS || '';

export default function Identity_Did_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.identity-did-hub/read-only/get-counter`,
        {
          method: 'GET',
