...
const CONTRACT_ADDRESS = process.env.FOOTBALL_GROUP_STAGE_REWARD_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'football-group-stage-reward';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Football Group Stage Reward',
