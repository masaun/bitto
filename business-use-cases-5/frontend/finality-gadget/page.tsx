...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FINALITY_GADGET_ADDRESS || '';

export default function Finality_GadgetPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.finality-gadget/read-only/get-counter`,
        {
          method: 'GET',
