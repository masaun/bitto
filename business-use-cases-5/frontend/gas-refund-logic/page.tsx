...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAS_REFUND_LOGIC_ADDRESS || '';

export default function Gas_Refund_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gas-refund-logic/read-only/get-counter`,
        {
          method: 'GET',
