...
export default function handcraftedWoodcraftMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Woodcraft Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_WOODCRAFT_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-woodcraft-market';
  ...
  return (
    <div>
      <h1>Handcrafted Woodcraft Market</h1>
