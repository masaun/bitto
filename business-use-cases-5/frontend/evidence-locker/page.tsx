...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EVIDENCE_LOCKER_ADDRESS || '';

export default function Evidence_LockerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.evidence-locker/read-only/get-counter`,
        {
          method: 'GET',
