...
const contractAddress = process.env.REACT_APP_ESCROW_RELEASE_CONDITIONS_CONTRACT_ADDRESS || '';
const contractName = 'escrow-release-conditions';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Escrow Release Conditions',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Escrow Release Conditions</h1>
