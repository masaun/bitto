...
export default function hospitalitySeatingEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Seating Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_SEATING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-seating-engine';
  ...
  return (
    <div>
      <h1>Hospitality Seating Engine</h1>
