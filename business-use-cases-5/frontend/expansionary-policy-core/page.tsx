...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EXPANSIONARY_POLICY_CORE_ADDRESS || '';

export default function Expansionary_Policy_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.expansionary-policy-core/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'expansionary-policy-core',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>expansionary-policy-core</h1>
