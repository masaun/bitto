...
const contractAddress = process.env.REACT_APP_GOVERNANCE_EMERGENCY_POWERS_CONTRACT_ADDRESS || '';
const contractName = 'governance-emergency-powers';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Governance Emergency Powers',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Governance Emergency Powers</h1>
