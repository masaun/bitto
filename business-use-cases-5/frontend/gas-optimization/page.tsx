...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAS_OPTIMIZATION_ADDRESS || '';

export default function Gas_OptimizationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gas-optimization/read-only/get-counter`,
        {
          method: 'GET',
