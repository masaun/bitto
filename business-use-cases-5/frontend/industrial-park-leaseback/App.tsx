...
const CONTRACT_ADDRESS = process.env.INDUSTRIAL_PARK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'industrial-park-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'industrial-park-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>industrial-park-leaseback</h1>
      {!userData ? (
