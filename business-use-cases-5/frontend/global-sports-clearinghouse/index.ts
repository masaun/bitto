...
const CONTRACT_ADDRESS = process.env.GLOBAL_SPORTS_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-sports-clearinghouse';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Sports Clearinghouse',
