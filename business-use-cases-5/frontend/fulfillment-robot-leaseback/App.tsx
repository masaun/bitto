...
const CONTRACT_ADDRESS = process.env.FULFILLMENT_ROBOT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fulfillment-robot-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fulfillment-robot-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>fulfillment-robot-leaseback</h1>
      {!userData ? (
