...
const CONTRACT_ADDRESS = process.env.GLOBAL_FOOTBALL_MERCH_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-football-merch-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Football Merch Exchange',
