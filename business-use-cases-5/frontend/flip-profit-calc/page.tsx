...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FLIP_PROFIT_CALC_ADDRESS || '';

export default function Flip_Profit_CalcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.flip-profit-calc/read-only/get-counter`,
        {
          method: 'GET',
