...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FLASH_LOAN_PROVIDER_ADDRESS || '';

export default function Flash_Loan_ProviderPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.flash-loan-provider/read-only/get-counter`,
        {
          method: 'GET',
