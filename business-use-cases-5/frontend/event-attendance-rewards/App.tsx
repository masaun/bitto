...
const contractAddress = process.env.REACT_APP_EVENT_ATTENDANCE_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'event-attendance-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Event Attendance Rewards</h1>
