...
const CONTRACT_ADDRESS = process.env.HEALTHCARE_BILLING_AUTOMATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'healthcare-billing-automation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>healthcare-billing-automation</h1>
      {!userData ? (
