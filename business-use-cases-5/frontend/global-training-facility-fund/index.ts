...
const CONTRACT_ADDRESS = process.env.GLOBAL_TRAINING_FACILITY_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-training-facility-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Training Facility Fund',
