...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GOVERNANCE_ALPHA_ADDRESS || '';

export default function Governance_AlphaPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.governance-alpha/read-only/get-counter`,
        {
          method: 'GET',
