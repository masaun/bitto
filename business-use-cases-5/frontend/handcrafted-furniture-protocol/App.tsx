...
export default function handcraftedFurnitureProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furniture Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNITURE_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furniture-protocol';
  ...
  return (
    <div>
      <h1>Handcrafted Furniture Protocol</h1>
