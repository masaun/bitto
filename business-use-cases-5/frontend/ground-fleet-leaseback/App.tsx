...
const CONTRACT_ADDRESS = process.env.GROUND_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ground-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ground-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
