...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-proactive-processor',
