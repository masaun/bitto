...
const CONTRACT_ADDRESS = process.env.FABRICATION_YARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fabrication-yard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fabrication-yard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>fabrication-yard-leaseback</h1>
      {!userData ? (
