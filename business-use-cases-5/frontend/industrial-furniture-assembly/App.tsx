...
export default function industrialFurnitureAssembly() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Industrial Furniture Assembly',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INDUSTRIAL_FURNITURE_ASSEMBLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'industrial-furniture-assembly';
  ...
  return (
    <div>
      <h1>Industrial Furniture Assembly</h1>
