...
const CONTRACT_ADDRESS = process.env.FAN_EXPERIENCE_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fan-experience-marketplace';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Fan Experience Marketplace',
