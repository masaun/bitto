...
export default function furnitureQualityAssurance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Quality Assurance',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_QUALITY_ASSURANCE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-quality-assurance';
  ...
  return (
    <div>
      <h1>Furniture Quality Assurance</h1>
