...
const CONTRACT_ADDRESS = process.env.GLASS_FACTORY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'glass-factory-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'glass-factory-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
