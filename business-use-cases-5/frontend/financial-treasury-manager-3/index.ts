...
const CONTRACT_ADDRESS = process.env.FINANCIAL_TREASURY_MANAGER_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-treasury-manager-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-treasury-manager-3',
