...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INDEX_TOKEN_MINT_ADDRESS || '';

export default function Index_Token_MintPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.index-token-mint/read-only/get-counter`,
        {
          method: 'GET',
