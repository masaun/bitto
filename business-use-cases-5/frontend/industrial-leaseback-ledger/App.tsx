...
const CONTRACT_ADDRESS = process.env.INDUSTRIAL_LEASEBACK_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'industrial-leaseback-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'industrial-leaseback-ledger', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>industrial-leaseback-ledger</h1>
      {!userData ? (
