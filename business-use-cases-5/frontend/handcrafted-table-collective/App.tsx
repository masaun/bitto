...
export default function handcraftedTableCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Table Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_TABLE_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-table-collective';
  ...
  return (
    <div>
      <h1>Handcrafted Table Collective</h1>
