...
export default function furnitureManufacturingLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Manufacturing Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_MANUFACTURING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-manufacturing-ledger';
  ...
  return (
    <div>
      <h1>Furniture Manufacturing Ledger</h1>
