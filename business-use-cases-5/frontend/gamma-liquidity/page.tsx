...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAMMA_LIQUIDITY_ADDRESS || '';

export default function Gamma_LiquidityPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gamma-liquidity/read-only/get-counter`,
        {
          method: 'GET',
