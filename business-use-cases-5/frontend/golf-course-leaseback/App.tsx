...
const CONTRACT_ADDRESS = process.env.GOLF_COURSE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'golf-course-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'golf-course-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
