...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FORENSIC_ANALYSIS_V1_ADDRESS || '';

export default function Forensic_Analysis_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.forensic-analysis-v1/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'forensic-analysis-v1',
