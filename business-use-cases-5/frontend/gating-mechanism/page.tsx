...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GATING_MECHANISM_ADDRESS || '';

export default function Gating_MechanismPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gating-mechanism/read-only/get-counter`,
        {
          method: 'GET',
