...
const CONTRACT_ADDRESS = process.env.FINANCIAL_ALLOCATION_ENGINE_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-allocation-engine-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-allocation-engine-3',
