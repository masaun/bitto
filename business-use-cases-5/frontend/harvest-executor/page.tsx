...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HARVEST_EXECUTOR_ADDRESS || '';

export default function Harvest_ExecutorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.harvest-executor/read-only/get-counter`,
        {
          method: 'GET',
