...
export default function furnitureQualityLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_QUALITY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-quality-ledger';
  ...
  return (
    <div>
      <h1>Furniture Quality Ledger</h1>
