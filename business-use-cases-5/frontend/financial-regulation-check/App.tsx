...
const contractAddress = process.env.REACT_APP_FINANCIAL_REGULATION_CHECK_CONTRACT_ADDRESS || '';
const contractName = 'financial-regulation-check';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Financial Regulation Check</h1>
