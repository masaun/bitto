...
export default function furnitureProductionNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Production Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_PRODUCTION_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-production-network';
  ...
  return (
    <div>
      <h1>Furniture Production Network</h1>
