...
const CONTRACT_ADDRESS = process.env.FINANCIAL_DEVELOPMENT_FUND_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-development-fund-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-development-fund-3',
