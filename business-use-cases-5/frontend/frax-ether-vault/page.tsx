...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FRAX_ETHER_VAULT_ADDRESS || '';

export default function Frax_Ether_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.frax-ether-vault/read-only/get-counter`,
        {
          method: 'GET',
