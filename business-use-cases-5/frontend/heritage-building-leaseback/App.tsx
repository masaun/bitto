...
const CONTRACT_ADDRESS = process.env.HERITAGE_BUILDING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'heritage-building-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'heritage-building-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>heritage-building-leaseback</h1>
      {!userData ? (
