...
const contractAddress = process.env.REACT_APP_HOSPITALITY_REVENUE_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-revenue-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Revenue Engine</h1>
