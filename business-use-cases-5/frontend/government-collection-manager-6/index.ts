...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_COLLECTION_MANAGER_6_ADDRESS || '';
const CONTRACT_NAME = 'government-collection-manager-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-collection-manager-6',
