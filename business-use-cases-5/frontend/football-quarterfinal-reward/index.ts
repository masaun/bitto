...
const CONTRACT_ADDRESS = process.env.FOOTBALL_QUARTERFINAL_REWARD_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'football-quarterfinal-reward';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Football Quarterfinal Reward',
