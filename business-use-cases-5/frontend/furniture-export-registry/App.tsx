...
export default function furnitureExportRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Export Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_EXPORT_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-export-registry';
  ...
  return (
    <div>
      <h1>Furniture Export Registry</h1>
