...
export default function heritageWoodcraftLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Heritage Woodcraft Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HERITAGE_WOODCRAFT_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'heritage-woodcraft-ledger';
  ...
  return (
    <div>
      <h1>Heritage Woodcraft Ledger</h1>
