...
export default function handcraftedWoodFactory() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_WOOD_FACTORY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-wood-factory';
  ...
  return (
    <div>
      <h1>Handcrafted Wood Factory</h1>
