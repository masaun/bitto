...
const CONTRACT_ADDRESS = process.env.HOST_NATION_REVENUE_SHARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'host-nation-revenue-sharing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Host Nation Revenue Sharing',
