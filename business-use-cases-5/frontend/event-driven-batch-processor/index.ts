...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_BATCH_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-batch-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-batch-processor',
