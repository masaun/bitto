...
const CONTRACT_ADDRESS = process.env.FURNITURE_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'furniture-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'furniture-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>furniture-plant-leaseback</h1>
      {!userData ? (
