...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FALLBACK_ORACLE_ADDRESS || '';

export default function Fallback_OraclePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fallback-oracle/read-only/get-counter`,
        {
          method: 'GET',
