...
export default function hospitalityFurnishingLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Furnishing Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_FURNISHING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-furnishing-ledger';
  ...
  return (
    <div>
      <h1>Hospitality Furnishing Ledger</h1>
