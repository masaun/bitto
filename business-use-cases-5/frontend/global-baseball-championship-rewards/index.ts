...
const CONTRACT_ADDRESS = process.env.GLOBAL_BASEBALL_CHAMPIONSHIP_REWARDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-baseball-championship-rewards';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Baseball Championship Rewards',
