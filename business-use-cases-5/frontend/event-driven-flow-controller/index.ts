...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_FLOW_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-flow-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-flow-controller',
