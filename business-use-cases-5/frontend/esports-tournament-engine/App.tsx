...
const CONTRACT_ADDRESS = process.env.ESPORTS_TOURNAMENT_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'esports-tournament-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'esports-tournament-engine',
