...
const CONTRACT_ADDRESS = process.env.FRANCHISE_LOCATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'franchise-location-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'franchise-location-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>franchise-location-leaseback</h1>
      {!userData ? (
