...
const CONTRACT_ADDRESS = process.env.GLOBAL_SPORTS_HOSPITALITY_SUITE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-sports-hospitality-suite';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Sports Hospitality Suite',
