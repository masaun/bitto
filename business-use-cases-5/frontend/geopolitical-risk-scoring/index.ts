...
const CONTRACT_ADDRESS = process.env.GEOPOLITICAL_RISK_SCORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'geopolitical-risk-scoring';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Geopolitical Risk Scoring',
