...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GRACE_PERIOD_MGR_ADDRESS || '';

export default function Grace_Period_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.grace-period-mgr/read-only/get-counter`,
        {
          method: 'GET',
