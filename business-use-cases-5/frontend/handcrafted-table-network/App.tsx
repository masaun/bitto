...
export default function handcraftedTableNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Table Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_TABLE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-table-network';
  ...
  return (
    <div>
      <h1>Handcrafted Table Network</h1>
