...
export default function furnishingDistributionEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furnishing Distribution Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNISHING_DISTRIBUTION_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furnishing-distribution-engine';
  ...
  return (
    <div>
      <h1>Furnishing Distribution Engine</h1>
