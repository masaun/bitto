...
const contractAddress = process.env.REACT_APP_GALAXY_MAPPING_CONSORTIUM_CONTRACT_ADDRESS || '';
const contractName = 'galaxy-mapping-consortium';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>galaxy mapping consortium</h1>
