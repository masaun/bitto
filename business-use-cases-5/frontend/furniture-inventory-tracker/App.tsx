...
export default function furnitureInventoryTracker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Inventory Tracker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_INVENTORY_TRACKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-inventory-tracker';
  ...
  return (
    <div>
      <h1>Furniture Inventory Tracker</h1>
