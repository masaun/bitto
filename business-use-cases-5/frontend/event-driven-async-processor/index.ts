...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_ASYNC_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-async-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-async-processor',
