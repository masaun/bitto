...
const CONTRACT_ADDRESS = process.env.HANGAR_PORTFOLIO_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hangar-portfolio-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hangar-portfolio-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>hangar-portfolio-leaseback</h1>
      {!userData ? (
