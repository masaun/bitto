...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_DISTRIBUTION_ENGINE_6_ADDRESS || '';
const CONTRACT_NAME = 'government-distribution-engine-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-distribution-engine-6',
