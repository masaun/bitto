...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-sequential-processor',
