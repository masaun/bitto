...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAS_STATION_API_ADDRESS || '';

export default function Gas_Station_ApiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gas-station-api/read-only/get-counter`,
        {
          method: 'GET',
