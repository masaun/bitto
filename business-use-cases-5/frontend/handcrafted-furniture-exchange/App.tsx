...
export default function handcraftedFurnitureExchange() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furniture Exchange',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNITURE_EXCHANGE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furniture-exchange';
  ...
  return (
    <div>
      <h1>Handcrafted Furniture Exchange</h1>
