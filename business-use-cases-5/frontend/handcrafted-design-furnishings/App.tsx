...
export default function handcraftedDesignFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Design Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_DESIGN_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-design-furnishings';
  ...
  return (
    <div>
      <h1>Handcrafted Design Furnishings</h1>
