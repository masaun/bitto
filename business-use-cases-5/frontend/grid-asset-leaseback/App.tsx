...
const CONTRACT_ADDRESS = process.env.GRID_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'grid-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'grid-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
