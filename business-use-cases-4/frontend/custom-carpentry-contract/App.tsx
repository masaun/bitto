...
export default function customCarpentryContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Custom Carpentry Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_CARPENTRY_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-carpentry-contract';
  ...
  return (
    <div>
      <h1>Custom Carpentry Contract</h1>
