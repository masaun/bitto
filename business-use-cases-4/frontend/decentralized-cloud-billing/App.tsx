...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_CLOUD_BILLING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-cloud-billing';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-cloud-billing',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-cloud-billing</h1>
      {!userData ? (
