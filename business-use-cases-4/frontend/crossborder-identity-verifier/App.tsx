...
const CONTRACT_ADDRESS = process.env.CROSSBORDER_IDENTITY_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossborder-identity-verifier';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossborder-identity-verifier',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossborder-identity-verifier</h1>
      {!userData ? (
