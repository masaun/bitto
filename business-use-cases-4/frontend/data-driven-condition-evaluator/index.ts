...
const CONTRACT_ADDRESS = process.env.DATA_DRIVEN_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'data-driven-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'data-driven-condition-evaluator',
