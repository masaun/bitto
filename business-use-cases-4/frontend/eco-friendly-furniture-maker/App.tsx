...
export default function ecoFriendlyFurnitureMaker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Eco Friendly Furniture Maker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_FRIENDLY_FURNITURE_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-friendly-furniture-maker';
  ...
  return (
    <div>
      <h1>Eco Friendly Furniture Maker</h1>
