...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_KNOWLEDGE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-knowledge-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-knowledge-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-knowledge-market</h1>
      {!userData ? (
