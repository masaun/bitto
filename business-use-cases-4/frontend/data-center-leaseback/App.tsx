...
const CONTRACT_ADDRESS = process.env.DATA_CENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-center-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'data-center-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
