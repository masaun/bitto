...
const CONTRACT_ADDRESS = process.env.CROSSBORDER_TRADE_FINANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossborder-trade-finance';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossborder-trade-finance',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossborder-trade-finance</h1>
      {!userData ? (
