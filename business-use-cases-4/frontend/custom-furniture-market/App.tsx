...
export default function customFurnitureMarket() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_FURNITURE_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-furniture-market';
