...
const contractAddress = process.env.REACT_APP_CROSS_BORDER_PROCUREMENT_CONTRACT_ADDRESS || '';
const contractName = 'cross-border-procurement';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Cross Border Procurement</h1>
