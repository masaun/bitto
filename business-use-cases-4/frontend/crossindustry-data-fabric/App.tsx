...
const CONTRACT_ADDRESS = process.env.CROSSINDUSTRY_DATA_FABRIC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossindustry-data-fabric';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossindustry-data-fabric',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossindustry-data-fabric</h1>
      {!userData ? (
