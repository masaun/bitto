...
const CONTRACT_ADDRESS = process.env.DIGITAL_NOTARY_INTEGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-notary-integration';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-notary-integration',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-notary-integration</h1>
      {!userData ? (
