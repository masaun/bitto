...
const CONTRACT_ADDRESS = process.env.CROSSPLATFORM_SERVICE_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossplatform-service-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossplatform-service-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossplatform-service-hub</h1>
      {!userData ? (
