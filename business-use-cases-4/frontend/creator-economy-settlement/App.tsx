...
const CONTRACT_ADDRESS = process.env.CREATOR_ECONOMY_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'creator-economy-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'creator-economy-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>creator-economy-settlement</h1>
      {!userData ? (
