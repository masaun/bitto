...
const CONTRACT_ADDRESS = process.env.CT_SCANNER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ct-scanner-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ct-scanner-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
