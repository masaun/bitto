...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_POLICY_ENFORCER_ADDRESS || '';
const CONTRACT_NAME = 'departmental-policy-enforcer';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-policy-enforcer',
