...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_SENSOR_GRID_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-sensor-grid';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-sensor-grid',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-sensor-grid</h1>
      {!userData ? (
