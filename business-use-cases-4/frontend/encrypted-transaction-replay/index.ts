...
const CONTRACT_ADDRESS = process.env.ENCRYPTED_TRANSACTION_REPLAY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'encrypted-transaction-replay';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EncryptedTransactionReplay',
