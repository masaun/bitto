...
const CONTRACT_ADDRESS = process.env.ENERGY_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'energy-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'energy-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
