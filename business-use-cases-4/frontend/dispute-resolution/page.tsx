...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DISPUTE_RESOLUTION_ADDRESS || '';

export default function Dispute_ResolutionPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dispute-resolution/read-only/get-counter`,
        {
          method: 'GET',
