...
const CONTRACT_ADDRESS = process.env.CYBERSECURITY_THREAT_INTEL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cybersecurity-threat-intel';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>cybersecurity-threat-intel</h1>
      {!userData ? (
