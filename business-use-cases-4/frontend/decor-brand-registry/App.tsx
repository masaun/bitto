...
export default function decorBrandRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_BRAND_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-brand-registry';
