...
const CONTRACT_ADDRESS = process.env.CORPORATE_COLLECTION_MANAGER_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-collection-manager-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-collection-manager-4',
