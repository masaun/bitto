...
const CONTRACT_ADDRESS = process.env.CORPORATE_VAULT_AGGREGATOR_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-vault-aggregator-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-vault-aggregator-4',
