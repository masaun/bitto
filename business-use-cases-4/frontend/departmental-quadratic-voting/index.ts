...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_QUADRATIC_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'departmental-quadratic-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-quadratic-voting',
