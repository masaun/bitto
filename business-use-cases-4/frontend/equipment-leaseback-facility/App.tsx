...
const CONTRACT_ADDRESS = process.env.EQUIPMENT_LEASEBACK_FACILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'equipment-leaseback-facility';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'equipment-leaseback-facility', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>equipment-leaseback-facility</h1>
      {!userData ? (
