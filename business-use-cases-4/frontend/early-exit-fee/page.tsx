...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EARLY_EXIT_FEE_ADDRESS || '';

export default function Early_Exit_FeePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.early-exit-fee/read-only/get-counter`,
        {
          method: 'GET',
