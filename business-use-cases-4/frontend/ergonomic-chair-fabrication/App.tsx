...
export default function ergonomicChairFabrication() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Ergonomic Chair Fabrication',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ERGONOMIC_CHAIR_FABRICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'ergonomic-chair-fabrication';
  ...
  return (
    <div>
      <h1>Ergonomic Chair Fabrication</h1>
