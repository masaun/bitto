...
const CONTRACT_ADDRESS = process.env.DRONE_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'drone-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'drone-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
