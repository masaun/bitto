...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_PAYMENT_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-payment-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-payment-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-payment-network</h1>
      {!userData ? (
