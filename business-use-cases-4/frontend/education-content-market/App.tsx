...
const CONTRACT_ADDRESS = process.env.EDUCATION_CONTENT_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'education-content-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>education-content-market</h1>
      {!userData ? (
