...
const contractAddress = process.env.REACT_APP_EDUCATION_CENTER_ENGAGEMENT_CONTRACT_ADDRESS || '';
const contractName = 'education-center-engagement';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Education Center Engagement</h1>
