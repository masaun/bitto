...
const contractAddress = process.env.REACT_APP_DESTINATION_IMPACT_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'destination-impact-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Destination Impact Protocol</h1>
