...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_WORKFLOW_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-workflow-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-workflow-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-workflow-engine</h1>
      {!userData ? (
