...
const CONTRACT_ADDRESS = process.env.CROSSCLOUD_INTEGRATION_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crosscloud-integration-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crosscloud-integration-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crosscloud-integration-hub</h1>
      {!userData ? (
