...
export default function customKitchenInstallations() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_KITCHEN_INSTALLATIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-kitchen-installations';
  ...
  return (
    <div>
      <h1>Custom Kitchen Installations</h1>
