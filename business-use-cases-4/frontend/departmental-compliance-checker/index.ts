...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_COMPLIANCE_CHECKER_ADDRESS || '';
const CONTRACT_NAME = 'departmental-compliance-checker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-compliance-checker',
