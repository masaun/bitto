...
const CONTRACT_ADDRESS = process.env.DISTILLERY_LEASEBACK_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'distillery-leaseback-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'distillery-leaseback-ledger', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>distillery-leaseback-ledger</h1>
      {!userData ? (
