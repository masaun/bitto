...
const contractAddress = process.env.REACT_APP_DOWNTOWN_MERCHANT_ALLIANCE_CONTRACT_ADDRESS || '';
const contractName = 'downtown-merchant-alliance';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Downtown Merchant Alliance</h1>
