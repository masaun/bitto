...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_STORAGE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-storage-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-storage-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-storage-market</h1>
      {!userData ? (
