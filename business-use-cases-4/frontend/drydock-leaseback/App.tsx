...
const CONTRACT_ADDRESS = process.env.DRYDOCK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'drydock-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'drydock-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
