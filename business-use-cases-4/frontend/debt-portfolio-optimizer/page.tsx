...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DEBT_PORTFOLIO_OPTIMIZER_ADDRESS || '';

export default function Debt_Portfolio_OptimizerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.debt-portfolio-optimizer/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'debt-portfolio-optimizer',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>debt-portfolio-optimizer</h1>
