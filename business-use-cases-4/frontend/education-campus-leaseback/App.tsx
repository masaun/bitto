...
const CONTRACT_ADDRESS = process.env.EDUCATION_CAMPUS_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'education-campus-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'education-campus-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>education-campus-leaseback</h1>
      {!userData ? (
