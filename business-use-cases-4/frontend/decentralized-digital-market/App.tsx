...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_DIGITAL_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-digital-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-digital-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-digital-market</h1>
      {!userData ? (
