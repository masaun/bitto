...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_FINANCE_BRIDGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-finance-bridge';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-finance-bridge',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-finance-bridge</h1>
      {!userData ? (
