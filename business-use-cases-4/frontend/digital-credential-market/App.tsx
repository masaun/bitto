...
const CONTRACT_ADDRESS = process.env.DIGITAL_CREDENTIAL_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-credential-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-credential-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-credential-market</h1>
      {!userData ? (
