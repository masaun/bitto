...
const CONTRACT_ADDRESS = process.env.ENCRYPTED_ARBITRATION_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'encrypted-arbitration-layer';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EncryptedArbitrationLayer',
