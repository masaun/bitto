...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EMAIL_TRIAGE_AI_ADDRESS || '';

export default function Email_Triage_AiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.email-triage-ai/read-only/get-counter`,
        {
          method: 'GET',
