...
const CONTRACT_ADDRESS = process.env.CROSSPLATFORM_IDENTITY_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossplatform-identity-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossplatform-identity-hub',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossplatform-identity-hub</h1>
      {!userData ? (
