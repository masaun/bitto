...
export default function diningSetProductionHub() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Dining Set Production Hub',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DINING_SET_PRODUCTION_HUB_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'dining-set-production-hub';
  ...
  return (
    <div>
      <h1>Dining Set Production Hub</h1>
