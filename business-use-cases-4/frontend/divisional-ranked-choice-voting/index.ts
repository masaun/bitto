...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'divisional-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-ranked-choice-voting',
