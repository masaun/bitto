...
const CONTRACT_ADDRESS = process.env.DIAGNOSTICS_LAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'diagnostics-lab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'diagnostics-lab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>diagnostics-lab-leaseback</h1>
      {!userData ? (
