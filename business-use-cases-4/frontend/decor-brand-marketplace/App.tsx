...
export default function decorBrandMarketplace() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_BRAND_MARKETPLACE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-brand-marketplace';
