...
const contractAddress = process.env.REACT_APP_DOWNTOWN_FOOT_TRAFFIC_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'downtown-foot-traffic-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Downtown Foot Traffic Rewards</h1>
