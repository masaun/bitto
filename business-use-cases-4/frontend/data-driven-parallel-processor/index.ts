...
const CONTRACT_ADDRESS = process.env.DATA_DRIVEN_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'data-driven-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'data-driven-parallel-processor',
