...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CREDIT_LINE_MGR_ADDRESS || '';

export default function Credit_Line_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.credit-line-mgr/read-only/get-counter`,
        {
          method: 'GET',
