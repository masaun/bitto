...
export default function ergonomicWorkstationFactory() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Ergonomic Workstation Factory',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ERGONOMIC_WORKSTATION_FACTORY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'ergonomic-workstation-factory';
  ...
  return (
    <div>
      <h1>Ergonomic Workstation Factory</h1>
