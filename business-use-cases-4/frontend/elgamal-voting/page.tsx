...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ELGAMAL_VOTING_ADDRESS || '';

export default function Elgamal_VotingPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.elgamal-voting/read-only/get-counter`,
        {
          method: 'GET',
