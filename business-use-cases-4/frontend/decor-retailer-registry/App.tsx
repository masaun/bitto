...
export default function decorRetailerRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_RETAILER_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-retailer-registry';
