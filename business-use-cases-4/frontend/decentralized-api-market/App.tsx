...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_API_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-api-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-api-market</h1>
      {!userData ? (
