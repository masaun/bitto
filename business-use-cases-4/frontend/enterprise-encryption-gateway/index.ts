...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_ENCRYPTION_GATEWAY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-encryption-gateway';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EnterpriseEncryptionGateway',
