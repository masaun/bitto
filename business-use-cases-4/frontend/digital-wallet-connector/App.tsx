...
const CONTRACT_ADDRESS = process.env.DIGITAL_WALLET_CONNECTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-wallet-connector';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-wallet-connector</h1>
      {!userData ? (
