...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_LIQUID_DEMOCRACY_ADDRESS || '';
const CONTRACT_NAME = 'departmental-liquid-democracy';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-liquid-democracy',
