...
const CONTRACT_ADDRESS = process.env.EDUCATION_CREDENTIAL_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'education-credential-verifier';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'education-credential-verifier',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>education-credential-verifier</h1>
      {!userData ? (
