...
const CONTRACT_ADDRESS = process.env.CORPORATE_TREASURY_MANAGER_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-treasury-manager-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-treasury-manager-4',
