...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_OVERSIGHT_BUREAU_ADDRESS || '';
const CONTRACT_NAME = 'departmental-oversight-bureau';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-oversight-bureau',
