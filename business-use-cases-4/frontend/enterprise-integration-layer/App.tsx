...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_INTEGRATION_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-integration-layer';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-integration-layer</h1>
      {!userData ? (
