...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_STAKEHOLDER_COUNCIL_ADDRESS || '';
const CONTRACT_NAME = 'divisional-stakeholder-council';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-stakeholder-council',
