...
export default function ecoWoodSourcingLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_WOOD_SOURCING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-wood-sourcing-ledger';
  ...
  return (
    <div>
      <h1>Eco Wood Sourcing Ledger</h1>
