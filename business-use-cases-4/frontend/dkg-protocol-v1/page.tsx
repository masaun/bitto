...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DKG_PROTOCOL_V1_ADDRESS || '';

export default function Dkg_Protocol_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dkg-protocol-v1/read-only/get-counter`,
        {
          method: 'GET',
