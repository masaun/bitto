...
const CONTRACT_ADDRESS = process.env.CUSTOMS_TERMINAL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'customs-terminal-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'customs-terminal-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>customs-terminal-leaseback</h1>
      {!userData ? (
