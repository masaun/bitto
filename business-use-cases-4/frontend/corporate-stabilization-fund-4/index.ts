...
const CONTRACT_ADDRESS = process.env.CORPORATE_STABILIZATION_FUND_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-stabilization-fund-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-stabilization-fund-4',
