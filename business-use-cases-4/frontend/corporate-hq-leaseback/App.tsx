...
const CONTRACT_ADDRESS = process.env.CORPORATE_HQ_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'corporate-hq-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'corporate-hq-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
