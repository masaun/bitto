...
const contractAddress = process.env.REACT_APP_DIFFERENTIATION_PATHWAY_EXCHANGE_CONTRACT_ADDRESS || '';
const contractName = 'differentiation-pathway-exchange';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>differentiation pathway exchange</h1>
