...
const CONTRACT_ADDRESS = process.env.CREATOR_ROYALTY_DISTRIBUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'creator-royalty-distribution';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'creator-royalty-distribution',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>creator-royalty-distribution</h1>
      {!userData ? (
