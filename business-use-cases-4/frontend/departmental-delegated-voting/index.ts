...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_DELEGATED_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'departmental-delegated-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-delegated-voting',
