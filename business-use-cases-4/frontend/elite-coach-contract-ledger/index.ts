...
const CONTRACT_ADDRESS = process.env.ELITE_COACH_CONTRACT_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'elite-coach-contract-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Elite Coach Contract Ledger',
