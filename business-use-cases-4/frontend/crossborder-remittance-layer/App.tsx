...
const CONTRACT_ADDRESS = process.env.CROSSBORDER_REMITTANCE_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossborder-remittance-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossborder-remittance-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossborder-remittance-layer</h1>
      {!userData ? (
