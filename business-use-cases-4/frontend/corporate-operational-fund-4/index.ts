...
const CONTRACT_ADDRESS = process.env.CORPORATE_OPERATIONAL_FUND_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-operational-fund-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-operational-fund-4',
