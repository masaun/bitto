...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_ATTESTATION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-attestation-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EnterpriseAttestationEngine',
