...
const CONTRACT_ADDRESS = process.env.CROSS_CHAIN_THRESHOLD_DECRYPTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-chain-threshold-decryption';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'CrossChainThresholdDecryption',
