...
const CONTRACT_ADDRESS = process.env.EDGE_DEVICE_AUTHENTICATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'edge-device-authenticator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'edge-device-authenticator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>edge-device-authenticator</h1>
      {!userData ? (
