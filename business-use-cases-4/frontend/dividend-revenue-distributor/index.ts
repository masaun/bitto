...
const CONTRACT_ADDRESS = process.env.DIVIDEND_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'dividend-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'dividend-revenue-distributor',
