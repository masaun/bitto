...
const CONTRACT_ADDRESS = process.env.DIGITAL_TWIN_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-twin-coordinator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-twin-coordinator</h1>
      {!userData ? (
