...
export default function ecoSeatingInitiative() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_SEATING_INITIATIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-seating-initiative';
