...
export default function ecoInteriorMarketplace() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_INTERIOR_MARKETPLACE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-interior-marketplace';
  ...
  return (
    <div>
      <h1>Eco Interior Marketplace</h1>
