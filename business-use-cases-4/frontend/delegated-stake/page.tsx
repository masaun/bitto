...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DELEGATED_STAKE_ADDRESS || '';

export default function Delegated_StakePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.delegated-stake/read-only/get-counter`,
        {
          method: 'GET',
