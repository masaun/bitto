...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_VIDEO_STREAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-video-stream';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-video-stream',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-video-stream</h1>
      {!userData ? (
