...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ENHANCEMENT_FLOOR_MODULE_NEW_ADDRESS || '';

export default function Enhancement_Floor_Module_NewPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'enhancement-floor-module-new',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.enhancement-floor-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'enhancement-floor-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>enhancement-floor-module-new</h1>
