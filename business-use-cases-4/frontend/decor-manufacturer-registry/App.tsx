...
export default function decorManufacturerRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Decor Manufacturer Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_MANUFACTURER_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-manufacturer-registry';
  ...
  return (
    <div>
      <h1>Decor Manufacturer Registry</h1>
