...
export default function customOfficeFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Custom Office Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_OFFICE_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-office-furnishings';
  ...
  return (
    <div>
      <h1>Custom Office Furnishings</h1>
