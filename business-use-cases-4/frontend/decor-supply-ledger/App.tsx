...
export default function decorSupplyLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_SUPPLY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-supply-ledger';
