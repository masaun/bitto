...
export default function decorSupplyChainEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Decor Supply Chain Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_SUPPLY_CHAIN_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-supply-chain-engine';
  ...
  return (
    <div>
      <h1>Decor Supply Chain Engine</h1>
