...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ESCROW_AGENT_V3_ADDRESS || '';

export default function Escrow_Agent_V3Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.escrow-agent-v3/read-only/get-counter`,
        {
          method: 'GET',
