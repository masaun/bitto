...
const CONTRACT_ADDRESS = process.env.EDGE_DATACENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'edge-datacenter-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'edge-datacenter-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>edge-datacenter-leaseback</h1>
      {!userData ? (
