...
const contractAddress = process.env.REACT_APP_DOWNTOWN_EXPERIENCE_GAME_CONTRACT_ADDRESS || '';
const contractName = 'downtown-experience-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Downtown Experience Game</h1>
