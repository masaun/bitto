...
const contractAddress = process.env.REACT_APP_COSMOSCOPE_DATA_CLEARING_CONTRACT_ADDRESS || '';
const contractName = 'cosmoscope-data-clearing';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>cosmoscope data clearing</h1>
