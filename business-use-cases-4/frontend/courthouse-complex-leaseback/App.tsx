...
const CONTRACT_ADDRESS = process.env.COURTHOUSE_COMPLEX_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'courthouse-complex-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'courthouse-complex-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>courthouse-complex-leaseback</h1>
      {!userData ? (
