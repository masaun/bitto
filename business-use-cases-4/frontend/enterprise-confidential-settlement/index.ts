...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_CONFIDENTIAL_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-confidential-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EnterpriseConfidentialSettlement',
