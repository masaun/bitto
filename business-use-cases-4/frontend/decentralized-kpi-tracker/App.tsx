...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_KPI_TRACKER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-kpi-tracker';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-kpi-tracker',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-kpi-tracker</h1>
      {!userData ? (
