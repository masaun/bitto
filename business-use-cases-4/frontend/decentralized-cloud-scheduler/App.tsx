...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_CLOUD_SCHEDULER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-cloud-scheduler';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-cloud-scheduler',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-cloud-scheduler</h1>
      {!userData ? (
