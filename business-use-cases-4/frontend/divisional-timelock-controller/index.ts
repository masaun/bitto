...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_TIMELOCK_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'divisional-timelock-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-timelock-controller',
