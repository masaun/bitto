...
const CONTRACT_ADDRESS = process.env.DIGITAL_COLLECTIBLES_MINT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-collectibles-mint';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Digital Collectibles Mint',
