...
export default function ergonomicSeatingLab() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ERGONOMIC_SEATING_LAB_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'ergonomic-seating-lab';
