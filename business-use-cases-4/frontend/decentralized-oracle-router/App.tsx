...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_ORACLE_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-oracle-router';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-oracle-router',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-oracle-router</h1>
      {!userData ? (
