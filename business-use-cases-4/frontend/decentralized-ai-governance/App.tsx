...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_AI_GOVERNANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-ai-governance';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-ai-governance',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-ai-governance</h1>
      {!userData ? (
