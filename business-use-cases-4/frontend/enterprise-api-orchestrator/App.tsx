...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_API_ORCHESTRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-api-orchestrator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-api-orchestrator</h1>
      {!userData ? (
