...
export default function decorSourcingEngine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_SOURCING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-sourcing-engine';
