...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_RISK_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-risk-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-risk-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-risk-market</h1>
      {!userData ? (
