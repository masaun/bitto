...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_EXECUTIVE_BOARD_ADDRESS || '';
const CONTRACT_NAME = 'departmental-executive-board';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-executive-board',
