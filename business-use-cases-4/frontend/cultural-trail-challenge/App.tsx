...
const contractAddress = process.env.REACT_APP_CULTURAL_TRAIL_CHALLENGE_CONTRACT_ADDRESS || '';
const contractName = 'cultural-trail-challenge';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Cultural Trail Challenge</h1>
