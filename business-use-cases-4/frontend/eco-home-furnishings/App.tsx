...
export default function ecoHomeFurnishings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_HOME_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-home-furnishings';
