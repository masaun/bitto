...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_ARBITRATION_BOARD_ADDRESS || '';
const CONTRACT_NAME = 'divisional-arbitration-board';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-arbitration-board',
