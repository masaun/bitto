...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ENTRY_POINT_V6_ADDRESS || '';

export default function Entry_Point_V6Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.entry-point-v6/read-only/get-counter`,
        {
          method: 'GET',
