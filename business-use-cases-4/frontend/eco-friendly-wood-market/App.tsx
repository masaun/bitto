...
export default function ecoFriendlyWoodMarket() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_FRIENDLY_WOOD_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-friendly-wood-market';
  ...
  return (
    <div>
      <h1>Eco Friendly Wood Market</h1>
