...
const CONTRACT_ADDRESS = process.env.CORPORATE_DEVELOPMENT_FUND_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-development-fund-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-development-fund-4',
