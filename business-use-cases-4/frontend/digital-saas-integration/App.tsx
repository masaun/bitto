...
const CONTRACT_ADDRESS = process.env.DIGITAL_SAAS_INTEGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-saas-integration';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-saas-integration</h1>
      {!userData ? (
