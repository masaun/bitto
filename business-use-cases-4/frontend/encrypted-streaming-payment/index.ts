...
const CONTRACT_ADDRESS = process.env.ENCRYPTED_STREAMING_PAYMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'encrypted-streaming-payment';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EncryptedStreamingPayment',
