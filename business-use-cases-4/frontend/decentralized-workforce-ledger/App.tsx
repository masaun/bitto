...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_WORKFORCE_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-workforce-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-workforce-ledger',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-workforce-ledger</h1>
      {!userData ? (
