...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DEBUG_TOOLKIT_V1_ADDRESS || '';

export default function Debug_Toolkit_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.debug-toolkit-v1/read-only/get-counter`,
        {
          method: 'GET',
