...
const CONTRACT_ADDRESS = process.env.DIGITAL_STREAMING_SUBSCRIPTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-streaming-subscription';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Digital Streaming Subscription',
