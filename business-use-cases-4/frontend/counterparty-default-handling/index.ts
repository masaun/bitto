...
const CONTRACT_ADDRESS = process.env.COUNTERPARTY_DEFAULT_HANDLING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'counterparty-default-handling';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Counterparty Default Handling',
