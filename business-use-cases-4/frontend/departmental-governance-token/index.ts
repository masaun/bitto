...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_GOVERNANCE_TOKEN_ADDRESS || '';
const CONTRACT_NAME = 'departmental-governance-token';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-governance-token',
