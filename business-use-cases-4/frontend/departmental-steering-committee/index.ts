...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_STEERING_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'departmental-steering-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-steering-committee',
