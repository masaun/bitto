...
export default function ecoFurnitureCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Eco Furniture Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_FURNITURE_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-furniture-certification';
  ...
  return (
    <div>
      <h1>Eco Furniture Certification</h1>
