...
const contractAddress = process.env.REACT_APP_DISINFECTANT_INVENTORY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'disinfectant-inventory-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>disinfectant inventory ledger</h1>
