...
export default function ecoInteriorLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-interior-ledger';
