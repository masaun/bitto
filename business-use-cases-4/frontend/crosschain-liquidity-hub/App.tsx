...
const CONTRACT_ADDRESS = process.env.CROSSCHAIN_LIQUIDITY_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crosschain-liquidity-hub';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crosschain-liquidity-hub</h1>
      {!userData ? (
