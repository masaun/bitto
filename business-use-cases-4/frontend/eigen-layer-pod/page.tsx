...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EIGEN_LAYER_POD_ADDRESS || '';

export default function Eigen_Layer_PodPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.eigen-layer-pod/read-only/get-counter`,
        {
          method: 'GET',
