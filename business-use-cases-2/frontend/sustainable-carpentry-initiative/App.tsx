...
export default function sustainableCarpentryInitiative() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Carpentry Initiative',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_CARPENTRY_INITIATIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-carpentry-initiative';
  ...
  return (
    <div>
      <h1>Sustainable Carpentry Initiative</h1>
