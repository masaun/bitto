...
const CONTRACT_ADDRESS = process.env.OTC_PRICING_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-pricing-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-pricing-interest-rate-cap',
