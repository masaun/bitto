...
const CONTRACT_ADDRESS = process.env.REGIONAL_TIMELOCK_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'regional-timelock-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'regional-timelock-controller',
