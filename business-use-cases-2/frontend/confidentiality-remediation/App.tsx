...
const contractAddress = process.env.REACT_APP_CONFIDENTIALITY_REMEDIATION_CONTRACT_ADDRESS || '';
const contractName = 'confidentiality-remediation';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Confidentiality Remediation',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Confidentiality Remediation</h1>
