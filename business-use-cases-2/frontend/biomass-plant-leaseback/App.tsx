...
const CONTRACT_ADDRESS = process.env.BIOMASS_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biomass-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'biomass-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
