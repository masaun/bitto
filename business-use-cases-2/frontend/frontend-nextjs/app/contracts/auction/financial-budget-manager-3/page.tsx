...
export default function FinancialBudgetManager3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-budget-manager-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-budget-manager-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-budget-manager-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Budget Manager 3</h1>
