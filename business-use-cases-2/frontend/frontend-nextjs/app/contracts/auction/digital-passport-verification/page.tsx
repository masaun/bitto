...
export default function DigitalPassportVerificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-passport-verification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-passport-verification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-passport-verification' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Digital Passport Verification</h1>
