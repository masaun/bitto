...
export default function PrivacyInteroperabilityLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('privacy-interoperability-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'privacy-interoperability-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'privacy-interoperability-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Privacy Interoperability Layer</h1>
