...
export default function AiAnalyticsMarketplacePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ai-analytics-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-analytics-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-analytics-marketplace' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ai Analytics Marketplace</h1>
