...
export default function ChampionshipSponsorshipAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-sponsorship-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-sponsorship-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-sponsorship-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Sponsorship Auction</h1>
