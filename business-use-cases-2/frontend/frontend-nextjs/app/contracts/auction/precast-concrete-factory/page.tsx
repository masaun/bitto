...
export default function PrecastConcreteFactoryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('precast-concrete-factory');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'precast-concrete-factory',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'precast-concrete-factory' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Precast Concrete Factory</h1>
