...
export default function SupplyDelayAlertSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('supply-delay-alert-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'supply-delay-alert-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'supply-delay-alert-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Supply Delay Alert System</h1>
