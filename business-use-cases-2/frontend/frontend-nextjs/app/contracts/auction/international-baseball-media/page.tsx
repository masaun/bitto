...
export default function InternationalBaseballMediaPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-baseball-media');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-baseball-media',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-baseball-media' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Baseball Media</h1>
