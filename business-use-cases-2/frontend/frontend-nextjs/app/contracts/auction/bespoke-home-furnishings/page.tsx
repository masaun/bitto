...
export default function BespokeHomeFurnishingsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-home-furnishings');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-home-furnishings',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-home-furnishings' },
      });
