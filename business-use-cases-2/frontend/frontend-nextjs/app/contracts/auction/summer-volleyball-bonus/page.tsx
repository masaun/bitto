...
export default function SummerVolleyballBonusPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('summer-volleyball-bonus');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'summer-volleyball-bonus',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'summer-volleyball-bonus' },
      });
