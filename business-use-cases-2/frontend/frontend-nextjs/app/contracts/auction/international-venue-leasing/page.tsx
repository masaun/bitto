...
export default function InternationalVenueLeasingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-venue-leasing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-venue-leasing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-venue-leasing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Venue Leasing</h1>
