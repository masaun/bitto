...
export default function ChampionshipEsportsCollabPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-esports-collab');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-esports-collab',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-esports-collab' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Esports Collab</h1>
