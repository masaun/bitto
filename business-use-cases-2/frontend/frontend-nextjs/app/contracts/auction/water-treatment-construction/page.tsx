...
export default function WaterTreatmentConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('water-treatment-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'water-treatment-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'water-treatment-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Water Treatment Construction</h1>
