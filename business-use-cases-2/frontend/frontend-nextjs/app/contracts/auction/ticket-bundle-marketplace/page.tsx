...
export default function TicketBundleMarketplacePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ticket-bundle-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ticket-bundle-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ticket-bundle-marketplace' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ticket Bundle Marketplace</h1>
