...
export default function SummerMarathonRegistrationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('summer-marathon-registration');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'summer-marathon-registration',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'summer-marathon-registration' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Summer Marathon Registration</h1>
