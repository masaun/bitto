...
export default function SurveillanceSystemBuildoutPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('surveillance-system-buildout');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'surveillance-system-buildout',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'surveillance-system-buildout' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Surveillance System Buildout</h1>
