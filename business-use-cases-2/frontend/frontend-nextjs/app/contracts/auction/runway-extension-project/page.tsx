...
export default function RunwayExtensionProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('runway-extension-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'runway-extension-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'runway-extension-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Runway Extension Project</h1>
