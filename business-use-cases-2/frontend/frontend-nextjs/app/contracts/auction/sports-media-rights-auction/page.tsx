...
export default function SportsMediaRightsAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-media-rights-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-media-rights-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-media-rights-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Media Rights Auction</h1>
