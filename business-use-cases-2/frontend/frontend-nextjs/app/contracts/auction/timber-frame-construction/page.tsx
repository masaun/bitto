...
export default function TimberFrameConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('timber-frame-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'timber-frame-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'timber-frame-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Timber Frame Construction</h1>
