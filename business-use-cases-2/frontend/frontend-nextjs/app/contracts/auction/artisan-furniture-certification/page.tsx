...
export default function ArtisanFurnitureCertificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('artisan-furniture-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'artisan-furniture-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'artisan-furniture-certification' },
      });
