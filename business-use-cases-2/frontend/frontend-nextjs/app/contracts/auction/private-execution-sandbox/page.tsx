...
export default function PrivateExecutionSandboxPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-execution-sandbox');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-execution-sandbox',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-execution-sandbox' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Execution Sandbox</h1>
