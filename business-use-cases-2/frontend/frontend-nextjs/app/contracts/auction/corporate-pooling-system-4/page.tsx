...
export default function CorporatePoolingSystem4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-pooling-system-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-pooling-system-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-pooling-system-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Pooling System 4</h1>
