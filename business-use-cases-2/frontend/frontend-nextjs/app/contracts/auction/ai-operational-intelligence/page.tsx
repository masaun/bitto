...
export default function AiOperationalIntelligencePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ai-operational-intelligence');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-operational-intelligence',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-operational-intelligence' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Ai Operational Intelligence</h1>
