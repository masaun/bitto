...
export default function FinancialBudgetTracker3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-budget-tracker-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-budget-tracker-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-budget-tracker-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Budget Tracker 3</h1>
