...
export default function OperationalBudgetMonitor2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-budget-monitor-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-budget-monitor-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-budget-monitor-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Budget Monitor 2</h1>
