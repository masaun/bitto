...
export default function RegionalLiquidDemocracyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('regional-liquid-democracy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'regional-liquid-democracy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'regional-liquid-democracy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Regional Liquid Democracy</h1>
