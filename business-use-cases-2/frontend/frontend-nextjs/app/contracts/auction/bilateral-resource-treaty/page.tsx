...
export default function BilateralResourceTreatyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bilateral-resource-treaty');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bilateral-resource-treaty',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bilateral-resource-treaty' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Bilateral Resource Treaty</h1>
