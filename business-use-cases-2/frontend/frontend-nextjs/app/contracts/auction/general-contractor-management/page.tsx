...
export default function GeneralContractorManagementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('general-contractor-management');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'general-contractor-management',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'general-contractor-management' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>General Contractor Management</h1>
