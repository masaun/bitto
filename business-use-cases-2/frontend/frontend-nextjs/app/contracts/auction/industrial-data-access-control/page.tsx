...
export default function IndustrialDataAccessControlPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('industrial-data-access-control');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'industrial-data-access-control',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'industrial-data-access-control' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Industrial Data Access Control</h1>
