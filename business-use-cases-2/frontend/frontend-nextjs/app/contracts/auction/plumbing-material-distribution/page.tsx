...
export default function PlumbingMaterialDistributionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('plumbing-material-distribution');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'plumbing-material-distribution',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'plumbing-material-distribution' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Plumbing Material Distribution</h1>
