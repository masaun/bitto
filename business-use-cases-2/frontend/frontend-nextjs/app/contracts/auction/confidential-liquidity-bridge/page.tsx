...
export default function ConfidentialLiquidityBridgePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('confidential-liquidity-bridge');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'confidential-liquidity-bridge',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'confidential-liquidity-bridge' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Confidential Liquidity Bridge</h1>
