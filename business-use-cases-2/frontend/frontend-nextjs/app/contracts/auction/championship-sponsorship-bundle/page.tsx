...
export default function ChampionshipSponsorshipBundlePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-sponsorship-bundle');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-sponsorship-bundle',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-sponsorship-bundle' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Sponsorship Bundle</h1>
