...
export default function DepartmentalOversightBureauPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('departmental-oversight-bureau');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'departmental-oversight-bureau',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'departmental-oversight-bureau' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Departmental Oversight Bureau</h1>
