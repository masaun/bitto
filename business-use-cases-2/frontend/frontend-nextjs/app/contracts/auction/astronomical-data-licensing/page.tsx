...
export default function AstronomicalDataLicensingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('astronomical-data-licensing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'astronomical-data-licensing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'astronomical-data-licensing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Astronomical Data Licensing</h1>
