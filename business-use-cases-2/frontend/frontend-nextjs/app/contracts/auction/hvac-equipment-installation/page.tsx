...
export default function HvacEquipmentInstallationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('hvac-equipment-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'hvac-equipment-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'hvac-equipment-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Hvac Equipment Installation</h1>
