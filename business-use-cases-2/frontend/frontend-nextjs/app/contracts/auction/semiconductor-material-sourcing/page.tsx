...
export default function SemiconductorMaterialSourcingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('semiconductor-material-sourcing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'semiconductor-material-sourcing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'semiconductor-material-sourcing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Semiconductor Material Sourcing</h1>
