...
export default function LogisticsHubDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('logistics-hub-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'logistics-hub-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'logistics-hub-development' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Logistics Hub Development</h1>
