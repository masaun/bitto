...
export default function DefectLiabilityRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('defect-liability-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'defect-liability-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'defect-liability-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Defect Liability Registry</h1>
