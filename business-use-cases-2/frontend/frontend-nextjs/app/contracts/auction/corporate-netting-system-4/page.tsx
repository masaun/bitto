...
export default function CorporateNettingSystem4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-netting-system-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-netting-system-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-netting-system-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Netting System 4</h1>
