...
export default function AutonomousBlockBuilderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('autonomous-block-builder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'autonomous-block-builder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'autonomous-block-builder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Autonomous Block Builder</h1>
