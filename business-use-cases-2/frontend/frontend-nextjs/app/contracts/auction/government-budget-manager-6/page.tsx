...
export default function GovernmentBudgetManager6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-budget-manager-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-budget-manager-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-budget-manager-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Budget Manager 6</h1>
