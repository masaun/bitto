...
export default function InsulationManufacturingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('insulation-manufacturing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'insulation-manufacturing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'insulation-manufacturing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Insulation Manufacturing</h1>
