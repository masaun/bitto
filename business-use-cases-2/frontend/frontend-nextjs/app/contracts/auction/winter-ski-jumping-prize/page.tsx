...
export default function WinterSkiJumpingPrizePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('winter-ski-jumping-prize');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'winter-ski-jumping-prize',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'winter-ski-jumping-prize' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Winter Ski Jumping Prize</h1>
