...
export default function WinterSpeedSkatingPrizePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('winter-speed-skating-prize');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'winter-speed-skating-prize',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'winter-speed-skating-prize' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Winter Speed Skating Prize</h1>
