...
export default function EmergencyPrivacySwitchPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('emergency-privacy-switch');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'emergency-privacy-switch',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'emergency-privacy-switch' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Emergency Privacy Switch</h1>
