...
export default function AiAgentDeploymentPage() {
  ...
  const contractAddress = getContractAddress('ai-agent-deployment');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-agent-deployment',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-agent-deployment' },
      });
