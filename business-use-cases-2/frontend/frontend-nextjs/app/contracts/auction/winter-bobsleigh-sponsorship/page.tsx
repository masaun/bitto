...
export default function WinterBobsleighSponsorshipPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('winter-bobsleigh-sponsorship');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'winter-bobsleigh-sponsorship',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'winter-bobsleigh-sponsorship' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Winter Bobsleigh Sponsorship</h1>
