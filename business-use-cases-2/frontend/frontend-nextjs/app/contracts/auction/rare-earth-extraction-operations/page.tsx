...
export default function RareEarthExtractionOperationsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-extraction-operations');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-extraction-operations',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-extraction-operations' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rare Earth Extraction Operations</h1>
