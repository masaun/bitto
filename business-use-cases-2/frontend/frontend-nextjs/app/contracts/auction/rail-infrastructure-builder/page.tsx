...
export default function RailInfrastructureBuilderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rail-infrastructure-builder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rail-infrastructure-builder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rail-infrastructure-builder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rail Infrastructure Builder</h1>
