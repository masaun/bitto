...
export default function ArbitrationCaseTrackerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('arbitration-case-tracker');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'arbitration-case-tracker',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'arbitration-case-tracker' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Arbitration Case Tracker</h1>
