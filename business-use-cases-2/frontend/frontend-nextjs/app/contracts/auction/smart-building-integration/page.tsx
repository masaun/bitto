...
export default function SmartBuildingIntegrationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('smart-building-integration');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'smart-building-integration',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'smart-building-integration' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Smart Building Integration</h1>
