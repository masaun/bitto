...
export default function ResidentialTowerBuilderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('residential-tower-builder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'residential-tower-builder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'residential-tower-builder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Residential Tower Builder</h1>
