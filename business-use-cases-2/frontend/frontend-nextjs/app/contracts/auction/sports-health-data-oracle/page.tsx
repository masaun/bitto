...
export default function SportsHealthDataOraclePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-health-data-oracle');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-health-data-oracle',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-health-data-oracle' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Health Data Oracle</h1>
