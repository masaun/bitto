...
export default function PerformanceBondRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('performance-bond-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'performance-bond-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'performance-bond-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Performance Bond Registry</h1>
