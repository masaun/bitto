...
export default function EnterprisePrivateTransactionsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('enterprise-private-transactions');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'enterprise-private-transactions',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'enterprise-private-transactions' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Enterprise Private Transactions</h1>
