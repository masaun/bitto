...
export default function AdvertisingScreenLeasebackPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('advertising-screen-leaseback');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'advertising-screen-leaseback',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'advertising-screen-leaseback' },
      });
