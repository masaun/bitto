...
export default function TrackAndFieldEquipmentLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('track-and-field-equipment-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'track-and-field-equipment-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'track-and-field-equipment-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Track And Field Equipment Ledger</h1>
