...
export default function ConstructionBidEvaluationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('construction-bid-evaluation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'construction-bid-evaluation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'construction-bid-evaluation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Construction Bid Evaluation</h1>
