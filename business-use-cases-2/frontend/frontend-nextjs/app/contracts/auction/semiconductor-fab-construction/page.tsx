...
export default function SemiconductorFabConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('semiconductor-fab-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'semiconductor-fab-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'semiconductor-fab-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Semiconductor Fab Construction</h1>
