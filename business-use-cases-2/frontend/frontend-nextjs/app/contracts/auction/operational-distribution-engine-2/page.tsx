...
export default function OperationalDistributionEngine2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-distribution-engine-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-distribution-engine-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-distribution-engine-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Distribution Engine 2</h1>
