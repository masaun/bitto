...
export default function GlobalSportsHospitalitySuitePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-sports-hospitality-suite');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-sports-hospitality-suite',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-sports-hospitality-suite' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Sports Hospitality Suite</h1>
