...
export default function TournamentBonusDistributorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tournament-bonus-distributor');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tournament-bonus-distributor',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tournament-bonus-distributor' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tournament Bonus Distributor</h1>
