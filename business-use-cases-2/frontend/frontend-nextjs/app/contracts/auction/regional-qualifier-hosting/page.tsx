...
export default function RegionalQualifierHostingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('regional-qualifier-hosting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'regional-qualifier-hosting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'regional-qualifier-hosting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Regional Qualifier Hosting</h1>
