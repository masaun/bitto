...
export default function ValidatorThresholdConsensusPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('validator-threshold-consensus');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'validator-threshold-consensus',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'validator-threshold-consensus' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Validator Threshold Consensus</h1>
