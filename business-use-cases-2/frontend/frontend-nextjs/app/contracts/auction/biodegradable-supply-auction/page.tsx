...
export default function BiodegradableSupplyAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('biodegradable-supply-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'biodegradable-supply-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'biodegradable-supply-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Biodegradable Supply Auction</h1>
