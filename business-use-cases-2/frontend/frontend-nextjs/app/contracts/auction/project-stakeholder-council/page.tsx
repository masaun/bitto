...
export default function ProjectStakeholderCouncilPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-stakeholder-council');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-stakeholder-council',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-stakeholder-council' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Project Stakeholder Council</h1>
