...
export default function ApparelFactoryLeasebackPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('apparel-factory-leaseback');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'apparel-factory-leaseback',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'apparel-factory-leaseback' },
      });
