...
export default function AssetMaintenanceRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('asset-maintenance-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'asset-maintenance-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'asset-maintenance-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Asset Maintenance Registry</h1>
