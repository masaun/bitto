...
export default function InternationalSportsLiquidityPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-sports-liquidity');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-sports-liquidity',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-sports-liquidity' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Sports Liquidity</h1>
