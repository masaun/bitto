...
export default function AdversarialTestingPage() {
  ...
  const contractAddress = getContractAddress('adversarial-testing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'adversarial-testing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'adversarial-testing' },
      });
