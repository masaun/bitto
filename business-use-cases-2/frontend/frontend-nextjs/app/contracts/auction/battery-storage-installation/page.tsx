...
export default function BatteryStorageInstallationPage() {
  ...
  const contractAddress = getContractAddress('battery-storage-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'battery-storage-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'battery-storage-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Battery Storage Installation</h1>
