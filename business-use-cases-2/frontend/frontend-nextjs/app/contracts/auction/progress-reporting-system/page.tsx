...
export default function ProgressReportingSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('progress-reporting-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'progress-reporting-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'progress-reporting-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Progress Reporting System</h1>
