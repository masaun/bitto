...
export default function FacadeConstructionRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('facade-construction-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'facade-construction-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'facade-construction-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Facade Construction Registry</h1>
