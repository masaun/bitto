...
export default function MineralExplorationPermitsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('mineral-exploration-permits');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'mineral-exploration-permits',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'mineral-exploration-permits' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Mineral Exploration Permits</h1>
