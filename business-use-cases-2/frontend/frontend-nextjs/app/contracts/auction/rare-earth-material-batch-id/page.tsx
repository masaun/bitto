...
export default function RareEarthMaterialBatchIdPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-material-batch-id');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-material-batch-id',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-material-batch-id' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rare Earth Material Batch Id</h1>
