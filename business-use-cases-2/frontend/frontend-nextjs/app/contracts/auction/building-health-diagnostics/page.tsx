...
export default function BuildingHealthDiagnosticsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('building-health-diagnostics');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'building-health-diagnostics',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'building-health-diagnostics' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Building Health Diagnostics</h1>
