...
export default function ChampionshipPerformanceBonusPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-performance-bonus');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-performance-bonus',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-performance-bonus' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Performance Bonus</h1>
