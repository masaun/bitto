...
export default function AiEnterpriseSecurityPage() {
  ...
  const contractAddress = getContractAddress('ai-enterprise-security');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-enterprise-security',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-enterprise-security' },
      });
