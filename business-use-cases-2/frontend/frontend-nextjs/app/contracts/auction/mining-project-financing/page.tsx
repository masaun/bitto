...
export default function MiningProjectFinancingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('mining-project-financing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'mining-project-financing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'mining-project-financing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Mining Project Financing</h1>
