...
export default function WasteManagementFacilityBuildPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('waste-management-facility-build');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'waste-management-facility-build',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'waste-management-facility-build' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Waste Management Facility Build</h1>
