...
export default function ProcurementManagementSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('procurement-management-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'procurement-management-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'procurement-management-system' },
      });
