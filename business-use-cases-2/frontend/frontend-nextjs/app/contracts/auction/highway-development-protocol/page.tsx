...
export default function HighwayDevelopmentProtocolPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('highway-development-protocol');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'highway-development-protocol',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'highway-development-protocol' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Highway Development Protocol</h1>
