...
export default function GeopoliticalRiskScoringPage() {
  ...
  const contractAddress = getContractAddress('geopolitical-risk-scoring');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'geopolitical-risk-scoring',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'geopolitical-risk-scoring' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Geopolitical Risk Scoring</h1>
