...
export default function ForceMajeureActivationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('force-majeure-activation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'force-majeure-activation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'force-majeure-activation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Force Majeure Activation</h1>
