...
export default function EnvironmentalPermitTrackerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('environmental-permit-tracker');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'environmental-permit-tracker',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'environmental-permit-tracker' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Environmental Permit Tracker</h1>
