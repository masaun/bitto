...
export default function SiteLogisticsOptimizerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('site-logistics-optimizer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'site-logistics-optimizer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'site-logistics-optimizer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Site Logistics Optimizer</h1>
