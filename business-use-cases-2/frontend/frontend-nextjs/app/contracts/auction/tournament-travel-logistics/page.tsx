...
export default function TournamentTravelLogisticsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tournament-travel-logistics');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tournament-travel-logistics',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tournament-travel-logistics' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tournament Travel Logistics</h1>
