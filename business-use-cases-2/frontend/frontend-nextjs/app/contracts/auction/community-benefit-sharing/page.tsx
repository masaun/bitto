...
export default function CommunityBenefitSharingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('community-benefit-sharing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'community-benefit-sharing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'community-benefit-sharing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Community Benefit Sharing</h1>
