...
export default function PrivacyMonitoringLayerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('privacy-monitoring-layer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'privacy-monitoring-layer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'privacy-monitoring-layer' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Privacy Monitoring Layer</h1>
