...
export default function HandoverDocumentationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('handover-documentation-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'handover-documentation-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'handover-documentation-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Handover Documentation System</h1>
