...
export default function EscalatorInstallationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('escalator-installation-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'escalator-installation-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'escalator-installation-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Escalator Installation System</h1>
