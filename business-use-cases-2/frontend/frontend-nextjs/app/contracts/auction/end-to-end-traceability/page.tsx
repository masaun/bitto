...
export default function EndToEndTraceabilityPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('end-to-end-traceability');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'end-to-end-traceability',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'end-to-end-traceability' },
      });
