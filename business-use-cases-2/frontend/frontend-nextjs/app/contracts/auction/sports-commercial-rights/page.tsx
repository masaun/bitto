...
export default function SportsCommercialRightsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-commercial-rights');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-commercial-rights',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-commercial-rights' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Commercial Rights</h1>
