...
export default function BambooFurnishingsCollectivePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bamboo-furnishings-collective');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bamboo-furnishings-collective',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bamboo-furnishings-collective' },
      });
