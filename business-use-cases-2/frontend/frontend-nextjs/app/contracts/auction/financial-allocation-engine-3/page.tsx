...
export default function FinancialAllocationEngine3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-allocation-engine-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-allocation-engine-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-allocation-engine-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Allocation Engine 3</h1>
