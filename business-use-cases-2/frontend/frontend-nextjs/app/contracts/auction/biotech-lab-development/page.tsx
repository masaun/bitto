...
export default function BiotechLabDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('biotech-lab-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'biotech-lab-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'biotech-lab-development' },
      });
