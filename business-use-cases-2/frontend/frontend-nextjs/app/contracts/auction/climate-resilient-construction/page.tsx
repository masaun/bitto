...
export default function ClimateResilientConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('climate-resilient-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'climate-resilient-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'climate-resilient-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Climate Resilient Construction</h1>
