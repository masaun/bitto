...
export default function EquipmentSupplierAuctionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('equipment-supplier-auction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'equipment-supplier-auction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'equipment-supplier-auction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Equipment Supplier Auction</h1>
