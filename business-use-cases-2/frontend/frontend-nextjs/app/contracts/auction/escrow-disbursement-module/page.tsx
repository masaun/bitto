...
export default function EscrowDisbursementModulePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('escrow-disbursement-module');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'escrow-disbursement-module',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'escrow-disbursement-module' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Escrow Disbursement Module</h1>
