...
export default function HeritageRestorationProgramPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('heritage-restoration-program');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'heritage-restoration-program',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'heritage-restoration-program' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Heritage Restoration Program</h1>
