...
export default function SiteAcquisitionProtocolPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('site-acquisition-protocol');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'site-acquisition-protocol',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'site-acquisition-protocol' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Site Acquisition Protocol</h1>
