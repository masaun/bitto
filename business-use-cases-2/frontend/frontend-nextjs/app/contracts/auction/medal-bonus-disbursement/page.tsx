...
export default function MedalBonusDisbursementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('medal-bonus-disbursement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'medal-bonus-disbursement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'medal-bonus-disbursement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Medal Bonus Disbursement</h1>
