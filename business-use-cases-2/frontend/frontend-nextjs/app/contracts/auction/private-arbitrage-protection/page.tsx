...
export default function PrivateArbitrageProtectionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-arbitrage-protection');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-arbitrage-protection',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-arbitrage-protection' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Arbitrage Protection</h1>
