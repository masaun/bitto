...
export default function ImportLicenseValidationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('import-license-validation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'import-license-validation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'import-license-validation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Import License Validation</h1>
