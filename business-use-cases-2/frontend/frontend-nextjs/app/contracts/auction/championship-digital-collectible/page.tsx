...
export default function ChampionshipDigitalCollectiblePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-digital-collectible');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-digital-collectible',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-digital-collectible' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Digital Collectible</h1>
