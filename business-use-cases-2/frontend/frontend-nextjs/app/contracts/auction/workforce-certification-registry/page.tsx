...
export default function WorkforceCertificationRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('workforce-certification-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'workforce-certification-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'workforce-certification-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Workforce Certification Registry</h1>
