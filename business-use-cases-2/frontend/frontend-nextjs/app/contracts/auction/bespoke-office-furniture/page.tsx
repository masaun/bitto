...
export default function BespokeOfficeFurniturePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-office-furniture');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-office-furniture',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-office-furniture' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Bespoke Office Furniture</h1>
