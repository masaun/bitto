...
export default function LogisticsShipmentTrackingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('logistics-shipment-tracking');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'logistics-shipment-tracking',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'logistics-shipment-tracking' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Logistics Shipment Tracking</h1>
