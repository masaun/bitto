...
export default function ProcurementSealedBiddingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('procurement-sealed-bidding');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'procurement-sealed-bidding',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'procurement-sealed-bidding' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Procurement Sealed Bidding</h1>
