...
export default function InfrastructureProjectLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('infrastructure-project-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'infrastructure-project-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'infrastructure-project-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Infrastructure Project Ledger</h1>
