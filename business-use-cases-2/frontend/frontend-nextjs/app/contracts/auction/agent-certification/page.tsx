...
export default function AgentCertificationPage() {
  ...
  const contractAddress = getContractAddress('agent-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'agent-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'agent-certification' },
      });
