...
export default function SportsInfluencerCampaignPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-influencer-campaign');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-influencer-campaign',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-influencer-campaign' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Influencer Campaign</h1>
