...
export default function SubcontractorCoordinationHubPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('subcontractor-coordination-hub');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'subcontractor-coordination-hub',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'subcontractor-coordination-hub' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Subcontractor Coordination Hub</h1>
