...
export default function BespokeContractFurnishingsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-contract-furnishings');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-contract-furnishings',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-contract-furnishings' },
      });
