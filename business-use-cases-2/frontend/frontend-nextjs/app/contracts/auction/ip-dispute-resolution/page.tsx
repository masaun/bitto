...
export default function IpDisputeResolutionPage() {
  ...
  const contractAddress = getContractAddress('ip-dispute-resolution');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ip-dispute-resolution',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ip-dispute-resolution' },
      });
