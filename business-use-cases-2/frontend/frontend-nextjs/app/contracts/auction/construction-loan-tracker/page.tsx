...
export default function ConstructionLoanTrackerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('construction-loan-tracker');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'construction-loan-tracker',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'construction-loan-tracker' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Construction Loan Tracker</h1>
