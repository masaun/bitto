...
export default function MaterialRecyclingProgramPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('material-recycling-program');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'material-recycling-program',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'material-recycling-program' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Material Recycling Program</h1>
