...
export default function InsuranceAndRiskCoveragePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('insurance-and-risk-coverage');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'insurance-and-risk-coverage',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'insurance-and-risk-coverage' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Insurance And Risk Coverage</h1>
