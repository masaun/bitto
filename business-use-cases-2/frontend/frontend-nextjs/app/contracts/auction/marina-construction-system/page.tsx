...
export default function MarinaConstructionSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('marina-construction-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'marina-construction-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'marina-construction-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Marina Construction System</h1>
