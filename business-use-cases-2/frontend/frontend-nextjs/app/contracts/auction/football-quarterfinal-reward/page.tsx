...
export default function FootballQuarterfinalRewardPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('football-quarterfinal-reward');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'football-quarterfinal-reward',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'football-quarterfinal-reward' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Football Quarterfinal Reward</h1>
