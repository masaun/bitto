...
export default function GovernmentNettingSystem6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-netting-system-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-netting-system-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-netting-system-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Netting System 6</h1>
