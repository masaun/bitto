...
export default function SportsPerformanceRewardsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-performance-rewards');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-performance-rewards',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-performance-rewards' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Performance Rewards</h1>
