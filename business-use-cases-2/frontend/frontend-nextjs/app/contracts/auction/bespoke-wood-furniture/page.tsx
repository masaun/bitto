...
export default function BespokeWoodFurniturePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-wood-furniture');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-wood-furniture',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-wood-furniture' },
      });
