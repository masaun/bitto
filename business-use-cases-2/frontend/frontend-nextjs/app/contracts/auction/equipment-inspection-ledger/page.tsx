...
export default function EquipmentInspectionLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('equipment-inspection-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'equipment-inspection-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'equipment-inspection-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Equipment Inspection Ledger</h1>
