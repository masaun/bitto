...
export default function StormwaterManagementProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('stormwater-management-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'stormwater-management-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'stormwater-management-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Stormwater Management Project</h1>
