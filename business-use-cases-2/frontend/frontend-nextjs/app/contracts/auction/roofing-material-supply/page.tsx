...
export default function RoofingMaterialSupplyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('roofing-material-supply');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'roofing-material-supply',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'roofing-material-supply' },
      });
