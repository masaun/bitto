...
export default function EncryptedCallForwarderPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('encrypted-call-forwarder');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'encrypted-call-forwarder',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'encrypted-call-forwarder' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Encrypted Call Forwarder</h1>
