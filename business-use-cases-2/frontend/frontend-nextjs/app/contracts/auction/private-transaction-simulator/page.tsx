...
export default function PrivateTransactionSimulatorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('private-transaction-simulator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'private-transaction-simulator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'private-transaction-simulator' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Private Transaction Simulator</h1>
