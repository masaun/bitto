...
export default function AthleteImageRightsManagerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-image-rights-manager');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-image-rights-manager',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-image-rights-manager' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Image Rights Manager</h1>
