...
export default function WarehouseBuildoutSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('warehouse-buildout-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'warehouse-buildout-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'warehouse-buildout-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Warehouse Buildout System</h1>
