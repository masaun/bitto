...
export default function RareEarthNationalPolicyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-national-policy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-national-policy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-national-policy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Rare Earth National Policy</h1>
