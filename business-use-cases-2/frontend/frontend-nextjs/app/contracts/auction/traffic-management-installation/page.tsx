...
export default function TrafficManagementInstallationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('traffic-management-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'traffic-management-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'traffic-management-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Traffic Management Installation</h1>
