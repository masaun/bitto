...
export default function CraneCertificationRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('crane-certification-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'crane-certification-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'crane-certification-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Crane Certification Registry</h1>
