...
export default function DigitalCollectiblesMintPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-collectibles-mint');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-collectibles-mint',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-collectibles-mint' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Digital Collectibles Mint</h1>
