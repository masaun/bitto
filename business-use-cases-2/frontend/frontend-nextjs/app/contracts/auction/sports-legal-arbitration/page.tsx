...
export default function SportsLegalArbitrationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-legal-arbitration');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-legal-arbitration',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-legal-arbitration' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Legal Arbitration</h1>
