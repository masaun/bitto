...
export default function ElevatorMaintenanceRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('elevator-maintenance-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'elevator-maintenance-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'elevator-maintenance-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Elevator Maintenance Registry</h1>
