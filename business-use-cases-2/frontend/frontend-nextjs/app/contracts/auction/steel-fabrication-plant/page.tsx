...
export default function SteelFabricationPlantPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('steel-fabrication-plant');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'steel-fabrication-plant',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'steel-fabrication-plant' },
      });
