...
export default function TurbineMagnetTraceabilityPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('turbine-magnet-traceability');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'turbine-magnet-traceability',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'turbine-magnet-traceability' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Turbine Magnet Traceability</h1>
