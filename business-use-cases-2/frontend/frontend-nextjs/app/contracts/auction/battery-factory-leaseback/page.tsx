...
export default function BatteryFactoryLeasebackPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('battery-factory-leaseback');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'battery-factory-leaseback',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'battery-factory-leaseback' },
      });
