...
export default function NetzeroBuildingProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('netzero-building-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'netzero-building-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'netzero-building-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Netzero Building Project</h1>
