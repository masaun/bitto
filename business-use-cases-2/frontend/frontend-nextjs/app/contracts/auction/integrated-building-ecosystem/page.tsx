...
export default function IntegratedBuildingEcosystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('integrated-building-ecosystem');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'integrated-building-ecosystem',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'integrated-building-ecosystem' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Integrated Building Ecosystem</h1>
