...
export default function AiDataLabelingMarketPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('ai-data-labeling-market');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-data-labeling-market',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-data-labeling-market' },
      });
