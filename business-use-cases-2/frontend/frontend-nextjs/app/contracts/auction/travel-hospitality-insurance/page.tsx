...
export default function TravelHospitalityInsurancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('travel-hospitality-insurance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'travel-hospitality-insurance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'travel-hospitality-insurance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Travel Hospitality Insurance</h1>
