...
export default function NftPrivateMarketplacePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('nft-private-marketplace');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'nft-private-marketplace',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'nft-private-marketplace' },
      });
