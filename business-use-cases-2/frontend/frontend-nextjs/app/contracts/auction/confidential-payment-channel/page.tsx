...
export default function ConfidentialPaymentChannelPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('confidential-payment-channel');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'confidential-payment-channel',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'confidential-payment-channel' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Confidential Payment Channel</h1>
