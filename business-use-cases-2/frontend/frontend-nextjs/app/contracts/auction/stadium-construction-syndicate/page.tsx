...
export default function StadiumConstructionSyndicatePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('stadium-construction-syndicate');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'stadium-construction-syndicate',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'stadium-construction-syndicate' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Stadium Construction Syndicate</h1>
