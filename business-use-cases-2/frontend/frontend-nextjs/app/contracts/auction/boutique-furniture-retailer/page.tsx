...
export default function BoutiqueFurnitureRetailerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('boutique-furniture-retailer');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'boutique-furniture-retailer',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'boutique-furniture-retailer' },
      });
