...
export default function TacticalOversightBureauPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-oversight-bureau');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-oversight-bureau',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-oversight-bureau' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Oversight Bureau</h1>
