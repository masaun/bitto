...
export default function EliteCoachContractLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('elite-coach-contract-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'elite-coach-contract-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'elite-coach-contract-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Elite Coach Contract Ledger</h1>
