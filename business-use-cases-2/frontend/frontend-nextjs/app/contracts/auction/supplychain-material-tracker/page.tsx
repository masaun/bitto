...
export default function SupplychainMaterialTrackerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('supplychain-material-tracker');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'supplychain-material-tracker',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'supplychain-material-tracker' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Supplychain Material Tracker</h1>
