...
export default function EnterpriseOrgHierarchyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('enterprise-org-hierarchy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'enterprise-org-hierarchy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'enterprise-org-hierarchy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Enterprise Org Hierarchy</h1>
