...
export default function PrefabStructureAssemblyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('prefab-structure-assembly');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'prefab-structure-assembly',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'prefab-structure-assembly' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Prefab Structure Assembly</h1>
