...
export default function IndustrialPlantConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('industrial-plant-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'industrial-plant-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'industrial-plant-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Industrial Plant Construction</h1>
