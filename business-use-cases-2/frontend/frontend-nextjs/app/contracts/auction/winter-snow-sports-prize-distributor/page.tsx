...
export default function WinterSnowSportsPrizeDistributorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('winter-snow-sports-prize-distributor');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'winter-snow-sports-prize-distributor',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'winter-snow-sports-prize-distributor' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Winter Snow Sports Prize Distributor</h1>
