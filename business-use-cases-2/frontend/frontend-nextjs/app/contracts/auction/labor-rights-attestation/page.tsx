...
export default function LaborRightsAttestationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('labor-rights-attestation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'labor-rights-attestation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'labor-rights-attestation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Labor Rights Attestation</h1>
