...
export default function InteriorFitoutRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('interior-fitout-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'interior-fitout-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'interior-fitout-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Interior Fitout Registry</h1>
