...
export default function CommercialComplexRegistryPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('commercial-complex-registry');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'commercial-complex-registry',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'commercial-complex-registry' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Commercial Complex Registry</h1>
