...
export default function AthleteSponsorshipMarketPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('athlete-sponsorship-market');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'athlete-sponsorship-market',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'athlete-sponsorship-market' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Athlete Sponsorship Market</h1>
