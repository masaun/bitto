...
export default function SoilRemediationProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('soil-remediation-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'soil-remediation-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'soil-remediation-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Soil Remediation Project</h1>
