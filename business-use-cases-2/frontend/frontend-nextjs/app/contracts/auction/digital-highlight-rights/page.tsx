...
export default function DigitalHighlightRightsPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('digital-highlight-rights');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'digital-highlight-rights',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'digital-highlight-rights' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Digital Highlight Rights</h1>
