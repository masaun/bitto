...
export default function AutoRenewalAuthorizationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('auto-renewal-authorization');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'auto-renewal-authorization',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'auto-renewal-authorization' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Auto Renewal Authorization</h1>
