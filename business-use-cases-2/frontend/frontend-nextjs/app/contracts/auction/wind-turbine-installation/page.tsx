...
export default function WindTurbineInstallationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('wind-turbine-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'wind-turbine-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'wind-turbine-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Wind Turbine Installation</h1>
