...
export default function ProjectLiquidDemocracyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('project-liquid-democracy');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'project-liquid-democracy',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'project-liquid-democracy' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Project Liquid Democracy</h1>
