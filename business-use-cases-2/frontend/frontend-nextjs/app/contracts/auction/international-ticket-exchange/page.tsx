...
export default function InternationalTicketExchangePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-ticket-exchange');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-ticket-exchange',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-ticket-exchange' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Ticket Exchange</h1>
