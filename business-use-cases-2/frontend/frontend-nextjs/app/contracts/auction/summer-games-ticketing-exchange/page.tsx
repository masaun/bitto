...
export default function SummerGamesTicketingExchangePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('summer-games-ticketing-exchange');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'summer-games-ticketing-exchange',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'summer-games-ticketing-exchange' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Summer Games Ticketing Exchange</h1>
