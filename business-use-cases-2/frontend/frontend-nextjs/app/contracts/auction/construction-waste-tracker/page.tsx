...
export default function ConstructionWasteTrackerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('construction-waste-tracker');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'construction-waste-tracker',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'construction-waste-tracker' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Construction Waste Tracker</h1>
