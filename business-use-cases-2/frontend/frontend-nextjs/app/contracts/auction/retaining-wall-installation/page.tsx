...
export default function RetainingWallInstallationPage() {
  ...
  const contractAddress = getContractAddress('retaining-wall-installation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'retaining-wall-installation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'retaining-wall-installation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Retaining Wall Installation</h1>
