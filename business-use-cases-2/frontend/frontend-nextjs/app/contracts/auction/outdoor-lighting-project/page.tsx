...
export default function OutdoorLightingProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('outdoor-lighting-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'outdoor-lighting-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'outdoor-lighting-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Outdoor Lighting Project</h1>
