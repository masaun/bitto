...
export default function TournamentVolunteerManagementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tournament-volunteer-management');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tournament-volunteer-management',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tournament-volunteer-management' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tournament Volunteer Management</h1>
