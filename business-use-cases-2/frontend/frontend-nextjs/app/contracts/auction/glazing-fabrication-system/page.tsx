...
export default function GlazingFabricationSystemPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('glazing-fabrication-system');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'glazing-fabrication-system',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'glazing-fabrication-system' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Glazing Fabrication System</h1>
