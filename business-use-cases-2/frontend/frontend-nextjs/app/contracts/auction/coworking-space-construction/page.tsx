...
export default function CoworkingSpaceConstructionPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('coworking-space-construction');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'coworking-space-construction',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'coworking-space-construction' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Coworking Space Construction</h1>
