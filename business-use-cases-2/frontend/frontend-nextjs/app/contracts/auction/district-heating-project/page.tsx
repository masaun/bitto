...
export default function DistrictHeatingProjectPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('district-heating-project');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'district-heating-project',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'district-heating-project' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>District Heating Project</h1>
