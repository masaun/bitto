...
export default function BiodiversityImpactMonitorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('biodiversity-impact-monitor');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'biodiversity-impact-monitor',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'biodiversity-impact-monitor' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Biodiversity Impact Monitor</h1>
