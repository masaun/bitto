...
export default function BroadbandInfrastructureLeasebackPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('broadband-infrastructure-leaseback');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'broadband-infrastructure-leaseback',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'broadband-infrastructure-leaseback' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Broadband Infrastructure Leaseback</h1>
