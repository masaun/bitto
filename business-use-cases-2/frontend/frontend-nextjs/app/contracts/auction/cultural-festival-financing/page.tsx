...
export default function CulturalFestivalFinancingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('cultural-festival-financing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'cultural-festival-financing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'cultural-festival-financing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Cultural Festival Financing</h1>
