...
export default function AgentEndOfLifePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('agent-end-of-life');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'agent-end-of-life',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'agent-end-of-life' },
      });
