...
export default function BespokeFurnitureCertificationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('bespoke-furniture-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'bespoke-furniture-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'bespoke-furniture-certification' },
      });
