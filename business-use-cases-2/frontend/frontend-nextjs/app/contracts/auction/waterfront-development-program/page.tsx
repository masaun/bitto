...
export default function WaterfrontDevelopmentProgramPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('waterfront-development-program');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'waterfront-development-program',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'waterfront-development-program' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Waterfront Development Program</h1>
