...
export default function AiContractNegotiatorPage() {
  ...
  const contractAddress = getContractAddress('ai-contract-negotiator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'ai-contract-negotiator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'ai-contract-negotiator' },
      });
