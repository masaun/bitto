...
export default function ValidatorPrivacyAttestationPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('validator-privacy-attestation');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'validator-privacy-attestation',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'validator-privacy-attestation' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Validator Privacy Attestation</h1>
