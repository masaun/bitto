...
export default function QuarryDevelopmentLedgerPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('quarry-development-ledger');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'quarry-development-ledger',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'quarry-development-ledger' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Quarry Development Ledger</h1>
