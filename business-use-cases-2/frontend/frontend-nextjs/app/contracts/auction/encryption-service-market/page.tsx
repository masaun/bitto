...
export default function EncryptionServiceMarketPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('encryption-service-market');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'encryption-service-market',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'encryption-service-market' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Encryption Service Market</h1>
