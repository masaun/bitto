...
export default function MascotLicensingRoyaltyPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('mascot-licensing-royalty');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'mascot-licensing-royalty',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'mascot-licensing-royalty' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Mascot Licensing Royalty</h1>
