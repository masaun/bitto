...
export default function InsurancePremiumRevenueValidatorPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('insurance-premium-revenue-validator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'insurance-premium-revenue-validator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'insurance-premium-revenue-validator' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Insurance Premium Revenue Validator</h1>
