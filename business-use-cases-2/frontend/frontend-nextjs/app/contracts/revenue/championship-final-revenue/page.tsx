...
export default function ChampionshipFinalRevenuePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('championship-final-revenue');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'championship-final-revenue',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'championship-final-revenue' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Championship Final Revenue</h1>
