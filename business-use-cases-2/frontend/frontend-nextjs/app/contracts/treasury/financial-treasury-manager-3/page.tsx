...
export default function FinancialTreasuryManager3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-treasury-manager-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-treasury-manager-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-treasury-manager-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Treasury Manager 3</h1>
