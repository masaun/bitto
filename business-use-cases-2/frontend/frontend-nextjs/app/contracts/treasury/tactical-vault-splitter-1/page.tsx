...
export default function TacticalVaultSplitter1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-vault-splitter-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-vault-splitter-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-vault-splitter-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Vault Splitter 1</h1>
