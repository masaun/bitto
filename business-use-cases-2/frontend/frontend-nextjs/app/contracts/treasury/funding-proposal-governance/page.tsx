...
export default function FundingProposalGovernancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('funding-proposal-governance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'funding-proposal-governance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'funding-proposal-governance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Funding Proposal Governance</h1>
