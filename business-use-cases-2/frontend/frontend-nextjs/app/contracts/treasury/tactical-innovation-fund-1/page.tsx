...
export default function TacticalInnovationFund1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-innovation-fund-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-innovation-fund-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-innovation-fund-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Innovation Fund 1</h1>
