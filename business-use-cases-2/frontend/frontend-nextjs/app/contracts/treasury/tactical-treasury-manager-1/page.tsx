...
export default function TacticalTreasuryManager1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-treasury-manager-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-treasury-manager-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-treasury-manager-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Treasury Manager 1</h1>
