...
export default function MunicipalCapitalPool7Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('municipal-capital-pool-7');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'municipal-capital-pool-7',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'municipal-capital-pool-7' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Municipal Capital Pool 7</h1>
