...
export default function GovernmentFundManager6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-fund-manager-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-fund-manager-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-fund-manager-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Fund Manager 6</h1>
