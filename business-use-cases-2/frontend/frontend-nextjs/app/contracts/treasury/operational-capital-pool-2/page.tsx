...
export default function OperationalCapitalPool2Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('operational-capital-pool-2');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'operational-capital-pool-2',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'operational-capital-pool-2' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Operational Capital Pool 2</h1>
