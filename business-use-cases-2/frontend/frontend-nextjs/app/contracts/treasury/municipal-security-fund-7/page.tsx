...
export default function MunicipalSecurityFund7Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('municipal-security-fund-7');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'municipal-security-fund-7',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'municipal-security-fund-7' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Municipal Security Fund 7</h1>
