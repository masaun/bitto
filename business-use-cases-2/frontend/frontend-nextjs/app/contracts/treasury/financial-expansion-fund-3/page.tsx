...
export default function FinancialExpansionFund3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-expansion-fund-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-expansion-fund-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-expansion-fund-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Expansion Fund 3</h1>
