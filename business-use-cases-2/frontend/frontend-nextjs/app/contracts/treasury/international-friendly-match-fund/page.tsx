...
export default function InternationalFriendlyMatchFundPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-friendly-match-fund');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-friendly-match-fund',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-friendly-match-fund' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Friendly Match Fund</h1>
