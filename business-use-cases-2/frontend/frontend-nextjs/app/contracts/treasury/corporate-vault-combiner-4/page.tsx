...
export default function CorporateVaultCombiner4Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('corporate-vault-combiner-4');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'corporate-vault-combiner-4',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'corporate-vault-combiner-4' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Corporate Vault Combiner 4</h1>
