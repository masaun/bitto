...
export default function TacticalStabilizationFund1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-stabilization-fund-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-stabilization-fund-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-stabilization-fund-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Stabilization Fund 1</h1>
