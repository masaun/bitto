...
export default function GovernmentLiquidityVault6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-liquidity-vault-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-liquidity-vault-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-liquidity-vault-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Liquidity Vault 6</h1>
