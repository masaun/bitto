...
export default function GovernmentCapitalPool6Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('government-capital-pool-6');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'government-capital-pool-6',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'government-capital-pool-6' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Government Capital Pool 6</h1>
