...
export default function TacticalLiquidityVault1Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('tactical-liquidity-vault-1');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'tactical-liquidity-vault-1',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'tactical-liquidity-vault-1' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Tactical Liquidity Vault 1</h1>
