...
export default function SnowVenueMaintenanceFundPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('snow-venue-maintenance-fund');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'snow-venue-maintenance-fund',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'snow-venue-maintenance-fund' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Snow Venue Maintenance Fund</h1>
