...
export default function FinancialSecurityFund3Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('financial-security-fund-3');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'financial-security-fund-3',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'financial-security-fund-3' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Financial Security Fund 3</h1>
