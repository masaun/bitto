...
export default function InstitutionalLiquidityVault5Page() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('institutional-liquidity-vault-5');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'institutional-liquidity-vault-5',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'institutional-liquidity-vault-5' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Institutional Liquidity Vault 5</h1>
