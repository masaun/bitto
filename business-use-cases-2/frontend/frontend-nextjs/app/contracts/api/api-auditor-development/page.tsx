...
export default function ApiAuditorDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-auditor-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-auditor-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-auditor-development' },
      });
