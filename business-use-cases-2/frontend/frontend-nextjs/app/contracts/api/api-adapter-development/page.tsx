...
export default function ApiAdapterDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-adapter-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-adapter-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-adapter-development' },
      });
