...
export default function ApiEncoderDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-encoder-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-encoder-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-encoder-development' },
      });
