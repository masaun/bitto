...
export default function ApiBridgeDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-bridge-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-bridge-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-bridge-development' },
      });
