...
export default function ApiDecoderDevelopmentPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('api-decoder-development');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'api-decoder-development',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'api-decoder-development' },
      });
