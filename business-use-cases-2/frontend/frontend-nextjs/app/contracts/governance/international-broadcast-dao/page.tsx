...
export default function InternationalBroadcastDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('international-broadcast-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'international-broadcast-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'international-broadcast-dao' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>International Broadcast Dao</h1>
