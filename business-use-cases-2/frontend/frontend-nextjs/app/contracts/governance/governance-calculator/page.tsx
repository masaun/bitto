...
export default function GovernanceCalculatorPage() {
  ...
  const contractAddress = getContractAddress('governance-calculator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'governance-calculator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'governance-calculator' },
      });
