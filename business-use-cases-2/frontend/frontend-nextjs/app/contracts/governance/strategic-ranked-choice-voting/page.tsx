...
export default function StrategicRankedChoiceVotingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('strategic-ranked-choice-voting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'strategic-ranked-choice-voting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'strategic-ranked-choice-voting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Strategic Ranked Choice Voting</h1>
