...
export default function DecentralizedPrivacyDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('decentralized-privacy-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'decentralized-privacy-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'decentralized-privacy-dao' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Decentralized Privacy Dao</h1>
