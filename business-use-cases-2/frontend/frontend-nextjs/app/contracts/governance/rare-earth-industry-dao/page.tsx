...
export default function RareEarthIndustryDaoPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('rare-earth-industry-dao');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'rare-earth-industry-dao',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'rare-earth-industry-dao' },
      });
