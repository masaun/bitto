...
export default function DivisionalRankedChoiceVotingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('divisional-ranked-choice-voting');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'divisional-ranked-choice-voting',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'divisional-ranked-choice-voting' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Divisional Ranked Choice Voting</h1>
