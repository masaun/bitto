...
export default function PrivacyUpgradeGovernancePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('privacy-upgrade-governance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'privacy-upgrade-governance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'privacy-upgrade-governance' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Privacy Upgrade Governance</h1>
