...
export default function AutomationCalculatorPage() {
  ...
  const contractAddress = getContractAddress('automation-calculator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'automation-calculator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'automation-calculator' },
      });
