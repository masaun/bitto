...
export default function GlobalSportsClearinghousePage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('global-sports-clearinghouse');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'global-sports-clearinghouse',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'global-sports-clearinghouse' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Global Sports Clearinghouse</h1>
