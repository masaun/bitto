...
export default function AutologousTreatmentSettlementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('autologous-treatment-settlement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'autologous-treatment-settlement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'autologous-treatment-settlement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Autologous Treatment Settlement</h1>
