...
export default function OfficialPartnerClearingPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('official-partner-clearing');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'official-partner-clearing',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'official-partner-clearing' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Official Partner Clearing</h1>
