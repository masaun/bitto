...
export default function SportsArbitrationSettlementPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('sports-arbitration-settlement');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'sports-arbitration-settlement',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'sports-arbitration-settlement' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Sports Arbitration Settlement</h1>
