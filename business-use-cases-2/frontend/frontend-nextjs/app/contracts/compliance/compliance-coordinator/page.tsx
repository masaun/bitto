...
export default function ComplianceCoordinatorPage() {
  ...
  const contractAddress = getContractAddress('compliance-coordinator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compliance-coordinator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compliance-coordinator' },
      });
