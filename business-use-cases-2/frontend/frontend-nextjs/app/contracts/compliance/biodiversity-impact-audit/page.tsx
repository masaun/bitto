...
export default function BiodiversityImpactAuditPage() {
  const [loading, setLoading] = useState(false);
  const [result, setResult] = useState<string | null>(null);
  const contractAddress = getContractAddress('biodiversity-impact-audit');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'biodiversity-impact-audit',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'biodiversity-impact-audit' },
      });
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      ...
      <h1>Biodiversity Impact Audit</h1>
