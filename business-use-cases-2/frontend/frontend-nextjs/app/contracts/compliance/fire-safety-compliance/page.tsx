...
export default function FireSafetyCompliancePage() {
  ...
  const contractAddress = getContractAddress('fire-safety-compliance');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'fire-safety-compliance',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'fire-safety-compliance' },
      });
