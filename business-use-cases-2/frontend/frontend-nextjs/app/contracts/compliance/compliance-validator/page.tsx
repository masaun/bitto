...
export default function ComplianceValidatorPage() {
  ...
  const contractAddress = getContractAddress('compliance-validator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compliance-validator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compliance-validator' },
      });
