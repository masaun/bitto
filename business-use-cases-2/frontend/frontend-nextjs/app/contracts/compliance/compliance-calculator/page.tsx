...
export default function ComplianceCalculatorPage() {
  ...
  const contractAddress = getContractAddress('compliance-calculator');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compliance-calculator',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compliance-calculator' },
      });
