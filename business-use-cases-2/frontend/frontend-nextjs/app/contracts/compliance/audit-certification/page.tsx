...
export default function AuditCertificationPage() {
  ...
  const contractAddress = getContractAddress('audit-certification');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'audit-certification',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'audit-certification' },
      });
