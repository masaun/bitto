...
export default function ComplianceVerifierPage() {
  ...
  const contractAddress = getContractAddress('compliance-verifier');
  ...
  const handleAction = async () => {
    ...
    try {
      await openContractCall({
        ...
        contractAddress,
        contractName: 'compliance-verifier',
        functionName: 'initialize',
        functionArgs: [],
        appDetails: { name: 'compliance-verifier' },
      });
