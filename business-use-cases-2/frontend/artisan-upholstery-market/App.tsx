...
export default function artisanUpholsteryMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Upholstery Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_UPHOLSTERY_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-upholstery-market';
  ...
  return (
    <div>
      <h1>Artisan Upholstery Market</h1>
