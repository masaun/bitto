...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HOMOMORPHIC_CALC_ADDRESS || '';

export default function Homomorphic_CalcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.homomorphic-calc/read-only/get-counter`,
        {
          method: 'GET',
