...
const CONTRACT_ADDRESS = process.env.DATA_DRIVEN_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'data-driven-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'data-driven-proactive-processor',
