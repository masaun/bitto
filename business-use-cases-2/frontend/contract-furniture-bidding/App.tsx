...
export default function contractFurnitureBidding() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Furniture Bidding',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_FURNITURE_BIDDING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-furniture-bidding';
  ...
  return (
    <div>
      <h1>Contract Furniture Bidding</h1>
