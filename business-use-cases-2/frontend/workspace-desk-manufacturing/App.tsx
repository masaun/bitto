...
export default function workspaceDeskManufacturing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Workspace Desk Manufacturing',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_DESK_MANUFACTURING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-desk-manufacturing';
  ...
  return (
    <div>
      <h1>Workspace Desk Manufacturing</h1>
