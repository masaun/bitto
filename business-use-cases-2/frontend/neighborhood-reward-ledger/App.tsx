...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_REWARD_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-reward-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Reward Ledger</h1>
