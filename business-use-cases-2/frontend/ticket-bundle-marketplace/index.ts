...
const CONTRACT_ADDRESS = process.env.TICKET_BUNDLE_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ticket-bundle-marketplace';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ticket Bundle Marketplace',
