...
export default function commercialSeatingLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Seating Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_SEATING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-seating-ledger';
  ...
  return (
    <div>
      <h1>Commercial Seating Ledger</h1>
