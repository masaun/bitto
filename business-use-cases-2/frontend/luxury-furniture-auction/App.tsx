...
export default function luxuryFurnitureAuction() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_FURNITURE_AUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-furniture-auction';
  ...
  return (
    <div>
      <h1>Luxury Furniture Auction</h1>
