...
const CONTRACT_ADDRESS = process.env.RENEWABLE_DIGITAL_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-digital-exchange';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-digital-exchange',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-digital-exchange</h1>
      {!userData ? (
