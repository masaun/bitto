...
const CONTRACT_ADDRESS = process.env.OTC_HAIRCUT_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-haircut-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-haircut-interest-rate-floor',
