...
const CONTRACT_ADDRESS = process.env.WAREHOUSE_LEASEBACK_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'warehouse-leaseback-vault';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'warehouse-leaseback-vault', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>warehouse-leaseback-vault</h1>
      {!userData ? (
