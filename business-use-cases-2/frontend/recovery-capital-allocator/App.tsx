...
const contractAddress = process.env.REACT_APP_RECOVERY_CAPITAL_ALLOCATOR_CONTRACT_ADDRESS || '';
const contractName = 'recovery-capital-allocator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>recovery capital allocator</h1>
