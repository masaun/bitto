...
const CONTRACT_ADDRESS = process.env.BRICK_MANUFACTURING_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'brick-manufacturing-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Brick Manufacturing Registry',
