...
const CONTRACT_ADDRESS = process.env.POULTRY_FARM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'poultry-farm-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'poultry-farm-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
