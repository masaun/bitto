...
const CONTRACT_ADDRESS = process.env.DELAYED_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'delayed-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'delayed-predictive-processor',
