...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_ENERGY_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-energy-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-energy-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-energy-market</h1>
      {!userData ? (
