...
export default function contractFurnitureSourcing() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Furniture Sourcing',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_FURNITURE_SOURCING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-furniture-sourcing';
  ...
  return (
    <div>
      <h1>Contract Furniture Sourcing</h1>
