...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_SERVICE_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-service-router';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'enterprise-service-router',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-service-router</h1>
      {!userData ? (
