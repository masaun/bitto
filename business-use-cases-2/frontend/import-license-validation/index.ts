...
const CONTRACT_ADDRESS = process.env.IMPORT_LICENSE_VALIDATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'import-license-validation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Import License Validation',
