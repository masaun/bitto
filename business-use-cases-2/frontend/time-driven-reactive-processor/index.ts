...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-reactive-processor',
