...
export default function bespokeDiningTableMaker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Dining Table Maker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_DINING_TABLE_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-dining-table-maker';
  ...
  return (
    <div>
      <h1>Bespoke Dining Table Maker</h1>
