...
export default function residentialContractFurniture() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Contract Furniture',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_CONTRACT_FURNITURE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-contract-furniture';
  ...
  return (
    <div>
      <h1>Residential Contract Furniture</h1>
