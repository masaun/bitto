...
export default function contractInteriorLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-interior-ledger';
  ...
  return (
    <div>
      <h1>Contract Interior Ledger</h1>
