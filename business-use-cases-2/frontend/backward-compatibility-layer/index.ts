...
const CONTRACT_ADDRESS = process.env.BACKWARD_COMPATIBILITY_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'backward-compatibility-layer';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'BackwardCompatibilityLayer',
