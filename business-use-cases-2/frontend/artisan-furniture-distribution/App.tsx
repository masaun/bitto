...
export default function artisanFurnitureDistribution() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furniture Distribution',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNITURE_DISTRIBUTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furniture-distribution';
  ...
  return (
    <div>
      <h1>Artisan Furniture Distribution</h1>
