...
const CONTRACT_ADDRESS = process.env.TOKENIZED_LOYALTY_REWARDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-loyalty-rewards';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-loyalty-rewards',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-loyalty-rewards</h1>
      {!userData ? (
