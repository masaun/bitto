...
const CONTRACT_ADDRESS = process.env.DATA_FARM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-farm-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'data-farm-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
