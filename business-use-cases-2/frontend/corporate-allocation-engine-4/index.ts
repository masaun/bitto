...
const CONTRACT_ADDRESS = process.env.CORPORATE_ALLOCATION_ENGINE_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-allocation-engine-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-allocation-engine-4',
