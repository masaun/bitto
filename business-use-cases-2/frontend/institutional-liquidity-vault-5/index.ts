...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_LIQUIDITY_VAULT_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-liquidity-vault-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-liquidity-vault-5',
