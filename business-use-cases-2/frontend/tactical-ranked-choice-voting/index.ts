...
const CONTRACT_ADDRESS = process.env.TACTICAL_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'tactical-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-ranked-choice-voting',
