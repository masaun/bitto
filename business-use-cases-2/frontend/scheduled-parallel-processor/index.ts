...
const CONTRACT_ADDRESS = process.env.SCHEDULED_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-parallel-processor',
