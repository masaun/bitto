...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_CONTENT_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-content-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-content-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-content-market</h1>
      {!userData ? (
