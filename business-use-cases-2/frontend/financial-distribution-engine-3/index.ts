...
const CONTRACT_ADDRESS = process.env.FINANCIAL_DISTRIBUTION_ENGINE_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-distribution-engine-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-distribution-engine-3',
