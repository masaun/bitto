...
const CONTRACT_ADDRESS = process.env.FINTECH_PAYMENT_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fintech-payment-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'fintech-payment-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>fintech-payment-settlement</h1>
      {!userData ? (
