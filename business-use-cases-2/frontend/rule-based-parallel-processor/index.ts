...
const CONTRACT_ADDRESS = process.env.RULE_BASED_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-parallel-processor',
