...
const CONTRACT_ADDRESS = process.env.SCHEDULED_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-proactive-processor',
