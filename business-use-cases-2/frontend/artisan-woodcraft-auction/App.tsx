...
export default function artisanWoodcraftAuction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Woodcraft Auction',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_WOODCRAFT_AUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-woodcraft-auction';
  ...
  return (
    <div>
      <h1>Artisan Woodcraft Auction</h1>
