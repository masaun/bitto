...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DEV_FUND_STREAM_ADDRESS || '';

export default function Dev_Fund_StreamPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dev-fund-stream/read-only/get-counter`,
        {
          method: 'GET',
