...
const contractAddress = process.env.REACT_APP_PAYMENT_CONDITION_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'payment-condition-engine';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Payment Condition Engine</h1>
