...
const CONTRACT_ADDRESS = process.env.COMMISSION_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'commission-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'commission-revenue-distributor',
