...
export default function urbanFurnitureRetail() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_URBAN_FURNITURE_RETAIL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'urban-furniture-retail';
