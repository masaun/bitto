...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PERPETUAL_FUTURE_ADDRESS || '';

export default function Perpetual_FuturePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.perpetual-future/read-only/get-counter`,
        {
          method: 'GET',
