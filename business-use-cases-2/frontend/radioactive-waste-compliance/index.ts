...
const CONTRACT_ADDRESS = process.env.RADIOACTIVE_WASTE_COMPLIANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'radioactive-waste-compliance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Radioactive Waste Compliance',
