...
export default function handcraftedFurnitureLogistics() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furniture Logistics',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNITURE_LOGISTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furniture-logistics';
  ...
  return (
    <div>
      <h1>Handcrafted Furniture Logistics</h1>
