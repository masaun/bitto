...
const contractAddress = process.env.REACT_APP_MERCHANT_ACTIVITY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'merchant-activity-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Merchant Activity Ledger</h1>
