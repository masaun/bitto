...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_RESEARCH_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-research-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-research-fund-5',
