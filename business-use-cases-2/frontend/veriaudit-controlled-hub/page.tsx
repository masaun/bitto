...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VERIAUDIT_CONTROLLED_HUB_ADDRESS || '';

export default function Veriaudit_Controlled_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.veriaudit-controlled-hub/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'veriaudit-controlled-hub',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>veriaudit-controlled-hub</h1>
