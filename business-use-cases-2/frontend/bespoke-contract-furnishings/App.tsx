...
export default function bespokeContractFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Contract Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_CONTRACT_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-contract-furnishings';
  ...
  return (
    <div>
      <h1>Bespoke Contract Furnishings</h1>
