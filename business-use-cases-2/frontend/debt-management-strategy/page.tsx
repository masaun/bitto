...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DEBT_MANAGEMENT_STRATEGY_ADDRESS || '';

export default function Debt_Management_StrategyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.debt-management-strategy/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'debt-management-strategy',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>debt-management-strategy</h1>
