...
const CONTRACT_ADDRESS = process.env.SMART_RETAIL_INTEGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-retail-integration';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-retail-integration</h1>
      {!userData ? (
