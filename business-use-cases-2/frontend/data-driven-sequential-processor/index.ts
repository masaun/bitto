...
const CONTRACT_ADDRESS = process.env.DATA_DRIVEN_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'data-driven-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'data-driven-sequential-processor',
