...
export default function furnitureWholesaleLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Wholesale Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_WHOLESALE_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-wholesale-ledger';
  ...
  return (
    <div>
      <h1>Furniture Wholesale Ledger</h1>
