...
const CONTRACT_ADDRESS = process.env.CLEANROOM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cleanroom-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cleanroom-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
