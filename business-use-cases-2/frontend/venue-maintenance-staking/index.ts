...
const CONTRACT_ADDRESS = process.env.VENUE_MAINTENANCE_STAKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'venue-maintenance-staking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Venue Maintenance Staking',
