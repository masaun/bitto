...
const contractAddress = process.env.REACT_APP_SUPPLIER_REPUTATION_SCORE_CONTRACT_ADDRESS || '';
const contractName = 'supplier-reputation-score';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Supplier Reputation Score',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Supplier Reputation Score</h1>
