...
const CONTRACT_ADDRESS = process.env.STADIUM_CONCESSIONS_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'stadium-concessions-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Stadium Concessions Settlement',
