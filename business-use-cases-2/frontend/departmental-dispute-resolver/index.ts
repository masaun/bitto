...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_DISPUTE_RESOLVER_ADDRESS || '';
const CONTRACT_NAME = 'departmental-dispute-resolver';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-dispute-resolver',
