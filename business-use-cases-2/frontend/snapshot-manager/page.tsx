...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SNAPSHOT_MANAGER_ADDRESS || '';

export default function Snapshot_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.snapshot-manager/read-only/get-counter`,
        {
          method: 'GET',
