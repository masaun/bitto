...
const contractAddress = process.env.REACT_APP_SCAFFOLD_MATERIAL_EXCHANGE_CONTRACT_ADDRESS || '';
const contractName = 'scaffold-material-exchange';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>scaffold material exchange</h1>
