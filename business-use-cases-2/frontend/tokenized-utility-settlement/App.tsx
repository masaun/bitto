...
const CONTRACT_ADDRESS = process.env.TOKENIZED_UTILITY_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-utility-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-utility-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-utility-settlement</h1>
      {!userData ? (
