...
const CONTRACT_ADDRESS = process.env.SOLVENT_EXTRACTION_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'solvent-extraction-tracking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Solvent Extraction Tracking',
