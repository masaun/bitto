...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SANDBOX_TEST_ENV_ADDRESS || '';

export default function Sandbox_Test_EnvPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sandbox-test-env/read-only/get-counter`,
        {
          method: 'GET',
