...
const CONTRACT_ADDRESS = process.env.TURBINE_MAGNET_TRACEABILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'turbine-magnet-traceability';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Turbine Magnet Traceability',
