...
const contractAddress = process.env.REACT_APP_PUBLIC_SPACE_REWARD_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'public-space-reward-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Public Space Reward Engine</h1>
