...
const CONTRACT_ADDRESS = process.env.AGENT_STATE_SYNCHRONIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-state-synchronization';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent State Synchronization',
