...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_DEPLOYMENT_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-deployment-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-deployment-fund-5',
