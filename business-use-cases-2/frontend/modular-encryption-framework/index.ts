...
const CONTRACT_ADDRESS = process.env.MODULAR_ENCRYPTION_FRAMEWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'modular-encryption-framework';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ModularEncryptionFramework',
