...
const CONTRACT_ADDRESS = process.env.LNG_TERMINAL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'lng-terminal-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'lng-terminal-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
