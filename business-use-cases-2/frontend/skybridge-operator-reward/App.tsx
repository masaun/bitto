...
const contractAddress = process.env.REACT_APP_SKYBRIDGE_OPERATOR_REWARD_CONTRACT_ADDRESS || '';
const contractName = 'skybridge-operator-reward';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>skyuridge operator reward</h1>
