...
export default function artisanFurnitureAuction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furniture Auction',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNITURE_AUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furniture-auction';
  ...
  return (
    <div>
      <h1>Artisan Furniture Auction</h1>
