...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-predictive-processor',
