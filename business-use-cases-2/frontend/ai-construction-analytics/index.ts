...
const CONTRACT_ADDRESS = process.env.AI_CONSTRUCTION_ANALYTICS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-construction-analytics';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ai Construction Analytics',
