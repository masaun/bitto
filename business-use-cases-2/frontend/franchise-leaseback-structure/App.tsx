...
const CONTRACT_ADDRESS = process.env.FRANCHISE_LEASEBACK_STRUCTURE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'franchise-leaseback-structure';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'franchise-leaseback-structure', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>franchise-leaseback-structure</h1>
      {!userData ? (
