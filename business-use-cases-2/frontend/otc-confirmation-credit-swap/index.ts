...
const CONTRACT_ADDRESS = process.env.OTC_CONFIRMATION_CREDIT_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-confirmation-credit-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-confirmation-credit-swap',
