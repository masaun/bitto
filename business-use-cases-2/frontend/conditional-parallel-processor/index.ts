...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-parallel-processor',
