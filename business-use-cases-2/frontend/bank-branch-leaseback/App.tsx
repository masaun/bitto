...
const CONTRACT_ADDRESS = process.env.BANK_BRANCH_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bank-branch-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'bank-branch-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
