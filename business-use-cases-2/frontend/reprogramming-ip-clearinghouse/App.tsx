...
const contractAddress = process.env.REACT_APP_REPROGRAMMING_IP_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const contractName = 'reprogramming-ip-clearinghouse';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>reprogramming ip clearinghouse</h1>
