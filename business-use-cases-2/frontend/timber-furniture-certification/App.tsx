...
export default function timberFurnitureCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Furniture Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FURNITURE_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-furniture-certification';
  ...
  return (
    <div>
      <h1>Timber Furniture Certification</h1>
