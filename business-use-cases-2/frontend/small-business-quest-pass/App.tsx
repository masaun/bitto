...
const contractAddress = process.env.REACT_APP_SMALL_BUSINESS_QUEST_PASS_CONTRACT_ADDRESS || '';
const contractName = 'small-business-quest-pass';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Small Business Quest Pass</h1>
