...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SWITCHBOARD_PUSH_ADDRESS || '';

export default function Switchboard_PushPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.switchboard-push/read-only/get-counter`,
        {
          method: 'GET',
