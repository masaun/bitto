...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-proactive-processor',
