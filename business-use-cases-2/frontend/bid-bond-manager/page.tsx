...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BID_BOND_MANAGER_ADDRESS || '';

export default function Bid_Bond_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bid-bond-manager/read-only/get-counter`,
        {
          method: 'GET',
