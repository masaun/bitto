...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_R3_CORDA_NOTARY_ADDRESS || '';

export default function R3_Corda_NotaryPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.r3-corda-notary/read-only/get-counter`,
        {
          method: 'GET',
