...
const CONTRACT_ADDRESS = process.env.METRO_SYSTEM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'metro-system-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'metro-system-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
