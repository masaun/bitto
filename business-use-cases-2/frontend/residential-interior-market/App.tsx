...
export default function residentialInteriorMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Interior Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_INTERIOR_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-interior-market';
  ...
  return (
    <div>
      <h1>Residential Interior Market</h1>
