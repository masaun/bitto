...
const contractAddress = process.env.REACT_APP_LOCAL_MERCHANT_REWARD_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'local-merchant-reward-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Merchant Reward Engine</h1>
