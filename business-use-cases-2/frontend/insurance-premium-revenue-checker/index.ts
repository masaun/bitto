...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_CHECKER_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-checker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-checker',
