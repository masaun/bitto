...
const CONTRACT_ADDRESS = process.env.OTC_COLLATERAL_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-collateral-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-collateral-interest-rate-cap',
