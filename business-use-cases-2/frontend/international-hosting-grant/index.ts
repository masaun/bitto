...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_HOSTING_GRANT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-hosting-grant';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Hosting Grant',
