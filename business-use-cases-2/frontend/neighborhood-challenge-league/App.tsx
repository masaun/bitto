...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_CHALLENGE_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-challenge-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Challenge League</h1>
