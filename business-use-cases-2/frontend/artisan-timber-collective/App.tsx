...
export default function artisanTimberCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Timber Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_TIMBER_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-timber-collective';
  ...
  return (
    <div>
      <h1>Artisan Timber Collective</h1>
