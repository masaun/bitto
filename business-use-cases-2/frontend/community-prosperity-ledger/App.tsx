...
const contractAddress = process.env.REACT_APP_COMMUNITY_PROSPERITY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'community-prosperity-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Prosperity Ledger</h1>
