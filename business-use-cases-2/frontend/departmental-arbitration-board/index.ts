...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_ARBITRATION_BOARD_ADDRESS || '';
const CONTRACT_NAME = 'departmental-arbitration-board';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-arbitration-board',
