...
const contractAddress = process.env.REACT_APP_CITY_TOURISM_GAMIFICATION_CONTRACT_ADDRESS || '';
const contractName = 'city-tourism-gamification';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>City Tourism Gamification</h1>
