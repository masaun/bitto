...
const contractAddress = process.env.REACT_APP_REPROGRAMMING_FACTOR_MARKETPLACE_CONTRACT_ADDRESS || '';
const contractName = 'reprogramming-factor-marketplace';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>reprogramming factor marketplace</h1>
