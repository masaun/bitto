...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PRIVACY_SHIELD_V1_ADDRESS || '';

export default function Privacy_Shield_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.privacy-shield-v1/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'privacy-shield-v1',
