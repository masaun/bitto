...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_RESOURCE_ALLOCATION_ADDRESS || '';

export default function Public_Resource_AllocationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-resource-allocation/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'public-resource-allocation',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>public-resource-allocation</h1>
