...
const CONTRACT_ADDRESS = process.env.RULE_BASED_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-pipeline-orchestrator',
