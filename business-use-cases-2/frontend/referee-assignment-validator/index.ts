...
const CONTRACT_ADDRESS = process.env.REFEREE_ASSIGNMENT_VALIDATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'referee-assignment-validator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Referee Assignment Validator',
