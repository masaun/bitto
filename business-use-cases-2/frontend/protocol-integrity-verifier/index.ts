...
const CONTRACT_ADDRESS = process.env.PROTOCOL_INTEGRITY_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'protocol-integrity-verifier';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ProtocolIntegrityVerifier',
