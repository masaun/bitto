...
export default function furnitureExportNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_EXPORT_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-export-network';
  ...
  return (
    <div>
      <h1>Furniture Export Network</h1>
