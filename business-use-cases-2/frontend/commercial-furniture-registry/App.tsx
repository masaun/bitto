...
export default function commercialFurnitureRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Furniture Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_FURNITURE_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-furniture-registry';
  ...
  return (
    <div>
      <h1>Commercial Furniture Registry</h1>
