...
const CONTRACT_ADDRESS = process.env.AI_OPERATIONAL_INTELLIGENCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-operational-intelligence';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'ai-operational-intelligence',
