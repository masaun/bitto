...
export default function residentialFurnitureMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Furniture Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_FURNITURE_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-furniture-market';
  ...
  return (
    <div>
      <h1>Residential Furniture Market</h1>
