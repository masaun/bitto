...
const CONTRACT_ADDRESS = process.env.REFINING_YIELD_ACCOUNTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'refining-yield-accounting';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Refining Yield Accounting',
