...
const CONTRACT_ADDRESS = process.env.ACCELERATOR_HUB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'accelerator-hub-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'accelerator-hub-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>accelerator-hub-leaseback</h1>
      {!userData ? (
