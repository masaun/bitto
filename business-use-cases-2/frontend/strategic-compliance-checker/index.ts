...
const CONTRACT_ADDRESS = process.env.STRATEGIC_COMPLIANCE_CHECKER_ADDRESS || '';
const CONTRACT_NAME = 'strategic-compliance-checker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-compliance-checker',
