...
const CONTRACT_ADDRESS = process.env.CROSSINDUSTRY_PAYMENT_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossindustry-payment-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossindustry-payment-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossindustry-payment-layer</h1>
      {!userData ? (
