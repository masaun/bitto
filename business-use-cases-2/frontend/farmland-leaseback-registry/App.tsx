...
const CONTRACT_ADDRESS = process.env.FARMLAND_LEASEBACK_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'farmland-leaseback-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'farmland-leaseback-registry', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>farmland-leaseback-registry</h1>
      {!userData ? (
