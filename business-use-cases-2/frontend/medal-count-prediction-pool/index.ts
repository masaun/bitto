...
const CONTRACT_ADDRESS = process.env.MEDAL_COUNT_PREDICTION_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'medal-count-prediction-pool';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Medal Count Prediction Pool',
