...
const CONTRACT_ADDRESS = process.env.OTC_CONFIRMATION_COMMODITY_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-confirmation-commodity-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-confirmation-commodity-swap',
