...
const CONTRACT_ADDRESS = process.env.CONSULATE_BUILDING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'consulate-building-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'consulate-building-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>consulate-building-leaseback</h1>
      {!userData ? (
