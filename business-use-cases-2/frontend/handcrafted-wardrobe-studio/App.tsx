...
export default function handcraftedWardrobeStudio() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Wardrobe Studio',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_WARDROBE_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-wardrobe-studio';
  ...
  return (
    <div>
      <h1>Handcrafted Wardrobe Studio</h1>
