...
export default function residentialFurnitureSupplier() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Furniture Supplier',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_FURNITURE_SUPPLIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-furniture-supplier';
  ...
  return (
    <div>
      <h1>Residential Furniture Supplier</h1>
