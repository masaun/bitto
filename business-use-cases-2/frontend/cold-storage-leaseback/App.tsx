...
const CONTRACT_ADDRESS = process.env.COLD_STORAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cold-storage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cold-storage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
