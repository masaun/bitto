...
const CONTRACT_ADDRESS = process.env.OTC_CLEARING_INTEREST_RATE_COLLAR_ADDRESS || '';
const CONTRACT_NAME = 'otc-clearing-interest-rate-collar';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-clearing-interest-rate-collar',
