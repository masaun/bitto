...
const CONTRACT_ADDRESS = process.env.MOBILITY_DATA_CLEARINGHOUSE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mobility-data-clearinghouse';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'mobility-data-clearinghouse',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>mobility-data-clearinghouse</h1>
      {!userData ? (
