...
const CONTRACT_ADDRESS = process.env.AGENT_HYPOTHESIS_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-hypothesis-tracking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent Hypothesis Tracking',
