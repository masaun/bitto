...
const CONTRACT_ADDRESS = process.env.ESCALATION_MANAGER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'escalation-manager-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'escalation-manager-dodd-frank',
