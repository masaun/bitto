...
const CONTRACT_ADDRESS = process.env.INFRASTRUCTURE_LEASEBACK_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'infrastructure-leaseback-hub';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'infrastructure-leaseback-hub', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>infrastructure-leaseback-hub</h1>
      {!userData ? (
