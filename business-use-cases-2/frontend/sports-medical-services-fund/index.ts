...
const CONTRACT_ADDRESS = process.env.SPORTS_MEDICAL_SERVICES_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-medical-services-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Medical Services Fund',
