...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_SPORTS_REVENUE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-sports-revenue';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Sports Revenue',
