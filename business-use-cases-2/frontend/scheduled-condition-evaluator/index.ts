...
const CONTRACT_ADDRESS = process.env.SCHEDULED_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-condition-evaluator',
