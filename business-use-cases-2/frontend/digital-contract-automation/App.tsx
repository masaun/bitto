...
const CONTRACT_ADDRESS = process.env.DIGITAL_CONTRACT_AUTOMATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-contract-automation';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-contract-automation',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-contract-automation</h1>
      {!userData ? (
