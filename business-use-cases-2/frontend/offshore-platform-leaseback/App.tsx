...
const CONTRACT_ADDRESS = process.env.OFFSHORE_PLATFORM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'offshore-platform-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'offshore-platform-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>offshore-platform-leaseback</h1>
      {!userData ? (
