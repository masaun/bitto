...
const CONTRACT_ADDRESS = process.env.CROSS_BORDER_BROADCAST_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-border-broadcast-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Cross Border Broadcast Auction',
