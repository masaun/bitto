...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_KEY_INFRA_ADDRESS || '';

export default function Public_Key_InfraPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-key-infra/read-only/get-counter`,
        {
          method: 'GET',
