...
const CONTRACT_ADDRESS = process.env.HOSPITAL_LEASEBACK_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hospital-leaseback-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hospital-leaseback-ledger', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>hospital-leaseback-ledger</h1>
      {!userData ? (
