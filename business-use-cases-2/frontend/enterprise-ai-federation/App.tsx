...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_AI_FEDERATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-ai-federation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-ai-federation</h1>
      {!userData ? (
