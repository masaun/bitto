...
const CONTRACT_ADDRESS = process.env.PORT_CRANE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'port-crane-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'port-crane-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
