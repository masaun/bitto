...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_SEARCH_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-search-index';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-search-index',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-search-index</h1>
      {!userData ? (
