...
export default function artisanChairmakerNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Chairmaker Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_CHAIRMAKER_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-chairmaker-network';
  ...
  return (
    <div>
      <h1>Artisan Chairmaker Network</h1>
