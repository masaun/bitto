...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MERKLE_TREE_ROOT_ADDRESS || '';

export default function Merkle_Tree_RootPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.merkle-tree-root/read-only/get-counter`,
        {
          method: 'GET',
