...
const CONTRACT_ADDRESS = process.env.AI_CLUSTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-cluster-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ai-cluster-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
