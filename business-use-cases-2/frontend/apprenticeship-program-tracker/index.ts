...
const CONTRACT_ADDRESS = process.env.APPRENTICESHIP_PROGRAM_TRACKER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'apprenticeship-program-tracker';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Apprenticeship Program Tracker',
