...
const CONTRACT_ADDRESS = process.env.CROSSINDUSTRY_ORACLE_HUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossindustry-oracle-hub';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossindustry-oracle-hub</h1>
      {!userData ? (
