...
export default function upholsteryMaterialTracker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Upholstery Material Tracker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_UPHOLSTERY_MATERIAL_TRACKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'upholstery-material-tracker';
  ...
  return (
    <div>
      <h1>Upholstery Material Tracker</h1>
