...
const contractAddress = process.env.REACT_APP_REGIONAL_ENGAGEMENT_INDEX_CONTRACT_ADDRESS || '';
const contractName = 'regional-engagement-index';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Engagement Index</h1>
