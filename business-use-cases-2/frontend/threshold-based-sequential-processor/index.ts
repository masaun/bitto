...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-sequential-processor',
