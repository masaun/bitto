...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_SIGNAL_MANAGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-signal-manager';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialSignalManager',
