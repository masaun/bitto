...
const CONTRACT_ADDRESS = process.env.COMMISSION_REVENUE_ESTIMATOR_ADDRESS || '';
const CONTRACT_NAME = 'commission-revenue-estimator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'commission-revenue-estimator',
