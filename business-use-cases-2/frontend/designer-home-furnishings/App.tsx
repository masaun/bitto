...
export default function designerHomeFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Designer Home Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DESIGNER_HOME_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'designer-home-furnishings';
  ...
  return (
    <div>
      <h1>Designer Home Furnishings</h1>
