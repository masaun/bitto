...
export default function contractSeatingLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_SEATING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-seating-ledger';
