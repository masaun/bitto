...
export default function premiumFurnitureNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Furniture Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_FURNITURE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-furniture-network';
  ...
  return (
    <div>
      <h1>Premium Furniture Network</h1>
