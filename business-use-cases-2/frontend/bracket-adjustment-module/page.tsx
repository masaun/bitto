...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BRACKET_ADJUSTMENT_MODULE_ADDRESS || '';

export default function Bracket_Adjustment_ModulePage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'bracket-adjustment-module',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bracket-adjustment-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'bracket-adjustment-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>bracket-adjustment-module</h1>
