...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_SPLITTER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-splitter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-splitter',
