...
const CONTRACT_ADDRESS = process.env.ASSET_MONETIZATION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asset-monetization-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'asset-monetization-engine', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>asset-monetization-engine</h1>
      {!userData ? (
