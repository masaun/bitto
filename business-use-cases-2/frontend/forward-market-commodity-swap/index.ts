...
const CONTRACT_ADDRESS = process.env.FORWARD_MARKET_COMMODITY_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'forward-market-commodity-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'forward-market-commodity-swap',
