...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_TASK_SCHEDULER_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-task-scheduler';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-task-scheduler',
