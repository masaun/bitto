...
const CONTRACT_ADDRESS = process.env.MERCHANDISING_ROYALTY_SPLITTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'merchandising-royalty-splitter';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Merchandising Royalty Splitter',
