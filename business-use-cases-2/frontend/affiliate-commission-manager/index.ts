...
const CONTRACT_ADDRESS = process.env.AFFILIATE_COMMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'affiliate-commission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'affiliate-commission-manager',
