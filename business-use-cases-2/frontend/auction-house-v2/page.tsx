...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AUCTION_HOUSE_V2_ADDRESS || '';

export default function Auction_House_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.auction-house-v2/read-only/get-counter`,
        {
          method: 'GET',
