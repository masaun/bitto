...
const CONTRACT_ADDRESS = process.env.TRACK_AND_FIELD_EQUIPMENT_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'track-and-field-equipment-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Track And Field Equipment Ledger',
