...
const contractAddress = process.env.REACT_APP_TOURISM_REWARD_ALLOCATION_CONTRACT_ADDRESS || '';
const contractName = 'tourism-reward-allocation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Reward Allocation</h1>
