...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BURN_MECHANISM_ADDRESS || '';

export default function Burn_MechanismPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.burn-mechanism/read-only/get-counter`,
        {
          method: 'GET',
