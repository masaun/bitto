...
const CONTRACT_ADDRESS = process.env.BUS_DEPOT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bus-depot-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'bus-depot-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
