...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CLEARPROOF_EXECUTION_HUB_ADDRESS || '';

export default function Clearproof_Execution_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.clearproof-execution-hub/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'clearproof-execution-hub',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>clearproof-execution-hub</h1>
