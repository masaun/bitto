...
export default function woodcraftTraceabilityLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Woodcraft Traceability Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WOODCRAFT_TRACEABILITY_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'woodcraft-traceability-ledger';
  ...
  return (
    <div>
      <h1>Woodcraft Traceability Ledger</h1>
