...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SBTC_COLLATERAL_ADDRESS || '';

export default function Sbtc_CollateralPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sbtc-collateral/read-only/get-counter`,
        {
          method: 'GET',
