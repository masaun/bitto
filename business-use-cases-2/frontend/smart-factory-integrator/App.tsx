...
const CONTRACT_ADDRESS = process.env.SMART_FACTORY_INTEGRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-factory-integrator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-factory-integrator</h1>
      {!userData ? (
