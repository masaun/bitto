...
const CONTRACT_ADDRESS = process.env.EMBEDDED_FINANCE_CONNECTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'embedded-finance-connector';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'embedded-finance-connector',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>embedded-finance-connector</h1>
      {!userData ? (
