...
const contractAddress = process.env.REACT_APP_REGIONAL_FESTIVAL_CHALLENGE_CONTRACT_ADDRESS || '';
const contractName = 'regional-festival-challenge';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Festival Challenge</h1>
