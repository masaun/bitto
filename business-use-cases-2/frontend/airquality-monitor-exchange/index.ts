...
const CONTRACT_ADDRESS = process.env.AIRQUALITY_MONITOR_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airquality-monitor-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Airquality Monitor Exchange',
