...
const contractAddress = process.env.REACT_APP_RETAIL_EXPERIENCE_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'retail-experience-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Retail Experience Engine</h1>
