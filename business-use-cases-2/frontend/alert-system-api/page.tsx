...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ALERT_SYSTEM_API_ADDRESS || '';

export default function Alert_System_ApiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.alert-system-api/read-only/get-counter`,
        {
          method: 'GET',
