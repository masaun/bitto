...
const CONTRACT_ADDRESS = process.env.STRATEGIC_PERMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'strategic-permission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-permission-manager',
