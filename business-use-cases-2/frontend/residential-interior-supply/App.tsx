...
export default function residentialInteriorSupply() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Interior Supply',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_INTERIOR_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-interior-supply';
  ...
  return (
    <div>
      <h1>Residential Interior Supply</h1>
