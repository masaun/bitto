...
const CONTRACT_ADDRESS = process.env.SMART_AGRICULTURE_INTEGRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-agriculture-integrator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'smart-agriculture-integrator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-agriculture-integrator</h1>
      {!userData ? (
