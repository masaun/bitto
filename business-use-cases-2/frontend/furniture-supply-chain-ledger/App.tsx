...
export default function furnitureSupplyChainLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Supply Chain Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_SUPPLY_CHAIN_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-supply-chain-ledger';
  ...
  return (
    <div>
      <h1>Furniture Supply Chain Ledger</h1>
