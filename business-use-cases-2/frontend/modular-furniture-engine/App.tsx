...
export default function modularFurnitureEngine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_FURNITURE_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-furniture-engine';
  ...
  return (
    <div>
      <h1>Modular Furniture Engine</h1>
