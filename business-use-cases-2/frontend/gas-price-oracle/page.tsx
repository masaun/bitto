...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAS_PRICE_ORACLE_ADDRESS || '';

export default function Gas_Price_OraclePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gas-price-oracle/read-only/get-counter`,
        {
          method: 'GET',
