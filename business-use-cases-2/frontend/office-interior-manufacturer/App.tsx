...
export default function officeInteriorManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Office Interior Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OFFICE_INTERIOR_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'office-interior-manufacturer';
  ...
  return (
    <div>
      <h1>Office Interior Manufacturer</h1>
