...
const CONTRACT_ADDRESS = process.env.ADVERTISING_SCREEN_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'advertising-screen-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'advertising-screen-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>advertising-screen-leaseback</h1>
      {!userData ? (
