...
export default function modularStorageSystems() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_STORAGE_SYSTEMS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-storage-systems';
