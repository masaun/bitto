...
const CONTRACT_ADDRESS = process.env.INSURANCE_OFFICE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'insurance-office-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'insurance-office-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>insurance-office-leaseback</h1>
      {!userData ? (
