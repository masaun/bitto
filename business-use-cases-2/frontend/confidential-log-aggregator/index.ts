...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_LOG_AGGREGATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-log-aggregator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialLogAggregator',
