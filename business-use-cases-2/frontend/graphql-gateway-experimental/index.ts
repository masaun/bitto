...
const CONTRACT_ADDRESS = process.env.GRAPHQL_GATEWAY_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'graphql-gateway-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'graphql-gateway-experimental',
