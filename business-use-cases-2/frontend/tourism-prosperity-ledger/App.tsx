...
const contractAddress = process.env.REACT_APP_TOURISM_PROSPERITY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'tourism-prosperity-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Prosperity Ledger</h1>
