...
const CONTRACT_ADDRESS = process.env.PRINTER_3D_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'printer-3d-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'printer-3d-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
