...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_EDUCATION_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-education-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-education-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-education-network</h1>
      {!userData ? (
