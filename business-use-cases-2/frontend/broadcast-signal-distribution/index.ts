...
const CONTRACT_ADDRESS = process.env.BROADCAST_SIGNAL_DISTRIBUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-signal-distribution';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcast Signal Distribution',
