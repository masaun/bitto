...
const CONTRACT_ADDRESS = process.env.RETAIL_STORE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'retail-store-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'retail-store-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
