...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EXPENDITURE_CEILING_MODULE_ADDRESS || '';

export default function Expenditure_Ceiling_ModulePage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'expenditure-ceiling-module',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.expenditure-ceiling-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'expenditure-ceiling-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>expenditure-ceiling-module</h1>
