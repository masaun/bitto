...
const CONTRACT_ADDRESS = process.env.AIRCRAFT_ENGINE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aircraft-engine-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'aircraft-engine-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>aircraft-engine-leaseback</h1>
      {!userData ? (
