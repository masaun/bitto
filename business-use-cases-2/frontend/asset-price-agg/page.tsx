...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ASSET_PRICE_AGG_ADDRESS || '';

export default function Asset_Price_AggPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.asset-price-agg/read-only/get-counter`,
        {
          method: 'GET',
