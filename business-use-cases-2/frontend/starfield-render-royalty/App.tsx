...
const contractAddress = process.env.REACT_APP_STARFIELD_RENDER_ROYALTY_CONTRACT_ADDRESS || '';
const contractName = 'starfield-render-royalty';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>starfield render royalty</h1>
