...
const CONTRACT_ADDRESS = process.env.REVIEW_COORDINATOR_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'review-coordinator-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'review-coordinator-dodd-frank',
