...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CHALLENGE_PERIOD_ADDRESS || '';

export default function Challenge_PeriodPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.challenge-period/read-only/get-counter`,
        {
          method: 'GET',
