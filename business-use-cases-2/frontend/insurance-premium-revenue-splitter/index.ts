...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_SPLITTER_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-splitter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-splitter',
