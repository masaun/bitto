...
const contractAddress = process.env.REACT_APP_MERCHANT_ACTIVATION_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'merchant-activation-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Merchant Activation Engine</h1>
