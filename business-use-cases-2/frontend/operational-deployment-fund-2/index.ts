...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_DEPLOYMENT_FUND_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-deployment-fund-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-deployment-fund-2',
