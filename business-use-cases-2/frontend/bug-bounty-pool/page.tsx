...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUG_BOUNTY_POOL_ADDRESS || '';

export default function Bug_Bounty_PoolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bug-bounty-pool/read-only/get-counter`,
        {
          method: 'GET',
