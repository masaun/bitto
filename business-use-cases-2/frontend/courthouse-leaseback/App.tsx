...
const CONTRACT_ADDRESS = process.env.COURTHOUSE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'courthouse-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'courthouse-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
