...
const CONTRACT_ADDRESS = process.env.WATER_TREATMENT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'water-treatment-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'water-treatment-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>water-treatment-leaseback</h1>
      {!userData ? (
