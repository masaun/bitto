...
const contractAddress = process.env.REACT_APP_PLURIVERSE_COLLABORATION_CONTRACT_ADDRESS || '';
const contractName = 'pluriverse-collaboration';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>pluriverse collauoration</h1>
