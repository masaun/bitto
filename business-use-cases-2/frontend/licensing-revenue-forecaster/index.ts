...
const CONTRACT_ADDRESS = process.env.LICENSING_REVENUE_FORECASTER_ADDRESS || '';
const CONTRACT_NAME = 'licensing-revenue-forecaster';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'licensing-revenue-forecaster',
