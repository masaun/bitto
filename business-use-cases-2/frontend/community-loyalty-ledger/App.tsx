...
const contractAddress = process.env.REACT_APP_COMMUNITY_LOYALTY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'community-loyalty-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Loyalty Ledger</h1>
