...
export default function artisanCabinetmakerLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Cabinetmaker Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_CABINETMAKER_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-cabinetmaker-ledger';
  ...
  return (
    <div>
      <h1>Artisan Cabinetmaker Ledger</h1>
