...
export default function timberCarpentryNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_CARPENTRY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-carpentry-network';
  ...
  return (
    <div>
      <h1>Timber Carpentry Network</h1>
