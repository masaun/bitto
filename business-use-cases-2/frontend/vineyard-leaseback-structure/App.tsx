...
const CONTRACT_ADDRESS = process.env.VINEYARD_LEASEBACK_STRUCTURE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'vineyard-leaseback-structure';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'vineyard-leaseback-structure', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>vineyard-leaseback-structure</h1>
      {!userData ? (
