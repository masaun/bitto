...
export default function decorRetailManagement() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_RETAIL_MANAGEMENT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-retail-management';
