...
const CONTRACT_ADDRESS = process.env.ART_MUSEUM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'art-museum-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'art-museum-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
