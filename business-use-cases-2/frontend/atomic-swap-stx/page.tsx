...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ATOMIC_SWAP_STX_ADDRESS || '';

export default function Atomic_Swap_StxPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.atomic-swap-stx/read-only/get-counter`,
        {
          method: 'GET',
