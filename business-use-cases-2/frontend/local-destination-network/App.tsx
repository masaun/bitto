...
const contractAddress = process.env.REACT_APP_LOCAL_DESTINATION_NETWORK_CONTRACT_ADDRESS || '';
const contractName = 'local-destination-network';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Destination Network</h1>
