...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_CAPITAL_POOL_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-capital-pool-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-capital-pool-5',
