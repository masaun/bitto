...
export default function highendCarpentryStudio() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HIGHEND_CARPENTRY_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'highend-carpentry-studio';
  ...
  return (
    <div>
      <h1>Highend Carpentry Studio</h1>
