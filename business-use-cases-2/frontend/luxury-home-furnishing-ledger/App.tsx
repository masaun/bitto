...
export default function luxuryHomeFurnishingLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Home Furnishing Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_HOME_FURNISHING_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-home-furnishing-ledger';
  ...
  return (
    <div>
      <h1>Luxury Home Furnishing Ledger</h1>
