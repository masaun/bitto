...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_MEDIA_RIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-media-rights';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Media Rights',
