...
export default function retailFurnitureBidding() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_FURNITURE_BIDDING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-furniture-bidding';
  ...
  return (
    <div>
      <h1>Retail Furniture Bidding</h1>
