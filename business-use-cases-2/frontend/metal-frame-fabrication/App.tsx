...
export default function metalFrameFabrication() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_METAL_FRAME_FABRICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'metal-frame-fabrication';
