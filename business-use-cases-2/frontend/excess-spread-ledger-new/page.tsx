...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EXCESS_SPREAD_LEDGER_NEW_ADDRESS || '';

export default function Excess_Spread_Ledger_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.excess-spread-ledger-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'excess-spread-ledger-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>excess-spread-ledger-new</h1>
