...
const contractAddress = process.env.REACT_APP_ORGANOGENESIS_RESEARCH_TOKEN_CONTRACT_ADDRESS || '';
const contractName = 'organogenesis-research-token';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>organogenesis research token</h1>
