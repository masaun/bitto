...
const CONTRACT_ADDRESS = process.env.LICENSING_COMMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'licensing-commission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'licensing-commission-manager',
