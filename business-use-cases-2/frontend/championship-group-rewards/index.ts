...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_GROUP_REWARDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-group-rewards';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Group Rewards',
