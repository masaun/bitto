...
const CONTRACT_ADDRESS = process.env.SWAP_MARKET_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'swap-market-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'swap-market-commodity-option',
