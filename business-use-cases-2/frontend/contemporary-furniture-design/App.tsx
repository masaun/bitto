...
export default function contemporaryFurnitureDesign() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contemporary Furniture Design',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTEMPORARY_FURNITURE_DESIGN_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contemporary-furniture-design';
  ...
  return (
    <div>
      <h1>Contemporary Furniture Design</h1>
