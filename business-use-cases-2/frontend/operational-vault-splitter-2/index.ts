...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_VAULT_SPLITTER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-vault-splitter-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-vault-splitter-2',
