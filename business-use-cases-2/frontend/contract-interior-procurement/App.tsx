...
export default function contractInteriorProcurement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Interior Procurement',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_INTERIOR_PROCUREMENT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-interior-procurement';
  ...
  return (
    <div>
      <h1>Contract Interior Procurement</h1>
