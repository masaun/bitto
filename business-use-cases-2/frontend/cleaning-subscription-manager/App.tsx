...
const contractAddress = process.env.REACT_APP_CLEANING_SUBSCRIPTION_MANAGER_CONTRACT_ADDRESS || '';
const contractName = 'cleaning-subscription-manager';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>cleaning suuscription manager</h1>
