...
export default function hardwoodTableManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hardwood Table Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HARDWOOD_TABLE_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hardwood-table-manufacturer';
  ...
  return (
    <div>
      <h1>Hardwood Table Manufacturer</h1>
