...
const CONTRACT_ADDRESS = process.env.TECH_PARK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tech-park-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'tech-park-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
