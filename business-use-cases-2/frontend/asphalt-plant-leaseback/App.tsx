...
const CONTRACT_ADDRESS = process.env.ASPHALT_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asphalt-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'asphalt-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
