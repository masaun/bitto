...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MERKLE_DISTRO_V2_ADDRESS || '';

export default function Merkle_Distro_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.merkle-distro-v2/read-only/get-counter`,
        {
          method: 'GET',
