...
const CONTRACT_ADDRESS = process.env.SMART_CONTRACT_LIFECYCLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-contract-lifecycle';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-contract-lifecycle</h1>
      {!userData ? (
