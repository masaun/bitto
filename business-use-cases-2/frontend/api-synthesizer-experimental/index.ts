...
const CONTRACT_ADDRESS = process.env.API_SYNTHESIZER_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'api-synthesizer-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'api-synthesizer-experimental',
