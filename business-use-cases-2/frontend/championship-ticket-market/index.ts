...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_TICKET_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-ticket-market';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Ticket Market',
