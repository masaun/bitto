...
const contractAddress = process.env.REACT_APP_QUAKEPROOF_SECURITIZATION_CONTRACT_ADDRESS || '';
const contractName = 'quakeproof-securitization';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>quakeproof securitization</h1>
