...
const contractAddress = process.env.REACT_APP_TISSUE_ENGINEERING_SYNDICATE_CONTRACT_ADDRESS || '';
const contractName = 'tissue-engineering-syndicate';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tissue engineering syndicate</h1>
