...
export default function premiumFurnitureLogistics() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Furniture Logistics',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_FURNITURE_LOGISTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-furniture-logistics';
  ...
  return (
    <div>
      <h1>Premium Furniture Logistics</h1>
