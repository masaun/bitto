...
const CONTRACT_ADDRESS = process.env.DELAYED_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'delayed-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'delayed-pipeline-orchestrator',
