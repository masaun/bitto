...
const contractAddress = process.env.REACT_APP_SANITATION_COMPLIANCE_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'sanitation-compliance-registry';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>sanitation compliance registry</h1>
