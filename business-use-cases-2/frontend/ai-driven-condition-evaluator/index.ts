...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-condition-evaluator',
