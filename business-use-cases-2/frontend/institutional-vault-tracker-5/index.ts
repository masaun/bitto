...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_TRACKER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-tracker-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-tracker-5',
