...
const contractAddress = process.env.REACT_APP_CONDITIONAL_PAYMENT_TEMPLATE_CONTRACT_ADDRESS || '';
const contractName = 'conditional-payment-template';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Conditional Payment Template',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Conditional Payment Template</h1>
