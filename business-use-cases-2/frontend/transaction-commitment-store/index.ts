...
const CONTRACT_ADDRESS = process.env.TRANSACTION_COMMITMENT_STORE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'transaction-commitment-store';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'TransactionCommitmentStore',
