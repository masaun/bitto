...
const CONTRACT_ADDRESS = process.env.AI_DEMAND_FORECAST_INPUTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-demand-forecast-inputs';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ai Demand Forecast Inputs',
