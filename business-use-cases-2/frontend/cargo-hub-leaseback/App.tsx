...
const CONTRACT_ADDRESS = process.env.CARGO_HUB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cargo-hub-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cargo-hub-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
