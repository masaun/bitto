...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOFT_PEG_MONITOR_ADDRESS || '';

export default function Soft_Peg_MonitorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.soft-peg-monitor/read-only/get-counter`,
        {
          method: 'GET',
