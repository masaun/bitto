...
const CONTRACT_ADDRESS = process.env.ATHLETE_BRAND_COLLABORATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-brand-collaboration';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Brand Collaboration',
