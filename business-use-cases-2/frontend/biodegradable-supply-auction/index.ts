...
const CONTRACT_ADDRESS = process.env.BIODEGRADABLE_SUPPLY_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'biodegradable-supply-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Biodegradable Supply Auction',
