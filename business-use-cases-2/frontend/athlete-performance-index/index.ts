...
const CONTRACT_ADDRESS = process.env.ATHLETE_PERFORMANCE_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-performance-index';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Performance Index',
