...
export default function artisanJoineryCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Joinery Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_JOINERY_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-joinery-certification';
  ...
  return (
    <div>
      <h1>Artisan Joinery Certification</h1>
