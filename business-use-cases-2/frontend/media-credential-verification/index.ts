...
const CONTRACT_ADDRESS = process.env.MEDIA_CREDENTIAL_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'media-credential-verification';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Media Credential Verification',
