...
const CONTRACT_ADDRESS = process.env.FINTECH_HQ_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fintech-hq-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fintech-hq-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
