...
export default function interiorSupplyRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_INTERIOR_SUPPLY_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'interior-supply-registry';
  ...
  return (
    <div>
      <h1>Interior Supply Registry</h1>
