...
const CONTRACT_ADDRESS = process.env.SCHEDULED_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-automation-manager',
