...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RISK_TRANCHE_B_ADDRESS || '';

export default function Risk_Tranche_BPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.risk-tranche-b/read-only/get-counter`,
        {
          method: 'GET',
