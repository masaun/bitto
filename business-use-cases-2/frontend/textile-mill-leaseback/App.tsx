...
const CONTRACT_ADDRESS = process.env.TEXTILE_MILL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'textile-mill-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'textile-mill-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
