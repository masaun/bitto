...
const CONTRACT_ADDRESS = process.env.DIGITAL_HEALTH_ANALYTICS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-health-analytics';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-health-analytics</h1>
      {!userData ? (
