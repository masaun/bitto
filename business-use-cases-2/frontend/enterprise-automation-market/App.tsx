...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_AUTOMATION_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-automation-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-automation-market</h1>
      {!userData ? (
