...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_JUST_IN_TIME_LIQ_ADDRESS || '';

export default function Just_In_Time_LiqPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.just-in-time-liq/read-only/get-counter`,
        {
          method: 'GET',
