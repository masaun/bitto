...
const CONTRACT_ADDRESS = process.env.ATHLETE_SPONSORSHIP_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-sponsorship-market';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Sponsorship Market',
