...
const CONTRACT_ADDRESS = process.env.PETROCHEMICAL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'petrochemical-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'petrochemical-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
