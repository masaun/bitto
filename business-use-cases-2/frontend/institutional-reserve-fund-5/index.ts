...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_RESERVE_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-reserve-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-reserve-fund-5',
