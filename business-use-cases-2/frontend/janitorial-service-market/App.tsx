...
const contractAddress = process.env.REACT_APP_JANITORIAL_SERVICE_MARKET_CONTRACT_ADDRESS || '';
const contractName = 'janitorial-service-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>janitorial service market</h1>
