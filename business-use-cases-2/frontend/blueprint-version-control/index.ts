...
const CONTRACT_ADDRESS = process.env.BLUEPRINT_VERSION_CONTROL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'blueprint-version-control';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Blueprint Version Control',
