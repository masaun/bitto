...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_TRANSACTION_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-transaction-router';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialTransactionRouter',
