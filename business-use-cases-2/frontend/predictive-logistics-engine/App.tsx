...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_LOGISTICS_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-logistics-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-logistics-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-logistics-engine</h1>
      {!userData ? (
