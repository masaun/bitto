...
export default function handcraftedLuxurySeating() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Luxury Seating',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_LUXURY_SEATING_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-luxury-seating';
  ...
  return (
    <div>
      <h1>Handcrafted Luxury Seating</h1>
