...
const CONTRACT_ADDRESS = process.env.COMPLIANCE_VERIFIER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'compliance-verifier-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'compliance-verifier-dodd-frank',
