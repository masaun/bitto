...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AUDITFLOW_PRIVATE_BRIDGE_ADDRESS || '';

export default function Auditflow_Private_BridgePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.auditflow-private-bridge/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'auditflow-private-bridge',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>auditflow-private-bridge</h1>
