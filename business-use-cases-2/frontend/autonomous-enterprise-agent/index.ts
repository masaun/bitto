...
const CONTRACT_ADDRESS = process.env.AUTONOMOUS_ENTERPRISE_AGENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'autonomous-enterprise-agent';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'AutonomousEnterpriseAgent',
