...
export default function furnitureLogisticsCoordinator() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Logistics Coordinator',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_LOGISTICS_COORDINATOR_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-logistics-coordinator';
  ...
  return (
    <div>
      <h1>Furniture Logistics Coordinator</h1>
