...
export default function artisanFurnitureSupply() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNITURE_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furniture-supply';
  ...
  return (
    <div>
      <h1>Artisan Furniture Supply</h1>
