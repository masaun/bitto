...
export default function luxuryHospitalityFurniture() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Hospitality Furniture',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_HOSPITALITY_FURNITURE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-hospitality-furniture';
