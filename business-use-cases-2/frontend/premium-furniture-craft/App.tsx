...
export default function premiumFurnitureCraft() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_FURNITURE_CRAFT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-furniture-craft';
