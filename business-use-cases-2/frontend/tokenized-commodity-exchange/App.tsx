...
const CONTRACT_ADDRESS = process.env.TOKENIZED_COMMODITY_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-commodity-exchange';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-commodity-exchange',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-commodity-exchange</h1>
      {!userData ? (
