...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROOF_OF_CUSTODY_ADDRESS || '';

export default function Proof_Of_CustodyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.proof-of-custody/read-only/get-counter`,
        {
          method: 'GET',
