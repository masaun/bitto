...
const CONTRACT_ADDRESS = process.env.DATA_DRIVEN_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'data-driven-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'data-driven-predictive-processor',
