...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_SPONSORSHIP_BUNDLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-sponsorship-bundle';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Sponsorship Bundle',
