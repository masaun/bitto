...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MINT_BURN_SYNC_ADDRESS || '';

export default function Mint_Burn_SyncPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.mint-burn-sync/read-only/get-counter`,
        {
          method: 'GET',
