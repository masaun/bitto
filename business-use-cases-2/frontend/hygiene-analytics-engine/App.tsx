...
const contractAddress = process.env.REACT_APP_HYGIENE_ANALYTICS_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'hygiene-analytics-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>hygiene analytics engine</h1>
