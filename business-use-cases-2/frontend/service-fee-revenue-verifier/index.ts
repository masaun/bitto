...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_VERIFIER_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-verifier';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-verifier',
