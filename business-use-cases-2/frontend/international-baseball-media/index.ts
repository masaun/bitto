...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_BASEBALL_MEDIA_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-baseball-media';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Baseball Media',
