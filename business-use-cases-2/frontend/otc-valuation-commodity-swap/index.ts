...
const CONTRACT_ADDRESS = process.env.OTC_VALUATION_COMMODITY_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-valuation-commodity-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-valuation-commodity-swap',
