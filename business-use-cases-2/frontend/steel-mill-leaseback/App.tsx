...
const CONTRACT_ADDRESS = process.env.STEEL_MILL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'steel-mill-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'steel-mill-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
