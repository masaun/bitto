...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_LOYALTY_GAME_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-loyalty-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Loyalty Game</h1>
