...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BLACK_SWAN_SIM_ADDRESS || '';

export default function Black_Swan_SimPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.black-swan-sim/read-only/get-counter`,
        {
          method: 'GET',
