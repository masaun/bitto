...
const CONTRACT_ADDRESS = process.env.BROADCAST_VAN_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-van-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'broadcast-van-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
