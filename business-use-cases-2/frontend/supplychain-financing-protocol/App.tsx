...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_FINANCING_PROTOCOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-financing-protocol';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-financing-protocol',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-financing-protocol</h1>
      {!userData ? (
