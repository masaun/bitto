...
const CONTRACT_ADDRESS = process.env.SECURITY_SYSTEM_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'security-system-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'security-system-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>security-system-leaseback</h1>
      {!userData ? (
