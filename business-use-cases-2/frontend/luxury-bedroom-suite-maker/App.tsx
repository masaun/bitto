...
export default function luxuryBedroomSuiteMaker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Bedroom Suite Maker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_BEDROOM_SUITE_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-bedroom-suite-maker';
  ...
  return (
    <div>
      <h1>Luxury Bedroom Suite Maker</h1>
