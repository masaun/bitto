...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_DEVELOPMENT_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-development-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-development-fund-6',
