...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ETHERFI_RESTAKE_ADDRESS || '';

export default function Etherfi_RestakePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.etherfi-restake/read-only/get-counter`,
        {
          method: 'GET',
