...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_RESOURCE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-resource-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-resource-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-resource-market</h1>
      {!userData ? (
