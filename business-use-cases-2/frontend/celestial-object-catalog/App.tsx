...
const contractAddress = process.env.REACT_APP_CELESTIAL_OBJECT_CATALOG_CONTRACT_ADDRESS || '';
const contractName = 'celestial-object-catalog';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>celestial ouject catalog</h1>
