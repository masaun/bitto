...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MONTE_CARLO_CALC_ADDRESS || '';

export default function Monte_Carlo_CalcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.monte-carlo-calc/read-only/get-counter`,
        {
          method: 'GET',
