...
export default function cabinetryInstallationSystem() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Cabinetry Installation System',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CABINETRY_INSTALLATION_SYSTEM_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'cabinetry-installation-system';
  ...
  return (
    <div>
      <h1>Cabinetry Installation System</h1>
