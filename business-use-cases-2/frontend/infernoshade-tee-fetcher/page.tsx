...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INFERNOSHADE_TEE_FETCHER_ADDRESS || '';

export default function Infernoshade_Tee_FetcherPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.infernoshade-tee-fetcher/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'infernoshade-tee-fetcher',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>infernoshade-tee-fetcher</h1>
