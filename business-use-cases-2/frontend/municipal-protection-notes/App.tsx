...
const contractAddress = process.env.REACT_APP_MUNICIPAL_PROTECTION_NOTES_CONTRACT_ADDRESS || '';
const contractName = 'municipal-protection-notes';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>municipal protection notes</h1>
