...
const contractAddress = process.env.REACT_APP_STARTUP_DISTRICT_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'startup-district-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Startup District Rewards</h1>
