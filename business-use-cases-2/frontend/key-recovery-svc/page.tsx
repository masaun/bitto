...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_KEY_RECOVERY_SVC_ADDRESS || '';

export default function Key_Recovery_SvcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.key-recovery-svc/read-only/get-counter`,
        {
          method: 'GET',
