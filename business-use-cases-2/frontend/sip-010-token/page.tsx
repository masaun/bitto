...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SIP_010_TOKEN_ADDRESS || '';

export default function Sip_010_TokenPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sip-010-token/read-only/get-counter`,
        {
          method: 'GET',
