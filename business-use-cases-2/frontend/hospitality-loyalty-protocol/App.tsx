...
const contractAddress = process.env.REACT_APP_HOSPITALITY_LOYALTY_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-loyalty-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Loyalty Protocol</h1>
