...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPGRADE_POLL_MGR_ADDRESS || '';

export default function Upgrade_Poll_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.upgrade-poll-mgr/read-only/get-counter`,
        {
          method: 'GET',
