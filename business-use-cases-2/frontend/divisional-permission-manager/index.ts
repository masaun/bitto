...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_PERMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'divisional-permission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-permission-manager',
