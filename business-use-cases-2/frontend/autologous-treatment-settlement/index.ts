...
const CONTRACT_ADDRESS = process.env.AUTOLOGOUS_TREATMENT_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'autologous-treatment-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Autologous Treatment Settlement',
