...
const CONTRACT_ADDRESS = process.env.AIRPORT_LEASEBACK_ARRANGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airport-leaseback-arrangement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'airport-leaseback-arrangement', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
