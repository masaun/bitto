...
const CONTRACT_ADDRESS = process.env.BRIDGE_LEASEBACK_ARRANGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bridge-leaseback-arrangement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'bridge-leaseback-arrangement', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>bridge-leaseback-arrangement</h1>
      {!userData ? (
