...
const CONTRACT_ADDRESS = process.env.MARINA_LEASEBACK_STRUCTURE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'marina-leaseback-structure';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'marina-leaseback-structure', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>marina-leaseback-structure</h1>
      {!userData ? (
