...
export default function outdoorPatioFabrication() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Outdoor Patio Fabrication',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_OUTDOOR_PATIO_FABRICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'outdoor-patio-fabrication';
  ...
  return (
    <div>
      <h1>Outdoor Patio Fabrication</h1>
