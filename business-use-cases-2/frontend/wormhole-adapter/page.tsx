...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WORMHOLE_ADAPTER_ADDRESS || '';

export default function Wormhole_AdapterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.wormhole-adapter/read-only/get-counter`,
        {
          method: 'GET',
