...
const CONTRACT_ADDRESS = process.env.TOKENIZED_INFRASTRUCTURE_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-infrastructure-fund';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-infrastructure-fund',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-infrastructure-fund</h1>
      {!userData ? (
