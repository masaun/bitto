...
const CONTRACT_ADDRESS = process.env.TOKENIZED_INSURANCE_POLICY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-insurance-policy';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-insurance-policy',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-insurance-policy</h1>
      {!userData ? (
