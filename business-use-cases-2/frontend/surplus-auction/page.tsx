...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SURPLUS_AUCTION_ADDRESS || '';

export default function Surplus_AuctionPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.surplus-auction/read-only/get-counter`,
        {
          method: 'GET',
