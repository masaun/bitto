...
const CONTRACT_ADDRESS = process.env.OTC_COUNTERPARTY_EQUITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-counterparty-equity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-counterparty-equity-option',
