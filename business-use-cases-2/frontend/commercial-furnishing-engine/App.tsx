...
export default function commercialFurnishingEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Furnishing Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_FURNISHING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-furnishing-engine';
  ...
  return (
    <div>
      <h1>Commercial Furnishing Engine</h1>
