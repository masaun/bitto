...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_DATA_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-data-exchange';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-data-exchange</h1>
      {!userData ? (
