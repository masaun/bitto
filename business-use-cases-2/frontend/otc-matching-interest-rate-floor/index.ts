...
const CONTRACT_ADDRESS = process.env.OTC_MATCHING_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-matching-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-matching-interest-rate-floor',
