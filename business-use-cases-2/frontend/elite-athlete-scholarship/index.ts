...
const CONTRACT_ADDRESS = process.env.ELITE_ATHLETE_SCHOLARSHIP_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'elite-athlete-scholarship';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Elite Athlete Scholarship',
