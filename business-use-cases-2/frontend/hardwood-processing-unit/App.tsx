...
export default function hardwoodProcessingUnit() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HARDWOOD_PROCESSING_UNIT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hardwood-processing-unit';
  ...
  return (
    <div>
      <h1>Hardwood Processing Unit</h1>
