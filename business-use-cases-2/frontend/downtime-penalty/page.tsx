...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DOWNTIME_PENALTY_ADDRESS || '';

export default function Downtime_PenaltyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.downtime-penalty/read-only/get-counter`,
        {
          method: 'GET',
