...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DIGITAL_ASSET_BACKED_LOAN_NEW_ADDRESS || '';

export default function Digital_Asset_Backed_Loan_NewPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'digital-asset-backed-loan-new',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.digital-asset-backed-loan-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'digital-asset-backed-loan-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>digital-asset-backed-loan-new</h1>
