...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-automation-manager',
