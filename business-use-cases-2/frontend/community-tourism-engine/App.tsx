...
const contractAddress = process.env.REACT_APP_COMMUNITY_TOURISM_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'community-tourism-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Tourism Engine</h1>
