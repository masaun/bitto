...
const contractAddress = process.env.REACT_APP_SUSTAINABLE_SHOPPING_QUEST_CONTRACT_ADDRESS || '';
const contractName = 'sustainable-shopping-quest';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Sustainable Shopping Quest</h1>
