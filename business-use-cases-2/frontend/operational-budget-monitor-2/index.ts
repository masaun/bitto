...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_BUDGET_MONITOR_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-budget-monitor-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-budget-monitor-2',
