...
const CONTRACT_ADDRESS = process.env.DIGITAL_PASSPORT_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-passport-verification';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Digital Passport Verification',
