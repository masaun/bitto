...
const CONTRACT_ADDRESS = process.env.TACTICAL_STABILIZATION_FUND_1_ADDRESS || '';
const CONTRACT_NAME = 'tactical-stabilization-fund-1';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-stabilization-fund-1',
