...
const CONTRACT_ADDRESS = process.env.RULE_BASED_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-sequential-processor',
