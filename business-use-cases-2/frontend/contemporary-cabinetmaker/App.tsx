...
export default function contemporaryCabinetmaker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contemporary Cabinetmaker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTEMPORARY_CABINETMAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contemporary-cabinetmaker';
  ...
  return (
    <div>
      <h1>Contemporary Cabinetmaker</h1>
