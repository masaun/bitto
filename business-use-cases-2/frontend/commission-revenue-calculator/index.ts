...
const CONTRACT_ADDRESS = process.env.COMMISSION_REVENUE_CALCULATOR_ADDRESS || '';
const CONTRACT_NAME = 'commission-revenue-calculator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'commission-revenue-calculator',
