...
export default function contractFurnitureNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Furniture Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_FURNITURE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-furniture-network';
  ...
  return (
    <div>
      <h1>Contract Furniture Network</h1>
