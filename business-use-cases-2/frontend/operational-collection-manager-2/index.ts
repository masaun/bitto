...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_COLLECTION_MANAGER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-collection-manager-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-collection-manager-2',
