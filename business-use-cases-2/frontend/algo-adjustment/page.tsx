...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ALGO_ADJUSTMENT_ADDRESS || '';

export default function Algo_AdjustmentPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.algo-adjustment/read-only/get-counter`,
        {
          method: 'GET',
