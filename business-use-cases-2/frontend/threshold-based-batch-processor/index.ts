...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_BATCH_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-batch-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-batch-processor',
