...
const CONTRACT_ADDRESS = process.env.GLOBAL_RANKING_POINTS_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-ranking-points-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Ranking Points Ledger',
