...
const CONTRACT_ADDRESS = process.env.CLOSING_SHOW_REVENUE_SHARE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'closing-show-revenue-share';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Closing Show Revenue Share',
