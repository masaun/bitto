...
const CONTRACT_ADDRESS = process.env.CNC_MACHINE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cnc-machine-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cnc-machine-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
