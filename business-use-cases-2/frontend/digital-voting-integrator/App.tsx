...
const CONTRACT_ADDRESS = process.env.DIGITAL_VOTING_INTEGRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-voting-integrator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-voting-integrator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-voting-integrator</h1>
      {!userData ? (
