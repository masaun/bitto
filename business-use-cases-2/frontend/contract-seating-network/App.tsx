...
export default function contractSeatingNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_SEATING_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-seating-network';
  ...
  return (
    <div>
      <h1>Contract Seating Network</h1>
