...
const contractAddress = process.env.REACT_APP_RECYCLING_INCENTIVE_POOL_CONTRACT_ADDRESS || '';
const contractName = 'recycling-incentive-pool';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>recycling incentive pool</h1>
