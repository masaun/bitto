...
const contractAddress = process.env.REACT_APP_ENTERTAINMENT_DISTRICT_PASS_CONTRACT_ADDRESS || '';
const contractName = 'entertainment-district-pass';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Entertainment District Pass</h1>
