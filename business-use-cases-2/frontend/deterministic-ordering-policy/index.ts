...
const CONTRACT_ADDRESS = process.env.DETERMINISTIC_ORDERING_POLICY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'deterministic-ordering-policy';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'DeterministicOrderingPolicy',
