...
const CONTRACT_ADDRESS = process.env.OPENCLAW_DATA_PERMISSIONING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-data-permissioning';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-data-permissioning',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-data-permissioning</h1>
      {!userData ? (
