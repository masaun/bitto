...
export default function retailInteriorSolutions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Retail Interior Solutions',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_INTERIOR_SOLUTIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-interior-solutions';
  ...
  return (
    <div>
      <h1>Retail Interior Solutions</h1>
