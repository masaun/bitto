...
const CONTRACT_ADDRESS = process.env.HOSPITALITY_LOYALTY_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hospitality-loyalty-program';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Hospitality Loyalty Program',
