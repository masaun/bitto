...
const CONTRACT_ADDRESS = process.env.BILATERAL_RESOURCE_TREATY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'bilateral-resource-treaty';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Bilateral Resource Treaty',
