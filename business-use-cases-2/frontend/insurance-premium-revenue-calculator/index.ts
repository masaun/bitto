...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_CALCULATOR_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-calculator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-calculator',
