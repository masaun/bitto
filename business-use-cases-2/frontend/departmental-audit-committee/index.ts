...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_AUDIT_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'departmental-audit-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-audit-committee',
