...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LAMBDA_INTEREST_ADDRESS || '';

export default function Lambda_InterestPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.lambda-interest/read-only/get-counter`,
        {
          method: 'GET',
