...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LOCK_DROP_EVENT_ADDRESS || '';

export default function Lock_Drop_EventPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.lock-drop-event/read-only/get-counter`,
        {
          method: 'GET',
