...
const CONTRACT_ADDRESS = process.env.INDUSTRIAL_DATA_ACCESS_CONTROL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'industrial-data-access-control';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Industrial Data Access Control',
