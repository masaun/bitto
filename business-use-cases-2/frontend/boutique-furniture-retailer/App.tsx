...
export default function boutiqueFurnitureRetailer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Boutique Furniture Retailer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BOUTIQUE_FURNITURE_RETAILER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'boutique-furniture-retailer';
  ...
  return (
    <div>
      <h1>Boutique Furniture Retailer</h1>
