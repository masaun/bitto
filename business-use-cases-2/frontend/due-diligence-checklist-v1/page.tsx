...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DUE_DILIGENCE_CHECKLIST_V1_ADDRESS || '';

export default function Due_Diligence_Checklist_V1Page() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'due-diligence-checklist-v1',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.due-diligence-checklist-v1/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'due-diligence-checklist-v1',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>due-diligence-checklist-v1</h1>
