...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_FORECAST_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-forecast-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-forecast-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-forecast-engine</h1>
      {!userData ? (
