...
const CONTRACT_ADDRESS = process.env.LEGACY_INFRASTRUCTURE_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'legacy-infrastructure-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Legacy Infrastructure Fund',
