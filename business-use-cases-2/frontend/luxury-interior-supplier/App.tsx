...
export default function luxuryInteriorSupplier() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_INTERIOR_SUPPLIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-interior-supplier';
  ...
  return (
    <div>
      <h1>Luxury Interior Supplier</h1>
