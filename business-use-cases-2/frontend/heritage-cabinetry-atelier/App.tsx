...
export default function heritageCabinetryAtelier() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Heritage Cabinetry Atelier',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HERITAGE_CABINETRY_ATELIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'heritage-cabinetry-atelier';
  ...
  return (
    <div>
      <h1>Heritage Cabinetry Atelier</h1>
