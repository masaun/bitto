...
export default function premiumWoodcraftIndex() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_WOODCRAFT_INDEX_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-woodcraft-index';
