...
const CONTRACT_ADDRESS = process.env.BREWERY_LEASEBACK_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'brewery-leaseback-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'brewery-leaseback-engine', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>brewery-leaseback-engine</h1>
      {!userData ? (
