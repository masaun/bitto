...
const contractAddress = process.env.REACT_APP_COMMUNITY_ENGAGEMENT_TOKEN_CONTRACT_ADDRESS || '';
const contractName = 'community-engagement-token';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Engagement Token</h1>
