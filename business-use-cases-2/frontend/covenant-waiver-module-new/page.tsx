...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COVENANT_WAIVER_MODULE_NEW_ADDRESS || '';

export default function Covenant_Waiver_Module_NewPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'covenant-waiver-module-new',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.covenant-waiver-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'covenant-waiver-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>covenant-waiver-module-new</h1>
