...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_VERIFIER_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-verifier';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-verifier',
