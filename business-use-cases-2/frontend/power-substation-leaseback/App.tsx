...
const CONTRACT_ADDRESS = process.env.POWER_SUBSTATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'power-substation-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'power-substation-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>power-substation-leaseback</h1>
      {!userData ? (
