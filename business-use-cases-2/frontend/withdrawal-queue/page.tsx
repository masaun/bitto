...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WITHDRAWAL_QUEUE_ADDRESS || '';

export default function Withdrawal_QueuePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.withdrawal-queue/read-only/get-counter`,
        {
          method: 'GET',
