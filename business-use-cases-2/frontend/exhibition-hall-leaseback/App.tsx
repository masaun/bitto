...
const CONTRACT_ADDRESS = process.env.EXHIBITION_HALL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'exhibition-hall-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'exhibition-hall-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>exhibition-hall-leaseback</h1>
      {!userData ? (
