...
export default function modernFurnitureCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Modern Furniture Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODERN_FURNITURE_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modern-furniture-collective';
  ...
  return (
    <div>
      <h1>Modern Furniture Collective</h1>
