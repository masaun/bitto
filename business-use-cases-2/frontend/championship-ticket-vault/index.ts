...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_TICKET_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-ticket-vault';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Ticket Vault',
