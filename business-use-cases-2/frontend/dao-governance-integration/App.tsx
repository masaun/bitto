...
const CONTRACT_ADDRESS = process.env.DAO_GOVERNANCE_INTEGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dao-governance-integration';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'dao-governance-integration',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>dao-governance-integration</h1>
      {!userData ? (
