...
const CONTRACT_ADDRESS = process.env.RARE_EARTH_EXTRACTION_OPERATIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rare-earth-extraction-operations';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Rare Earth Extraction Operations',
