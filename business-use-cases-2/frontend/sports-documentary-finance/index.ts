...
const CONTRACT_ADDRESS = process.env.SPORTS_DOCUMENTARY_FINANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-documentary-finance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Documentary Finance',
