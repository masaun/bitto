...
export default function bespokeInteriorNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_INTERIOR_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-interior-network';
  ...
  return (
    <div>
      <h1>Bespoke Interior Network</h1>
