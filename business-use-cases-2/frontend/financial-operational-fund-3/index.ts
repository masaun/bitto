...
const CONTRACT_ADDRESS = process.env.FINANCIAL_OPERATIONAL_FUND_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-operational-fund-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-operational-fund-3',
