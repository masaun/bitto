...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_PERMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'departmental-permission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-permission-manager',
