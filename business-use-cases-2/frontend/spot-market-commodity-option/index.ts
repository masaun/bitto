...
const CONTRACT_ADDRESS = process.env.SPOT_MARKET_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'spot-market-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'spot-market-commodity-option',
