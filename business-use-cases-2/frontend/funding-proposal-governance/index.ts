...
const CONTRACT_ADDRESS = process.env.FUNDING_PROPOSAL_GOVERNANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'funding-proposal-governance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Funding Proposal Governance',
