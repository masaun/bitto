...
const CONTRACT_ADDRESS = process.env.RECURRING_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'recurring-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-reactive-processor',
