...
export default function furnitureRetailAnalytics() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Retail Analytics',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_RETAIL_ANALYTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-retail-analytics';
