...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_ACTION_EXECUTOR_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-action-executor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-action-executor',
