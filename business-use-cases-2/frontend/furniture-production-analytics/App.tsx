...
export default function furnitureProductionAnalytics() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Production Analytics',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_PRODUCTION_ANALYTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-production-analytics';
  ...
  return (
    <div>
      <h1>Furniture Production Analytics</h1>
