...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AFFILIATE_PAYOUT_ADDRESS || '';

export default function Affiliate_PayoutPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.affiliate-payout/read-only/get-counter`,
        {
          method: 'GET',
