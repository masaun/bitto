...
const CONTRACT_ADDRESS = process.env.SCHEDULED_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-reactive-processor',
