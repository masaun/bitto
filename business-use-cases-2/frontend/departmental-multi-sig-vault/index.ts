...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_MULTI_SIG_VAULT_ADDRESS || '';
const CONTRACT_NAME = 'departmental-multi-sig-vault';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-multi-sig-vault',
