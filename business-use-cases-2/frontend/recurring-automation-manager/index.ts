...
const CONTRACT_ADDRESS = process.env.RECURRING_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'recurring-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-automation-manager',
