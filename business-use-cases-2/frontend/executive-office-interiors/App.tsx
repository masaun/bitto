...
export default function executiveOfficeInteriors() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Executive Office Interiors',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_EXECUTIVE_OFFICE_INTERIORS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'executive-office-interiors';
  ...
  return (
    <div>
      <h1>Executive Office Interiors</h1>
