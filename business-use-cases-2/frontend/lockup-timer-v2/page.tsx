...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LOCKUP_TIMER_V2_ADDRESS || '';

export default function Lockup_Timer_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.lockup-timer-v2/read-only/get-counter`,
        {
          method: 'GET',
