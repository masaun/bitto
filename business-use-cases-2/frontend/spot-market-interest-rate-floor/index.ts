...
const CONTRACT_ADDRESS = process.env.SPOT_MARKET_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'spot-market-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'spot-market-interest-rate-floor',
