...
const CONTRACT_ADDRESS = process.env.ADVERTISING_COMMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-commission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-commission-manager',
