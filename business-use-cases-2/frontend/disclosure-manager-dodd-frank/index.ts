...
const CONTRACT_ADDRESS = process.env.DISCLOSURE_MANAGER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'disclosure-manager-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'disclosure-manager-dodd-frank',
