...
const CONTRACT_ADDRESS = process.env.BILATERAL_NETTING_VARIANCE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'bilateral-netting-variance-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'bilateral-netting-variance-swap',
