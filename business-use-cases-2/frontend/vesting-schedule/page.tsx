...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VESTING_SCHEDULE_ADDRESS || '';

export default function Vesting_SchedulePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.vesting-schedule/read-only/get-counter`,
        {
          method: 'GET',
