...
const CONTRACT_ADDRESS = process.env.OTC_DESK_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-desk-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-desk-interest-rate-floor',
