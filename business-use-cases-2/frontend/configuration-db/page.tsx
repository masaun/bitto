...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONFIGURATION_DB_ADDRESS || '';

export default function Configuration_DbPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.configuration-db/read-only/get-counter`,
        {
          method: 'GET',
