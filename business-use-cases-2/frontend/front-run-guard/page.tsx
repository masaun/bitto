...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FRONT_RUN_GUARD_ADDRESS || '';

export default function Front_Run_GuardPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.front-run-guard/read-only/get-counter`,
        {
          method: 'GET',
