...
const CONTRACT_ADDRESS = process.env.FOOTBALL_STADIUM_UPGRADE_BOND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'football-stadium-upgrade-bond';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Football Stadium Upgrade Bond',
