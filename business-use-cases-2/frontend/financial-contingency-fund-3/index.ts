...
const CONTRACT_ADDRESS = process.env.FINANCIAL_CONTINGENCY_FUND_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-contingency-fund-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-contingency-fund-3',
