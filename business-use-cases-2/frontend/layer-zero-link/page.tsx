...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LAYER_ZERO_LINK_ADDRESS || '';

export default function Layer_Zero_LinkPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.layer-zero-link/read-only/get-counter`,
        {
          method: 'GET',
