...
const CONTRACT_ADDRESS = process.env.TOKENIZED_MEMBERSHIP_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-membership-system';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-membership-system',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-membership-system</h1>
      {!userData ? (
