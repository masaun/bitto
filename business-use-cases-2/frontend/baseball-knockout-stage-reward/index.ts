...
const CONTRACT_ADDRESS = process.env.BASEBALL_KNOCKOUT_STAGE_REWARD_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'baseball-knockout-stage-reward';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Baseball Knockout Stage Reward',
