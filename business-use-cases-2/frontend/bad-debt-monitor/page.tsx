...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BAD_DEBT_MONITOR_ADDRESS || '';

export default function Bad_Debt_MonitorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.bad-debt-monitor/read-only/get-counter`,
        {
          method: 'GET',
