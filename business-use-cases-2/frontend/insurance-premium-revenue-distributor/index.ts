...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-distributor',
