...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AMM_REAL_ESTATE_ADDRESS || '';

export default function Amm_Real_EstatePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.amm-real-estate/read-only/get-counter`,
        {
          method: 'GET',
