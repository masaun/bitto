...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_QUEUE_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-queue-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-queue-manager',
