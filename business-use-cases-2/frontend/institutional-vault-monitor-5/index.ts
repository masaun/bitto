...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_MONITOR_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-monitor-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-monitor-5',
