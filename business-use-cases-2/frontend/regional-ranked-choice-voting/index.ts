...
const CONTRACT_ADDRESS = process.env.REGIONAL_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'regional-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'regional-ranked-choice-voting',
