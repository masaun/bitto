...
const CONTRACT_ADDRESS = process.env.SCHEDULED_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-predictive-processor',
