...
export default function bespokeCabinetmakerNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Cabinetmaker Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_CABINETMAKER_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-cabinetmaker-network';
  ...
  return (
    <div>
      <h1>Bespoke Cabinetmaker Network</h1>
