...
const CONTRACT_ADDRESS = process.env.SUPPLY_DISRUPTION_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supply-disruption-monitoring';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Supply Disruption Monitoring',
