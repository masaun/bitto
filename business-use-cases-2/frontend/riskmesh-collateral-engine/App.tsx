...
const contractAddress = process.env.REACT_APP_RISKMESH_COLLATERAL_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'riskmesh-collateral-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>riskmesh collateral engine</h1>
