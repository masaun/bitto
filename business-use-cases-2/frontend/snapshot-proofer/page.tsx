...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SNAPSHOT_PROOFER_ADDRESS || '';

export default function Snapshot_ProoferPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.snapshot-proofer/read-only/get-counter`,
        {
          method: 'GET',
