...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ORDER_BOOK_DEX_ADDRESS || '';

export default function Order_Book_DexPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.order-book-dex/read-only/get-counter`,
        {
          method: 'GET',
