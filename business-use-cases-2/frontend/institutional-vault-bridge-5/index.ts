...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_BRIDGE_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-bridge-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-bridge-5',
