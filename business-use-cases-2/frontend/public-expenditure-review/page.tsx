...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_EXPENDITURE_REVIEW_ADDRESS || '';

export default function Public_Expenditure_ReviewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-expenditure-review/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'public-expenditure-review',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>public-expenditure-review</h1>
