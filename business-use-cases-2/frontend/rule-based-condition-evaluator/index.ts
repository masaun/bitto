...
const CONTRACT_ADDRESS = process.env.RULE_BASED_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-condition-evaluator',
