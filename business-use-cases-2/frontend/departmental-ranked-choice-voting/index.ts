...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'departmental-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-ranked-choice-voting',
