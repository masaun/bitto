...
const contractAddress = process.env.REACT_APP_VISITOR_EXPERIENCE_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'visitor-experience-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Visitor Experience Ledger</h1>
