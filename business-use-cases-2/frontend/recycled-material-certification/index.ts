...
const CONTRACT_ADDRESS = process.env.RECYCLED_MATERIAL_CERTIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'recycled-material-certification';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Recycled Material Certification',
