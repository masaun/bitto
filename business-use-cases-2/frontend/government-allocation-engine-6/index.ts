...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_ALLOCATION_ENGINE_6_ADDRESS || '';
const CONTRACT_NAME = 'government-allocation-engine-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-allocation-engine-6',
