...
const contractAddress = process.env.REACT_APP_REGIONAL_ATTRACTION_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'regional-attraction-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Attraction League</h1>
