...
const CONTRACT_ADDRESS = process.env.ATHLETE_COMMERCIAL_RIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-commercial-rights';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Commercial Rights',
