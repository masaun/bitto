...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_BUDGET_MANAGER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-budget-manager-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-budget-manager-5',
