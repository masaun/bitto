...
export default function residentialCarpentryNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Carpentry Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_CARPENTRY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-carpentry-network';
  ...
  return (
    <div>
      <h1>Residential Carpentry Network</h1>
