...
export default function heritageFurnitureBrand() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HERITAGE_FURNITURE_BRAND_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'heritage-furniture-brand';
  ...
  return (
    <div>
      <h1>Heritage Furniture Brand</h1>
