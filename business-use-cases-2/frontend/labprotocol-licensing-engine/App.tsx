...
const contractAddress = process.env.REACT_APP_LABPROTOCOL_LICENSING_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'labprotocol-licensing-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>lauprotocol licensing engine</h1>
