...
const CONTRACT_ADDRESS = process.env.CARGO_PLANE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cargo-plane-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'cargo-plane-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
