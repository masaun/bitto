...
const CONTRACT_ADDRESS = process.env.TACTICAL_STAKEHOLDER_COUNCIL_ADDRESS || '';
const CONTRACT_NAME = 'tactical-stakeholder-council';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-stakeholder-council',
