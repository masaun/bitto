...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WATCHTOWER_HIDDEN_RUNNER_ADDRESS || '';

export default function Watchtower_Hidden_RunnerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.watchtower-hidden-runner/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'watchtower-hidden-runner',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>watchtower-hidden-runner</h1>
