...
export default function contractFurnitureRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Furniture Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_FURNITURE_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-furniture-registry';
  ...
  return (
    <div>
      <h1>Contract Furniture Registry</h1>
