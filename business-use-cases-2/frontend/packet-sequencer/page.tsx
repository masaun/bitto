...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PACKET_SEQUENCER_ADDRESS || '';

export default function Packet_SequencerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.packet-sequencer/read-only/get-counter`,
        {
          method: 'GET',
