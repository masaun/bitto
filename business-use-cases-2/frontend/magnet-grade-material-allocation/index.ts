...
const CONTRACT_ADDRESS = process.env.MAGNET_GRADE_MATERIAL_ALLOCATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'magnet-grade-material-allocation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Magnet Grade Material Allocation',
