...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RHO_FORWARD_RATE_ADDRESS || '';

export default function Rho_Forward_RatePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.rho-forward-rate/read-only/get-counter`,
        {
          method: 'GET',
