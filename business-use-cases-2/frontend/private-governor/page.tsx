...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PRIVATE_GOVERNOR_ADDRESS || '';

export default function Private_GovernorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.private-governor/read-only/get-counter`,
        {
          method: 'GET',
