...
const CONTRACT_ADDRESS = process.env.CORPORATE_DISTRIBUTION_ENGINE_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-distribution-engine-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-distribution-engine-4',
