...
const CONTRACT_ADDRESS = process.env.ROYALTY_PAYMENT_DISTRIBUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'royalty-payment-distribution';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Royalty Payment Distribution',
