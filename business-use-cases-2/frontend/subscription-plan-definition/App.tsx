...
const contractAddress = process.env.REACT_APP_SUBSCRIPTION_PLAN_DEFINITION_CONTRACT_ADDRESS || '';
const contractName = 'subscription-plan-definition';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Subscription Plan Definition',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Subscription Plan Definition</h1>
