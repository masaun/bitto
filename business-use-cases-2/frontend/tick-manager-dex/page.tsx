...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TICK_MANAGER_DEX_ADDRESS || '';

export default function Tick_Manager_DexPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tick-manager-dex/read-only/get-counter`,
        {
          method: 'GET',
