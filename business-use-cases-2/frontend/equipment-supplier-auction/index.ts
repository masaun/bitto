...
const CONTRACT_ADDRESS = process.env.EQUIPMENT_SUPPLIER_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'equipment-supplier-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Equipment Supplier Auction',
