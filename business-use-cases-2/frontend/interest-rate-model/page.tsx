...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INTEREST_RATE_MODEL_ADDRESS || '';

export default function Interest_Rate_ModelPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.interest-rate-model/read-only/get-counter`,
        {
          method: 'GET',
