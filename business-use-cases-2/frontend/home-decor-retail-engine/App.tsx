...
export default function homeDecorRetailEngine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOME_DECOR_RETAIL_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'home-decor-retail-engine';
  ...
  return (
    <div>
      <h1>Home Decor Retail Engine</h1>
