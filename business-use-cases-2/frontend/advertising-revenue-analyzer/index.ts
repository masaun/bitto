...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_ANALYZER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-analyzer';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-analyzer',
