...
export default function bespokeInteriorFabricator() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Interior Fabricator',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_INTERIOR_FABRICATOR_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-interior-fabricator';
  ...
  return (
    <div>
      <h1>Bespoke Interior Fabricator</h1>
