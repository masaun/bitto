...
export default function commercialFitoutProvider() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Fitout Provider',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_FITOUT_PROVIDER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-fitout-provider';
  ...
  return (
    <div>
      <h1>Commercial Fitout Provider</h1>
