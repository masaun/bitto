...
export default function mattressProductionFacility() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Mattress Production Facility',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MATTRESS_PRODUCTION_FACILITY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'mattress-production-facility';
  ...
  return (
    <div>
      <h1>Mattress Production Facility</h1>
