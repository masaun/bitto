...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-proactive-processor',
