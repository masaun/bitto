...
const CONTRACT_ADDRESS = process.env.ACCESS_CONTROL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'access-control-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'access-control-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>access-control-leaseback</h1>
      {!userData ? (
