...
export default function premiumBedroomManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Bedroom Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_BEDROOM_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-bedroom-manufacturer';
  ...
  return (
    <div>
      <h1>Premium Bedroom Manufacturer</h1>
