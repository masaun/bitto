...
const contractAddress = process.env.REACT_APP_DOWNTOWN_LOYALTY_NETWORK_CONTRACT_ADDRESS || '';
const contractName = 'downtown-loyalty-network';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Downtown Loyalty Network</h1>
