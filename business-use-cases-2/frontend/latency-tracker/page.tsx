...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LATENCY_TRACKER_ADDRESS || '';

export default function Latency_TrackerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.latency-tracker/read-only/get-counter`,
        {
          method: 'GET',
