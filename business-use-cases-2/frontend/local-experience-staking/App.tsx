...
const contractAddress = process.env.REACT_APP_LOCAL_EXPERIENCE_STAKING_CONTRACT_ADDRESS || '';
const contractName = 'local-experience-staking';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Experience Staking</h1>
