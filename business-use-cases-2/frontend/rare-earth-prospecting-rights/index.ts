...
const CONTRACT_ADDRESS = process.env.RARE_EARTH_PROSPECTING_RIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rare-earth-prospecting-rights';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Rare Earth Prospecting Rights',
