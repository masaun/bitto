...
export default function hospitalityInteriorNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Interior Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_INTERIOR_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-interior-network';
  ...
  return (
    <div>
      <h1>Hospitality Interior Network</h1>
