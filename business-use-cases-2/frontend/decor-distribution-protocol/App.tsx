...
export default function decorDistributionProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Decor Distribution Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_DISTRIBUTION_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-distribution-protocol';
  ...
  return (
    <div>
      <h1>Decor Distribution Protocol</h1>
