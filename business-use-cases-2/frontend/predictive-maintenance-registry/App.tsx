...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_MAINTENANCE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-maintenance-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-maintenance-registry',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-maintenance-registry</h1>
      {!userData ? (
