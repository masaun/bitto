...
const CONTRACT_ADDRESS = process.env.STRUCTURED_LEASEBACK_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'structured-leaseback-fund';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'structured-leaseback-fund', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>structured-leaseback-fund</h1>
      {!userData ? (
