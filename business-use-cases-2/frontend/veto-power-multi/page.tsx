...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VETO_POWER_MULTI_ADDRESS || '';

export default function Veto_Power_MultiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.veto-power-multi/read-only/get-counter`,
        {
          method: 'GET',
