...
const CONTRACT_ADDRESS = process.env.PARKING_GARAGE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'parking-garage-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'parking-garage-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>parking-garage-leaseback</h1>
      {!userData ? (
