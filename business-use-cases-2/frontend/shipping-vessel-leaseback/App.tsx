...
const CONTRACT_ADDRESS = process.env.SHIPPING_VESSEL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'shipping-vessel-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'shipping-vessel-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>shipping-vessel-leaseback</h1>
      {!userData ? (
