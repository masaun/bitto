...
const CONTRACT_ADDRESS = process.env.ATHLETE_ENDORSEMENT_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-endorsement-marketplace';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Endorsement Marketplace',
