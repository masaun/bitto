...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_COMPLIANCE_CHECKER_ADDRESS || '';
const CONTRACT_NAME = 'divisional-compliance-checker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-compliance-checker',
