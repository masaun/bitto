...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_API_INTEGRATOR_ADDRESS || '';

export default function Api_IntegratorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.api-integrator/read-only/get-counter`,
        {
          method: 'GET',
