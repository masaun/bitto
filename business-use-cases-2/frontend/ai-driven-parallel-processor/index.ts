...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-parallel-processor',
