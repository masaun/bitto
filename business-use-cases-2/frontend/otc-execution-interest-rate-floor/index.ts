...
const CONTRACT_ADDRESS = process.env.OTC_EXECUTION_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-execution-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-execution-interest-rate-floor',
