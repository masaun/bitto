...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PERCENTAGE_CALC_ADDRESS || '';

export default function Percentage_CalcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.percentage-calc/read-only/get-counter`,
        {
          method: 'GET',
