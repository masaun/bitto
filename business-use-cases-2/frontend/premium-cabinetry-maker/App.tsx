...
export default function premiumCabinetryMaker() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_CABINETRY_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-cabinetry-maker';
