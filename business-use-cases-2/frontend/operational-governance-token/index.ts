...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_GOVERNANCE_TOKEN_ADDRESS || '';
const CONTRACT_NAME = 'operational-governance-token';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-governance-token',
