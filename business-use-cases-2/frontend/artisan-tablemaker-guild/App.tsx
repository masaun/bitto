...
export default function artisanTablemakerGuild() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_TABLEMAKER_GUILD_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-tablemaker-guild';
  ...
  return (
    <div>
      <h1>Artisan Tablemaker Guild</h1>
