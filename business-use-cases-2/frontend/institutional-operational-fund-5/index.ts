...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_OPERATIONAL_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-operational-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-operational-fund-5',
