...
export default function decorRetailSupply() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_RETAIL_SUPPLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-retail-supply';
