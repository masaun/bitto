...
const contractAddress = process.env.REACT_APP_DESTINATION_GROWTH_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'destination-growth-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Destination Growth Engine</h1>
