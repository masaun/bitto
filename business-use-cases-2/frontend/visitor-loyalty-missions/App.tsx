...
const contractAddress = process.env.REACT_APP_VISITOR_LOYALTY_MISSIONS_CONTRACT_ADDRESS || '';
const contractName = 'visitor-loyalty-missions';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Visitor Loyalty Missions</h1>
