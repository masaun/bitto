...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DONATION_TRACKER_ADDRESS || '';

export default function Donation_TrackerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.donation-tracker/read-only/get-counter`,
        {
          method: 'GET',
