...
const CONTRACT_ADDRESS = process.env.RULE_BASED_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-automation-manager',
