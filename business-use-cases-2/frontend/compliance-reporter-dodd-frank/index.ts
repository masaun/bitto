...
const CONTRACT_ADDRESS = process.env.COMPLIANCE_REPORTER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'compliance-reporter-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'compliance-reporter-dodd-frank',
