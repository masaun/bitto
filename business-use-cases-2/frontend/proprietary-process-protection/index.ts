...
const CONTRACT_ADDRESS = process.env.PROPRIETARY_PROCESS_PROTECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'proprietary-process-protection';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Proprietary Process Protection',
