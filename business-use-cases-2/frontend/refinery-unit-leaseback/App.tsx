...
const CONTRACT_ADDRESS = process.env.REFINERY_UNIT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'refinery-unit-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'refinery-unit-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
