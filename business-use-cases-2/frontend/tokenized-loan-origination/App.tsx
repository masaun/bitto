...
const CONTRACT_ADDRESS = process.env.TOKENIZED_LOAN_ORIGINATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-loan-origination';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-loan-origination',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-loan-origination</h1>
      {!userData ? (
