...
export default function residentialFurnishingProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Furnishing Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_FURNISHING_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-furnishing-protocol';
  ...
  return (
    <div>
      <h1>Residential Furnishing Protocol</h1>
