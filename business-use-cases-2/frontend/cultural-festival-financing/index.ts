...
const CONTRACT_ADDRESS = process.env.CULTURAL_FESTIVAL_FINANCING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cultural-festival-financing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Cultural Festival Financing',
