...
const CONTRACT_ADDRESS = process.env.THRESHOLD_ENCRYPTION_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'threshold-encryption-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ThresholdEncryptionRegistry',
