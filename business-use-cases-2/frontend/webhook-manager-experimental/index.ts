...
const CONTRACT_ADDRESS = process.env.WEBHOOK_MANAGER_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'webhook-manager-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'webhook-manager-experimental',
