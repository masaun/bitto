...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BIG_INT_HANDLER_ADDRESS || '';

export default function Big_Int_HandlerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.big-int-handler/read-only/get-counter`,
        {
          method: 'GET',
