...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CONSTANT_PRODUCT_ADDRESS || '';

export default function Constant_ProductPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.constant-product/read-only/get-counter`,
        {
          method: 'GET',
