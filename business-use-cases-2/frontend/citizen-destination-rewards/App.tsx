...
const contractAddress = process.env.REACT_APP_CITIZEN_DESTINATION_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'citizen-destination-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citizen Destination Rewards</h1>
