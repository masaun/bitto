...
const CONTRACT_ADDRESS = process.env.WAREHOUSE_RACK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'warehouse-rack-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'warehouse-rack-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>warehouse-rack-leaseback</h1>
      {!userData ? (
