...
const contractAddress = process.env.REACT_APP_EARTHQUAKE_YIELD_DISTRIBUTOR_CONTRACT_ADDRESS || '';
const contractName = 'earthquake-yield-distributor';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>earthquake yield distriuutor</h1>
