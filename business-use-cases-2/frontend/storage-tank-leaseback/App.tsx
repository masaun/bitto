...
const CONTRACT_ADDRESS = process.env.STORAGE_TANK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'storage-tank-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'storage-tank-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
