...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_TAX_COLLECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'government-tax-collection';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Government Tax Collection',
