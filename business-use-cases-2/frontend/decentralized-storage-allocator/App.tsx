...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_STORAGE_ALLOCATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-storage-allocator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-storage-allocator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-storage-allocator</h1>
      {!userData ? (
