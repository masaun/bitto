...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FIREBLOCKS_SYNC_ADDRESS || '';

export default function Fireblocks_SyncPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fireblocks-sync/read-only/get-counter`,
        {
          method: 'GET',
