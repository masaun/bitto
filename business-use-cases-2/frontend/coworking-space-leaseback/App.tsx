...
const CONTRACT_ADDRESS = process.env.COWORKING_SPACE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'coworking-space-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'coworking-space-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>coworking-space-leaseback</h1>
      {!userData ? (
