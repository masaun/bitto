...
const contractAddress = process.env.REACT_APP_LOCAL_CITY_TREASURE_HUNT_CONTRACT_ADDRESS || '';
const contractName = 'local-city-treasure-hunt';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local City Treasure Hunt</h1>
