...
const CONTRACT_ADDRESS = process.env.TOKENIZED_SUPPLY_VOUCHER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-supply-voucher';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-supply-voucher</h1>
      {!userData ? (
