...
const CONTRACT_ADDRESS = process.env.LONG_TERM_OFFTAKE_AGREEMENTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'long-term-offtake-agreements';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Long Term Offtake Agreements',
