...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_EXAMINER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-examiner';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-examiner',
