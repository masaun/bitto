...
export default function handcraftedDiningCollection() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_DINING_COLLECTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-dining-collection';
  ...
  return (
    <div>
      <h1>Handcrafted Dining Collection</h1>
