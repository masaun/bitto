...
export default function commercialSeatingSolutions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Commercial Seating Solutions',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_COMMERCIAL_SEATING_SOLUTIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'commercial-seating-solutions';
  ...
  return (
    <div>
      <h1>Commercial Seating Solutions</h1>
