...
const CONTRACT_ADDRESS = process.env.AIRPORT_EXPANSION_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airport-expansion-coordinator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Airport Expansion Coordinator',
