...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_MANAGER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-manager-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-manager-5',
