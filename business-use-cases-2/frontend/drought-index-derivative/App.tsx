...
const contractAddress = process.env.REACT_APP_DROUGHT_INDEX_DERIVATIVE_CONTRACT_ADDRESS || '';
const contractName = 'drought-index-derivative';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>drought index derivative</h1>
