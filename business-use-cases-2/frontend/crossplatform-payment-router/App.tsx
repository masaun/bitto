...
const CONTRACT_ADDRESS = process.env.CROSSPLATFORM_PAYMENT_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossplatform-payment-router';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossplatform-payment-router',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossplatform-payment-router</h1>
      {!userData ? (
