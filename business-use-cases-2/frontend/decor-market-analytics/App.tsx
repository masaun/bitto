...
export default function decorMarketAnalytics() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_MARKET_ANALYTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-market-analytics';
