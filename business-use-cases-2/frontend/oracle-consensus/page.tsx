...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ORACLE_CONSENSUS_ADDRESS || '';

export default function Oracle_ConsensusPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.oracle-consensus/read-only/get-counter`,
        {
          method: 'GET',
