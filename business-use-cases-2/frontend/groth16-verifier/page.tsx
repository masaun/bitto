...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GROTH16_VERIFIER_ADDRESS || '';

export default function Groth16_VerifierPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.groth16-verifier/read-only/get-counter`,
        {
          method: 'GET',
