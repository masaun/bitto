...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_REPORTER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-reporter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-reporter',
