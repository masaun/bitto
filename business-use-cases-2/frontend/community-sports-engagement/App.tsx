...
const contractAddress = process.env.REACT_APP_COMMUNITY_SPORTS_ENGAGEMENT_CONTRACT_ADDRESS || '';
const contractName = 'community-sports-engagement';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Sports Engagement</h1>
