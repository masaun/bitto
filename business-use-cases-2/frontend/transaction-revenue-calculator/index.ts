...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_CALCULATOR_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-calculator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-calculator',
