...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ARCHITECTURAL_REVIEW_BOT_ADDRESS || '';

export default function Architectural_Review_BotPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.architectural-review-bot/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'architectural-review-bot',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>architectural-review-bot</h1>
