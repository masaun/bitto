...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_HEALTH_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-health-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-health-engine</h1>
      {!userData ? (
