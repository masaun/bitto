...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_PROPOSAL_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-proposal-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialProposalEngine',
