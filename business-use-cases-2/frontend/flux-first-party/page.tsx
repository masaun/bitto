...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FLUX_FIRST_PARTY_ADDRESS || '';

export default function Flux_First_PartyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.flux-first-party/read-only/get-counter`,
        {
          method: 'GET',
