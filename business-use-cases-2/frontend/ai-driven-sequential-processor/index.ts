...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-sequential-processor',
