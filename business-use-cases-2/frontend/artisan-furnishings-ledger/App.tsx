...
export default function artisanFurnishingsLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furnishings Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNISHINGS_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furnishings-ledger';
  ...
  return (
    <div>
      <h1>Artisan Furnishings Ledger</h1>
