...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EB5_VISA_TRACKER_ADDRESS || '';

export default function Eb5_Visa_TrackerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.eb5-visa-tracker/read-only/get-counter`,
        {
          method: 'GET',
