...
const CONTRACT_ADDRESS = process.env.DIGITAL_SUPPLYCHAIN_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-supplychain-layer';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-supplychain-layer',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-supplychain-layer</h1>
      {!userData ? (
