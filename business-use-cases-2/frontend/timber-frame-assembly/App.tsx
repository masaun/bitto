...
export default function timberFrameAssembly() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FRAME_ASSEMBLY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-frame-assembly';
