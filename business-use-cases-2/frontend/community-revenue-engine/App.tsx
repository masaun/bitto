...
const contractAddress = process.env.REACT_APP_COMMUNITY_REVENUE_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'community-revenue-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Revenue Engine</h1>
