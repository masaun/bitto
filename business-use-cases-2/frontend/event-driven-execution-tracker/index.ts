...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_EXECUTION_TRACKER_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-execution-tracker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-execution-tracker',
