...
const CONTRACT_ADDRESS = process.env.NAVAL_YARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'naval-yard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'naval-yard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
