...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STRESS_TEST_TOOL_ADDRESS || '';

export default function Stress_Test_ToolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.stress-test-tool/read-only/get-counter`,
        {
          method: 'GET',
