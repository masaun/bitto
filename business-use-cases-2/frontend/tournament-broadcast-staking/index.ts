...
const CONTRACT_ADDRESS = process.env.TOURNAMENT_BROADCAST_STAKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tournament-broadcast-staking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Tournament Broadcast Staking',
