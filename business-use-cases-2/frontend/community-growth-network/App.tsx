...
const contractAddress = process.env.REACT_APP_COMMUNITY_GROWTH_NETWORK_CONTRACT_ADDRESS || '';
const contractName = 'community-growth-network';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Growth Network</h1>
