...
export default function furnitureDistributionNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Distribution Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_DISTRIBUTION_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-distribution-network';
  ...
  return (
    <div>
      <h1>Furniture Distribution Network</h1>
