...
const CONTRACT_ADDRESS = process.env.COLOCATION_SITE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'colocation-site-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'colocation-site-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>colocation-site-leaseback</h1>
      {!userData ? (
