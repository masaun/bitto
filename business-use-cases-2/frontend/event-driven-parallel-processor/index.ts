...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-parallel-processor',
