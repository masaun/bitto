...
const CONTRACT_ADDRESS = process.env.ANTI_DOPING_COMPLIANCE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'anti-doping-compliance-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Anti Doping Compliance Registry',
