...
export default function artisanInteriorCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Interior Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_INTERIOR_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-interior-collective';
  ...
  return (
    <div>
      <h1>Artisan Interior Collective</h1>
