...
const CONTRACT_ADDRESS = process.env.AI_RISK_ASSESSMENT_MODULE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-risk-assessment-module';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'ai-risk-assessment-module',
