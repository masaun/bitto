...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RHO_STAKING_V2_ADDRESS || '';

export default function Rho_Staking_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.rho-staking-v2/read-only/get-counter`,
        {
          method: 'GET',
