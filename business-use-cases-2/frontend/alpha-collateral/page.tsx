...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ALPHA_COLLATERAL_ADDRESS || '';

export default function Alpha_CollateralPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.alpha-collateral/read-only/get-counter`,
        {
          method: 'GET',
