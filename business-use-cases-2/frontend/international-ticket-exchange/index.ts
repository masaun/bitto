...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_TICKET_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-ticket-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Ticket Exchange',
