...
const contractAddress = process.env.REACT_APP_STARGAZER_MEMBERSHIP_PASS_CONTRACT_ADDRESS || '';
const contractName = 'stargazer-membership-pass';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>stargazer memuership pass</h1>
