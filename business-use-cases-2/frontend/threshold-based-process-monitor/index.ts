...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_PROCESS_MONITOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-process-monitor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-process-monitor',
