...
export default function furnitureCraftsmanshipIndex() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Furniture Craftsmanship Index',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_CRAFTSMANSHIP_INDEX_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-craftsmanship-index';
  ...
  return (
    <div>
      <h1>Furniture Craftsmanship Index</h1>
