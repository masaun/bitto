...
const CONTRACT_ADDRESS = process.env.AI_DATACENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-datacenter-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ai-datacenter-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
