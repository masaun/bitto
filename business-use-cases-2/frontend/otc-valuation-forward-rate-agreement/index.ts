...
const CONTRACT_ADDRESS = process.env.OTC_VALUATION_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'otc-valuation-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-valuation-forward-rate-agreement',
