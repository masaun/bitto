...
const CONTRACT_ADDRESS = process.env.AGENT_CHAIN_OF_THOUGHT_HASH_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-chain-of-thought-hash';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent Chain Of Thought Hash',
