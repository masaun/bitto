...
const CONTRACT_ADDRESS = process.env.PAPER_MILL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'paper-mill-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'paper-mill-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
