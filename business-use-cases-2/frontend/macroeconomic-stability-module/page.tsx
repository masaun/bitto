...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MACROECONOMIC_STABILITY_MODULE_ADDRESS || '';

export default function Macroeconomic_Stability_ModulePage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'macroeconomic-stability-module',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.macroeconomic-stability-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'macroeconomic-stability-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>macroeconomic-stability-module</h1>
