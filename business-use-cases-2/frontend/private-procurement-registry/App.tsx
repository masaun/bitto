...
const contractAddress = process.env.REACT_APP_PRIVATE_PROCUREMENT_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'private-procurement-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Private Procurement Registry',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Private Procurement Registry</h1>
