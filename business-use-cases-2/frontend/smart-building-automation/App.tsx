...
const CONTRACT_ADDRESS = process.env.SMART_BUILDING_AUTOMATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-building-automation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-building-automation</h1>
      {!userData ? (
