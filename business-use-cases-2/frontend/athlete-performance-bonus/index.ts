...
const CONTRACT_ADDRESS = process.env.ATHLETE_PERFORMANCE_BONUS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-performance-bonus';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Performance Bonus',
