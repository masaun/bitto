...
const CONTRACT_ADDRESS = process.env.BROADBAND_INFRASTRUCTURE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadband-infrastructure-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'broadband-infrastructure-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
