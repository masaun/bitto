...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_JOB_SCHEDULER_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-job-scheduler';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-job-scheduler',
