...
export default function artisanFurnitureCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furniture Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNITURE_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furniture-certification';
  ...
  return (
    <div>
      <h1>Artisan Furniture Certification</h1>
