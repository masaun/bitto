...
const CONTRACT_ADDRESS = process.env.TORCH_RELAY_SPONSORSHIP_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'torch-relay-sponsorship-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Torch Relay Sponsorship Ledger',
