...
export default function premiumCraftsmanshipRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Craftsmanship Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_CRAFTSMANSHIP_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-craftsmanship-registry';
  ...
  return (
    <div>
      <h1>Premium Craftsmanship Registry</h1>
