...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROOFLINK_PRIVATE_ROUTER_ADDRESS || '';

export default function Prooflink_Private_RouterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.prooflink-private-router/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'prooflink-private-router',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>prooflink-private-router</h1>
