...
export default function sustainableCabinetryEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Cabinetry Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_CABINETRY_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-cabinetry-engine';
  ...
  return (
    <div>
      <h1>Sustainable Cabinetry Engine</h1>
