...
export default function smartFurnishingIntegration() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Smart Furnishing Integration',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SMART_FURNISHING_INTEGRATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'smart-furnishing-integration';
  ...
  return (
    <div>
      <h1>Smart Furnishing Integration</h1>
