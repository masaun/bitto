...
const CONTRACT_ADDRESS = process.env.CROSS_LEAGUE_COLLABORATION_DAO_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-league-collaboration-dao';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Cross League Collaboration Dao',
