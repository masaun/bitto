...
const contractAddress = process.env.REACT_APP_LOCAL_SHOPPING_CHALLENGE_CONTRACT_ADDRESS || '';
const contractName = 'local-shopping-challenge';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Shopping Challenge</h1>
