...
const CONTRACT_ADDRESS = process.env.CORPORATE_CONTINGENCY_FUND_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-contingency-fund-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-contingency-fund-4',
