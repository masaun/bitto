...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_EXAMINER_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-examiner';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-examiner',
