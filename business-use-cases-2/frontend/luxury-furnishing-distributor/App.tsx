...
export default function luxuryFurnishingDistributor() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Luxury Furnishing Distributor',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_FURNISHING_DISTRIBUTOR_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-furnishing-distributor';
  ...
  return (
    <div>
      <h1>Luxury Furnishing Distributor</h1>
