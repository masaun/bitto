...
export default function artisanalFurnitureVault() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisanal Furniture Vault',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISANAL_FURNITURE_VAULT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisanal-furniture-vault';
  ...
  return (
    <div>
      <h1>Artisanal Furniture Vault</h1>
