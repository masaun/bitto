...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_HEALTH_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-health-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-health-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-health-market</h1>
      {!userData ? (
