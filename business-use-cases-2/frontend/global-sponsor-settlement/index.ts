...
const CONTRACT_ADDRESS = process.env.GLOBAL_SPONSOR_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-sponsor-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Sponsor Settlement',
