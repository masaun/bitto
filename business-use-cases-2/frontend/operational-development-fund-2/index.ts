...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_DEVELOPMENT_FUND_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-development-fund-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-development-fund-2',
