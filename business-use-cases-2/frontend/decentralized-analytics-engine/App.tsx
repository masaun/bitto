...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_ANALYTICS_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-analytics-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-analytics-engine</h1>
      {!userData ? (
