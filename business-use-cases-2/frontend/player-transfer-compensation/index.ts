...
const CONTRACT_ADDRESS = process.env.PLAYER_TRANSFER_COMPENSATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'player-transfer-compensation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Player Transfer Compensation',
