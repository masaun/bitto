...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TEMPESTFORGE_PRIVATE_HUB_ADDRESS || '';

export default function Tempestforge_Private_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tempestforge-private-hub/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'tempestforge-private-hub',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>tempestforge-private-hub</h1>
