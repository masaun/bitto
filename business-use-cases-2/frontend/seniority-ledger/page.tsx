...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SENIORITY_LEDGER_ADDRESS || '';

export default function Seniority_LedgerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.seniority-ledger/read-only/get-counter`,
        {
          method: 'GET',
