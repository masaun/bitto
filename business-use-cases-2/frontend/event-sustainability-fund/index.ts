...
const CONTRACT_ADDRESS = process.env.EVENT_SUSTAINABILITY_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'event-sustainability-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Event Sustainability Fund',
