...
const contractAddress = process.env.REACT_APP_HOSPITALITY_ACTIVATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-activation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Activation Ledger</h1>
