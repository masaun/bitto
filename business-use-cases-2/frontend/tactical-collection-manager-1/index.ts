...
const CONTRACT_ADDRESS = process.env.TACTICAL_COLLECTION_MANAGER_1_ADDRESS || '';
const CONTRACT_NAME = 'tactical-collection-manager-1';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'tactical-collection-manager-1',
