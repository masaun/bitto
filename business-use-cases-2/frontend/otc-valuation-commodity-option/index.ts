...
const CONTRACT_ADDRESS = process.env.OTC_VALUATION_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-valuation-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-valuation-commodity-option',
