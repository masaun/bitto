...
const CONTRACT_ADDRESS = process.env.HEAVY_EQUIPMENT_YARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'heavy-equipment-yard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'heavy-equipment-yard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>heavy-equipment-yard-leaseback</h1>
      {!userData ? (
