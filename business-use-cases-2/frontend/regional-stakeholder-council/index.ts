...
const CONTRACT_ADDRESS = process.env.REGIONAL_STAKEHOLDER_COUNCIL_ADDRESS || '';
const CONTRACT_NAME = 'regional-stakeholder-council';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'regional-stakeholder-council',
