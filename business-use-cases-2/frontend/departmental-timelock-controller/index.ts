...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_TIMELOCK_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'departmental-timelock-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-timelock-controller',
