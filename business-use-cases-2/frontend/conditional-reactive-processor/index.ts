...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-reactive-processor',
