...
const CONTRACT_ADDRESS = process.env.SPORTS_TECH_INTEGRATION_DAO_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-tech-integration-dao';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Tech Integration Dao',
