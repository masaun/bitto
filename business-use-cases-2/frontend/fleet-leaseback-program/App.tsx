...
const CONTRACT_ADDRESS = process.env.FLEET_LEASEBACK_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fleet-leaseback-program';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fleet-leaseback-program', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
