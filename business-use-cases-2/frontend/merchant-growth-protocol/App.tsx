...
const contractAddress = process.env.REACT_APP_MERCHANT_GROWTH_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'merchant-growth-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Merchant Growth Protocol</h1>
