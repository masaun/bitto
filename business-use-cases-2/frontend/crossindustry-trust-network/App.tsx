...
const CONTRACT_ADDRESS = process.env.CROSSINDUSTRY_TRUST_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crossindustry-trust-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crossindustry-trust-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crossindustry-trust-network</h1>
      {!userData ? (
