...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_POLICY_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'departmental-policy-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-policy-committee',
