...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CCIP_INTEGRATOR_ADDRESS || '';

export default function Ccip_IntegratorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ccip-integrator/read-only/get-counter`,
        {
          method: 'GET',
