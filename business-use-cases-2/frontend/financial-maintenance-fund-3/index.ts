...
const CONTRACT_ADDRESS = process.env.FINANCIAL_MAINTENANCE_FUND_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-maintenance-fund-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-maintenance-fund-3',
