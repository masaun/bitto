...
const CONTRACT_ADDRESS = process.env.HYPERSCALE_FACILITY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hyperscale-facility-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'hyperscale-facility-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>hyperscale-facility-leaseback</h1>
      {!userData ? (
