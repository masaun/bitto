...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SOCIAL_GUARDIAN_ADDRESS || '';

export default function Social_GuardianPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.social-guardian/read-only/get-counter`,
        {
          method: 'GET',
