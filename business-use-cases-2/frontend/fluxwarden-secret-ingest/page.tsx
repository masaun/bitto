...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FLUXWARDEN_SECRET_INGEST_ADDRESS || '';

export default function Fluxwarden_Secret_IngestPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fluxwarden-secret-ingest/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'fluxwarden-secret-ingest',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>fluxwarden-secret-ingest</h1>
