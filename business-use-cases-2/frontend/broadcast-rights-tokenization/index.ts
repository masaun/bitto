...
const CONTRACT_ADDRESS = process.env.BROADCAST_RIGHTS_TOKENIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-rights-tokenization';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcast Rights Tokenization',
