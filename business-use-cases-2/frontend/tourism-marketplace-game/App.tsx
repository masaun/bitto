...
const contractAddress = process.env.REACT_APP_TOURISM_MARKETPLACE_GAME_CONTRACT_ADDRESS || '';
const contractName = 'tourism-marketplace-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Marketplace Game</h1>
