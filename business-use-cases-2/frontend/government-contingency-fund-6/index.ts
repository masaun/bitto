...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_CONTINGENCY_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-contingency-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-contingency-fund-6',
