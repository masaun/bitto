...
const CONTRACT_ADDRESS = process.env.SMART_MANUFACTURING_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-manufacturing-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'smart-manufacturing-network',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-manufacturing-network</h1>
      {!userData ? (
