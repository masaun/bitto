...
const CONTRACT_ADDRESS = process.env.HISTORICAL_PRODUCTION_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'historical-production-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Historical Production Ledger',
