...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_PROJECTOR_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-projector';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-projector',
