...
const CONTRACT_ADDRESS = process.env.TOKENIZED_ACCESS_CONTROL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-access-control';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-access-control</h1>
      {!userData ? (
