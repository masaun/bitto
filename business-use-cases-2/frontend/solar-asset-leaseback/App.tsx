...
const CONTRACT_ADDRESS = process.env.SOLAR_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'solar-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'solar-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
