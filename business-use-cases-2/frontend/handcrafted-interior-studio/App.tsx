...
export default function handcraftedInteriorStudio() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Interior Studio',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_INTERIOR_STUDIO_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-interior-studio';
  ...
  return (
    <div>
      <h1>Handcrafted Interior Studio</h1>
