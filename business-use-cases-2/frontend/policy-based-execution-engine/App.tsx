...
const contractAddress = process.env.REACT_APP_POLICY_BASED_EXECUTION_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'policy-based-execution-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Policy Based Execution Engine',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Policy Based Execution Engine</h1>
