...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_YIELD_OPTIMIZER_ADDRESS || '';

export default function Yield_OptimizerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.yield-optimizer/read-only/get-counter`,
        {
          method: 'GET',
