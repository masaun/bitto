...
const CONTRACT_ADDRESS = process.env.SPOT_MARKET_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'spot-market-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'spot-market-interest-rate-swap',
