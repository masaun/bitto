...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_ASSET_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-asset-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-asset-registry',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-asset-registry</h1>
      {!userData ? (
