...
export default function ecoFriendlyInteriors() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_FRIENDLY_INTERIORS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-friendly-interiors';
