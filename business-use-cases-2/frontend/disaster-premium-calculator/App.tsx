...
const contractAddress = process.env.REACT_APP_DISASTER_PREMIUM_CALCULATOR_CONTRACT_ADDRESS || '';
const contractName = 'disaster-premium-calculator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>disaster premium calculator</h1>
