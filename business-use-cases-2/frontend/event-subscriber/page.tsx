...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_EVENT_SUBSCRIBER_ADDRESS || '';

export default function Event_SubscriberPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.event-subscriber/read-only/get-counter`,
        {
          method: 'GET',
