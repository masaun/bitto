...
const contractAddress = process.env.REACT_APP_ZERO_KNOWLEDGE_QUOTE_PROOF_CONTRACT_ADDRESS || '';
const contractName = 'zero-knowledge-quote-proof';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Zero Knowledge Quote Proof',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Zero Knowledge Quote Proof</h1>
