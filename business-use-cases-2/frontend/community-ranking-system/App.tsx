...
const contractAddress = process.env.REACT_APP_COMMUNITY_RANKING_SYSTEM_CONTRACT_ADDRESS || '';
const contractName = 'community-ranking-system';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Community Ranking System</h1>
