...
const CONTRACT_ADDRESS = process.env.SHOPPING_MALL_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'shopping-mall-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'shopping-mall-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
