...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INDEX_FUND_CORE_ADDRESS || '';

export default function Index_Fund_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.index-fund-core/read-only/get-counter`,
        {
          method: 'GET',
