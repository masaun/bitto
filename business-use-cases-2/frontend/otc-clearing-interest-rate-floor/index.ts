...
const CONTRACT_ADDRESS = process.env.OTC_CLEARING_INTEREST_RATE_FLOOR_ADDRESS || '';
const CONTRACT_NAME = 'otc-clearing-interest-rate-floor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-clearing-interest-rate-floor',
