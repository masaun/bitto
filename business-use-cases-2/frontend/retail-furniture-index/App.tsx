...
export default function retailFurnitureIndex() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_FURNITURE_INDEX_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-furniture-index';
