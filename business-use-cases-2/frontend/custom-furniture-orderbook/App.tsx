...
export default function customFurnitureOrderbook() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Custom Furniture Orderbook',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_FURNITURE_ORDERBOOK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-furniture-orderbook';
  ...
  return (
    <div>
      <h1>Custom Furniture Orderbook</h1>
