...
const CONTRACT_ADDRESS = process.env.EV_CHARGING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ev-charging-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ev-charging-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
