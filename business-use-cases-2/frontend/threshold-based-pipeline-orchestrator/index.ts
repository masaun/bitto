...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-pipeline-orchestrator',
