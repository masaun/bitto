...
const contractAddress = process.env.REACT_APP_PHOTON_CAPTURE_VALIDATION_CONTRACT_ADDRESS || '';
const contractName = 'photon-capture-validation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>photon capture validation</h1>
