...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_MAINTENANCE_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-maintenance-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-maintenance-fund-6',
