...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-proactive-processor',
