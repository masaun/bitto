...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STEALTH_RELAYER_ADDRESS || '';

export default function Stealth_RelayerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.stealth-relayer/read-only/get-counter`,
        {
          method: 'GET',
