...
const contractAddress = process.env.REACT_APP_SUPPLIER_PERFORMANCE_ANALYSIS_CONTRACT_ADDRESS || '';
const contractName = 'supplier-performance-analysis';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Supplier Performance Analysis</h1>
