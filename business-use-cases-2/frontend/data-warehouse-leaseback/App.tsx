...
const CONTRACT_ADDRESS = process.env.DATA_WAREHOUSE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-warehouse-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'data-warehouse-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>data-warehouse-leaseback</h1>
      {!userData ? (
