...
export default function artisanFurnishingMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furnishing Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNISHING_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furnishing-market';
  ...
  return (
    <div>
      <h1>Artisan Furnishing Market</h1>
