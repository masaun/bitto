...
const CONTRACT_ADDRESS = process.env.MULTILATERAL_NETTING_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'multilateral-netting-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'multilateral-netting-commodity-option',
