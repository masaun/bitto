...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_INDUSTRIAL_POLICY_MODULE_ADDRESS || '';

export default function Industrial_Policy_ModulePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.industrial-policy-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'industrial-policy-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>industrial-policy-module</h1>
