...
const CONTRACT_ADDRESS = process.env.SPORTS_MEDIA_RIGHTS_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-media-rights-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Media Rights Auction',
