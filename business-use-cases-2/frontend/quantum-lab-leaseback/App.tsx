...
const CONTRACT_ADDRESS = process.env.QUANTUM_LAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'quantum-lab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'quantum-lab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
