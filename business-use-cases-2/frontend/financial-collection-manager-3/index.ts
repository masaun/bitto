...
const CONTRACT_ADDRESS = process.env.FINANCIAL_COLLECTION_MANAGER_3_ADDRESS || '';
const CONTRACT_NAME = 'financial-collection-manager-3';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'financial-collection-manager-3',
