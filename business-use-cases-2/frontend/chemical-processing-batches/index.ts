...
const CONTRACT_ADDRESS = process.env.CHEMICAL_PROCESSING_BATCHES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'chemical-processing-batches';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Chemical Processing Batches',
