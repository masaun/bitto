...
const CONTRACT_ADDRESS = process.env.TAXI_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'taxi-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'taxi-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
