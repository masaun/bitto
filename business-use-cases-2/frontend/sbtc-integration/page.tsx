...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SBTC_INTEGRATION_ADDRESS || '';

export default function Sbtc_IntegrationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sbtc-integration/read-only/get-counter`,
        {
          method: 'GET',
