...
export default function sustainableJoineryNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Joinery Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_JOINERY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-joinery-network';
  ...
  return (
    <div>
      <h1>Sustainable Joinery Network</h1>
