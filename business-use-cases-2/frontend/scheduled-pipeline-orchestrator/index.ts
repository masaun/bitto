...
const CONTRACT_ADDRESS = process.env.SCHEDULED_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'scheduled-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'scheduled-pipeline-orchestrator',
