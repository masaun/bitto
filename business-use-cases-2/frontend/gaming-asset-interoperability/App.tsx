...
const CONTRACT_ADDRESS = process.env.GAMING_ASSET_INTEROPERABILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'gaming-asset-interoperability';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'gaming-asset-interoperability',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>gaming-asset-interoperability</h1>
      {!userData ? (
