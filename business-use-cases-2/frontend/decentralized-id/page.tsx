...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DECENTRALIZED_ID_ADDRESS || '';

export default function Decentralized_IdPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.decentralized-id/read-only/get-counter`,
        {
          method: 'GET',
