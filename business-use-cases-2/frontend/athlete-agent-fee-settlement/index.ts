...
const CONTRACT_ADDRESS = process.env.ATHLETE_AGENT_FEE_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-agent-fee-settlement';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Agent Fee Settlement',
