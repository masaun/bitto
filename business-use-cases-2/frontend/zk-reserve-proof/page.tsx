...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ZK_RESERVE_PROOF_ADDRESS || '';

export default function Zk_Reserve_ProofPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.zk-reserve-proof/read-only/get-counter`,
        {
          method: 'GET',
