...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-condition-evaluator',
