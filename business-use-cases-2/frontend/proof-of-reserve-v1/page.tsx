...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROOF_OF_RESERVE_V1_ADDRESS || '';

export default function Proof_Of_Reserve_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.proof-of-reserve-v1/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'proof-of-reserve-v1',
