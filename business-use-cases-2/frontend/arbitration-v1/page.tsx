...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ARBITRATION_V1_ADDRESS || '';

export default function Arbitration_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.arbitration-v1/read-only/get-counter`,
        {
          method: 'GET',
