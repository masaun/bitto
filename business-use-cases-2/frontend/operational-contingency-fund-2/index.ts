...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_CONTINGENCY_FUND_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-contingency-fund-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-contingency-fund-2',
