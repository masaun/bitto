...
const CONTRACT_ADDRESS = process.env.PRIVACY_COMPLIANCE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'privacy-compliance-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivacyComplianceRegistry',
