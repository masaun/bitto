...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SESSION_KEY_MGR_ADDRESS || '';

export default function Session_Key_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.session-key-mgr/read-only/get-counter`,
        {
          method: 'GET',
