...
const contractAddress = process.env.REACT_APP_CONDITIONAL_TRIGGER_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'conditional-trigger-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Conditional Trigger Registry',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Conditional Trigger Registry</h1>
