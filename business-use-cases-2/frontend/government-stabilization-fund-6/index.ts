...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_STABILIZATION_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-stabilization-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-stabilization-fund-6',
