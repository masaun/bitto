...
const contractAddress = process.env.REACT_APP_CATASTROPHE_TRANCHE_SPLITTER_CONTRACT_ADDRESS || '';
const contractName = 'catastrophe-tranche-splitter';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>catastrophe tranche splitter</h1>
