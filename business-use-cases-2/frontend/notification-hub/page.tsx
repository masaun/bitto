...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_NOTIFICATION_HUB_ADDRESS || '';

export default function Notification_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.notification-hub/read-only/get-counter`,
        {
          method: 'GET',
