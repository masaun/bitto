...
const CONTRACT_ADDRESS = process.env.EVENT_CARBON_OFFSET_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'event-carbon-offset-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Event Carbon Offset Registry',
