...
const CONTRACT_ADDRESS = process.env.GLOBAL_HOSPITALITY_REVENUE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-hospitality-revenue';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Hospitality Revenue',
