...
const CONTRACT_ADDRESS = process.env.TRANSACTION_ENCRYPTION_MANAGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'transaction-encryption-manager';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'TransactionEncryptionManager',
