...
const CONTRACT_ADDRESS = process.env.AI_SERVER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-server-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ai-server-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
