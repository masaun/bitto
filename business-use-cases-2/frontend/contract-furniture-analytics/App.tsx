...
export default function contractFurnitureAnalytics() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Furniture Analytics',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_FURNITURE_ANALYTICS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-furniture-analytics';
  ...
  return (
    <div>
      <h1>Contract Furniture Analytics</h1>
