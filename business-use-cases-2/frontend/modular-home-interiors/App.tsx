...
export default function modularHomeInteriors() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_HOME_INTERIORS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-home-interiors';
