...
const CONTRACT_ADDRESS = process.env.OPENCLAW_AI_AGENT_ORCHESTRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-ai-agent-orchestrator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-ai-agent-orchestrator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-ai-agent-orchestrator</h1>
      {!userData ? (
