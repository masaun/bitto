...
const CONTRACT_ADDRESS = process.env.RENEWABLE_INFRASTRUCTURE_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-infrastructure-fund';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-infrastructure-fund</h1>
      {!userData ? (
