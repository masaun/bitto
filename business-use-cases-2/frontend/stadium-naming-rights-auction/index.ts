...
const CONTRACT_ADDRESS = process.env.STADIUM_NAMING_RIGHTS_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'stadium-naming-rights-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Stadium Naming Rights Auction',
