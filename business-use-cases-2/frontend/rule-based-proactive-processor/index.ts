...
const CONTRACT_ADDRESS = process.env.RULE_BASED_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-proactive-processor',
