...
const contractAddress = process.env.REACT_APP_POLICY_OVERRIDE_APPROVAL_CONTRACT_ADDRESS || '';
const contractName = 'policy-override-approval';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Policy Override Approval</h1>
