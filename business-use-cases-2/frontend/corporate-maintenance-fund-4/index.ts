...
const CONTRACT_ADDRESS = process.env.CORPORATE_MAINTENANCE_FUND_4_ADDRESS || '';
const CONTRACT_NAME = 'corporate-maintenance-fund-4';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'corporate-maintenance-fund-4',
