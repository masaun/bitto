...
const CONTRACT_ADDRESS = process.env.THIRD_PARTY_AUDIT_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'third-party-audit-verification';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Third Party Audit Verification',
