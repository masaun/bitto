...
export default function designerFurnitureMarketplace() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Designer Furniture Marketplace',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DESIGNER_FURNITURE_MARKETPLACE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'designer-furniture-marketplace';
  ...
  return (
    <div>
      <h1>Designer Furniture Marketplace</h1>
