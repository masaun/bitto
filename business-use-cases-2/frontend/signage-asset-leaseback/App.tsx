...
const CONTRACT_ADDRESS = process.env.SIGNAGE_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'signage-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'signage-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
