...
const contractAddress = process.env.REACT_APP_CITY_COOPERATION_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'city-cooperation-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>City Cooperation Protocol</h1>
