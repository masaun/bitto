...
const contractAddress = process.env.REACT_APP_URBAN_DISCOVERY_MISSIONS_CONTRACT_ADDRESS || '';
const contractName = 'urban-discovery-missions';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Urban Discovery Missions</h1>
