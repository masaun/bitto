...
const CONTRACT_ADDRESS = process.env.BILLBOARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'billboard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'billboard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
