...
const CONTRACT_ADDRESS = process.env.DIGITAL_RIGHTS_TOKENIZER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-rights-tokenizer';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-rights-tokenizer</h1>
      {!userData ? (
