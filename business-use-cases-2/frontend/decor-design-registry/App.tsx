...
export default function decorDesignRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_DESIGN_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-design-registry';
