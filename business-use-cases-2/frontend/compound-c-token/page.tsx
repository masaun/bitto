...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COMPOUND_C_TOKEN_ADDRESS || '';

export default function Compound_C_TokenPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.compound-c-token/read-only/get-counter`,
        {
          method: 'GET',
