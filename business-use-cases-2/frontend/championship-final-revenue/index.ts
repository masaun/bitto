...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_FINAL_REVENUE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-final-revenue';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Final Revenue',
