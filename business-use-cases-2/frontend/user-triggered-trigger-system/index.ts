...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_TRIGGER_SYSTEM_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-trigger-system';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-trigger-system',
