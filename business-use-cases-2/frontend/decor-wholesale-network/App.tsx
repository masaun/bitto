...
export default function decorWholesaleNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_WHOLESALE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-wholesale-network';
