...
export default function luxuryHomeFittings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_LUXURY_HOME_FITTINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'luxury-home-fittings';
