...
const CONTRACT_ADDRESS = process.env.SMART_INFRASTRUCTURE_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'smart-infrastructure-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'smart-infrastructure-ledger',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>smart-infrastructure-ledger</h1>
      {!userData ? (
