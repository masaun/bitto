...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-condition-evaluator',
