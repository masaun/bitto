...
const contractAddress = process.env.REACT_APP_CIVIC_LEADERBOARD_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'civic-leaderboard-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Civic Leaderboard Engine</h1>
