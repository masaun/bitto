...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_AUTOMATION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'conditional-automation-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-automation-manager',
