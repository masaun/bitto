...
const CONTRACT_ADDRESS = process.env.ENVIRONMENTAL_LIABILITY_CLAIMS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'environmental-liability-claims';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Environmental Liability Claims',
