...
const CONTRACT_ADDRESS = process.env.VENUE_SPONSORSHIP_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'venue-sponsorship-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Venue Sponsorship Auction',
