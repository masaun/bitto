...
const CONTRACT_ADDRESS = process.env.AGENT_OWNERSHIP_MIGRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-ownership-migration';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent Ownership Migration',
