...
export default function designerWorkspaceSupplier() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Designer Workspace Supplier',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DESIGNER_WORKSPACE_SUPPLIER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'designer-workspace-supplier';
  ...
  return (
    <div>
      <h1>Designer Workspace Supplier</h1>
