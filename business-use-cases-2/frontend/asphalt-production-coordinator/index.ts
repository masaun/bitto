...
const CONTRACT_ADDRESS = process.env.ASPHALT_PRODUCTION_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asphalt-production-coordinator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Asphalt Production Coordinator',
