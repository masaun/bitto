...
const CONTRACT_ADDRESS = process.env.HELICOPTER_LEASEBACK_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'helicopter-leaseback-program';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'helicopter-leaseback-program', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>helicopter-leaseback-program</h1>
      {!userData ? (
