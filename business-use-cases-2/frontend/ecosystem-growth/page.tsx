...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ECOSYSTEM_GROWTH_ADDRESS || '';

export default function Ecosystem_GrowthPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ecosystem-growth/read-only/get-counter`,
        {
          method: 'GET',
