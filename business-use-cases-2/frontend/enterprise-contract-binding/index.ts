...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_CONTRACT_BINDING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-contract-binding';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EnterpriseContractBinding',
