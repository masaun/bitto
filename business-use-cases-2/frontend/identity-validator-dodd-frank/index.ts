...
const CONTRACT_ADDRESS = process.env.IDENTITY_VALIDATOR_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'identity-validator-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'identity-validator-dodd-frank',
