...
const CONTRACT_ADDRESS = process.env.ASTROPHOTOGRAPHY_RIGHTS_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'astrophotography-rights-ledger';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Astrophotography Rights Ledger',
