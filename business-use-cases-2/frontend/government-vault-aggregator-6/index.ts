...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_VAULT_AGGREGATOR_6_ADDRESS || '';
const CONTRACT_NAME = 'government-vault-aggregator-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-vault-aggregator-6',
