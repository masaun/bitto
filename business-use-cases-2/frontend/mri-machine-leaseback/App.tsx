...
const CONTRACT_ADDRESS = process.env.MRI_MACHINE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'mri-machine-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'mri-machine-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
