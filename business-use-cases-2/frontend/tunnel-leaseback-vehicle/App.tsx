...
const CONTRACT_ADDRESS = process.env.TUNNEL_LEASEBACK_VEHICLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tunnel-leaseback-vehicle';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'tunnel-leaseback-vehicle', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tunnel-leaseback-vehicle</h1>
      {!userData ? (
