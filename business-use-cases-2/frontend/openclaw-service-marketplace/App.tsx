...
const CONTRACT_ADDRESS = process.env.OPENCLAW_SERVICE_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-service-marketplace';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-service-marketplace',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-service-marketplace</h1>
      {!userData ? (
