...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_MAINTENANCE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-maintenance-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-maintenance-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-maintenance-market</h1>
      {!userData ? (
