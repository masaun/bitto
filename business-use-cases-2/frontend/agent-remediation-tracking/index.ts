...
const CONTRACT_ADDRESS = process.env.AGENT_REMEDIATION_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-remediation-tracking';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent Remediation Tracking',
