...
const CONTRACT_ADDRESS = process.env.OTC_SETTLEMENT_INTEREST_RATE_CAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-settlement-interest-rate-cap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-settlement-interest-rate-cap',
