...
const contractAddress = process.env.REACT_APP_TOURISM_COLLABORATION_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'tourism-collaboration-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Collaboration Engine</h1>
