...
const CONTRACT_ADDRESS = process.env.ALLOGENEIC_MATCHMAKING_CORE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'allogeneic-matchmaking-core';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Allogeneic Matchmaking Core',
