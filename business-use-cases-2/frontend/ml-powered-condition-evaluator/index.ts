...
const CONTRACT_ADDRESS = process.env.ML_POWERED_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-condition-evaluator',
