...
const CONTRACT_ADDRESS = process.env.LAND_RESTORATION_OBLIGATIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'land-restoration-obligations';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Land Restoration Obligations',
