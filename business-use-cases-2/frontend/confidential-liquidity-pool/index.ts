...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_LIQUIDITY_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-liquidity-pool';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialLiquidityPool',
