...
const CONTRACT_ADDRESS = process.env.TOURNAMENT_STATS_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tournament-stats-verifier';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Tournament Stats Verifier',
