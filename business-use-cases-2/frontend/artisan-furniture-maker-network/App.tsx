...
export default function artisanFurnitureMakerNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisan Furniture Maker Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_FURNITURE_MAKER_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-furniture-maker-network';
  ...
  return (
    <div>
      <h1>Artisan Furniture Maker Network</h1>
