...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_SOCIAL_GRAPH_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-social-graph';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-social-graph</h1>
      {!userData ? (
