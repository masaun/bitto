...
const CONTRACT_ADDRESS = process.env.ARCHITECTURE_DESIGN_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'architecture-design-market';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Architecture Design Market',
