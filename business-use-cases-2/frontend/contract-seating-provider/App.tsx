...
export default function contractSeatingProvider() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Seating Provider',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_SEATING_PROVIDER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-seating-provider';
  ...
  return (
    <div>
      <h1>Contract Seating Provider</h1>
