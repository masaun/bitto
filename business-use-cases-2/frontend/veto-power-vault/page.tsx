...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VETO_POWER_VAULT_ADDRESS || '';

export default function Veto_Power_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.veto-power-vault/read-only/get-counter`,
        {
          method: 'GET',
