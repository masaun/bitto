...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AUDITSTAMP_SECURE_RUNNER_ADDRESS || '';

export default function Auditstamp_Secure_RunnerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.auditstamp-secure-runner/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'auditstamp-secure-runner',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>auditstamp-secure-runner</h1>
