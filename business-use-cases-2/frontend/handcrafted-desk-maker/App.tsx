...
export default function handcraftedDeskMaker() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_DESK_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-desk-maker';
