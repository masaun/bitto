...
export default function handcraftedStorageSolutions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Storage Solutions',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_STORAGE_SOLUTIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-storage-solutions';
  ...
  return (
    <div>
      <h1>Handcrafted Storage Solutions</h1>
