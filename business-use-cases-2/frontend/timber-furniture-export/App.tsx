...
export default function timberFurnitureExport() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FURNITURE_EXPORT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-furniture-export';
