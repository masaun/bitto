...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_TASK_SCHEDULER_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-task-scheduler';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-task-scheduler',
