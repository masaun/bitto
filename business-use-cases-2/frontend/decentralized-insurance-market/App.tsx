...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_INSURANCE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-insurance-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-insurance-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-insurance-market</h1>
      {!userData ? (
