...
const CONTRACT_ADDRESS = process.env.RARE_EARTH_SEPARATION_FACILITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rare-earth-separation-facility';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Rare Earth Separation Facility',
