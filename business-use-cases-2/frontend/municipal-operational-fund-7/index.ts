...
const CONTRACT_ADDRESS = process.env.MUNICIPAL_OPERATIONAL_FUND_7_ADDRESS || '';
const CONTRACT_NAME = 'municipal-operational-fund-7';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'municipal-operational-fund-7',
