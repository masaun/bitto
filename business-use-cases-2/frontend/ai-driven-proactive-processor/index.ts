...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_PROACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-proactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-proactive-processor',
