...
const CONTRACT_ADDRESS = process.env.DOCUMENT_PROCESSOR_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'document-processor-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'document-processor-dodd-frank',
