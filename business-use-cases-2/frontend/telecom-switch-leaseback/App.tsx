...
const CONTRACT_ADDRESS = process.env.TELECOM_SWITCH_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'telecom-switch-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'telecom-switch-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>telecom-switch-leaseback</h1>
      {!userData ? (
