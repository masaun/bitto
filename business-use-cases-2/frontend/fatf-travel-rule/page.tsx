...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FATF_TRAVEL_RULE_ADDRESS || '';

export default function Fatf_Travel_RulePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fatf-travel-rule/read-only/get-counter`,
        {
          method: 'GET',
