...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_COMMERCE_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-commerce-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Commerce Engine</h1>
