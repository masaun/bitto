...
const CONTRACT_ADDRESS = process.env.DRILLING_RIG_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'drilling-rig-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'drilling-rig-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
