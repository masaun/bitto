...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_LIQUID_DEMOCRACY_ADDRESS || '';
const CONTRACT_NAME = 'operational-liquid-democracy';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-liquid-democracy',
