...
const CONTRACT_ADDRESS = process.env.ASSET_MAINTENANCE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asset-maintenance-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Asset Maintenance Registry',
