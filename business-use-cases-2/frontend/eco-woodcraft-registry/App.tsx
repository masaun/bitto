...
export default function ecoWoodcraftRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_WOODCRAFT_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-woodcraft-registry';
