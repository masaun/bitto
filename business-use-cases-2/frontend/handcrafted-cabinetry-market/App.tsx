...
export default function handcraftedCabinetryMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Cabinetry Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_CABINETRY_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-cabinetry-market';
  ...
  return (
    <div>
      <h1>Handcrafted Cabinetry Market</h1>
