...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PROPOSAL_SUBMISSION_ADDRESS || '';

export default function Proposal_SubmissionPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.proposal-submission/read-only/get-counter`,
        {
          method: 'GET',
