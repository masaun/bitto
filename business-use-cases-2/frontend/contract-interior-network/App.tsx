...
export default function contractInteriorNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contract Interior Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTRACT_INTERIOR_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contract-interior-network';
  ...
  return (
    <div>
      <h1>Contract Interior Network</h1>
