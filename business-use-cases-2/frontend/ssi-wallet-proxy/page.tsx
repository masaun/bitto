...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SSI_WALLET_PROXY_ADDRESS || '';

export default function Ssi_Wallet_ProxyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ssi-wallet-proxy/read-only/get-counter`,
        {
          method: 'GET',
