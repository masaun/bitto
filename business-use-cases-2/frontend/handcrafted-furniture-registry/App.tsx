...
export default function handcraftedFurnitureRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Furniture Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_FURNITURE_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-furniture-registry';
  ...
  return (
    <div>
      <h1>Handcrafted Furniture Registry</h1>
