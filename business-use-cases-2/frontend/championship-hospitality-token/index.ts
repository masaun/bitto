...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_HOSPITALITY_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-hospitality-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Hospitality Token',
