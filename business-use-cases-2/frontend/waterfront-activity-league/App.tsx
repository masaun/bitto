...
const contractAddress = process.env.REACT_APP_WATERFRONT_ACTIVITY_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'waterfront-activity-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Waterfront Activity League</h1>
