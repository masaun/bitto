...
export default function bespokeFurnitureCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Furniture Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_FURNITURE_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-furniture-certification';
  ...
  return (
    <div>
      <h1>Bespoke Furniture Certification</h1>
