...
export default function sustainableWoodcraftHub() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Sustainable Woodcraft Hub',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SUSTAINABLE_WOODCRAFT_HUB_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'sustainable-woodcraft-hub';
  ...
  return (
    <div>
      <h1>Sustainable Woodcraft Hub</h1>
