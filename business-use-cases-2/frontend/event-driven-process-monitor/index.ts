...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_PROCESS_MONITOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-process-monitor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-process-monitor',
