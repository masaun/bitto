...
const CONTRACT_ADDRESS = process.env.VENUE_CONSTRUCTION_ESCROW_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'venue-construction-escrow';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Venue Construction Escrow',
