...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_DIGITAL_COLLECTIBLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-digital-collectible';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Digital Collectible',
