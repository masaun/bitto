...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AML_SCREENING_MODULE_NEW_ADDRESS || '';

export default function Aml_Screening_Module_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.aml-screening-module-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'aml-screening-module-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>aml-screening-module-new</h1>
