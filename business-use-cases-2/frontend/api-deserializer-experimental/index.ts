...
const CONTRACT_ADDRESS = process.env.API_DESERIALIZER_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'api-deserializer-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'api-deserializer-experimental',
