...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_BROADCAST_DAO_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-broadcast-dao';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Broadcast Dao',
