...
const contractAddress = process.env.REACT_APP_SURFACE_TESTING_CERTIFICATE_CONTRACT_ADDRESS || '';
const contractName = 'surface-testing-certificate';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>surface testing certificate</h1>
