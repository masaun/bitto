...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DAO_TREASURY_V2_ADDRESS || '';

export default function Dao_Treasury_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dao-treasury-v2/read-only/get-counter`,
        {
          method: 'GET',
