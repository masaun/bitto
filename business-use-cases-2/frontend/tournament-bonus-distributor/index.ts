...
const CONTRACT_ADDRESS = process.env.TOURNAMENT_BONUS_DISTRIBUTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tournament-bonus-distributor';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Tournament Bonus Distributor',
