...
const CONTRACT_ADDRESS = process.env.AGENT_MEMORY_ACCESS_CONTROL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agent-memory-access-control';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Agent Memory Access Control',
