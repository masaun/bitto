...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_POOLING_SYSTEM_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-pooling-system-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-pooling-system-5',
