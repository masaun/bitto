...
const CONTRACT_ADDRESS = process.env.ML_POWERED_EXECUTION_TRACKER_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-execution-tracker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-execution-tracker',
