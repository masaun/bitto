...
const contractAddress = process.env.REACT_APP_SURGE_PRICING_CONDITIONS_CONTRACT_ADDRESS || '';
const contractName = 'surge-pricing-conditions';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Surge Pricing Conditions</h1>
