...
export default function customShelvingMaker() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_SHELVING_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-shelving-maker';
