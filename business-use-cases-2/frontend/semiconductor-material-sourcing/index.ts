...
const CONTRACT_ADDRESS = process.env.SEMICONDUCTOR_MATERIAL_SOURCING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'semiconductor-material-sourcing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Semiconductor Material Sourcing',
