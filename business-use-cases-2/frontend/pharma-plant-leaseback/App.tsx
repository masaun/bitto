...
const CONTRACT_ADDRESS = process.env.PHARMA_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'pharma-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'pharma-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
