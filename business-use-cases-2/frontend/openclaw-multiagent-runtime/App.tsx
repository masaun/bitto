...
const CONTRACT_ADDRESS = process.env.OPENCLAW_MULTIAGENT_RUNTIME_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-multiagent-runtime';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'openclaw-multiagent-runtime',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-multiagent-runtime</h1>
      {!userData ? (
