...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ZONING_COMPLIANCE_CHECKER_ADDRESS || '';

export default function Zoning_Compliance_CheckerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.zoning-compliance-checker/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'zoning-compliance-checker',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>zoning-compliance-checker</h1>
