...
const CONTRACT_ADDRESS = process.env.PROPERTY_LEASEBACK_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'property-leaseback-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'property-leaseback-settlement', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>property-leaseback-settlement</h1>
      {!userData ? (
