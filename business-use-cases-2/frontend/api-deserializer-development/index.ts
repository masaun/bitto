...
const CONTRACT_ADDRESS = process.env.API_DESERIALIZER_DEVELOPMENT_ADDRESS || '';
const CONTRACT_NAME = 'api-deserializer-development';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'api-deserializer-development',
