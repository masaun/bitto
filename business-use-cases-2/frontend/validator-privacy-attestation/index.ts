...
const CONTRACT_ADDRESS = process.env.VALIDATOR_PRIVACY_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-privacy-attestation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorPrivacyAttestation',
