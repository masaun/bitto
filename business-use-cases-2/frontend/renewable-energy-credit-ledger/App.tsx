...
const CONTRACT_ADDRESS = process.env.RENEWABLE_ENERGY_CREDIT_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-energy-credit-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-energy-credit-ledger',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-energy-credit-ledger</h1>
      {!userData ? (
