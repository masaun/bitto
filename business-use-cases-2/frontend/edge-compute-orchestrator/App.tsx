...
const CONTRACT_ADDRESS = process.env.EDGE_COMPUTE_ORCHESTRATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'edge-compute-orchestrator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'edge-compute-orchestrator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>edge-compute-orchestrator</h1>
      {!userData ? (
