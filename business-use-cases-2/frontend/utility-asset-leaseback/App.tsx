...
const CONTRACT_ADDRESS = process.env.UTILITY_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'utility-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'utility-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
