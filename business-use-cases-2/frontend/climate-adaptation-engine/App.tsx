...
const CONTRACT_ADDRESS = process.env.CLIMATE_ADAPTATION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-adaptation-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'climate-adaptation-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-adaptation-engine</h1>
      {!userData ? (
