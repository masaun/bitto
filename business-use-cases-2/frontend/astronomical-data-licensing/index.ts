...
const CONTRACT_ADDRESS = process.env.ASTRONOMICAL_DATA_LICENSING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'astronomical-data-licensing';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Astronomical Data Licensing',
