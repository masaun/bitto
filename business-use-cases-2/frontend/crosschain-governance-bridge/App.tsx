...
const CONTRACT_ADDRESS = process.env.CROSSCHAIN_GOVERNANCE_BRIDGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crosschain-governance-bridge';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crosschain-governance-bridge',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crosschain-governance-bridge</h1>
      {!userData ? (
