...
const CONTRACT_ADDRESS = process.env.OTC_BROKER_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-broker-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-broker-interest-rate-swap',
