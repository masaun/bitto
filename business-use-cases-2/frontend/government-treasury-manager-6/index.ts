...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_TREASURY_MANAGER_6_ADDRESS || '';
const CONTRACT_NAME = 'government-treasury-manager-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-treasury-manager-6',
