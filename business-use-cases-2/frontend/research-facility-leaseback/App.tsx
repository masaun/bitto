...
const CONTRACT_ADDRESS = process.env.RESEARCH_FACILITY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'research-facility-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'research-facility-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>research-facility-leaseback</h1>
      {!userData ? (
