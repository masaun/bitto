...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MARKET_MAKER_V1_ADDRESS || '';

export default function Market_Maker_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.market-maker-v1/read-only/get-counter`,
        {
          method: 'GET',
