...
export default function ecoWoodFurnishings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_WOOD_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-wood-furnishings';
