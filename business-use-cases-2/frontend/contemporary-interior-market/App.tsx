...
export default function contemporaryInteriorMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Contemporary Interior Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CONTEMPORARY_INTERIOR_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'contemporary-interior-market';
  ...
  return (
    <div>
      <h1>Contemporary Interior Market</h1>
