...
const contractAddress = process.env.REACT_APP_EXPOSURE_AGGREGATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'exposure-aggregation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>exposure aggregation ledger</h1>
