...
const CONTRACT_ADDRESS = process.env.AI_DRIVEN_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ai-driven-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ai-driven-predictive-processor',
