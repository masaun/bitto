...
const CONTRACT_ADDRESS = process.env.ML_POWERED_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-reactive-processor',
