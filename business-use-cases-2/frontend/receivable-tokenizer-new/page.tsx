...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RECEIVABLE_TOKENIZER_NEW_ADDRESS || '';

export default function Receivable_Tokenizer_NewPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.receivable-tokenizer-new/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'receivable-tokenizer-new',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>receivable-tokenizer-new</h1>
