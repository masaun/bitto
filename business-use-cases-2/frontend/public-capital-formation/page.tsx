...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_CAPITAL_FORMATION_ADDRESS || '';

export default function Public_Capital_FormationPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-capital-formation/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'public-capital-formation',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>public-capital-formation</h1>
