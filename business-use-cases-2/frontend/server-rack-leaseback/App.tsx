...
const CONTRACT_ADDRESS = process.env.SERVER_RACK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'server-rack-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'server-rack-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
