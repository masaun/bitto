...
const CONTRACT_ADDRESS = process.env.BATTERY_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battery-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'battery-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
