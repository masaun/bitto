...
const CONTRACT_ADDRESS = process.env.FITNESS_CENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'fitness-center-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'fitness-center-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>fitness-center-leaseback</h1>
      {!userData ? (
