...
const CONTRACT_ADDRESS = process.env.SHOWROOM_LEASEBACK_ARRANGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'showroom-leaseback-arrangement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'showroom-leaseback-arrangement', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>showroom-leaseback-arrangement</h1>
      {!userData ? (
