...
export default function bambooFurnishingsCollective() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bamboo Furnishings Collective',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BAMBOO_FURNISHINGS_COLLECTIVE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bamboo-furnishings-collective';
  ...
  return (
    <div>
      <h1>Bamboo Furnishings Collective</h1>
