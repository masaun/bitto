...
const CONTRACT_ADDRESS = process.env.BROADCAST_AD_REVENUE_SPLIT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-ad-revenue-split';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Broadcast Ad Revenue Split',
