...
const contractAddress = process.env.REACT_APP_LOCAL_ENTERPRISE_ENGAGEMENT_CONTRACT_ADDRESS || '';
const contractName = 'local-enterprise-engagement';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Enterprise Engagement</h1>
