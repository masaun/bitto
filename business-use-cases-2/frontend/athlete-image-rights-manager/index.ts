...
const CONTRACT_ADDRESS = process.env.ATHLETE_IMAGE_RIGHTS_MANAGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-image-rights-manager';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Image Rights Manager',
