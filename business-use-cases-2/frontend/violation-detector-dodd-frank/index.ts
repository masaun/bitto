...
const CONTRACT_ADDRESS = process.env.VIOLATION_DETECTOR_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'violation-detector-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'violation-detector-dodd-frank',
