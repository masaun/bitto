...
export default function premiumInteriorDistribution() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Interior Distribution',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_INTERIOR_DISTRIBUTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-interior-distribution';
  ...
  return (
    <div>
      <h1>Premium Interior Distribution</h1>
