...
const CONTRACT_ADDRESS = process.env.ML_POWERED_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-pipeline-orchestrator',
