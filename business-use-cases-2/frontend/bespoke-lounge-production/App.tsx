...
export default function bespokeLoungeProduction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Bespoke Lounge Production',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_LOUNGE_PRODUCTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-lounge-production';
  ...
  return (
    <div>
      <h1>Bespoke Lounge Production</h1>
