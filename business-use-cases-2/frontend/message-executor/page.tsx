...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_MESSAGE_EXECUTOR_ADDRESS || '';

export default function Message_ExecutorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.message-executor/read-only/get-counter`,
        {
          method: 'GET',
