...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_DEPLOYMENT_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-deployment-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-deployment-fund-6',
