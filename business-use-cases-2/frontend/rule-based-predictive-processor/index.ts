...
const CONTRACT_ADDRESS = process.env.RULE_BASED_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-predictive-processor',
