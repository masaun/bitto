...
const CONTRACT_ADDRESS = process.env.TELECOM_TOWER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'telecom-tower-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'telecom-tower-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
