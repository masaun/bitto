...
const CONTRACT_ADDRESS = process.env.LAB_EQUIPMENT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'lab-equipment-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'lab-equipment-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
