...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_MAINTENANCE_FUND_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-maintenance-fund-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-maintenance-fund-5',
