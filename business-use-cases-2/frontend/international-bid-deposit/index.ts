...
const CONTRACT_ADDRESS = process.env.INTERNATIONAL_BID_DEPOSIT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'international-bid-deposit';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'International Bid Deposit',
