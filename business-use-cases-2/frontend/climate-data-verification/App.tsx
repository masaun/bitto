...
const CONTRACT_ADDRESS = process.env.CLIMATE_DATA_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'climate-data-verification';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'climate-data-verification',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>climate-data-verification</h1>
      {!userData ? (
