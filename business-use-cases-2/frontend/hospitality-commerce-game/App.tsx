...
const contractAddress = process.env.REACT_APP_HOSPITALITY_COMMERCE_GAME_CONTRACT_ADDRESS || '';
const contractName = 'hospitality-commerce-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Hospitality Commerce Game</h1>
