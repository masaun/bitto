...
const CONTRACT_ADDRESS = process.env.DIGITAL_SERVICE_MARKETPLACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'digital-service-marketplace';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'digital-service-marketplace',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>digital-service-marketplace</h1>
      {!userData ? (
