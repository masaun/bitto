...
const CONTRACT_ADDRESS = process.env.SATELLITE_IMAGERY_BRIDGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'satellite-imagery-bridge';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>satellite-imagery-bridge</h1>
      {!userData ? (
