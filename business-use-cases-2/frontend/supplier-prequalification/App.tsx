...
const contractAddress = process.env.REACT_APP_SUPPLIER_PREQUALIFICATION_CONTRACT_ADDRESS || '';
const contractName = 'supplier-prequalification';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Supplier Prequalification</h1>
