...
const CONTRACT_ADDRESS = process.env.AFFORDABLE_RENTAL_PROJECT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'affordable-rental-project';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Affordable Rental Project',
