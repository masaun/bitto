...
const CONTRACT_ADDRESS = process.env.FOOTBALL_SEMI_FINAL_BONUS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'football-semi-final-bonus';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Football Semi Final Bonus',
