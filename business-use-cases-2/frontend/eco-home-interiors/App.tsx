...
export default function ecoHomeInteriors() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ECO_HOME_INTERIORS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'eco-home-interiors';
