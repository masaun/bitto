...
const CONTRACT_ADDRESS = process.env.CONDITIONAL_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'conditional-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'conditional-condition-evaluator',
