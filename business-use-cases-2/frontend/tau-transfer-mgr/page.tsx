...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TAU_TRANSFER_MGR_ADDRESS || '';

export default function Tau_Transfer_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tau-transfer-mgr/read-only/get-counter`,
        {
          method: 'GET',
