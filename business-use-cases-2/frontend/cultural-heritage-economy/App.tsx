...
const contractAddress = process.env.REACT_APP_CULTURAL_HERITAGE_ECONOMY_CONTRACT_ADDRESS || '';
const contractName = 'cultural-heritage-economy';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Cultural Heritage Economy</h1>
