...
const contractAddress = process.env.REACT_APP_LOCAL_CITY_GROWTH_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'local-city-growth-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local City Growth Ledger</h1>
