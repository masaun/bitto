...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RECURSIVE_SNARK_ADDRESS || '';

export default function Recursive_SnarkPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.recursive-snark/read-only/get-counter`,
        {
          method: 'GET',
