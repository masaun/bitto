...
const CONTRACT_ADDRESS = process.env.HOSPITALITY_PACKAGE_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'hospitality-package-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Hospitality Package Auction',
