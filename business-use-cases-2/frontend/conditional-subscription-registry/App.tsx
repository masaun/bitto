...
const contractAddress = process.env.REACT_APP_CONDITIONAL_SUBSCRIPTION_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'conditional-subscription-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Conditional Subscription Registry',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Conditional Subscription Registry</h1>
