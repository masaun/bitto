...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_ECONOMIC_GAME_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-economic-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Economic Game</h1>
