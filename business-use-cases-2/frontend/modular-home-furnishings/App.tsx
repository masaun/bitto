...
export default function modularHomeFurnishings() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_HOME_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-home-furnishings';
  ...
  return (
    <div>
      <h1>Modular Home Furnishings</h1>
