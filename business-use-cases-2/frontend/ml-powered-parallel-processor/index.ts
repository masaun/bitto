...
const CONTRACT_ADDRESS = process.env.ML_POWERED_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-parallel-processor',
