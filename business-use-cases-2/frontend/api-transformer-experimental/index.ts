...
const CONTRACT_ADDRESS = process.env.API_TRANSFORMER_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'api-transformer-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'api-transformer-experimental',
