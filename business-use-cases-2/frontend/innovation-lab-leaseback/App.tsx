...
const CONTRACT_ADDRESS = process.env.INNOVATION_LAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'innovation-lab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'innovation-lab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>innovation-lab-leaseback</h1>
      {!userData ? (
