...
const CONTRACT_ADDRESS = process.env.TOKENIZED_SUBSCRIPTION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-subscription-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-subscription-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-subscription-engine</h1>
      {!userData ? (
