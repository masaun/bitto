...
const CONTRACT_ADDRESS = process.env.DATA_LAKE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-lake-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'data-lake-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
