...
const CONTRACT_ADDRESS = process.env.REGTECH_COMPLIANCE_MONITOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'regtech-compliance-monitor';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'regtech-compliance-monitor',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>regtech-compliance-monitor</h1>
      {!userData ? (
