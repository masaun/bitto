...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_OPERATIONAL_FUND_6_ADDRESS || '';
const CONTRACT_NAME = 'government-operational-fund-6';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'government-operational-fund-6',
