...
const CONTRACT_ADDRESS = process.env.FIRESTATION_LEASEBACK_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'firestation-leaseback-program';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'firestation-leaseback-program', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>firestation-leaseback-program</h1>
      {!userData ? (
