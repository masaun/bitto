...
const CONTRACT_ADDRESS = process.env.ANTI_CORRUPTION_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'anti-corruption-attestation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Anti Corruption Attestation',
