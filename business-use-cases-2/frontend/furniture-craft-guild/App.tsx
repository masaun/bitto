...
export default function furnitureCraftGuild() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_FURNITURE_CRAFT_GUILD_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'furniture-craft-guild';
