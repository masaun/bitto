...
const contractAddress = process.env.REACT_APP_OBSERVATORY_MAINTENANCE_FUND_CONTRACT_ADDRESS || '';
const contractName = 'observatory-maintenance-fund';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>ouservatory maintenance fund</h1>
