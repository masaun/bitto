...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BLOCKDAEMON_NODE_ADDRESS || '';

export default function Blockdaemon_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.blockdaemon-node/read-only/get-counter`,
        {
          method: 'GET',
