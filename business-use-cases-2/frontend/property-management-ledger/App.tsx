...
const CONTRACT_ADDRESS = process.env.PROPERTY_MANAGEMENT_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'property-management-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>property-management-ledger</h1>
      {!userData ? (
