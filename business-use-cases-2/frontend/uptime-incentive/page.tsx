...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPTIME_INCENTIVE_ADDRESS || '';

export default function Uptime_IncentivePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.uptime-incentive/read-only/get-counter`,
        {
          method: 'GET',
