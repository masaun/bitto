...
const CONTRACT_ADDRESS = process.env.PREDICTIVE_CONSUMER_INSIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'predictive-consumer-insights';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'predictive-consumer-insights',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>predictive-consumer-insights</h1>
      {!userData ? (
