...
const CONTRACT_ADDRESS = process.env.TELEMEDICINE_ACCESS_GATEWAY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'telemedicine-access-gateway';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'telemedicine-access-gateway',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>telemedicine-access-gateway</h1>
      {!userData ? (
