...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_PRIVATE_TRANSACTIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-private-transactions';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'EnterprisePrivateTransactions',
