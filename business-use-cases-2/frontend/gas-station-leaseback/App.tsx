...
const CONTRACT_ADDRESS = process.env.GAS_STATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'gas-station-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'gas-station-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
