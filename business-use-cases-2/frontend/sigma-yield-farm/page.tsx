...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SIGMA_YIELD_FARM_ADDRESS || '';

export default function Sigma_Yield_FarmPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.sigma-yield-farm/read-only/get-counter`,
        {
          method: 'GET',
