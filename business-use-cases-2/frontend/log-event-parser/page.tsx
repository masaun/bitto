...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LOG_EVENT_PARSER_ADDRESS || '';

export default function Log_Event_ParserPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.log-event-parser/read-only/get-counter`,
        {
          method: 'GET',
