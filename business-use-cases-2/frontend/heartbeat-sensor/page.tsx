...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HEARTBEAT_SENSOR_ADDRESS || '';

export default function Heartbeat_SensorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.heartbeat-sensor/read-only/get-counter`,
        {
          method: 'GET',
