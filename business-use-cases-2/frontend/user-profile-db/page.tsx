...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_USER_PROFILE_DB_ADDRESS || '';

export default function User_Profile_DbPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.user-profile-db/read-only/get-counter`,
        {
          method: 'GET',
