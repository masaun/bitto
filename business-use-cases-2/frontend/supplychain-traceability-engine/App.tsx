...
const CONTRACT_ADDRESS = process.env.SUPPLYCHAIN_TRACEABILITY_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'supplychain-traceability-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'supplychain-traceability-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>supplychain-traceability-engine</h1>
      {!userData ? (
