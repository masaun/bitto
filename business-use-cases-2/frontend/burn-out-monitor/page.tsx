...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BURN_OUT_MONITOR_ADDRESS || '';

export default function Burn_Out_MonitorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.burn-out-monitor/read-only/get-counter`,
        {
          method: 'GET',
