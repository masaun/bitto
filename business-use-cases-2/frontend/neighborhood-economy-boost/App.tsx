...
const contractAddress = process.env.REACT_APP_NEIGHBORHOOD_ECONOMY_BOOST_CONTRACT_ADDRESS || '';
const contractName = 'neighborhood-economy-boost';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Neighborhood Economy Boost</h1>
