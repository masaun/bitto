...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_FIXED_RATE_BOND_ADDRESS || '';

export default function Fixed_Rate_BondPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.fixed-rate-bond/read-only/get-counter`,
        {
          method: 'GET',
