...
const CONTRACT_ADDRESS = process.env.GEOLOGICAL_SURVEY_RECORDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'geological-survey-records';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Geological Survey Records',
