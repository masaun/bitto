...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DARK_POOL_LOGIC_ADDRESS || '';

export default function Dark_Pool_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dark-pool-logic/read-only/get-counter`,
        {
          method: 'GET',
