...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PORTFOLIO_TRACKER_ADDRESS || '';

export default function Portfolio_TrackerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.portfolio-tracker/read-only/get-counter`,
        {
          method: 'GET',
