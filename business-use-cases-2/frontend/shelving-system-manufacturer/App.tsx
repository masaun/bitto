...
export default function shelvingSystemManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Shelving System Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SHELVING_SYSTEM_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'shelving-system-manufacturer';
  ...
  return (
    <div>
      <h1>Shelving System Manufacturer</h1>
