...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GAMIFICATION_HUB_ADDRESS || '';

export default function Gamification_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gamification-hub/read-only/get-counter`,
        {
          method: 'GET',
