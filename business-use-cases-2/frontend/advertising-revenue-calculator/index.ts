...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_CALCULATOR_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-calculator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-calculator',
