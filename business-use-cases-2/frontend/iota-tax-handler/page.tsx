...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_IOTA_TAX_HANDLER_ADDRESS || '';

export default function Iota_Tax_HandlerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.iota-tax-handler/read-only/get-counter`,
        {
          method: 'GET',
