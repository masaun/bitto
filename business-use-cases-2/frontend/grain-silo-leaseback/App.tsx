...
const CONTRACT_ADDRESS = process.env.GRAIN_SILO_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'grain-silo-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'grain-silo-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
