...
const contractAddress = process.env.REACT_APP_PROCUREMENT_POLICY_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'procurement-policy-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Procurement Policy Engine',
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Procurement Policy Engine</h1>
