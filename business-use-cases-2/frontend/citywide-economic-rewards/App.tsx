...
const contractAddress = process.env.REACT_APP_CITYWIDE_ECONOMIC_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'citywide-economic-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Citywide Economic Rewards</h1>
