...
const contractAddress = process.env.REACT_APP_CIVIC_ENGAGEMENT_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'civic-engagement-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Civic Engagement Rewards</h1>
