...
const contractAddress = process.env.REACT_APP_SKYBRIDGE_IMAGING_EXCHANGE_CONTRACT_ADDRESS || '';
const contractName = 'skybridge-imaging-exchange';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>skyuridge imaging exchange</h1>
