...
export default function artisanHomeCollection() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_HOME_COLLECTION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-home-collection';
