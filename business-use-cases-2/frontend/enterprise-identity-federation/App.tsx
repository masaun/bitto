...
const CONTRACT_ADDRESS = process.env.ENTERPRISE_IDENTITY_FEDERATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'enterprise-identity-federation';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>enterprise-identity-federation</h1>
      {!userData ? (
