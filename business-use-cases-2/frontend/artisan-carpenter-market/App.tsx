...
export default function artisanCarpenterMarket() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISAN_CARPENTER_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisan-carpenter-market';
  ...
  return (
    <div>
      <h1>Artisan Carpenter Market</h1>
