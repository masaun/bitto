...
export default function artisanalJoineryNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Artisanal Joinery Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_ARTISANAL_JOINERY_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'artisanal-joinery-network';
  ...
  return (
    <div>
      <h1>Artisanal Joinery Network</h1>
