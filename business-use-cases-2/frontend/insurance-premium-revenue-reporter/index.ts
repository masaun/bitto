...
const CONTRACT_ADDRESS = process.env.INSURANCE_PREMIUM_REVENUE_REPORTER_ADDRESS || '';
const CONTRACT_NAME = 'insurance-premium-revenue-reporter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'insurance-premium-revenue-reporter',
