...
export default function modularStorageManufacturer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Modular Storage Manufacturer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_STORAGE_MANUFACTURER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-storage-manufacturer';
  ...
  return (
    <div>
      <h1>Modular Storage Manufacturer</h1>
