...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_CELL_MANAGER_PCC_ADDRESS || '';

export default function Cell_Manager_PccPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.cell-manager-pcc/read-only/get-counter`,
        {
          method: 'GET',
