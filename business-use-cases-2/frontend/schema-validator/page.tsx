...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SCHEMA_VALIDATOR_ADDRESS || '';

export default function Schema_ValidatorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.schema-validator/read-only/get-counter`,
        {
          method: 'GET',
