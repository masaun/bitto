...
export default function seatingDesignLaboratory() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Seating Design Laboratory',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_SEATING_DESIGN_LABORATORY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'seating-design-laboratory';
  ...
  return (
    <div>
      <h1>Seating Design Laboratory</h1>
