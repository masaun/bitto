...
const CONTRACT_ADDRESS = process.env.WEBSOCKET_GATEWAY_PRODUCTION_ADDRESS || '';
const CONTRACT_NAME = 'websocket-gateway-production';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'websocket-gateway-production',
