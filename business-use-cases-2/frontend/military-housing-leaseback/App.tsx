...
const CONTRACT_ADDRESS = process.env.MILITARY_HOUSING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'military-housing-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'military-housing-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>military-housing-leaseback</h1>
      {!userData ? (
