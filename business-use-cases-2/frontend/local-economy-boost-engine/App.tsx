...
const contractAddress = process.env.REACT_APP_LOCAL_ECONOMY_BOOST_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'local-economy-boost-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Economy Boost Engine</h1>
