...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COPPER_CLEAR_INT_ADDRESS || '';

export default function Copper_Clear_IntPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.copper-clear-int/read-only/get-counter`,
        {
          method: 'GET',
