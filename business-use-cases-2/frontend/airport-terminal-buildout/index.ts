...
const CONTRACT_ADDRESS = process.env.AIRPORT_TERMINAL_BUILDOUT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airport-terminal-buildout';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Airport Terminal Buildout',
