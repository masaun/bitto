...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_REDSTONE_ADAPTER_ADDRESS || '';

export default function Redstone_AdapterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.redstone-adapter/read-only/get-counter`,
        {
          method: 'GET',
