...
const CONTRACT_ADDRESS = process.env.SPORTS_HEALTH_DATA_ORACLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'sports-health-data-oracle';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Sports Health Data Oracle',
