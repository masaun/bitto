...
export default function minimalistFurnitureLine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Minimalist Furniture Line',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MINIMALIST_FURNITURE_LINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'minimalist-furniture-line';
  ...
  return (
    <div>
      <h1>Minimalist Furniture Line</h1>
