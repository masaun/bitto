...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_VERIFIER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-verifier';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-verifier',
