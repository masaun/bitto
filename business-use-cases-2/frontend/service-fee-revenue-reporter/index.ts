...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_REPORTER_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-reporter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-reporter',
