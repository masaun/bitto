...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_API3_QRNG_LOGIC_ADDRESS || '';

export default function Api3_Qrng_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.api3-qrng-logic/read-only/get-counter`,
        {
          method: 'GET',
