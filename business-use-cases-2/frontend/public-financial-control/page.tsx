...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_FINANCIAL_CONTROL_ADDRESS || '';

export default function Public_Financial_ControlPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-financial-control/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'public-financial-control',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>public-financial-control</h1>
