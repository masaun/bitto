...
const CONTRACT_ADDRESS = process.env.AQUATIC_CENTER_OPERATIONS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aquatic-center-operations';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Aquatic Center Operations',
