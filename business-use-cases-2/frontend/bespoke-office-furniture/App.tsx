...
export default function bespokeOfficeFurniture() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_OFFICE_FURNITURE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-office-furniture';
