...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VOLUME_TRACKER_ADDRESS || '';

export default function Volume_TrackerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.volume-tracker/read-only/get-counter`,
        {
          method: 'GET',
