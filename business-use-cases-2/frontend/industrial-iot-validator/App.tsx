...
const CONTRACT_ADDRESS = process.env.INDUSTRIAL_IOT_VALIDATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'industrial-iot-validator';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>industrial-iot-validator</h1>
      {!userData ? (
