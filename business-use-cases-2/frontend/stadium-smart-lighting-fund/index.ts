...
const CONTRACT_ADDRESS = process.env.STADIUM_SMART_LIGHTING_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'stadium-smart-lighting-fund';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Stadium Smart Lighting Fund',
