...
export default function timberProcessingRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Processing Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_PROCESSING_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-processing-registry';
  ...
  return (
    <div>
      <h1>Timber Processing Registry</h1>
