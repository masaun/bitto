...
const CONTRACT_ADDRESS = process.env.OTC_CLEARING_INTEREST_RATE_SWAP_ADDRESS || '';
const CONTRACT_NAME = 'otc-clearing-interest-rate-swap';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-clearing-interest-rate-swap',
