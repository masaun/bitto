...
export default function retailShowroomManagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Retail Showroom Management',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_SHOWROOM_MANAGEMENT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-showroom-management';
  ...
  return (
    <div>
      <h1>Retail Showroom Management</h1>
