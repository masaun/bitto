...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_STEERING_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'divisional-steering-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-steering-committee',
