...
const CONTRACT_ADDRESS = process.env.BILATERAL_NETTING_FORWARD_RATE_AGREEMENT_ADDRESS || '';
const CONTRACT_NAME = 'bilateral-netting-forward-rate-agreement';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'bilateral-netting-forward-rate-agreement',
