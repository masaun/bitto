...
const CONTRACT_ADDRESS = process.env.AFFILIATE_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'affiliate-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'affiliate-revenue-distributor',
