...
export default function modularOfficeFurnishings() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Modular Office Furnishings',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_MODULAR_OFFICE_FURNISHINGS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'modular-office-furnishings';
  ...
  return (
    <div>
      <h1>Modular Office Furnishings</h1>
