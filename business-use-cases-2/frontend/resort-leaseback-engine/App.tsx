...
const CONTRACT_ADDRESS = process.env.RESORT_LEASEBACK_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'resort-leaseback-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'resort-leaseback-engine', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
