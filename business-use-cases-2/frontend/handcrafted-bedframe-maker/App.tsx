...
export default function handcraftedBedframeMaker() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Handcrafted Bedframe Maker',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HANDCRAFTED_BEDFRAME_MAKER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'handcrafted-bedframe-maker';
  ...
  return (
    <div>
      <h1>Handcrafted Bedframe Maker</h1>
