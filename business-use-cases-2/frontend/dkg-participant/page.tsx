...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DKG_PARTICIPANT_ADDRESS || '';

export default function Dkg_ParticipantPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.dkg-participant/read-only/get-counter`,
        {
          method: 'GET',
