...
export default function workspaceFurnitureBid() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_FURNITURE_BID_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-furniture-bid';
