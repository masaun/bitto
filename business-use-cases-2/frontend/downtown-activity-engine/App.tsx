...
const contractAddress = process.env.REACT_APP_DOWNTOWN_ACTIVITY_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'downtown-activity-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Downtown Activity Engine</h1>
