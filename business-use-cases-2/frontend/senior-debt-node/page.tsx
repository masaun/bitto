...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_SENIOR_DEBT_NODE_ADDRESS || '';

export default function Senior_Debt_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.senior-debt-node/read-only/get-counter`,
        {
          method: 'GET',
