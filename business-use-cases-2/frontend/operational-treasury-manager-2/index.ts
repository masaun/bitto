...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_TREASURY_MANAGER_2_ADDRESS || '';
const CONTRACT_NAME = 'operational-treasury-manager-2';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-treasury-manager-2',
