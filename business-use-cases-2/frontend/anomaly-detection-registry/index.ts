...
const CONTRACT_ADDRESS = process.env.ANOMALY_DETECTION_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'anomaly-detection-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Anomaly Detection Registry',
