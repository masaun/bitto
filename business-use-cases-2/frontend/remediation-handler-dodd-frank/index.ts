...
const CONTRACT_ADDRESS = process.env.REMEDIATION_HANDLER_DODD_FRANK_ADDRESS || '';
const CONTRACT_NAME = 'remediation-handler-dodd-frank';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'remediation-handler-dodd-frank',
