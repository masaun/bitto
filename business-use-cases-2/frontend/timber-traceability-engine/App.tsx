...
export default function timberTraceabilityEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Traceability Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_TRACEABILITY_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-traceability-engine';
  ...
  return (
    <div>
      <h1>Timber Traceability Engine</h1>
