...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_XBTC_RESERVE_MGR_ADDRESS || '';

export default function Xbtc_Reserve_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.xbtc-reserve-mgr/read-only/get-counter`,
        {
          method: 'GET',
