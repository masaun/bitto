...
export default function timberFurnitureLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FURNITURE_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-furniture-ledger';
