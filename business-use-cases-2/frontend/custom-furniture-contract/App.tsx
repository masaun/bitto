...
export default function customFurnitureContract() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Custom Furniture Contract',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_FURNITURE_CONTRACT_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-furniture-contract';
  ...
  return (
    <div>
      <h1>Custom Furniture Contract</h1>
