...
const CONTRACT_ADDRESS = process.env.OPENING_SHOW_TICKET_VAULT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'opening-show-ticket-vault';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Opening Show Ticket Vault',
