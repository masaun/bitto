...
export default function hospitalityFurnitureBid() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Furniture Bid',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_FURNITURE_BID_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-furniture-bid';
  ...
  return (
    <div>
      <h1>Hospitality Furniture Bid</h1>
