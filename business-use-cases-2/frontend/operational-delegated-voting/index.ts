...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_DELEGATED_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'operational-delegated-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-delegated-voting',
