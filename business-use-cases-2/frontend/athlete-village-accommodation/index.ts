...
const CONTRACT_ADDRESS = process.env.ATHLETE_VILLAGE_ACCOMMODATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-village-accommodation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Village Accommodation',
