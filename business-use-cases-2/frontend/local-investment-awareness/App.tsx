...
const contractAddress = process.env.REACT_APP_LOCAL_INVESTMENT_AWARENESS_CONTRACT_ADDRESS || '';
const contractName = 'local-investment-awareness';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Investment Awareness</h1>
