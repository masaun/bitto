...
const CONTRACT_ADDRESS = process.env.PATROL_VEHICLE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'patrol-vehicle-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'patrol-vehicle-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>patrol-vehicle-leaseback</h1>
      {!userData ? (
