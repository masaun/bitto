...
const CONTRACT_ADDRESS = process.env.HARVESTER_EQUIPMENT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'harvester-equipment-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'harvester-equipment-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>harvester-equipment-leaseback</h1>
      {!userData ? (
