...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_COMMUNITY_VOTING_ADDRESS || '';

export default function Community_VotingPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.community-voting/read-only/get-counter`,
        {
          method: 'GET',
