...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_LETTER_OF_CREDIT_ADDRESS || '';

export default function Letter_Of_CreditPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.letter-of-credit/read-only/get-counter`,
        {
          method: 'GET',
