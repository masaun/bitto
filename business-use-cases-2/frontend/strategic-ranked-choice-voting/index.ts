...
const CONTRACT_ADDRESS = process.env.STRATEGIC_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'strategic-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'strategic-ranked-choice-voting',
