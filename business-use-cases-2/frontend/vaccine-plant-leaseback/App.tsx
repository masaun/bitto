...
const CONTRACT_ADDRESS = process.env.VACCINE_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'vaccine-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'vaccine-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
