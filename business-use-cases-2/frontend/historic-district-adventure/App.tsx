...
const contractAddress = process.env.REACT_APP_HISTORIC_DISTRICT_ADVENTURE_CONTRACT_ADDRESS || '';
const contractName = 'historic-district-adventure';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Historic District Adventure</h1>
