...
const CONTRACT_ADDRESS = process.env.INSTITUTIONAL_VAULT_ROUTER_5_ADDRESS || '';
const CONTRACT_NAME = 'institutional-vault-router-5';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'institutional-vault-router-5',
