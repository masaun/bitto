...
const CONTRACT_ADDRESS = process.env.FORKLIFT_LEASEBACK_PROGRAM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'forklift-leaseback-program';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'forklift-leaseback-program', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>forklift-leaseback-program</h1>
      {!userData ? (
