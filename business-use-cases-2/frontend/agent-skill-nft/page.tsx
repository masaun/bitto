...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_AGENT_SKILL_NFT_ADDRESS || '';

export default function Agent_Skill_NftPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.agent-skill-nft/read-only/get-counter`,
        {
          method: 'GET',
