...
const CONTRACT_ADDRESS = process.env.ML_POWERED_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'ml-powered-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'ml-powered-predictive-processor',
