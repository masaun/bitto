...
const CONTRACT_ADDRESS = process.env.COLDCHAIN_PORTFOLIO_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'coldchain-portfolio-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'coldchain-portfolio-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>coldchain-portfolio-leaseback</h1>
      {!userData ? (
