...
const CONTRACT_ADDRESS = process.env.OTC_MATCHING_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-matching-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-matching-commodity-option',
