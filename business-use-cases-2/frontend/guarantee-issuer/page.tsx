...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GUARANTEE_ISSUER_ADDRESS || '';

export default function Guarantee_IssuerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.guarantee-issuer/read-only/get-counter`,
        {
          method: 'GET',
