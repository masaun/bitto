...
export default function customWardrobeFabricator() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Custom Wardrobe Fabricator',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CUSTOM_WARDROBE_FABRICATOR_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'custom-wardrobe-fabricator';
  ...
  return (
    <div>
      <h1>Custom Wardrobe Fabricator</h1>
