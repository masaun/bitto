...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_GEMINI_TRUST_API_ADDRESS || '';

export default function Gemini_Trust_ApiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.gemini-trust-api/read-only/get-counter`,
        {
          method: 'GET',
