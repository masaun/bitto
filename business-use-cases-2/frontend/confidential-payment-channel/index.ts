...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_PAYMENT_CHANNEL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-payment-channel';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialPaymentChannel',
