...
const CONTRACT_ADDRESS = process.env.CROWDSOURCED_MAPPING_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crowdsourced-mapping-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crowdsourced-mapping-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crowdsourced-mapping-engine</h1>
      {!userData ? (
