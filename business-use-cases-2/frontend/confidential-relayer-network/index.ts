...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_RELAYER_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-relayer-network';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ConfidentialRelayerNetwork',
