...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_AUTONOMOUS_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-autonomous-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'decentralized-autonomous-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>decentralized-autonomous-market</h1>
      {!userData ? (
