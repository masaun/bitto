...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_HALL_OF_FAME_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-hall-of-fame';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Hall Of Fame',
