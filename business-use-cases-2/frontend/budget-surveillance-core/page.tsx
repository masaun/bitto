...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_BUDGET_SURVEILLANCE_CORE_ADDRESS || '';

export default function Budget_Surveillance_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.budget-surveillance-core/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'budget-surveillance-core',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>budget-surveillance-core</h1>
