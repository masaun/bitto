...
export default function decorManufacturingProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Decor Manufacturing Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_DECOR_MANUFACTURING_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'decor-manufacturing-protocol';
  ...
  return (
    <div>
      <h1>Decor Manufacturing Protocol</h1>
