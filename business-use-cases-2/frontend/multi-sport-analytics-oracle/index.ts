...
const CONTRACT_ADDRESS = process.env.MULTI_SPORT_ANALYTICS_ORACLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'multi-sport-analytics-oracle';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Multi Sport Analytics Oracle',
