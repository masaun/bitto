...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TREASURY_SURPLUS_ADDRESS || '';

export default function Treasury_SurplusPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.treasury-surplus/read-only/get-counter`,
        {
          method: 'GET',
