...
const CONTRACT_ADDRESS = process.env.DIVISIONAL_STRATEGY_COMMITTEE_ADDRESS || '';
const CONTRACT_NAME = 'divisional-strategy-committee';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'divisional-strategy-committee',
