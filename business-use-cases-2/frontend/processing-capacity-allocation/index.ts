...
const CONTRACT_ADDRESS = process.env.PROCESSING_CAPACITY_ALLOCATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'processing-capacity-allocation';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Processing Capacity Allocation',
