...
export default function cabinetryDesignProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Cabinetry Design Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_CABINETRY_DESIGN_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'cabinetry-design-protocol';
  ...
  return (
    <div>
      <h1>Cabinetry Design Protocol</h1>
