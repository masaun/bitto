...
const CONTRACT_ADDRESS = process.env.PRIVATE_TRANSACTION_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'private-transaction-registry';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'PrivateTransactionRegistry',
