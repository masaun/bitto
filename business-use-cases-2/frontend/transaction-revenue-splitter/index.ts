...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_SPLITTER_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-splitter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-splitter',
