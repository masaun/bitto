...
const CONTRACT_ADDRESS = process.env.ROBOTICS_WAREHOUSE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'robotics-warehouse-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'robotics-warehouse-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>robotics-warehouse-leaseback</h1>
      {!userData ? (
