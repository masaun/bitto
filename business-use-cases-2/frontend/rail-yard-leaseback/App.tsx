...
const CONTRACT_ADDRESS = process.env.RAIL_YARD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rail-yard-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'rail-yard-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
