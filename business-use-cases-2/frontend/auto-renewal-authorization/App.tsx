...
const contractAddress = process.env.REACT_APP_AUTO_RENEWAL_AUTHORIZATION_CONTRACT_ADDRESS || '';
const contractName = 'auto-renewal-authorization';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'Auto Renewal Authorization',
