...
const CONTRACT_ADDRESS = process.env.AFFORDABLE_HOUSING_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'affordable-housing-engine';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Affordable Housing Engine',
