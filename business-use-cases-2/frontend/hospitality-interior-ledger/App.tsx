...
export default function hospitalityInteriorLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Hospitality Interior Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_HOSPITALITY_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'hospitality-interior-ledger';
  ...
  return (
    <div>
      <h1>Hospitality Interior Ledger</h1>
