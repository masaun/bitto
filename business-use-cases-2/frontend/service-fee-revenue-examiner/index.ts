...
const CONTRACT_ADDRESS = process.env.SERVICE_FEE_REVENUE_EXAMINER_ADDRESS || '';
const CONTRACT_NAME = 'service-fee-revenue-examiner';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'service-fee-revenue-examiner',
