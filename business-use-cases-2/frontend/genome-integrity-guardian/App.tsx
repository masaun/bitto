...
const contractAddress = process.env.REACT_APP_GENOME_INTEGRITY_GUARDIAN_CONTRACT_ADDRESS || '';
const contractName = 'genome-integrity-guardian';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>genome integrity guardian</h1>
