...
const CONTRACT_ADDRESS = process.env.BROADCAST_TOWER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'broadcast-tower-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'broadcast-tower-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>broadcast-tower-leaseback</h1>
      {!userData ? (
