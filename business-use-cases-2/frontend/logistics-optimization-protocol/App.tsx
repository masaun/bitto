...
const CONTRACT_ADDRESS = process.env.LOGISTICS_OPTIMIZATION_PROTOCOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'logistics-optimization-protocol';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'logistics-optimization-protocol',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>logistics-optimization-protocol</h1>
      {!userData ? (
