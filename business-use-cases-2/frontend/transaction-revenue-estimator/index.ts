...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_ESTIMATOR_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-estimator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-estimator',
