...
const contractAddress = process.env.REACT_APP_LOCAL_ENGAGEMENT_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'local-engagement-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Local Engagement Protocol</h1>
