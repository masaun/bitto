...
export default function premiumFurnitureBrandRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Premium Furniture Brand Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_PREMIUM_FURNITURE_BRAND_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'premium-furniture-brand-registry';
  ...
  return (
    <div>
      <h1>Premium Furniture Brand Registry</h1>
