...
export default function bespokeSeatingEngine() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_BESPOKE_SEATING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'bespoke-seating-engine';
