...
const CONTRACT_ADDRESS = process.env.OTC_CLEARING_COMMODITY_OPTION_ADDRESS || '';
const CONTRACT_NAME = 'otc-clearing-commodity-option';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'otc-clearing-commodity-option',
