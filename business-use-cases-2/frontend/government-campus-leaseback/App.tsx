...
const CONTRACT_ADDRESS = process.env.GOVERNMENT_CAMPUS_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'government-campus-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'government-campus-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>government-campus-leaseback</h1>
      {!userData ? (
