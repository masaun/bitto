...
const CONTRACT_ADDRESS = process.env.OPENCLAW_IDENTITY_ORACLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'openclaw-identity-oracle';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>openclaw-identity-oracle</h1>
      {!userData ? (
