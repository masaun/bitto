...
const CONTRACT_ADDRESS = process.env.OPERATIONAL_RANKED_CHOICE_VOTING_ADDRESS || '';
const CONTRACT_NAME = 'operational-ranked-choice-voting';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'operational-ranked-choice-voting',
