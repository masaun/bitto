...
const CONTRACT_ADDRESS = process.env.DEPARTMENTAL_STAKEHOLDER_COUNCIL_ADDRESS || '';
const CONTRACT_NAME = 'departmental-stakeholder-council';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'departmental-stakeholder-council',
