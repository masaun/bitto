...
const CONTRACT_ADDRESS = process.env.TOKENIZED_INTELLECTUAL_PROPERTY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-intellectual-property';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-intellectual-property',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-intellectual-property</h1>
      {!userData ? (
