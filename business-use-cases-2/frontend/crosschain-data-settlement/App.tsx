...
const CONTRACT_ADDRESS = process.env.CROSSCHAIN_DATA_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crosschain-data-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'crosschain-data-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>crosschain-data-settlement</h1>
      {!userData ? (
