...
const CONTRACT_ADDRESS = process.env.RAILCAR_LEASEBACK_FUND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'railcar-leaseback-fund';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'railcar-leaseback-fund', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
