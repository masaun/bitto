...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_OKX_SNAPSHOT_CHK_ADDRESS || '';

export default function Okx_Snapshot_ChkPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.okx-snapshot-chk/read-only/get-counter`,
        {
          method: 'GET',
