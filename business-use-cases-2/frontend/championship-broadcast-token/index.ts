...
const CONTRACT_ADDRESS = process.env.CHAMPIONSHIP_BROADCAST_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'championship-broadcast-token';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Championship Broadcast Token',
