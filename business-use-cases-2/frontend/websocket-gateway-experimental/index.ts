...
const CONTRACT_ADDRESS = process.env.WEBSOCKET_GATEWAY_EXPERIMENTAL_ADDRESS || '';
const CONTRACT_NAME = 'websocket-gateway-experimental';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'websocket-gateway-experimental',
