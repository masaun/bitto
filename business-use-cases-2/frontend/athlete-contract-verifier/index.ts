...
const CONTRACT_ADDRESS = process.env.ATHLETE_CONTRACT_VERIFIER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'athlete-contract-verifier';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Athlete Contract Verifier',
