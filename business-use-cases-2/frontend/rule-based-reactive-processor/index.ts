...
const CONTRACT_ADDRESS = process.env.RULE_BASED_REACTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-reactive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-reactive-processor',
