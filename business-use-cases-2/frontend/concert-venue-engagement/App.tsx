...
const contractAddress = process.env.REACT_APP_CONCERT_VENUE_ENGAGEMENT_CONTRACT_ADDRESS || '';
const contractName = 'concert-venue-engagement';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Concert Venue Engagement</h1>
