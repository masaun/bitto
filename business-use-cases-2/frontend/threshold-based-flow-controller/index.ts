...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_FLOW_CONTROLLER_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-flow-controller';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-flow-controller',
