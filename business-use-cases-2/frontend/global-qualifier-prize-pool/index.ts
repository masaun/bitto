...
const CONTRACT_ADDRESS = process.env.GLOBAL_QUALIFIER_PRIZE_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'global-qualifier-prize-pool';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Global Qualifier Prize Pool',
