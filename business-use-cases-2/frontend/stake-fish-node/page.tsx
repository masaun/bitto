...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_STAKE_FISH_NODE_ADDRESS || '';

export default function Stake_Fish_NodePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.stake-fish-node/read-only/get-counter`,
        {
          method: 'GET',
