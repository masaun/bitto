...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_HEDGE_FUND_VAULT_ADDRESS || '';

export default function Hedge_Fund_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.hedge-fund-vault/read-only/get-counter`,
        {
          method: 'GET',
