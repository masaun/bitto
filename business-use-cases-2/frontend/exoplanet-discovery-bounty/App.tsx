...
const contractAddress = process.env.REACT_APP_EXOPLANET_DISCOVERY_BOUNTY_CONTRACT_ADDRESS || '';
const contractName = 'exoplanet-discovery-bounty';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>exoplanet discovery uounty</h1>
