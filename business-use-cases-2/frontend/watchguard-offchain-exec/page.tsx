...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WATCHGUARD_OFFCHAIN_EXEC_ADDRESS || '';

export default function Watchguard_Offchain_ExecPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.watchguard-offchain-exec/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'watchguard-offchain-exec',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>watchguard-offchain-exec</h1>
