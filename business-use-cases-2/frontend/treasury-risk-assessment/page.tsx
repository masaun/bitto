...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TREASURY_RISK_ASSESSMENT_ADDRESS || '';

export default function Treasury_Risk_AssessmentPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.treasury-risk-assessment/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'treasury-risk-assessment',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>treasury-risk-assessment</h1>
