...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_QUOTE_ASSET_FEED_ADDRESS || '';

export default function Quote_Asset_FeedPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.quote-asset-feed/read-only/get-counter`,
        {
          method: 'GET',
