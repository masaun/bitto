...
const CONTRACT_ADDRESS = process.env.EVENT_DRIVEN_ACTION_EXECUTOR_ADDRESS || '';
const CONTRACT_NAME = 'event-driven-action-executor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'event-driven-action-executor',
