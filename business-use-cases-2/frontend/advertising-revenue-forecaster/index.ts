...
const CONTRACT_ADDRESS = process.env.ADVERTISING_REVENUE_FORECASTER_ADDRESS || '';
const CONTRACT_NAME = 'advertising-revenue-forecaster';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'advertising-revenue-forecaster',
