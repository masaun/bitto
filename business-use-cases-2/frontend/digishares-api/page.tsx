...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_DIGISHARES_API_ADDRESS || '';

export default function Digishares_ApiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.digishares-api/read-only/get-counter`,
        {
          method: 'GET',
