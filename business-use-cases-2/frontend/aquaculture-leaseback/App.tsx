...
const CONTRACT_ADDRESS = process.env.AQUACULTURE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aquaculture-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'aquaculture-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
