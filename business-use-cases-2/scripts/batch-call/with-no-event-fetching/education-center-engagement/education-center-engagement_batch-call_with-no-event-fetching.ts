...
const contractDetails = parseContractIdentifier(
  process.env.EDUCATION_CENTER_ENGAGEMENT_CONTRACT_ADDRESS,
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for EducationCenterEngagement Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  EducationCenterEngagement Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log('Environment Variable: EDUCATION_CENTER_ENGAGEMENT_CONTRACT_ADDRESS');

  if (!process.env.EDUCATION_CENTER_ENGAGEMENT_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: EDUCATION_CENTER_ENGAGEMENT_CONTRACT_ADDRESS not set in environment.');
