...
const contractDetails = parseContractIdentifier(
  process.env.CULTURAL_HERITAGE_ECONOMY_CONTRACT_ADDRESS,
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for CulturalHeritageEconomy Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  CulturalHeritageEconomy Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log('Environment Variable: CULTURAL_HERITAGE_ECONOMY_CONTRACT_ADDRESS');

  if (!process.env.CULTURAL_HERITAGE_ECONOMY_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: CULTURAL_HERITAGE_ECONOMY_CONTRACT_ADDRESS not set in environment.');
