...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for LocalCityProsperity Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  LocalCityProsperity Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log('Environment Variable: LOCAL_CITY_PROSPERITY_CONTRACT_ADDRESS');

  if (!process.env.LOCAL_CITY_PROSPERITY_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: LOCAL_CITY_PROSPERITY_CONTRACT_ADDRESS not set in environment.');
