...
const contractDetails = parseContractIdentifier(
  process.env.NEIGHBORHOOD_ECONOMIC_GAME_CONTRACT_ADDRESS,
  'neighborhood-economic-game'
);
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for NeighborhoodEconomicGame Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  NeighborhoodEconomicGame Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log('Environment Variable: NEIGHBORHOOD_ECONOMIC_GAME_CONTRACT_ADDRESS');

  if (!process.env.NEIGHBORHOOD_ECONOMIC_GAME_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: NEIGHBORHOOD_ECONOMIC_GAME_CONTRACT_ADDRESS not set in environment.');
