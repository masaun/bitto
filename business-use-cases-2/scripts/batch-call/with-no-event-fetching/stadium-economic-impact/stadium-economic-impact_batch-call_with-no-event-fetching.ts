...
const contractDetails = parseContractIdentifier(
  process.env.STADIUM_ECONOMIC_IMPACT_CONTRACT_ADDRESS,
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for StadiumEconomicImpact Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  StadiumEconomicImpact Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log('Environment Variable: STADIUM_ECONOMIC_IMPACT_CONTRACT_ADDRESS');

  if (!process.env.STADIUM_ECONOMIC_IMPACT_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: STADIUM_ECONOMIC_IMPACT_CONTRACT_ADDRESS not set in environment.');
