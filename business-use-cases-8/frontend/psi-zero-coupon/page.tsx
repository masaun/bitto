...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PSI_ZERO_COUPON_ADDRESS || '';

export default function Psi_Zero_CouponPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.psi-zero-coupon/read-only/get-counter`,
        {
          method: 'GET',
