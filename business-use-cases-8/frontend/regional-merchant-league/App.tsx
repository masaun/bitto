...
const contractAddress = process.env.REACT_APP_REGIONAL_MERCHANT_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'regional-merchant-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Merchant League</h1>
