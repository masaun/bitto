...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_QUORUM_VALIDATOR_ADDRESS || '';

export default function Quorum_ValidatorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.quorum-validator/read-only/get-counter`,
        {
          method: 'GET',
