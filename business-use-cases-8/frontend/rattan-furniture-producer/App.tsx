...
export default function rattanFurnitureProducer() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Rattan Furniture Producer',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RATTAN_FURNITURE_PRODUCER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'rattan-furniture-producer';
  ...
  return (
    <div>
      <h1>Rattan Furniture Producer</h1>
