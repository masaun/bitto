...
const CONTRACT_ADDRESS = process.env.REGIONAL_QUALIFIER_HOSTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'regional-qualifier-hosting';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Regional Qualifier Hosting',
