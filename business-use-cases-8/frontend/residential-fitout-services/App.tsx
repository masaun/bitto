...
export default function residentialFitoutServices() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Fitout Services',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_FITOUT_SERVICES_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-fitout-services';
  ...
  return (
    <div>
      <h1>Residential Fitout Services</h1>
