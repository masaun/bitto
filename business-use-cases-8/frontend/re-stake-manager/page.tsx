...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RE_STAKE_MANAGER_ADDRESS || '';

export default function Re_Stake_ManagerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.re-stake-manager/read-only/get-counter`,
        {
          method: 'GET',
