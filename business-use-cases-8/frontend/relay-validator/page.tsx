...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RELAY_VALIDATOR_ADDRESS || '';

export default function Relay_ValidatorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.relay-validator/read-only/get-counter`,
        {
          method: 'GET',
