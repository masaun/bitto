...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RESERVE_FUND_V1_ADDRESS || '';

export default function Reserve_Fund_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.reserve-fund-v1/read-only/get-counter`,
        {
          method: 'GET',
