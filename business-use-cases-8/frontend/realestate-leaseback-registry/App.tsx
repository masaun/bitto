...
const CONTRACT_ADDRESS = process.env.REALESTATE_LEASEBACK_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'realestate-leaseback-registry';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'realestate-leaseback-registry', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>realestate-leaseback-registry</h1>
      {!userData ? (
