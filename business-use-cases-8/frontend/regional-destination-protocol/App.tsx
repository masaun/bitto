...
const contractAddress = process.env.REACT_APP_REGIONAL_DESTINATION_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'regional-destination-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Destination Protocol</h1>
