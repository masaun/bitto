...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RECOVERY_PHRASE_ADDRESS || '';

export default function Recovery_PhrasePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.recovery-phrase/read-only/get-counter`,
        {
          method: 'GET',
