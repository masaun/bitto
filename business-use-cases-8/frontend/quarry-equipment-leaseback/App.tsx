...
const CONTRACT_ADDRESS = process.env.QUARRY_EQUIPMENT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'quarry-equipment-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'quarry-equipment-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>quarry-equipment-leaseback</h1>
      {!userData ? (
