...
export default function residentialSeatingEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Seating Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_SEATING_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-seating-engine';
  ...
  return (
    <div>
      <h1>Residential Seating Engine</h1>
