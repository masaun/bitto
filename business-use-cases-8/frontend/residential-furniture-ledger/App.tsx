...
export default function residentialFurnitureLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Furniture Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_FURNITURE_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-furniture-ledger';
  ...
  return (
    <div>
      <h1>Residential Furniture Ledger</h1>
