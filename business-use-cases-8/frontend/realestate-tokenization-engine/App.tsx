...
const CONTRACT_ADDRESS = process.env.REALESTATE_TOKENIZATION_ENGINE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'realestate-tokenization-engine';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'realestate-tokenization-engine',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>realestate-tokenization-engine</h1>
      {!userData ? (
