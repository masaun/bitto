...
export default function retailInteriorLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-interior-ledger';
