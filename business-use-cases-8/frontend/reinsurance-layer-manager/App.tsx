...
const contractAddress = process.env.REACT_APP_REINSURANCE_LAYER_MANAGER_CONTRACT_ADDRESS || '';
const contractName = 'reinsurance-layer-manager';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>reinsurance layer manager</h1>
