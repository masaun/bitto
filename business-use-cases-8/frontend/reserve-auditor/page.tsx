...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RESERVE_AUDITOR_ADDRESS || '';

export default function Reserve_AuditorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.reserve-auditor/read-only/get-counter`,
        {
          method: 'GET',
