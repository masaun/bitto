...
const CONTRACT_ADDRESS = process.env.RENEWABLE_INFRASTRUCTURE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-infrastructure-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'renewable-infrastructure-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-infrastructure-leaseback</h1>
      {!userData ? (
