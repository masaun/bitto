...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_REVOKE_LIST_MGR_ADDRESS || '';

export default function Revoke_List_MgrPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.revoke-list-mgr/read-only/get-counter`,
        {
          method: 'GET',
