...
const CONTRACT_ADDRESS = process.env.RENEWABLE_GRID_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-grid-coordinator';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-grid-coordinator',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-grid-coordinator</h1>
      {!userData ? (
