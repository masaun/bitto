...
export default function retailFurnishingProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Retail Furnishing Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_FURNISHING_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-furnishing-protocol';
  ...
  return (
    <div>
      <h1>Retail Furnishing Protocol</h1>
