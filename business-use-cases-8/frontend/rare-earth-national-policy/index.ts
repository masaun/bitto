...
const CONTRACT_ADDRESS = process.env.RARE_EARTH_NATIONAL_POLICY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rare-earth-national-policy';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Rare Earth National Policy',
