...
export default function retailShowroomLedger() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_SHOWROOM_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-showroom-ledger';
