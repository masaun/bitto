...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RISK_MODELING_AI_ADDRESS || '';

export default function Risk_Modeling_AiPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.risk-modeling-ai/read-only/get-counter`,
        {
          method: 'GET',
