...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RIPPLE_LEDGER_V1_ADDRESS || '';

export default function Ripple_Ledger_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ripple-ledger-v1/read-only/get-counter`,
        {
          method: 'GET',
