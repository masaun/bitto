...
const CONTRACT_ADDRESS = process.env.ROBOTICS_LAB_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'robotics-lab-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'robotics-lab-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
