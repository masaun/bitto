...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_REVENUE_NEUTRAL_ADJUSTER_ADDRESS || '';

export default function Revenue_Neutral_AdjusterPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.revenue-neutral-adjuster/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'revenue-neutral-adjuster',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>revenue-neutral-adjuster</h1>
