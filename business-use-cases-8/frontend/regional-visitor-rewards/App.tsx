...
const contractAddress = process.env.REACT_APP_REGIONAL_VISITOR_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'regional-visitor-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Visitor Rewards</h1>
