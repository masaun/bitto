...
const contractAddress = process.env.REACT_APP_PUBLIC_PARK_EXPLORATION_GAME_CONTRACT_ADDRESS || '';
const contractName = 'public-park-exploration-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Public Park Exploration Game</h1>
