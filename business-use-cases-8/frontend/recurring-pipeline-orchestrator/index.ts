...
const CONTRACT_ADDRESS = process.env.RECURRING_PIPELINE_ORCHESTRATOR_ADDRESS || '';
const CONTRACT_NAME = 'recurring-pipeline-orchestrator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-pipeline-orchestrator',
