...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ROUTE_OPTIMIZER_ADDRESS || '';

export default function Route_OptimizerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.route-optimizer/read-only/get-counter`,
        {
          method: 'GET',
