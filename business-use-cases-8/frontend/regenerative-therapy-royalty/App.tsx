...
const contractAddress = process.env.REACT_APP_REGENERATIVE_THERAPY_ROYALTY_CONTRACT_ADDRESS || '';
const contractName = 'regenerative-therapy-royalty';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>regenerative therapy royalty</h1>
