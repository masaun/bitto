...
const CONTRACT_ADDRESS = process.env.QUARRY_ASSET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'quarry-asset-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'quarry-asset-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
