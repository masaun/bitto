...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_REVENUE_SHARING_ADDRESS || '';

export default function Revenue_SharingPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.revenue-sharing/read-only/get-counter`,
        {
          method: 'GET',
