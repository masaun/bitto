...
const contractAddress = process.env.REACT_APP_RESTAURANT_CHECKIN_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'restaurant-checkin-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Restaurant Checkin Rewards</h1>
