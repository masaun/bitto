...
const contractAddress = process.env.REACT_APP_RENEWAL_CONDITION_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'renewal-condition-engine';
...
export default function App() {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '40px auto', padding: '20px', fontFamily: 'sans-serif' }}>
      <h1>Renewal Condition Engine</h1>
