...
const CONTRACT_ADDRESS = process.env.RENEWABLE_CREDIT_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-credit-exchange';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-credit-exchange',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-credit-exchange</h1>
      {!userData ? (
