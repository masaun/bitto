...
const contractAddress = process.env.REACT_APP_REGIONAL_COMMERCE_CHALLENGE_CONTRACT_ADDRESS || '';
const contractName = 'regional-commerce-challenge';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Commerce Challenge</h1>
