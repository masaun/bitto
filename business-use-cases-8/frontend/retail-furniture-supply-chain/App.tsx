...
export default function retailFurnitureSupplyChain() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Retail Furniture Supply Chain',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_FURNITURE_SUPPLY_CHAIN_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-furniture-supply-chain';
  ...
  return (
    <div>
      <h1>Retail Furniture Supply Chain</h1>
