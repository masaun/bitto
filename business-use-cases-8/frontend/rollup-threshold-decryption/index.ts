...
const CONTRACT_ADDRESS = process.env.ROLLUP_THRESHOLD_DECRYPTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rollup-threshold-decryption';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'RollupThresholdDecryption',
