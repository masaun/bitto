...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RIPPLE_EVM_PROXY_ADDRESS || '';

export default function Ripple_Evm_ProxyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ripple-evm-proxy/read-only/get-counter`,
        {
          method: 'GET',
