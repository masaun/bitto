...
const CONTRACT_ADDRESS = process.env.REAL_TIME_TRAFFIC_ORACLE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'real-time-traffic-oracle';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>real-time-traffic-oracle</h1>
      {!userData ? (
