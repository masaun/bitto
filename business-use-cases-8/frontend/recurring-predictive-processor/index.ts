...
const CONTRACT_ADDRESS = process.env.RECURRING_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'recurring-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-predictive-processor',
