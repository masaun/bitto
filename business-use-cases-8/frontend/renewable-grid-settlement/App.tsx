...
const CONTRACT_ADDRESS = process.env.RENEWABLE_GRID_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-grid-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-grid-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-grid-settlement</h1>
      {!userData ? (
