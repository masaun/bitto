...
const CONTRACT_ADDRESS = process.env.PUBLIC_HOUSING_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'public-housing-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'public-housing-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>public-housing-leaseback</h1>
      {!userData ? (
