...
const CONTRACT_ADDRESS = process.env.RULE_BASED_EXECUTION_TRACKER_ADDRESS || '';
const CONTRACT_NAME = 'rule-based-execution-tracker';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'rule-based-execution-tracker',
