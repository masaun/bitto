...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RATIO_MONITOR_V1_ADDRESS || '';

export default function Ratio_Monitor_V1Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.ratio-monitor-v1/read-only/get-counter`,
        {
          method: 'GET',
