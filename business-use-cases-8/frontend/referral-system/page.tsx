...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_REFERRAL_SYSTEM_ADDRESS || '';

export default function Referral_SystemPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.referral-system/read-only/get-counter`,
        {
          method: 'GET',
