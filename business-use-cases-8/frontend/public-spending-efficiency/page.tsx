...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PUBLIC_SPENDING_EFFICIENCY_ADDRESS || '';

export default function Public_Spending_EfficiencyPage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'public-spending-efficiency',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.public-spending-efficiency/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'public-spending-efficiency',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>public-spending-efficiency</h1>
