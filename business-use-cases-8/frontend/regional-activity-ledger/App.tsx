...
const contractAddress = process.env.REACT_APP_REGIONAL_ACTIVITY_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'regional-activity-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Regional Activity Ledger</h1>
