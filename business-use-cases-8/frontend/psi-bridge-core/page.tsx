...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PSI_BRIDGE_CORE_ADDRESS || '';

export default function Psi_Bridge_CorePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.psi-bridge-core/read-only/get-counter`,
        {
          method: 'GET',
