...
const CONTRACT_ADDRESS = process.env.RECURRING_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'recurring-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-sequential-processor',
