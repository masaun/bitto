...
const CONTRACT_ADDRESS = process.env.RESEARCH_DATA_COLLABORATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'research-data-collaboration';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>research-data-collaboration</h1>
      {!userData ? (
