...
const CONTRACT_ADDRESS = process.env.REHEARSAL_SPACE_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rehearsal-space-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'rehearsal-space-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>rehearsal-space-leaseback</h1>
      {!userData ? (
