...
export default function reclinerEngineeringSystem() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Recliner Engineering System',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RECLINER_ENGINEERING_SYSTEM_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'recliner-engineering-system';
  ...
  return (
    <div>
      <h1>Recliner Engineering System</h1>
