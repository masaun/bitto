...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_PYTH_PRICE_PROXY_ADDRESS || '';

export default function Pyth_Price_ProxyPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.pyth-price-proxy/read-only/get-counter`,
        {
          method: 'GET',
