...
export default function retailFurnitureNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RETAIL_FURNITURE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'retail-furniture-network';
  ...
  return (
    <div>
      <h1>Retail Furniture Network</h1>
