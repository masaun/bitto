...
const CONTRACT_ADDRESS = process.env.REFERRAL_REVENUE_DISTRIBUTOR_ADDRESS || '';
const CONTRACT_NAME = 'referral-revenue-distributor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'referral-revenue-distributor',
