...
const CONTRACT_ADDRESS = process.env.RARE_EARTH_MATERIAL_BATCH_ID_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'rare-earth-material-batch-id';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Rare Earth Material Batch Id',
