...
const CONTRACT_ADDRESS = process.env.RECURRING_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'recurring-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'recurring-condition-evaluator',
