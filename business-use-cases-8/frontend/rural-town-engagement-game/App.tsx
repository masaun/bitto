...
const contractAddress = process.env.REACT_APP_RURAL_TOWN_ENGAGEMENT_GAME_CONTRACT_ADDRESS || '';
const contractName = 'rural-town-engagement-game';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Rural Town Engagement Game</h1>
