...
export default function residentialDesignEngine() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Residential Design Engine',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_RESIDENTIAL_DESIGN_ENGINE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'residential-design-engine';
  ...
  return (
    <div>
      <h1>Residential Design Engine</h1>
