...
const CONTRACT_ADDRESS = process.env.RETAIL_LEASEBACK_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'retail-leaseback-network';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'retail-leaseback-network', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>retail-leaseback-network</h1>
      {!userData ? (
