...
const CONTRACT_ADDRESS = process.env.RENEWABLE_ENERGY_SETTLEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-energy-settlement';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-energy-settlement',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-energy-settlement</h1>
      {!userData ? (
