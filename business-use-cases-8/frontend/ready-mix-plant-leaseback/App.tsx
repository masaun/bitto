...
const CONTRACT_ADDRESS = process.env.READY_MIX_PLANT_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ready-mix-plant-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'ready-mix-plant-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>ready-mix-plant-leaseback</h1>
      {!userData ? (
