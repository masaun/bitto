...
const CONTRACT_ADDRESS = process.env.RENEWABLE_ASSET_TOKENIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'renewable-asset-tokenization';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'renewable-asset-tokenization',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>renewable-asset-tokenization</h1>
      {!userData ? (
