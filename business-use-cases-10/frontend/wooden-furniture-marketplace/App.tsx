...
export default function woodenFurnitureMarketplace() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Wooden Furniture Marketplace',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WOODEN_FURNITURE_MARKETPLACE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'wooden-furniture-marketplace';
  ...
  return (
    <div>
      <h1>Wooden Furniture Marketplace</h1>
