...
const CONTRACT_ADDRESS = process.env.TOURNAMENT_TRAVEL_LOGISTICS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tournament-travel-logistics';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Tournament Travel Logistics',
