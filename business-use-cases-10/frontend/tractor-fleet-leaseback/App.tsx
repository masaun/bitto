...
const CONTRACT_ADDRESS = process.env.TRACTOR_FLEET_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tractor-fleet-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'tractor-fleet-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
