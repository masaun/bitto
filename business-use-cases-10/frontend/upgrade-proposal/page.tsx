...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPGRADE_PROPOSAL_ADDRESS || '';

export default function Upgrade_ProposalPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.upgrade-proposal/read-only/get-counter`,
        {
          method: 'GET',
