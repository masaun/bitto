...
const CONTRACT_ADDRESS = process.env.WASTE_FACILITY_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'waste-facility-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'waste-facility-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>waste-facility-leaseback</h1>
      {!userData ? (
