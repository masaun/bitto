...
const CONTRACT_ADDRESS = process.env.TOKENIZED_DATA_LICENSING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-data-licensing';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-data-licensing</h1>
      {!userData ? (
