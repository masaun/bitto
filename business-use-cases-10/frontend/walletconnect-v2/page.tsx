...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WALLETCONNECT_V2_ADDRESS || '';

export default function Walletconnect_V2Page() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.walletconnect-v2/read-only/get-counter`,
        {
          method: 'GET',
