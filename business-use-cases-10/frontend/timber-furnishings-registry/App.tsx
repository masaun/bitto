...
export default function timberFurnishingsRegistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Furnishings Registry',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FURNISHINGS_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-furnishings-registry';
  ...
  return (
    <div>
      <h1>Timber Furnishings Registry</h1>
