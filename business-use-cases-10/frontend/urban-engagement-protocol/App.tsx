...
const contractAddress = process.env.REACT_APP_URBAN_ENGAGEMENT_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'urban-engagement-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Urban Engagement Protocol</h1>
