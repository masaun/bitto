...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_ASYNC_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-async-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-async-processor',
