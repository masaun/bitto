...
const CONTRACT_ADDRESS = process.env.TRANSACTION_DECRYPTION_COORDINATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'transaction-decryption-coordinator';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'TransactionDecryptionCoordinator',
