...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WINDING_UP_AGENT_ADDRESS || '';

export default function Winding_Up_AgentPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.winding-up-agent/read-only/get-counter`,
        {
          method: 'GET',
