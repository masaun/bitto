...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_WRAPPED_BTC_POOL_ADDRESS || '';

export default function Wrapped_Btc_PoolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.wrapped-btc-pool/read-only/get-counter`,
        {
          method: 'GET',
