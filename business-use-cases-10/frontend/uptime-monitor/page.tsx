...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPTIME_MONITOR_ADDRESS || '';

export default function Uptime_MonitorPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.uptime-monitor/read-only/get-counter`,
        {
          method: 'GET',
