...
const contractAddress = process.env.REACT_APP_TOURISM_SYNERGY_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'tourism-synergy-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Synergy Protocol</h1>
