...
export default function timberWorkshopRegistry() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_WORKSHOP_REGISTRY_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-workshop-registry';
  ...
  return (
    <div>
      <h1>Timber Workshop Registry</h1>
