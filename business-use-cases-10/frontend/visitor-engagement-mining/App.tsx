...
const contractAddress = process.env.REACT_APP_VISITOR_ENGAGEMENT_MINING_CONTRACT_ADDRESS || '';
const contractName = 'visitor-engagement-mining';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Visitor Engagement Mining</h1>
