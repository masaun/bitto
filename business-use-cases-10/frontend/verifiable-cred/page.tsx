...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VERIFIABLE_CRED_ADDRESS || '';

export default function Verifiable_CredPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.verifiable-cred/read-only/get-counter`,
        {
          method: 'GET',
