...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_SEQUENTIAL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-sequential-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-sequential-processor',
