...
const CONTRACT_ADDRESS = process.env.WINTER_SNOW_SPORTS_PRIZE_DISTRIBUTOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'winter-snow-sports-prize-distributor';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Winter Snow Sports Prize Distributor',
