...
const contractAddress = process.env.REACT_APP_TOURISM_PARTICIPATION_LEDGER_CONTRACT_ADDRESS || '';
const contractName = 'tourism-participation-ledger';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Participation Ledger</h1>
