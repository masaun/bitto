...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-predictive-processor',
