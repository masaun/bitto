...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VERIFIED_ISSUER_ADDRESS || '';

export default function Verified_IssuerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.verified-issuer/read-only/get-counter`,
        {
          method: 'GET',
