...
const CONTRACT_ADDRESS = process.env.TOKENIZED_REVENUE_SHARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-revenue-sharing';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-revenue-sharing',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-revenue-sharing</h1>
      {!userData ? (
