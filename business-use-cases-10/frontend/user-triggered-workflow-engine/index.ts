...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_WORKFLOW_ENGINE_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-workflow-engine';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-workflow-engine',
