...
const CONTRACT_ADDRESS = process.env.TRAINING_CAMP_SPONSORSHIP_ROUTER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'training-camp-sponsorship-router';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Training Camp Sponsorship Router',
