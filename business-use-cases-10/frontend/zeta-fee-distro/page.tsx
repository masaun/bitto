...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_ZETA_FEE_DISTRO_ADDRESS || '';

export default function Zeta_Fee_DistroPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.zeta-fee-distro/read-only/get-counter`,
        {
          method: 'GET',
