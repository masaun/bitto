...
export default function workspaceFurnitureNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Workspace Furniture Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_FURNITURE_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-furniture-network';
  ...
  return (
    <div>
      <h1>Workspace Furniture Network</h1>
