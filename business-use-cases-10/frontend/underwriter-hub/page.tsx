...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UNDERWRITER_HUB_ADDRESS || '';

export default function Underwriter_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.underwriter-hub/read-only/get-counter`,
        {
          method: 'GET',
