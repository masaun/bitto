...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_TZERO_COMPLIANCE_ADDRESS || '';

export default function Tzero_CompliancePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.tzero-compliance/read-only/get-counter`,
        {
          method: 'GET',
