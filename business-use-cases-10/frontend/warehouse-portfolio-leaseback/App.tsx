...
const CONTRACT_ADDRESS = process.env.WAREHOUSE_PORTFOLIO_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'warehouse-portfolio-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'warehouse-portfolio-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>warehouse-portfolio-leaseback</h1>
      {!userData ? (
