...
const contractAddress = process.env.REACT_APP_TYPHOON_PARAMETRIC_ENGINE_CONTRACT_ADDRESS || '';
const contractName = 'typhoon-parametric-engine';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>typhoon parametric engine</h1>
