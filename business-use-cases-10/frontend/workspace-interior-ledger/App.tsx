...
export default function workspaceInteriorLedger() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Workspace Interior Ledger',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_INTERIOR_LEDGER_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-interior-ledger';
  ...
  return (
    <div>
      <h1>Workspace Interior Ledger</h1>
