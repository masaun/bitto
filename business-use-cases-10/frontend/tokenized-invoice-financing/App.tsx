...
const CONTRACT_ADDRESS = process.env.TOKENIZED_INVOICE_FINANCING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-invoice-financing';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-invoice-financing',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-invoice-financing</h1>
      {!userData ? (
