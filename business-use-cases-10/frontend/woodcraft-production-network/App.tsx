...
export default function woodcraftProductionNetwork() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Woodcraft Production Network',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WOODCRAFT_PRODUCTION_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'woodcraft-production-network';
  ...
  return (
    <div>
      <h1>Woodcraft Production Network</h1>
