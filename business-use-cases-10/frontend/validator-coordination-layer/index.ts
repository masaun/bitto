...
const CONTRACT_ADDRESS = process.env.VALIDATOR_COORDINATION_LAYER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-coordination-layer';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorCoordinationLayer',
