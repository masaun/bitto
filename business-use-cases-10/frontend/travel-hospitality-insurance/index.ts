...
const CONTRACT_ADDRESS = process.env.TRAVEL_HOSPITALITY_INSURANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'travel-hospitality-insurance';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Travel Hospitality Insurance',
