...
const CONTRACT_ADDRESS = process.env.TOKENIZED_SERVICE_BROKER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-service-broker';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-service-broker</h1>
      {!userData ? (
