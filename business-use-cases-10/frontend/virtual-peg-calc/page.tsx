...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VIRTUAL_PEG_CALC_ADDRESS || '';

export default function Virtual_Peg_CalcPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.virtual-peg-calc/read-only/get-counter`,
        {
          method: 'GET',
