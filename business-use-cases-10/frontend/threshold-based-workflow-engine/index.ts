...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_WORKFLOW_ENGINE_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-workflow-engine';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-workflow-engine',
