...
export default function workspaceInteriorSolutions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Workspace Interior Solutions',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_INTERIOR_SOLUTIONS_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-interior-solutions';
  ...
  return (
    <div>
      <h1>Workspace Interior Solutions</h1>
