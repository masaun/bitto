...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_USD_STABLE_VAULT_ADDRESS || '';

export default function Usd_Stable_VaultPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.usd-stable-vault/read-only/get-counter`,
        {
          method: 'GET',
