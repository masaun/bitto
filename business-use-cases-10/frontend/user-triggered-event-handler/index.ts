...
const CONTRACT_ADDRESS = process.env.USER_TRIGGERED_EVENT_HANDLER_ADDRESS || '';
const CONTRACT_NAME = 'user-triggered-event-handler';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'user-triggered-event-handler',
