...
export default function timberSourcingNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_SOURCING_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-sourcing-network';
