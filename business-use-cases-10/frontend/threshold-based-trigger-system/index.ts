...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_TRIGGER_SYSTEM_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-trigger-system';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-trigger-system',
