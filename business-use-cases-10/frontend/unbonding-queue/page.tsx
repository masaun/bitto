...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UNBONDING_QUEUE_ADDRESS || '';

export default function Unbonding_QueuePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.unbonding-queue/read-only/get-counter`,
        {
          method: 'GET',
