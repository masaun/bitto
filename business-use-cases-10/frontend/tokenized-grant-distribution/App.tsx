...
const CONTRACT_ADDRESS = process.env.TOKENIZED_GRANT_DISTRIBUTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-grant-distribution';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-grant-distribution',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-grant-distribution</h1>
      {!userData ? (
