...
const CONTRACT_ADDRESS = process.env.WORLD_FINALS_TICKET_AUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'world-finals-ticket-auction';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'World Finals Ticket Auction',
