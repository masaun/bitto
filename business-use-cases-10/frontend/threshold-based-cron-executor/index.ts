...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_CRON_EXECUTOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-cron-executor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-cron-executor',
