...
const CONTRACT_ADDRESS = process.env.TOKENIZED_REALESTATE_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-realestate-market';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-realestate-market',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-realestate-market</h1>
      {!userData ? (
