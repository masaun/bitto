...
export default function timberDesignCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Design Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_DESIGN_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-design-certification';
  ...
  return (
    <div>
      <h1>Timber Design Certification</h1>
