...
const CONTRACT_ADDRESS = process.env.TRANSACTION_COMMISSION_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'transaction-commission-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-commission-manager',
