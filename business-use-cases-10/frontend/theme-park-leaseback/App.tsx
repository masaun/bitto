...
const CONTRACT_ADDRESS = process.env.THEME_PARK_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'theme-park-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'theme-park-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
