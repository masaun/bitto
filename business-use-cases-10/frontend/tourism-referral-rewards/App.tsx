...
const contractAddress = process.env.REACT_APP_TOURISM_REFERRAL_REWARDS_CONTRACT_ADDRESS || '';
const contractName = 'tourism-referral-rewards';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Referral Rewards</h1>
