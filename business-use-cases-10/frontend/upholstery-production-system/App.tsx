...
export default function upholsteryProductionSystem() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Upholstery Production System',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_UPHOLSTERY_PRODUCTION_SYSTEM_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'upholstery-production-system';
  ...
  return (
    <div>
      <h1>Upholstery Production System</h1>
