...
const CONTRACT_ADDRESS = process.env.TOKENIZED_REWARD_ECOSYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-reward-ecosystem';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-reward-ecosystem',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-reward-ecosystem</h1>
      {!userData ? (
