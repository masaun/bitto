...
const CONTRACT_ADDRESS = process.env.TRANSACTION_SEQUENCING_POLICY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'transaction-sequencing-policy';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'TransactionSequencingPolicy',
