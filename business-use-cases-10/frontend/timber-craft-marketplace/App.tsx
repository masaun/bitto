...
export default function timberCraftMarketplace() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_CRAFT_MARKETPLACE_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-craft-marketplace';
  ...
  return (
    <div>
      <h1>Timber Craft Marketplace</h1>
