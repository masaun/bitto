...
export default function timberCraftCertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Craft Certification',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_CRAFT_CERTIFICATION_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-craft-certification';
  ...
  return (
    <div>
      <h1>Timber Craft Certification</h1>
