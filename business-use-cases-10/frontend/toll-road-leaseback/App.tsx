...
const CONTRACT_ADDRESS = process.env.TOLL_ROAD_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'toll-road-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'toll-road-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
