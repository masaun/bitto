...
const CONTRACT_ADDRESS = process.env.TRANSACTION_REVENUE_REPORTER_ADDRESS || '';
const CONTRACT_NAME = 'transaction-revenue-reporter';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'transaction-revenue-reporter',
