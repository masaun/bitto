...
const CONTRACT_ADDRESS = process.env.TOKENIZED_EQUITY_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-equity-exchange';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-equity-exchange',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-equity-exchange</h1>
      {!userData ? (
