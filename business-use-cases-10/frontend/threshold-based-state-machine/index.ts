...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_STATE_MACHINE_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-state-machine';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-state-machine',
