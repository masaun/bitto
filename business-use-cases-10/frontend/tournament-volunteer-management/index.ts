...
const CONTRACT_ADDRESS = process.env.TOURNAMENT_VOLUNTEER_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tournament-volunteer-management';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Tournament Volunteer Management',
