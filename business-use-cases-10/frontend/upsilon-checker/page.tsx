...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UPSILON_CHECKER_ADDRESS || '';

export default function Upsilon_CheckerPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.upsilon-checker/read-only/get-counter`,
        {
          method: 'GET',
