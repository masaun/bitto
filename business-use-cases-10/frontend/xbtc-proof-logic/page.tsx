...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_XBTC_PROOF_LOGIC_ADDRESS || '';

export default function Xbtc_Proof_LogicPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.xbtc-proof-logic/read-only/get-counter`,
        {
          method: 'GET',
