...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_ACTION_EXECUTOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-action-executor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-action-executor',
