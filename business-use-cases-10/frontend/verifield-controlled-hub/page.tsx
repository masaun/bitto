...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VERIFIELD_CONTROLLED_HUB_ADDRESS || '';

export default function Verifield_Controlled_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.verifield-controlled-hub/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'verifield-controlled-hub',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>verifield-controlled-hub</h1>
