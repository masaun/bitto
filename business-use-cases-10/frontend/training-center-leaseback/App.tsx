...
const CONTRACT_ADDRESS = process.env.TRAINING_CENTER_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'training-center-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'training-center-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>training-center-leaseback</h1>
      {!userData ? (
