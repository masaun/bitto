...
const CONTRACT_ADDRESS = process.env.TOKENIZED_DONATION_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-donation-platform';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-donation-platform',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-donation-platform</h1>
      {!userData ? (
