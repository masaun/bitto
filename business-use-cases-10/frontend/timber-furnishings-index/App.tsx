...
export default function timberFurnishingsIndex() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_FURNISHINGS_INDEX_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-furnishings-index';
  ...
  return (
    <div>
      <h1>Timber Furnishings Index</h1>
