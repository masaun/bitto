...
const contractAddress = process.env.REACT_APP_TOURISM_ACTIVATION_PROTOCOL_CONTRACT_ADDRESS || '';
const contractName = 'tourism-activation-protocol';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Activation Protocol</h1>
