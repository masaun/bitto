...
const CONTRACT_ADDRESS = process.env.TOKENIZED_FREIGHT_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-freight-market';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-freight-market</h1>
      {!userData ? (
