...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_QUEUE_MANAGER_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-queue-manager';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-queue-manager',
