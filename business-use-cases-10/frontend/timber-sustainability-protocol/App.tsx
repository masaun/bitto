...
export default function timberSustainabilityProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Timber Sustainability Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_SUSTAINABILITY_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-sustainability-protocol';
  ...
  return (
    <div>
      <h1>Timber Sustainability Protocol</h1>
