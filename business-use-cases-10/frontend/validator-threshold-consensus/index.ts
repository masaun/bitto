...
const CONTRACT_ADDRESS = process.env.VALIDATOR_THRESHOLD_CONSENSUS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-threshold-consensus';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorThresholdConsensus',
