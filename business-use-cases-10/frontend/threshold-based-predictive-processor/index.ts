...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_PREDICTIVE_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-predictive-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-predictive-processor',
