...
const CONTRACT_ADDRESS = process.env.WAREHOUSE_AUTOMATION_LEASEBACK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'warehouse-automation-leaseback';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'warehouse-automation-leaseback', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>warehouse-automation-leaseback</h1>
      {!userData ? (
