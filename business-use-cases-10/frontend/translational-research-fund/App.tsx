...
const contractAddress = process.env.REACT_APP_TRANSLATIONAL_RESEARCH_FUND_CONTRACT_ADDRESS || '';
const contractName = 'translational-research-fund';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>translational research fund</h1>
