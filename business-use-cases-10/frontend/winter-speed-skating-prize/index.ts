...
const CONTRACT_ADDRESS = process.env.WINTER_SPEED_SKATING_PRIZE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'winter-speed-skating-prize';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Winter Speed Skating Prize',
