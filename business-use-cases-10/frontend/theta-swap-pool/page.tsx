...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_THETA_SWAP_POOL_ADDRESS || '';

export default function Theta_Swap_PoolPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.theta-swap-pool/read-only/get-counter`,
        {
          method: 'GET',
