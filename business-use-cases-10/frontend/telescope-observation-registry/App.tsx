...
const contractAddress = process.env.REACT_APP_TELESCOPE_OBSERVATION_REGISTRY_CONTRACT_ADDRESS || '';
const contractName = 'telescope-observation-registry';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>telescope ouservation registry</h1>
