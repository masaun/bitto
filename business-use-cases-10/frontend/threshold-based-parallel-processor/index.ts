...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-parallel-processor',
