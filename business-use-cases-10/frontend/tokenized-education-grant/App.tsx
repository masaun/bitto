...
const CONTRACT_ADDRESS = process.env.TOKENIZED_EDUCATION_GRANT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-education-grant';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-education-grant',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-education-grant</h1>
      {!userData ? (
