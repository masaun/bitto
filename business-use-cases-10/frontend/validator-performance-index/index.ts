...
const CONTRACT_ADDRESS = process.env.VALIDATOR_PERFORMANCE_INDEX_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-performance-index';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorPerformanceIndex',
