...
export default function woodcraftCertificationProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Woodcraft Certification Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WOODCRAFT_CERTIFICATION_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'woodcraft-certification-protocol';
  ...
  return (
    <div>
      <h1>Woodcraft Certification Protocol</h1>
