...
export default function timberDesignWorkshop() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_DESIGN_WORKSHOP_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-design-workshop';
