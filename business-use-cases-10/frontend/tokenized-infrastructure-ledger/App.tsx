...
const CONTRACT_ADDRESS = process.env.TOKENIZED_INFRASTRUCTURE_LEDGER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'tokenized-infrastructure-ledger';
...
export default function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: {
        name: 'tokenized-infrastructure-ledger',
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>tokenized-infrastructure-ledger</h1>
      {!userData ? (
