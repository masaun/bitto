...
export default function workspaceSeatingProtocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Workspace Seating Protocol',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_WORKSPACE_SEATING_PROTOCOL_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'workspace-seating-protocol';
  ...
  return (
    <div>
      <h1>Workspace Seating Protocol</h1>
