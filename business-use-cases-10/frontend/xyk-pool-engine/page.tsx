...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_XYK_POOL_ENGINE_ADDRESS || '';

export default function Xyk_Pool_EnginePage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.xyk-pool-engine/read-only/get-counter`,
        {
          method: 'GET',
