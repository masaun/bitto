...
const contractAddress = process.env.REACT_APP_URBAN_DESTINATION_LEAGUE_CONTRACT_ADDRESS || '';
const contractName = 'urban-destination-league';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Urban Destination League</h1>
