...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_VERICHIEF_CONTROLLED_HUB_ADDRESS || '';

export default function Verichief_Controlled_HubPage() {
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.verichief-controlled-hub/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'verichief-controlled-hub',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>verichief-controlled-hub</h1>
