...
const CONTRACT_ADDRESS = process.env.TIME_DRIVEN_PARALLEL_PROCESSOR_ADDRESS || '';
const CONTRACT_NAME = 'time-driven-parallel-processor';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'time-driven-parallel-processor',
