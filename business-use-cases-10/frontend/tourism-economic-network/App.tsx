...
const contractAddress = process.env.REACT_APP_TOURISM_ECONOMIC_NETWORK_CONTRACT_ADDRESS || '';
const contractName = 'tourism-economic-network';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Tourism Economic Network</h1>
