...
export default function upholsteryMaterialMarket() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'Upholstery Material Market',
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_UPHOLSTERY_MATERIAL_MARKET_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'upholstery-material-market';
  ...
  return (
    <div>
      <h1>Upholstery Material Market</h1>
