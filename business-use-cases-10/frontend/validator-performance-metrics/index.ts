...
const CONTRACT_ADDRESS = process.env.VALIDATOR_PERFORMANCE_METRICS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-performance-metrics';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorPerformanceMetrics',
