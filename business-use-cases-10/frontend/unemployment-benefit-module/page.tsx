...
const CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_UNEMPLOYMENT_BENEFIT_MODULE_ADDRESS || '';

export default function Unemployment_Benefit_ModulePage() {
  ...
  const handleConnect = () => {
    ...
    showConnect({
      appDetails: {
        name: 'unemployment-benefit-module',
  ...
  const getCounter = async () => {
    ...
    try {
      const response = await fetch(
        `https://api.mainnet.hiro.so/v1/contract/{CONTRACT_ADDRESS}.unemployment-benefit-module/read-only/get-counter`,
        {
          method: 'GET',
    ...
    try {
      const response = await fetch('/api/call-contract', {
        ...
        body: JSON.stringify({
          ...
          contractName: 'unemployment-benefit-module',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial' }>
      <h1>unemployment-benefit-module</h1>
