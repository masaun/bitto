...
const CONTRACT_ADDRESS = process.env.WINTER_BOBSLEIGH_SPONSORSHIP_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'winter-bobsleigh-sponsorship';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Winter Bobsleigh Sponsorship',
