...
const CONTRACT_ADDRESS = process.env.VALIDATOR_SEQUENCING_COMMITTEE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'validator-sequencing-committee';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'ValidatorSequencingCommittee',
