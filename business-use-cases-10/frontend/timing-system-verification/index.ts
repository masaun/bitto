...
const CONTRACT_ADDRESS = process.env.TIMING_SYSTEM_VERIFICATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'timing-system-verification';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Timing System Verification',
