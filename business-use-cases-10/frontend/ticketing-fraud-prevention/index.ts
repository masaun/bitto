...
const CONTRACT_ADDRESS = process.env.TICKETING_FRAUD_PREVENTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ticketing-fraud-prevention';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ticketing Fraud Prevention',
