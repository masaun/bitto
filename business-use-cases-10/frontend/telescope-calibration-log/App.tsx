...
const contractAddress = process.env.REACT_APP_TELESCOPE_CALIBRATION_LOG_CONTRACT_ADDRESS || '';
const contractName = 'telescope-calibration-log';
...
export default function App() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      <h1>telescope caliuration log</h1>
