...
const CONTRACT_ADDRESS = process.env.WINTER_GAMES_TICKETING_EXCHANGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'winter-games-ticketing-exchange';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Winter Games Ticketing Exchange',
