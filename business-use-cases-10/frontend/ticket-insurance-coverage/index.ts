...
const CONTRACT_ADDRESS = process.env.TICKET_INSURANCE_COVERAGE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ticket-insurance-coverage';
...
function connectWallet() {
  showConnect({
    appDetails: {
      name: 'Ticket Insurance Coverage',
