...
export default function timberDesignNetwork() {
  ...
  const registerSupplier = async () => {
    ...
    const contractAddress = process.env.REACT_APP_TIMBER_DESIGN_NETWORK_CONTRACT_ADDRESS.split('.')[0];
    const contractName = 'timber-design-network';
