...
const CONTRACT_ADDRESS = process.env.THRESHOLD_BASED_CONDITION_EVALUATOR_ADDRESS || '';
const CONTRACT_NAME = 'threshold-based-condition-evaluator';
...
export const initialize = async () => {
  try {
    await openContractCall({
      ...
      functionArgs: [],
      appDetails: {
        name: 'threshold-based-condition-evaluator',
