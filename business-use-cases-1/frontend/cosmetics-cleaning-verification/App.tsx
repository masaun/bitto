...
export default function cosmeticscleaningverification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics cleaning verification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-cleaning-verification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics cleaning verification</h1>
