...
const CONTRACT_ADDRESS = process.env.CRISIS_MANAGEMENT_HOSPITALITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crisis-management-hospitality';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrisisManagementHospitality', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
