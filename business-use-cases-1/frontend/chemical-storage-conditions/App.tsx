...
export default function chemicalstorageconditions() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical storage conditions',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-storage-conditions',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical storage conditions</h1>
