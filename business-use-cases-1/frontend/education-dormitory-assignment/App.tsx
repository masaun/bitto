...
export default function educationdormitoryassignment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education dormitory assignment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-dormitory-assignment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education dormitory assignment</h1>
