...
const CONTRACT_ADDRESS = process.env.CREDIT_SCORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'credit-scoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CreditScoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
