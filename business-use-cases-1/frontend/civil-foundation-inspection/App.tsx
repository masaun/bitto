...
export default function civilfoundationinspection() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil foundation inspection',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-foundation-inspection',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil foundation inspection</h1>
