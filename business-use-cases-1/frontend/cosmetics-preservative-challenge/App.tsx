...
export default function cosmeticspreservativechallenge() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics preservative challenge',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-preservative-challenge',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics preservative challenge</h1>
