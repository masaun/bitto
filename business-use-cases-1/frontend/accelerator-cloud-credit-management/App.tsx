...
export default function acceleratorcloudcreditmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator cloud credit management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-cloud-credit-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator cloud credit management</h1>
