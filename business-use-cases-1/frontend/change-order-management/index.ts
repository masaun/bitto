...
const CONTRACT_ADDRESS = process.env.CHANGE_ORDER_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'change-order-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ChangeOrderManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
