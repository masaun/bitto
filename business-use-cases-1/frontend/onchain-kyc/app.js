...
const contractName = 'onchain-kyc';
...
document.getElementById('submit-kyc').addEventListener('click', () => {
  callContract('submit-kyc', []);
});

document.getElementById('approve-kyc').addEventListener('click', () => {
  callContract('approve-kyc', []);
});

document.getElementById('reject-kyc').addEventListener('click', () => {
  callContract('reject-kyc', []);
});

document.getElementById('renew-kyc').addEventListener('click', () => {
  callContract('renew-kyc', []);
});

document.getElementById('revoke-kyc').addEventListener('click', () => {
  callContract('revoke-kyc', []);
});
