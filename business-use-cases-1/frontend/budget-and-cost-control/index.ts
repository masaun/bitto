...
const CONTRACT_ADDRESS = process.env.BUDGET_AND_COST_CONTROL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'budget-and-cost-control';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BudgetAndCostControl', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
