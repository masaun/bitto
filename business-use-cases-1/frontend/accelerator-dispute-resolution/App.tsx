...
export default function acceleratordisputeresolution() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator dispute resolution',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-dispute-resolution',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator dispute resolution</h1>
