...
export default function pharmaceuticalpharmacylicense() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical pharmacy license',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-pharmacy-license',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical pharmacy license</h1>
