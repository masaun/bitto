...
export default function pharmaceuticalpackageinsert() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical package insert',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-package-insert',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical package insert</h1>
