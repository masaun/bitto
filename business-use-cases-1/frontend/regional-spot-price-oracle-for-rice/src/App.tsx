...
const CONTRACT_NAME = 'regional-spot-price-oracle-for-rice';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'regional-spot-price-oracle-for-rice', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>regional-spot-price-oracle-for-rice</h1>
      {!userData ? (
