...
export default function pharmaceuticaladherencetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical adherence tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-adherence-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical adherence tracking</h1>
