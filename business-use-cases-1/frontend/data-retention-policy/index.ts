...
const CONTRACT_ADDRESS = process.env.DATA_RETENTION_POLICY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-retention-policy';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DataRetentionPolicy', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
