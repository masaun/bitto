...
const CONTRACT_ADDRESS = process.env.AS_BUILT_DOCUMENTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'as-built-documentation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AsBuiltDocumentation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
