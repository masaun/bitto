...
export default function cosmeticsfragrancetesting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics fragrance testing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-fragrance-testing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics fragrance testing</h1>
