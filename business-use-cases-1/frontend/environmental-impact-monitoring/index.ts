...
const CONTRACT_ADDRESS = process.env.ENVIRONMENTAL_IMPACT_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'environmental-impact-monitoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EnvironmentalImpactMonitoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
