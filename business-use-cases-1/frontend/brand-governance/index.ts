...
const CONTRACT_ADDRESS = process.env.BRAND_GOVERNANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'brand-governance';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BrandGovernance', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
