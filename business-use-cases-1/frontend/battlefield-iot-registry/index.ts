...
const CONTRACT_ADDRESS = process.env.BATTLEFIELD_IOT_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'battlefield-iot-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BattlefieldIotRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
