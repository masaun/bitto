...
const CONTRACT_ADDRESS = process.env.DTCC_FOR_AGRICULTURAL_MARKET_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dtcc-for-agricultural-market';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DtccForAgriculturalMarket', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
