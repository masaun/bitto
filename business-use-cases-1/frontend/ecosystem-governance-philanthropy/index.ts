...
const CONTRACT_ADDRESS = process.env.ECOSYSTEM_GOVERNANCE_PHILANTHROPY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ecosystem-governance-philanthropy';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EcosystemGovernancePhilanthropy', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
