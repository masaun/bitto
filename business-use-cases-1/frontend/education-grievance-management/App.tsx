...
export default function educationgrievancemanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education grievance management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-grievance-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education grievance management</h1>
