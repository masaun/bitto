...
export default function chemicalemployeecertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical employee certification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-employee-certification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical employee certification</h1>
