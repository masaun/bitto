...
const CONTRACT_ADDRESS = process.env.AUTOMATED_DIRECTORS_AND_BOARD_MEMBERS_IN_COMPANY_CONTRACT_ADDRESS || '';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedDirectorsAndBoardMembersInCompany', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
