...
const CONTRACT_ADDRESS = process.env.CREDIT_ISSUANCE_FOR_FARMERS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'credit-issuance-for-farmers';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CreditIssuanceForFarmers', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
