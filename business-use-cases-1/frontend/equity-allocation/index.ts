...
const CONTRACT_ADDRESS = process.env.EQUITY_ALLOCATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'equity-allocation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EquityAllocation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
