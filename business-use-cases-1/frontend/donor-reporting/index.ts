...
const CONTRACT_ADDRESS = process.env.DONOR_REPORTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'donor-reporting';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DonorReporting', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
