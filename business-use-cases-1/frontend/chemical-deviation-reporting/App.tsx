...
export default function chemicaldeviationreporting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical deviation reporting',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-deviation-reporting',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical deviation reporting</h1>
