...
export default function chemicaltemperaturelogging() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical temperature logging',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-temperature-logging',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical temperature logging</h1>
