...
const CONTRACT_ADDRESS = process.env.DUE_DILIGENCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'due-diligence';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DueDiligence', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
