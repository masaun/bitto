...
const CONTRACT_ADDRESS = process.env.ECOSYSTEM_GOVERNANCE_CONSTRUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ecosystem-governance-construction';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EcosystemGovernanceConstruction', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
