...
const CONTRACT_ADDRESS = process.env.CROSS_AGENCY_COORDINATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-agency-coordination';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossAgencyCoordination', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
