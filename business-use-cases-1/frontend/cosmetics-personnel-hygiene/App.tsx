...
export default function cosmeticspersonnelhygiene() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics personnel hygiene',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-personnel-hygiene',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics personnel hygiene</h1>
