...
const CONTRACT_ADDRESS = process.env.DECOMMISSIONING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decommissioning';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'Decommissioning', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
