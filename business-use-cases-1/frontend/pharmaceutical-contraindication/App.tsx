...
export default function pharmaceuticalcontraindication() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical contraindication',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-contraindication',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical contraindication</h1>
