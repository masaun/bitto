...
export default function educationdisciplinaryaction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education disciplinary action',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-disciplinary-action',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education disciplinary action</h1>
