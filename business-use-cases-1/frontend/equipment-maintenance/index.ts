...
const CONTRACT_ADDRESS = process.env.EQUIPMENT_MAINTENANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'equipment-maintenance';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EquipmentMaintenance', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
