...
const CONTRACT_ADDRESS = process.env.COMPLIANCE_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'compliance-attestation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ComplianceAttestation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
