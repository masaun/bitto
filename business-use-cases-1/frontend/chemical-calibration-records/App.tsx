...
export default function chemicalcaliurationrecords() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical caliuration records',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-calibration-records',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical caliuration records</h1>
