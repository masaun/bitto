...
const CONTRACT_ADDRESS = process.env.CARRIED_INTEREST_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carried-interest';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarriedInterest', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
