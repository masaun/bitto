...
const CONTRACT_ADDRESS = process.env.AUCTION_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'auction-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AuctionManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
