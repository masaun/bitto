...
const CONTRACT_ADDRESS = process.env.CYBER_DEFENSE_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cyber-defense-monitoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CyberDefenseMonitoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
