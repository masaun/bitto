...
const CONTRACT_ADDRESS = process.env.AGENTIC_STATE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agentic-state';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AgenticState', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
