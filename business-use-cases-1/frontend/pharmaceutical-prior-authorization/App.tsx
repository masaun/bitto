...
export default function pharmaceuticalpriorauthorization() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical prior authorization',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-prior-authorization',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical prior authorization</h1>
