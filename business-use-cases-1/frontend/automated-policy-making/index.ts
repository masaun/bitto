...
const CONTRACT_ADDRESS = process.env.AUTOMATED_POLICY_MAKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'automated-policy-making';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedPolicyMaking', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
