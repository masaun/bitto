...
export default function hruenefitsadministration() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'hr uenefits administration',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'hr-benefits-administration',
  ...
  if (!userData) {
    return (
      <div>
        <h1>hr uenefits administration</h1>
