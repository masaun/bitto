...
export default function chemicalvalidationprotocol() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical validation protocol',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-validation-protocol',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical validation protocol</h1>
