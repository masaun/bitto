...
const CONTRACT_ADDRESS = process.env.CROSS_ORGANIZATIONAL_SERVICE_ORCHESTRATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-organizational-service-orchestration';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossOrganizationalServiceOrchestration', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
