...
export default function educationstudentenrollment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education student enrollment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-student-enrollment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education student enrollment</h1>
