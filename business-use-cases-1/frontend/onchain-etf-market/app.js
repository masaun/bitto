...
const contractName = 'onchain-etf-market';
...
document.getElementById('create-fund').addEventListener('click', () => {
  callContract('create-fund', []);
});

document.getElementById('add-holding').addEventListener('click', () => {
  callContract('add-holding', []);
});

document.getElementById('purchase-shares').addEventListener('click', () => {
  callContract('purchase-shares', []);
});

document.getElementById('redeem-shares').addEventListener('click', () => {
  callContract('redeem-shares', []);
});

document.getElementById('update-nav').addEventListener('click', () => {
  callContract('update-nav', []);
});

document.getElementById('distribute-management-fee').addEventListener('click', () => {
  callContract('distribute-management-fee', []);
});
