...
export default function pharmaceuticalregulatoryfiling() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical regulatory filing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-regulatory-filing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical regulatory filing</h1>
