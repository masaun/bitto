...
export default function acceleratorworkshopattendance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator workshop attendance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-workshop-attendance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator workshop attendance</h1>
