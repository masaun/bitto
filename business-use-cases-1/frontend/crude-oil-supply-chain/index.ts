...
const CONTRACT_ADDRESS = process.env.CRUDE_OIL_SUPPLY_CHAIN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crude-oil-supply-chain';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrudeOilSupplyChain', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
