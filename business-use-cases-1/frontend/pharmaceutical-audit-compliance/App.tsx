...
export default function pharmaceuticalauditcompliance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical audit compliance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-audit-compliance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical audit compliance</h1>
