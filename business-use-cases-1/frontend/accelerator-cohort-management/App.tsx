...
export default function acceleratorcohortmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator cohort management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-cohort-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator cohort management</h1>
