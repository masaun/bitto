...
const CONTRACT_ADDRESS = process.env.AID_ANALYSIS_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aid-analysis-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AidAnalysisPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
