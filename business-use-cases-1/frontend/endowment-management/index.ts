...
const CONTRACT_ADDRESS = process.env.ENDOWMENT_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'endowment-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EndowmentManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
