...
const CONTRACT_ADDRESS = process.env.DYNAMIC_PRICING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dynamic-pricing';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DynamicPricing', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
