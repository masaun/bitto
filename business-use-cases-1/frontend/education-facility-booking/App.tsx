...
export default function educationfacilityuooking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education facility uooking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-facility-booking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education facility uooking</h1>
