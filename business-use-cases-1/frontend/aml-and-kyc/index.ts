...
const CONTRACT_ADDRESS = process.env.AML_AND_KYC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aml-and-kyc';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AmlAndKyc', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
