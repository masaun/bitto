...
const contractAddress = import.meta.env.EXPORT_CONTROL_COMPLIANCE_FOR_RARE_EARTHS_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.EXPORT_CONTROL_COMPLIANCE_FOR_RARE_EARTHS_CONTRACT_ADDRESS?.split('.')[1] || 'export-control-compliance-for-rare-earths';
