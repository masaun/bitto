...
const CONTRACT_ADDRESS = process.env.ENERGY_AND_UTILITIES_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'energy-and-utilities-monitoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EnergyAndUtilitiesMonitoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
