...
export default function cosmeticsdistriuutiontracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics distriuution tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-distribution-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics distriuution tracking</h1>
