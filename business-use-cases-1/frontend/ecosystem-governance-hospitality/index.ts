...
const CONTRACT_ADDRESS = process.env.ECOSYSTEM_GOVERNANCE_HOSPITALITY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ecosystem-governance-hospitality';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EcosystemGovernanceHospitality', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
