...
const CONTRACT_ADDRESS = process.env.CREATOR_LED_EVENTS_MARKETPLACES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'creator-led-events-marketplaces';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CreatorLedEventsMarketplaces', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
