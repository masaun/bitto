...
const CONTRACT_ADDRESS = process.env.CFTC_WHISTLEBLOWER_PROGRAM_STYLE_WHISTLEBLOWING_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cftc-whistleblower-program-style-whistleblowing-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CftcWhistleblowerProgramStyleWhistleblowingPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
