...
const CONTRACT_ADDRESS = process.env.AIRLINE_SEAT_TICKETING_SERVICE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'airline-seat-ticketing-service';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AirlineSeatTicketingService', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
