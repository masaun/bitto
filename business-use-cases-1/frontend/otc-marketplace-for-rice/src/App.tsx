...
const CONTRACT_NAME = 'otc-marketplace-for-rice';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'otc-marketplace-for-rice', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>otc-marketplace-for-rice</h1>
      {!userData ? (
