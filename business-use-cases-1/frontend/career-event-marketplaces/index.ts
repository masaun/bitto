...
const CONTRACT_ADDRESS = process.env.CAREER_EVENT_MARKETPLACES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'career-event-marketplaces';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CareerEventMarketplaces', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
