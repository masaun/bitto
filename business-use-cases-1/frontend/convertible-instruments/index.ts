...
const CONTRACT_ADDRESS = process.env.CONVERTIBLE_INSTRUMENTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'convertible-instruments';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConvertibleInstruments', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
