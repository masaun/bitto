...
export default function cosmeticscomplaintmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics complaint management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-complaint-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics complaint management</h1>
