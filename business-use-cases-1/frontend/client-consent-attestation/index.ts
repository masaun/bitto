...
const CONTRACT_ADDRESS = process.env.CLIENT_CONSENT_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'client-consent-attestation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClientConsentAttestation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
