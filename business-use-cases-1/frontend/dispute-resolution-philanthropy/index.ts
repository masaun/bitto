...
const CONTRACT_ADDRESS = process.env.DISPUTE_RESOLUTION_PHILANTHROPY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dispute-resolution-philanthropy';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DisputeResolutionPhilanthropy', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
