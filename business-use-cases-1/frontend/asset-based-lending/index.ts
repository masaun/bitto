...
const CONTRACT_ADDRESS = process.env.ASSET_BASED_LENDING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'asset-based-lending';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AssetBasedLending', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
