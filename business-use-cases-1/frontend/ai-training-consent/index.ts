...
const CONTRACT_ADDRESS = process.env.AI_TRAINING_CONSENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-training-consent';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AiTrainingConsent', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
