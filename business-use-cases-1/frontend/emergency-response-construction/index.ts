...
const CONTRACT_ADDRESS = process.env.EMERGENCY_RESPONSE_CONSTRUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'emergency-response-construction';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EmergencyResponseConstruction', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
