...
const CONTRACT_ADDRESS = process.env.CLASSIFIED_PROJECT_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'classified-project-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClassifiedProjectRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
