...
const contractAddress = import.meta.env.MARKETPLACE_FOR_TRADING_ONCHAIN_YIELDS_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.MARKETPLACE_FOR_TRADING_ONCHAIN_YIELDS_CONTRACT_ADDRESS?.split('.')[1] || 'marketplace-for-trading-onchain-yields';
