...
export default function pharmaceuticalpatientregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical patient registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-patient-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical patient registry</h1>
