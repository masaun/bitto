...
export default function educationinternshiptracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education internship tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-internship-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education internship tracking</h1>
