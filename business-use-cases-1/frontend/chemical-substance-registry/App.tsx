...
export default function chemicalsuustanceregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical suustance registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-substance-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical suustance registry</h1>
