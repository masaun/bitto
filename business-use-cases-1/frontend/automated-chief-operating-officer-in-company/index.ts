...
const CONTRACT_ADDRESS = process.env.AUTOMATED_CHIEF_OPERATING_OFFICER_IN_COMPANY_CONTRACT_ADDRESS || '';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedChiefOperatingOfficerInCompany', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
