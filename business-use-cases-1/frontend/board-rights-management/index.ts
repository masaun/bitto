...
const CONTRACT_ADDRESS = process.env.BOARD_RIGHTS_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'board-rights-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BoardRightsManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
