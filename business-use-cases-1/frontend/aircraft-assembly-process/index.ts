...
const CONTRACT_ADDRESS = process.env.AIRCRAFT_ASSEMBLY_PROCESS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aircraft-assembly-process';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AircraftAssemblyProcess', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
