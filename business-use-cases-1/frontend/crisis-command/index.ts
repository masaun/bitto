...
const CONTRACT_ADDRESS = process.env.CRISIS_COMMAND_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crisis-command';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrisisCommand', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
