...
const CONTRACT_ADDRESS = process.env.ARTISAN_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'artisan-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ArtisanRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
