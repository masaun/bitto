...
export default function pharmaceuticalapitracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical api tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-api-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical api tracking</h1>
