...
const contractAddress = import.meta.env.AIRCRAFT_OEM_MANAGEMENT_CONTRACT_ADDRESS?.split('.')[0] || 'SP1V95DB4JK47QVPJBXCEN6MT35JK84CQ4CWS15DQ';
const contractName = import.meta.env.AIRCRAFT_OEM_MANAGEMENT_CONTRACT_ADDRESS?.split('.')[1] || 'aircraft-oem-management';
