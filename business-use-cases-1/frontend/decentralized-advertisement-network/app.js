...
const contractName = 'decentralized-advertisement-network';
...
document.getElementById('create-campaign').addEventListener('click', () => {
  callContract('create-campaign', []);
});

document.getElementById('register-publisher').addEventListener('click', () => {
  callContract('register-publisher', []);
});

document.getElementById('record-impression').addEventListener('click', () => {
  callContract('record-impression', []);
});

document.getElementById('distribute-payment').addEventListener('click', () => {
  callContract('distribute-payment', []);
});

document.getElementById('update-campaign-status').addEventListener('click', () => {
  callContract('update-campaign-status', []);
});
