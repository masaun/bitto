...
const CONTRACT_ADDRESS = process.env.CARBON_CREDIT_TOKENIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-credit-tokenization';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonCreditTokenization', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
