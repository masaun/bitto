...
const CONTRACT_ADDRESS = process.env.COMMAND_AUTHORIZATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'command-authorization';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CommandAuthorization', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
