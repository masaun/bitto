...
const CONTRACT_ADDRESS = process.env.ADMINISTRATIVE_COST_TRACKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'administrative-cost-tracking';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AdministrativeCostTracking', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
