...
export default function cosmeticsproductregistry() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics product registry',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-product-registry',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics product registry</h1>
