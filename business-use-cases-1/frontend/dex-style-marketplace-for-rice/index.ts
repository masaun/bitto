...
const CONTRACT_ADDRESS = process.env.DEX_STYLE_MARKETPLACE_FOR_RICE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dex-style-marketplace-for-rice';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DexStyleMarketplaceForRice', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
