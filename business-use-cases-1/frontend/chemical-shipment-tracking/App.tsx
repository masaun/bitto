...
export default function chemicalshipmenttracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical shipment tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-shipment-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical shipment tracking</h1>
