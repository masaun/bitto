...
const CONTRACT_ADDRESS = process.env.CLIENT_IDENTITY_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'client-identity-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClientIdentityRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
