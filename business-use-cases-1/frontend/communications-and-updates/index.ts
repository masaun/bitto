...
const CONTRACT_ADDRESS = process.env.COMMUNICATIONS_AND_UPDATES_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'communications-and-updates';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CommunicationsAndUpdates', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
