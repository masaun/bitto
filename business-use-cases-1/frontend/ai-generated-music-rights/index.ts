...
const CONTRACT_ADDRESS = process.env.AI_GENERATED_MUSIC_RIGHTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-generated-music-rights';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AiGeneratedMusicRights', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
