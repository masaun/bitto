...
const CONTRACT_ADDRESS = process.env.CLIENT_EXPERIENCE_NFT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'client-experience-nft';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClientExperienceNft', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
