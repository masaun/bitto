...
const CONTRACT_ADDRESS = process.env.BENEFICIARY_CONSENT_ATTESTATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'beneficiary-consent-attestation';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BeneficiaryConsentAttestation', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
