...
export default function cosmeticsformuladevelopment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics formula development',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-formula-development',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics formula development</h1>
