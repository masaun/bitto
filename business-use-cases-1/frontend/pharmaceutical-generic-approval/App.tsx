...
export default function pharmaceuticalgenericapproval() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical generic approval',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-generic-approval',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical generic approval</h1>
