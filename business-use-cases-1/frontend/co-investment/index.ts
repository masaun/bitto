...
const CONTRACT_ADDRESS = process.env.CO_INVESTMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'co-investment';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CoInvestment', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
