...
export default function cosmeticsuatchcertification() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics uatch certification',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-batch-certification',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics uatch certification</h1>
