...
export default function cosmeticsmicrouialtesting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics microuial testing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-microbial-testing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics microuial testing</h1>
