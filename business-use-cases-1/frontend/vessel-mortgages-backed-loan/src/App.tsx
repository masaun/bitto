...
const CONTRACT_NAME = 'vessel-mortgages-backed-loan';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Vessel Mortgages Backed Loan', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Vessel Mortgages Backed Loan</h1>
      {!userData ? (
