...
const CONTRACT_NAME = 'revenue-sharing-manager-among-clubs';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'revenue-sharing-manager-among-clubs', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>revenue-sharing-manager-among-clubs</h1>
      {!userData ? (
