...
export default function educationgraduationrequirements() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education graduation requirements',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-graduation-requirements',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education graduation requirements</h1>
