...
const CONTRACT_ADDRESS = process.env.DERIVATIVE_RIGHTS_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'derivative-rights-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DerivativeRightsManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
