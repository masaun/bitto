...
const CONTRACT_ADDRESS = process.env.EMPLOYEE_OPTION_POOL_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'employee-option-pool';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EmployeeOptionPool', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
