...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_GEO_MAPPING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-geo-mapping';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedGeoMapping', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
