...
export default function acceleratorlegalsupportaccess() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator legal support access',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-legal-support-access',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator legal support access</h1>
