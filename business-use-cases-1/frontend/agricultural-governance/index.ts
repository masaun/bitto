...
const CONTRACT_ADDRESS = process.env.AGRICULTURAL_GOVERNANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agricultural-governance';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AgriculturalGovernance', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
