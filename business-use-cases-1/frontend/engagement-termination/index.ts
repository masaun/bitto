...
const CONTRACT_ADDRESS = process.env.ENGAGEMENT_TERMINATION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'engagement-termination';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EngagementTermination', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
