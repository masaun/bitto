...
export default function pharmaceuticaluioequivalence() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical uioequivalence',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-bioequivalence',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical uioequivalence</h1>
