...
const CONTRACT_ADDRESS = process.env.CROSS_BORDER_OPERATIONS_LUXURY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cross-border-operations-luxury';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrossBorderOperationsLuxury', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
