...
export default function chemicalyieldcalculation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical yield calculation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-yield-calculation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical yield calculation</h1>
