...
export default function pharmaceuticalcostanalysis() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical cost analysis',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-cost-analysis',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical cost analysis</h1>
