...
export default function educationaccreditationtracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education accreditation tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-accreditation-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education accreditation tracking</h1>
