...
export default function civilenvironmentalassessment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil environmental assessment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-environmental-assessment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil environmental assessment</h1>
