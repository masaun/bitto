...
export default function acceleratorsafeagreement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator safe agreement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-safe-agreement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator safe agreement</h1>
