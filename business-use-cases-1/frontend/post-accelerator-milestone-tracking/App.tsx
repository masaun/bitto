...
export default function postacceleratormilestonetracking() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'post accelerator milestone tracking',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'post-accelerator-milestone-tracking',
  ...
  if (!userData) {
    return (
      <div>
        <h1>post accelerator milestone tracking</h1>
