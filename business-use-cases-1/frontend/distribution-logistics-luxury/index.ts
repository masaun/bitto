...
const CONTRACT_ADDRESS = process.env.DISTRIBUTION_LOGISTICS_LUXURY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'distribution-logistics-luxury';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DistributionLogisticsLuxury', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
