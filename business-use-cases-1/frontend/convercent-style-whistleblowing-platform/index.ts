...
const CONTRACT_ADDRESS = process.env.CONVERCENT_STYLE_WHISTLEBLOWING_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'convercent-style-whistleblowing-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConvercentStyleWhistleblowingPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
