...
const CONTRACT_ADDRESS = process.env.BENEFIT_SHARING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'benefit-sharing';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BenefitSharing', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
