...
export default function pharmaceuticaluioavailauility() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical uioavailauility',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-bioavailability',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical uioavailauility</h1>
