...
const CONTRACT_ADDRESS = process.env.AGRICULTURAL_AGGREGATOR_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agricultural-aggregator';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AgriculturalAggregator', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
