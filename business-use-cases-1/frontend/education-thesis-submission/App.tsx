...
export default function educationthesissuumission() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education thesis suumission',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-thesis-submission',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education thesis suumission</h1>
