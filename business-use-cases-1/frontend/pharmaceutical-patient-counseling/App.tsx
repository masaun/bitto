...
export default function pharmaceuticalpatientcounseling() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical patient counseling',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-patient-counseling',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical patient counseling</h1>
