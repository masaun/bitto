...
const CONTRACT_ADDRESS = process.env.COMMERCIAL_ACCESS_LICENSING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'commercial-access-licensing';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CommercialAccessLicensing', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
