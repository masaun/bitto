...
const CONTRACT_ADDRESS = process.env.AUDIT_LOG_REGISTRY_VC_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'audit-log-registry-vc';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AuditLogRegistryVc', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
