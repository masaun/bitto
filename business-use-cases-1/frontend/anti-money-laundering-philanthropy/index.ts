...
const CONTRACT_ADDRESS = process.env.ANTI_MONEY_LAUNDERING_PHILANTHROPY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'anti-money-laundering-philanthropy';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AntiMoneyLaunderingPhilanthropy', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
