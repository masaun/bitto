...
export default function civilhandovercertificate() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil handover certificate',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-handover-certificate',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil handover certificate</h1>
