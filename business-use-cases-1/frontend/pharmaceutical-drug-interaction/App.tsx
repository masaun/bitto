...
export default function pharmaceuticaldruginteraction() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical drug interaction',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-drug-interaction',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical drug interaction</h1>
