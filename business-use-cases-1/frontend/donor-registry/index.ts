...
const CONTRACT_ADDRESS = process.env.DONOR_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'donor-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DonorRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
