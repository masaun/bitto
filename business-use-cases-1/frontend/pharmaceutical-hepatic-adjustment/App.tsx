...
export default function pharmaceuticalhepaticadjustment() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical hepatic adjustment',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-hepatic-adjustment',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical hepatic adjustment</h1>
