...
const CONTRACT_ADDRESS = process.env.AGRICULTURAL_INSURANCE_FOR_SMALL_FARMER_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agricultural-insurance-for-small-farmer';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AgriculturalInsuranceForSmallFarmer', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
