...
export default function pharmaceuticalmanufacturinguatch() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical manufacturing uatch',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-manufacturing-batch',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical manufacturing uatch</h1>
