...
const CONTRACT_NAME = 'parametric-climate-insurance';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Parametric Climate Insurance', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Parametric Climate Insurance</h1>
      {!userData ? (
