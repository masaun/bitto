...
export default function hrdisauilityaccommodation() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'hr disauility accommodation',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'hr-disability-accommodation',
  ...
  if (!userData) {
    return (
      <div>
        <h1>hr disauility accommodation</h1>
