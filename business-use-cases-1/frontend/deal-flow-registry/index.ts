...
const CONTRACT_ADDRESS = process.env.DEAL_FLOW_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'deal-flow-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DealFlowRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
