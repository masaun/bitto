...
const CONTRACT_ADDRESS = process.env.CARBON_REVENUE_BACKED_SENIOR_TRANCHE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-revenue-backed-senior-tranche';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonRevenueBackedSeniorTranche', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
