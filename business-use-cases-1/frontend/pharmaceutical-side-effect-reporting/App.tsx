...
export default function pharmaceuticalsideeffectreporting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical side effect reporting',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-side-effect-reporting',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical side effect reporting</h1>
