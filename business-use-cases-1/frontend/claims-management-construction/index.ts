...
const CONTRACT_ADDRESS = process.env.CLAIMS_MANAGEMENT_CONSTRUCTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'claims-management-construction';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ClaimsManagementConstruction', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
