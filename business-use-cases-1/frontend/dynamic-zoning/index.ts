...
const CONTRACT_ADDRESS = process.env.DYNAMIC_ZONING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dynamic-zoning';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DynamicZoning', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
