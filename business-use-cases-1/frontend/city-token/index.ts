...
const CONTRACT_ADDRESS = process.env.CITY_TOKEN_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'city-token';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CityToken', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
