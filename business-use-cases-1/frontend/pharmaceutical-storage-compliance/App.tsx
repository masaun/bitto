...
export default function pharmaceuticalstoragecompliance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical storage compliance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-storage-compliance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical storage compliance</h1>
