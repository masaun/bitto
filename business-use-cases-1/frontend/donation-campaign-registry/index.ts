...
const CONTRACT_ADDRESS = process.env.DONATION_CAMPAIGN_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'donation-campaign-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DonationCampaignRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
