...
export default function cosmeticsmanufacturingprocess() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics manufacturing process',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-manufacturing-process',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics manufacturing process</h1>
