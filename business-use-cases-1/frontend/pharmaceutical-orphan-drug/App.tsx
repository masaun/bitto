...
export default function pharmaceuticalorphandrug() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical orphan drug',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-orphan-drug',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical orphan drug</h1>
