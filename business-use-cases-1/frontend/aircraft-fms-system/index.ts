...
const CONTRACT_ADDRESS = process.env.AIRCRAFT_FMS_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'aircraft-fms-system';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AircraftFmsSystem', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
