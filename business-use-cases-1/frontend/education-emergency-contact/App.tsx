...
export default function educationemergencycontact() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education emergency contact',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-emergency-contact',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education emergency contact</h1>
