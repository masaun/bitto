...
const CONTRACT_ADDRESS = process.env.CRISIS_MANAGEMENT_PHILANTHROPY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'crisis-management-philanthropy';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CrisisManagementPhilanthropy', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
