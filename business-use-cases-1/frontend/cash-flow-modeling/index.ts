...
const CONTRACT_ADDRESS = process.env.CASH_FLOW_MODELING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'cash-flow-modeling';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CashFlowModeling', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
