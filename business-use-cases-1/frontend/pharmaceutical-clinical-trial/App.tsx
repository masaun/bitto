...
export default function pharmaceuticalclinicaltrial() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical clinical trial',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-clinical-trial',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical clinical trial</h1>
