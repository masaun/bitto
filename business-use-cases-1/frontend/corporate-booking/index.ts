...
const CONTRACT_ADDRESS = process.env.CORPORATE_BOOKING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'corporate-booking';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CorporateBooking', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
