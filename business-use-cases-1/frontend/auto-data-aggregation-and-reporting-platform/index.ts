...
const CONTRACT_ADDRESS = process.env.AUTO_DATA_AGGREGATION_AND_REPORTING_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'auto-data-aggregation-and-reporting-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutoDataAggregationAndReportingPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
