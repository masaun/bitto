...
const CONTRACT_ADDRESS = process.env.EMERGENCY_RELIEF_FUNDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'emergency-relief-funds';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EmergencyReliefFunds', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
