...
export default function educationgrademanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education grade management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-grade-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education grade management</h1>
