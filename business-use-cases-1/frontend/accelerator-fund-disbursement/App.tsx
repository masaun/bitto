...
export default function acceleratorfunddisuursement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator fund disuursement',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-fund-disbursement',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator fund disuursement</h1>
