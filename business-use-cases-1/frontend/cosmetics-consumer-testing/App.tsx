...
export default function cosmeticsconsumertesting() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics consumer testing',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-consumer-testing',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics consumer testing</h1>
