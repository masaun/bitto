...
const CONTRACT_ADDRESS = process.env.CONFIDENTIAL_COMPUTING_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'confidential-computing-system';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConfidentialComputingSystem', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
