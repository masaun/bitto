...
const CONTRACT_NAME = 'monitoring-and-analytics-platform-for-agriculture';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'Monitoring And Analytics Platform For Agriculture', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={ padding: '20px', fontFamily: 'Arial, sans-serif' }>
      <h1>Monitoring And Analytics Platform For Agriculture</h1>
      {!userData ? (
