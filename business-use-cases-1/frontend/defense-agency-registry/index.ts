...
const CONTRACT_ADDRESS = process.env.DEFENSE_AGENCY_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'defense-agency-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DefenseAgencyRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
