...
const CONTRACT_ADDRESS = process.env.ALLVOICES_STYLE_WHISTLEBLOWING_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'allvoices-style-whistleblowing-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AllvoicesStyleWhistleblowingPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
