...
const CONTRACT_ADDRESS = process.env.BOUTIQUE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'boutique-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BoutiqueRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
