...
const CONTRACT_ADDRESS = process.env.ENERGY_PERFORMANCE_MONITORING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'energy-performance-monitoring';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EnergyPerformanceMonitoring', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
