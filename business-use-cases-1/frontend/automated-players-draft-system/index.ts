...
const CONTRACT_ADDRESS = process.env.AUTOMATED_PLAYERS_DRAFT_SYSTEM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'automated-players-draft-system';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AutomatedPlayersDraftSystem', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
