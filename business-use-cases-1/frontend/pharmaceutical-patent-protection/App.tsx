...
export default function pharmaceuticalpatentprotection() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'pharmaceutical patent protection',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'pharmaceutical-patent-protection',
  ...
  if (!userData) {
    return (
      <div>
        <h1>pharmaceutical patent protection</h1>
