...
const CONTRACT_ADDRESS = process.env.BOARD_VOTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'board-voting';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BoardVoting', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
