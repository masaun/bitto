...
const CONTRACT_ADDRESS = process.env.EARMARKED_FUNDS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'earmarked-funds';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EarmarkedFunds', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
