...
const CONTRACT_ADDRESS = process.env.CONFLICT_OF_INTEREST_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'conflict-of-interest';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConflictOfInterest', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
