...
const CONTRACT_ADDRESS = process.env.CREATOR_MEETUPS_PLATFORM_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'creator-meetups-platform';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CreatorMeetupsPlatform', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
