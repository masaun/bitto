...
const CONTRACT_ADDRESS = process.env.DECENTRALIZING_FOOD_DELIVERY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralizing-food-delivery';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizingFoodDelivery', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
