...
const CONTRACT_ADDRESS = process.env.DATA_USAGE_METERING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'data-usage-metering';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DataUsageMetering', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
