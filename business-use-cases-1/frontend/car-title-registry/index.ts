...
const CONTRACT_ADDRESS = process.env.CAR_TITLE_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'car-title-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarTitleRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
