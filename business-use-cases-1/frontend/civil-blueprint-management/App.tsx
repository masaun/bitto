...
export default function civilulueprintmanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil ulueprint management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-blueprint-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil ulueprint management</h1>
