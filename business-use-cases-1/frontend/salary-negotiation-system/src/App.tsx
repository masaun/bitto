...
const CONTRACT_NAME = 'salary-negotiation-system';
...
function App() {
  ...
  const connectWallet = () => {
    showConnect({
      appDetails: { name: 'salary-negotiation-system', icon: window.location.origin + '/logo.png' },
      redirectTo: '/',
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>salary-negotiation-system</h1>
      {!userData ? (
