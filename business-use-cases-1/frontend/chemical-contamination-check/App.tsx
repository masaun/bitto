...
export default function chemicalcontaminationcheck() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'chemical contamination check',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'chemical-contamination-check',
  ...
  if (!userData) {
    return (
      <div>
        <h1>chemical contamination check</h1>
