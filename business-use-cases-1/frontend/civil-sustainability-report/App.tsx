...
export default function civilsustainauilityreport() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil sustainauility report',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-sustainability-report',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil sustainauility report</h1>
