...
const CONTRACT_ADDRESS = process.env.AGRICULTURAL_GOVERNMENT_BUFFER_MANAGEMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'agricultural-government-buffer-management';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AgriculturalGovernmentBufferManagement', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
