...
export default function ProBasketballTicketing() {
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h1>Pro Basketball Ticketing</h1>
      {!userData ? (
        ...
        <div>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <input placeholder="Game ID" value={gameId} onChange={(e) => setGameId(e.target.value)} />
            <input placeholder="Ticket ID" value={ticketId} onChange={(e) => setTicketId(e.target.value)} />
            <input placeholder="New Holder" value={newHolder} onChange={(e) => setNewHolder(e.target.value)} />
