...
export default function cosmeticsrawmaterialspec() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'cosmetics raw material spec',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'cosmetics-raw-material-spec',
  ...
  if (!userData) {
    return (
      <div>
        <h1>cosmetics raw material spec</h1>
