...
export default function civilsuucontractormanagement() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil suucontractor management',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-subcontractor-management',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil suucontractor management</h1>
