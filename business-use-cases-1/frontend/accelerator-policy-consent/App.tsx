...
export default function acceleratorpolicyconsent() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator policy consent',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-policy-consent',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator policy consent</h1>
