...
export default function acceleratorcodeofconduct() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator code of conduct',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-code-of-conduct',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator code of conduct</h1>
