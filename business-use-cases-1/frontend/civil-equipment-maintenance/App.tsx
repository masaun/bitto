...
export default function civilequipmentmaintenance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'civil equipment maintenance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'civil-equipment-maintenance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>civil equipment maintenance</h1>
