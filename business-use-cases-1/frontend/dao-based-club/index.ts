...
const CONTRACT_ADDRESS = process.env.DAO_BASED_CLUB_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'dao-based-club';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DaoBasedClub', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
