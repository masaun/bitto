...
const CONTRACT_ADDRESS = process.env.CAPACITY_BUILDING_GRANTS_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'capacity-building-grants';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CapacityBuildingGrants', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
