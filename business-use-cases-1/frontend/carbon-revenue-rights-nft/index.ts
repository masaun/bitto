...
const CONTRACT_ADDRESS = process.env.CARBON_REVENUE_RIGHTS_NFT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'carbon-revenue-rights-nft';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CarbonRevenueRightsNft', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
