...
const CONTRACT_ADDRESS = process.env.EDGE_PREPROCESSING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'edge-preprocessing';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'EdgePreprocessing', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
