...
const CONTRACT_ADDRESS = process.env.CAPITAL_COMMITMENT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'capital-commitment';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CapitalCommitment', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
