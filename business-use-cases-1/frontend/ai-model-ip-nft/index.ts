...
const CONTRACT_ADDRESS = process.env.AI_MODEL_IP_NFT_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-model-ip-nft';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AiModelIpNft', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
