...
export default function educationeventregistration() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education event registration',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-event-registration',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education event registration</h1>
