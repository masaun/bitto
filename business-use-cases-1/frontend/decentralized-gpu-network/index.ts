...
const CONTRACT_ADDRESS = process.env.DECENTRALIZED_GPU_NETWORK_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'decentralized-gpu-network';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'DecentralizedGpuNetwork', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
