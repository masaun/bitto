...
export default function acceleratorprogramperformance() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'accelerator program performance',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'accelerator-program-performance',
  ...
  if (!userData) {
    return (
      <div>
        <h1>accelerator program performance</h1>
