...
export default function educationvaccinationrecords() {
  ...
  const authenticate = () => {
    showConnect({
      appDetails: {
        name: 'education vaccination records',
  ...
  const createRecord = async () => {
    ...
    const options = {
      ...
      contractName: 'education-vaccination-records',
  ...
  if (!userData) {
    return (
      <div>
        <h1>education vaccination records</h1>
