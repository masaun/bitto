...
const CONTRACT_ADDRESS = process.env.BRAND_GOVERNANCE_LUXURY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'brand-governance-luxury';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BrandGovernanceLuxury', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
