...
const CONTRACT_ADDRESS = process.env.BUSINESS_MODEL_ANALYTICS_MODEL_MARKETPACE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'business-model-analytics-model-marketpace';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'BusinessModelAnalyticsModelMarketpace', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
