...
const CONTRACT_ADDRESS = process.env.COMMUNITY_IMPACT_REPORTING_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'community-impact-reporting';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CommunityImpactReporting', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
