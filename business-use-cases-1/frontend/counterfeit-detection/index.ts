...
const CONTRACT_ADDRESS = process.env.COUNTERFEIT_DETECTION_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'counterfeit-detection';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'CounterfeitDetection', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
