...
const CONTRACT_ADDRESS = process.env.AI_TARGETING_GOVERNANCE_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'ai-targeting-governance';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'AiTargetingGovernance', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
