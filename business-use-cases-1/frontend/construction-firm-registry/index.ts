...
const CONTRACT_ADDRESS = process.env.CONSTRUCTION_FIRM_REGISTRY_CONTRACT_ADDRESS || '';
const CONTRACT_NAME = 'construction-firm-registry';
...
document.getElementById('connectBtn')?.addEventListener('click', () => {
  showConnect({
    appDetails: { name: 'ConstructionFirmRegistry', icon: window.location.origin + '/logo.png' },
    redirectTo: '/',
