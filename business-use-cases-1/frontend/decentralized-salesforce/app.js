...
const contractName = 'decentralized-salesforce';
...
document.getElementById('create-account').addEventListener('click', () => {
  callContract('create-account', []);
});

document.getElementById('add-lead').addEventListener('click', () => {
  callContract('add-lead', []);
});

document.getElementById('convert-lead').addEventListener('click', () => {
  callContract('convert-lead', []);
});

document.getElementById('create-subscription').addEventListener('click', () => {
  callContract('create-subscription', []);
});

document.getElementById('update-account-status').addEventListener('click', () => {
  callContract('update-account-status', []);
});
