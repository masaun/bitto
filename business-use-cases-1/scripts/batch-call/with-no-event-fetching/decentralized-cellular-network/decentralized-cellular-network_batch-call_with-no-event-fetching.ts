...
const contractDetails = parseContractIdentifier(
  process.env.DECENTRALIZED_CELLULAR_NETWORK_CONTRACT_ADDRESS,
  'decentralized-cellular-network'
);
  ...
  return [
    {
      ...
      description: 'Create cellular network',
    },
    {
      name: 'register-node',
      args: (index: number, sender: string) => [
      ...
      description: 'Register network node',
    },
    {
      name: 'start-data-session',
      args: (index: number, sender: string) => [
        uintCV(1000000),
        uintCV(1000000),
        uintCV(1000000),
      ],
      description: 'Start data session',
    },
    {
      name: 'distribute-node-rewards',
      args: (index: number, sender: string) => [
        uintCV(1000000),
        uintCV(1000000),
        uintCV(1000000),
      ],
      description: 'Distribute node rewards',
    },
    {
...
async function executeAllBatchCalls(dryRun: boolean = false, specificFunction?: string): Promise<BatchCallResult[]> {
  console.log('\n=== Starting Batch Calls for Decentralized Cellular Network Contract ===');
...
async function main(): Promise<void> {
  console.log('==========================================================');
  console.log('  Decentralized Cellular Network Contract - Batch Call Script');
  ...
  console.log(`Batch Size: ${CONFIG.batchSize} calls per function`);
  console.log(`Environment Variable: DECENTRALIZED_CELLULAR_NETWORK_CONTRACT_ADDRESS`);

  if (!process.env.DECENTRALIZED_CELLULAR_NETWORK_CONTRACT_ADDRESS) {
    console.warn('\n⚠ Warning: DECENTRALIZED_CELLULAR_NETWORK_CONTRACT_ADDRESS not set in environment.');
